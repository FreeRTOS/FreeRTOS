 ...
 * \return      error code
 */
    int32_t drv_flash_initialize( const csi_flash_t * instance,
                                  flash_event_cb_t cb_event );
 ...
 */
    int32_t drv_flash_read( const csi_flash_t * instance,
                            uint32_t addr,
                            void * data,
                            uint32_t cnt );
 ...
 */
    int32_t drv_flash_program( const csi_flash_t * instance,
                               uint32_t addr,
                               const void * data,
                               uint32_t cnt );
 ...
 * \return      error code
 */
    int32_t drv_flash_erase_sector( const csi_flash_t * instance,
                                    uint32_t addr );
