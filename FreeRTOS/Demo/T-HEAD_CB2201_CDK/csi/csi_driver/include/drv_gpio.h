 ...
 * \return      error code
 */
    int32_t csi_gpio_port_write( gpio_port_handle_t handle,
                                 uint32_t mask,
                                 uint32_t value );
 ...
 * \return      error code
 */
    int32_t csi_gpio_port_read( gpio_port_handle_t handle,
                                uint32_t mask,
                                uint32_t * value );
 ...
 * \return      error code
 */
    int32_t csi_gpio_pin_write( gpio_pin_handle_t pin,
                                bool value );
 ...
 * \return      error code
 */
    int32_t csi_gpio_pin_read( gpio_pin_handle_t pin,
                               bool * value );
 ...
 * \return      error code
 */
    int32_t csi_gpio_pin_irq_set( gpio_pin_handle_t pin,
