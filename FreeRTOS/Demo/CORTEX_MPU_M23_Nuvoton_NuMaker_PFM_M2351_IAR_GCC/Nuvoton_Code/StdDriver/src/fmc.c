 ...
 */
int32_t FMC_Read_OTP( uint32_t u32OtpNum,
                      uint32_t * u32LowWord,
                      uint32_t * u32HighWord )
{
    int32_t ret = 0;
 ...
 */
int32_t FMC_SetSPKey( uint32_t au32Key[ 3 ],
                      uint32_t u32Kpmax,
                      uint32_t u32Kemax,
                      const int32_t i32LockCONFIG,
                      const int32_t i32LockSPROM )
{
 ...
 */
int32_t FMC_WriteConfig( uint32_t au32Config[],
                         uint32_t u32Count )
{
    int32_t ret = 0;
    uint32_t i;
 ...
 */
int32_t FMC_Write_OTP( uint32_t u32OtpNum,
                       uint32_t u32LowWord,
                       uint32_t u32HighWord )
{
    int32_t ret = 0;
