...
/* fips wrapper calls, user can call direct */
    ...
    ( !defined( HAVE_FIPS_VERSION ) || ( HAVE_FIPS_VERSION < 2 ) )
        ...
        int wc_InitSha256_ex( wc_Sha256 * sha,
                              void * heap,
                              int devId )
        {
            ( void ) heap;
        ...
        int wc_Sha256Final( wc_Sha256 * sha,
                            byte * out )
        {
...
/* #if defined(HAVE_INTEL_AVX1/2) at the tail of sha256 */
                ...
                static int (* Transform_Sha256_p)( wc_Sha256 * sha256,
                                                   const byte * data );
                /* = _Transform_Sha256 */
                static int (* Transform_Sha256_Len_p)( wc_Sha256 * sha256,
                                                       const byte * data,
                                                       word32 len );
                /* = NULL */
                ...
                int wc_InitSha256_ex( wc_Sha256 * sha256,
                                      void * heap,
                                      int devId )
                {
                    int ret = 0;
                ...
                static int Transform_Sha256_Len( wc_Sha256 * sha256,
                                                 const byte * data,
                                                 word32 len )
                {
                    int ret = wolfSSL_CryptHwMutexLock();
                    ...
                    if( ret == 0 )
                    {
                        ...
                        #endif /* if defined( WC_HASH_DATA_ALIGNMENT ) && WC_HASH_DATA_ALIGNMENT > 0 */
                        {
                            #ifdef FREESCALE_MMCAU_CLASSIC_SHA
...
/* Supports CubeMX HAL or Standard Peripheral Library */
                ...
                static int wc_Sha256SCE_XTRANSFORM( wc_Sha256 * sha256,
                                                    const byte * data )
                {
...
/* implemented in wolfcrypt/src/port/cypress/psoc6_crypto.c */
            ...
            #else  /* if defined( HAVE_INTEL_AVX1 ) || defined( HAVE_INTEL_AVX2 ) */
                #define NEED_SOFT_SHA256
 ...
 *  the compilers can recognize them better for optimization */
    ...
    h( j ) = t0 + t1
                                                 ...
                                                 const byte * data )
                    {
                        ...
                        #else  /* ifdef WOLFSSL_SMALL_STACK_CACHE */
                            word32 W[ WC_SHA256_BLOCK_SIZE ];
                        #endif /* ifdef WOLFSSL_SMALL_STACK_CACHE */
                ...
                #else  /* ifndef SHA256_MANY_REGISTERS */
    ...
    h( j ) = t0 + t1
            ...
            #endif /* ifdef NEED_SOFT_SHA256 */
/* End wc_ software implementation */


            #ifdef XTRANSFORM

                static WC_INLINE void AddLength( wc_Sha256 * sha256,
                                                 word32 len )
                {
...
/* do block size increments/updates */
                                                   ...
                                                   word32 len )
                {
                    ...
                    if( sha256->buffLen > 0 )
                    {
                        ...
                        if( sha256->buffLen == WC_SHA256_BLOCK_SIZE )
                        {
                            ...
                            #else  /* if defined( WOLFSSL_ESP32WROOM32_CRYPT ) && !defined( NO_WOLFSSL_ESP32WROOM32_CRYPT_HASH ) */
                                ret = XTRANSFORM( sha256, ( const byte * ) local );
                    ...
                    #endif /* if !defined( XTRANSFORM_LEN ) || defined( HAVE_INTEL_AVX1 ) || defined( HAVE_INTEL_AVX2 ) */
                ...
                static WC_INLINE int Sha256Final( wc_Sha256 * sha256 )
                {
                    ...
                    #endif /* if defined( FREESCALE_MMCAU_SHA ) || defined( HAVE_INTEL_AVX1 ) || defined( HAVE_INTEL_AVX2 ) */
                ...
                int wc_Sha256FinalRaw( wc_Sha256 * sha256,
                                       byte * hash )
                {
...
/* Supports CubeMX HAL or Standard Peripheral Library */
                    ...
                    int wc_InitSha224_ex( wc_Sha224 * sha224,
                                          void * heap,
                                          int devId )
                    {
                        if( sha224 == NULL )
        ...
        #ifdef WOLFSSL_SHA224
            int wc_Sha224GetHash( wc_Sha224 * sha224,
                                  byte * hash )
            {
                int ret;
                wc_Sha224 tmpSha224;
            ...
            int wc_Sha224Copy( wc_Sha224 * src,
                               wc_Sha224 * dst )
            {
                int ret = 0;
            ...
            #if defined( WOLFSSL_HASH_FLAGS ) || defined( WOLF_CRYPTO_CB )
                int wc_Sha224SetFlags( wc_Sha224 * sha224,
                                       word32 flags )
                {
                    if( sha224 )
                    {
                ...
                int wc_Sha224GetFlags( wc_Sha224 * sha224,
                                       word32 * flags )
                {
                    if( sha224 && flags )
                    {
            ...
            #endif /* if defined( WOLFSSL_HASH_FLAGS ) || defined( WOLF_CRYPTO_CB ) */
...
/* implemented in wolfcrypt/src/port/Renesas/renesas_tsip_sha.c */
            ...
            int wc_Sha256Copy( wc_Sha256 * src,
                               wc_Sha256 * dst )
            {
                int ret = 0;
        ...
        #endif /* ifdef WOLFSSL_AFALG_HASH */

        #if defined( WOLFSSL_HASH_FLAGS ) || defined( WOLF_CRYPTO_CB )
            int wc_Sha256SetFlags( wc_Sha256 * sha256,
                                   word32 flags )
            {
                if( sha256 )
                {
            ...
            int wc_Sha256GetFlags( wc_Sha256 * sha256,
                                   word32 * flags )
            {
                if( sha256 && flags )
                {
