...
extern __inline__ int metal_cpu_get_msip( struct metal_cpu * cpu,
                                          int hartid );

extern __inline__ struct metal_interrupt * metal_cpu_interrupt_controller( struct metal_cpu * cpu );

extern __inline__ int metal_cpu_exception_register( struct metal_cpu * cpu,
                                                    int ecode,
...
extern __inline__ struct metal_buserror * metal_cpu_get_buserror( struct metal_cpu * cpu );
