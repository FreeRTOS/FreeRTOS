...
void __metal_driver_ucb_htif0_init( struct metal_uart * uart,
                                    int baud_rate );
int __metal_driver_ucb_htif0_putc( struct metal_uart * uart,
                                   int c );
int __metal_driver_ucb_htif0_getc( struct metal_uart * uart,
                                   int * c );
...
#endif /* ifndef METAL__DRIVERS__UCB_HTIF0_H */
