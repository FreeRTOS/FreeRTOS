...
extern void halLcdDrawCurrentLine( const unsigned int * value,
                                   int length );

/*Draw at specified location by calling */
/*LCD_Set_Address(Address) & LCD_Draw_Current_Block( value ) */
extern void halLcdDrawBlock( unsigned int Address,
                             unsigned int Value );
...
extern void halLcdPixel( int x,
                         int y,
                         unsigned char GrayScale );
/*Draw Line from (x1,y1) to (x2,y2) with GrayScale level */
extern void halLcdLine( int x1,
                        int y1,
                        int x2,
                        int y2,
                        unsigned char GrayScale );
extern void halLcdHLine( int x1,
                         int x2,
                         int y,
                         unsigned char GrayScale );
extern void halLcdVLine( int x1,
                         int x2,
                         int y,
                         unsigned char GrayScale );

extern void halLcdCircle( int x,
                          int y,
                          int Radius,
                          int GrayScale );

extern void halLcdImage( const unsigned int Image[],
                         int Columns,
                         int Rows,
                         int x,
                         int y );
extern void halLcdClearImage( int Columns,
                              int Rows,
                              int x,
                              int y );

/*Print String of Length starting at current LCD location */
extern void halLcdPrint( char String[],
                         unsigned char TextStyle );

/*Print String of Length starting at (x,y) */
extern void halLcdPrintXY( char String[],
                           int x,
                           int y,
                           unsigned char TextStyle );

/*Print String of Length starting at (x,y) */
extern void halLcdPrintLine( char String[],
                             unsigned char Line,
                             unsigned char TextStyle );
extern void halLcdPrintLineCol( char String[],
                                unsigned char Line,
                                unsigned char Col,
                                unsigned char TextStyle );
...
extern void halLcdHScroll( int yStart,
                           int yEnd );
