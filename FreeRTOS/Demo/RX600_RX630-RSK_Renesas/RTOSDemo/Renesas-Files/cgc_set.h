...
#else  /* if   ( PCLK1215_DIV == 64 ) */
    #define PCLK1215_SCKCR    0x00001000L
#endif /* if   ( PCLK1215_DIV == 64 ) */
...
#else  /* if   ( PCLKB_DIV == 64 ) */
    #define PCLKB_SCKCR    0x00000100L
#endif /* if   ( PCLKB_DIV == 64 ) */
...
#else  /* if   ( PCLK47_DIV == 64 ) */
    #define PCLK47_SCKCR    0x00000010L
#endif /* if   ( PCLK47_DIV == 64 ) */
...
#else  /* if   ( PCLK03_DIV == 64 ) */
    #define PCLK03_SCKCR    0x00000001L
#endif /* if   ( PCLK03_DIV == 64 ) */
...
#endif /* if ( CLK_SOURCE == CLK_SOURCE_LOCO ) */

#endif /* ifndef CGC_SET_VALUES_H_ */
