...
/* void *R_BSP_GetEXTB(void) (This macro uses API function of BSP.) */
        ...
        #endif /* if defined( __CCRX__ ) */
    #endif /* ifdef BSP_MCU_EXCEPTION_TABLE */
...
***********************************************************************************************************************/
    ...
    R_BSP_ATTRIB_INLINE_ASM void R_BSP_BitSet( uint8_t * data,
                                               uint32_t bit );
    R_BSP_ATTRIB_INLINE_ASM void R_BSP_BitClear( uint8_t * data,
                                                 uint32_t bit );
    R_BSP_ATTRIB_INLINE_ASM void R_BSP_BitReverse( uint8_t * data,
                                                   uint32_t bit );
    ...
    int32_t R_BSP_MoveFromAccMiLong( void );
            ...
            #ifdef __FPU
                R_BSP_ATTRIB_INLINE_ASM void R_BSP_CalcSine_Cosine( float f,
                                                                    float * sin,
                                                                    float * cos );
                R_BSP_ATTRIB_INLINE_ASM void R_BSP_CalcAtan_SquareRoot( float y,
                                                                        float x,
                                                                        float * atan2,
                                                                        float * hypot );
            #endif /* __FPU */
        #endif /* __TFU */
    #endif /* ifdef BSP_MCU_TRIGONOMETRIC */
