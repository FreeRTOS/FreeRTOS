...
void __metal_zero_memory( unsigned char * base,
                          unsigned int size )
{
...
void __metal_default_exception_handler( struct metal_cpu * cpu,
                                        int ecode )
{
    metal_shutdown( 100 );
}

void __metal_default_interrupt_handler( int id,
                                        void * priv )
{
    metal_shutdown( 200 );
}
...
void __metal_default_sw_handler( int id,
                                 void * priv )
{
    uintptr_t mcause;
    struct __metal_driver_riscv_cpu_intc * intc;
...
void __metal_default_beu_handler( int id,
                                  void * priv )
{
}

void __metal_default_timer_handler( int id,
                                    void * priv )
{
...
struct metal_interrupt * __metal_driver_cpu_timer_controller_interrupt( struct metal_cpu * cpu )
{
...
struct metal_interrupt * __metal_driver_cpu_sw_controller_interrupt( struct metal_cpu * cpu )
{
    #ifdef __METAL_DT_RISCV_CLINT0_HANDLE
        return __METAL_DT_RISCV_CLINT0_HANDLE;
    #else
...
int __metal_driver_cpu_set_sw_ipi( struct metal_cpu * cpu,
                                   int hartid )
{
    int rc = -1;
...
int __metal_driver_cpu_clear_sw_ipi( struct metal_cpu * cpu,
                                     int hartid )
{
    int rc = -1;
    struct metal_interrupt * sw_intc;
...
int __metal_driver_cpu_get_msip( struct metal_cpu * cpu,
                                 int hartid )
{
    int rc = 0;
    struct metal_interrupt * sw_intc;
...
struct metal_interrupt * __metal_driver_cpu_controller_interrupt( struct metal_cpu * cpu )
{
    return __metal_driver_cpu_interrupt_controller( cpu );
}

int __metal_driver_cpu_enable_interrupt( struct metal_cpu * cpu,
                                         void * priv )
{
...
int __metal_driver_cpu_disable_interrupt( struct metal_cpu * cpu,
                                          void * priv )
{
    if( __metal_driver_cpu_interrupt_controller( cpu ) )
    {
...
int __metal_driver_cpu_exception_register( struct metal_cpu * cpu,
                                           int ecode,
                                           metal_exception_handler_t isr )
{
    struct __metal_driver_riscv_cpu_intc * intc =
...
int __metal_driver_cpu_set_exception_pc( struct metal_cpu * cpu,
                                         uintptr_t mepc )
{
