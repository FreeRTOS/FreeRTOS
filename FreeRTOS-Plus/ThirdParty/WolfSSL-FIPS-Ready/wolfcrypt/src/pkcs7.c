...
/* creates a PKCS7State structure and returns 0 on success */
        ...
        static void wc_PKCS7_ResetStream( PKCS7 * pkcs7 )
        {
            if( ( pkcs7 != NULL ) && ( pkcs7->stream != NULL ) )
            {
                ...
                #endif /* ifdef WC_PKCS7_STREAM_DEBUG */
 ...
 * returns 0 on success  */
        static int wc_PKCS7_GrowStream( PKCS7 * pkcs7,
                                        word32 newSz )
        {
            byte * pt;
 ...
 * returns 0 on success
 */
        static int wc_PKCS7_AddDataToStream( PKCS7 * pkcs7,
                                             byte * in,
                                             word32 inSz,
                                             word32 expected,
                                             byte ** pt,
 ...
 */
        static long wc_PKCS7_GetMaxStream( PKCS7 * pkcs7,
                                           byte flag,
                                           byte * in,
                                           word32 defSz )
        {
...
/* setter function for stored variables */
        static void wc_PKCS7_StreamStoreVar( PKCS7 * pkcs7,
                                             word32 var1,
                                             int var2,
                                             int var3 )
        {
...
/* getter function for stored variables */
        static void wc_PKCS7_StreamGetVar( PKCS7 * pkcs7,
                                           word32 * var1,
                                           int * var2,
                                           int * var3 )
        {
 ...
 * returns 0 on success */
        static int wc_PKCS7_StreamEndCase( PKCS7 * pkcs7,
                                           word32 * tmpIdx,
                                           word32 * idx )
        {
            int ret = 0;
 ...
 * for easier debugging */
    static void wc_PKCS7_ChangeState( PKCS7 * pkcs7,
                                      int newState )
    {
        #ifdef WC_PKCS7_STREAM_DEBUG
 ...
 * 0 upon failure */
                                  ...
                                  word32 outputSz )
    {
        ...
        const byte envelopedData[] =
        {
            0x2A, 0x86, 0x48, 0x86, 0xF7,
            0x0D, 0x01, 0x07, 0x03
        };
        const byte authEnvelopedData[] =
        {
            0x2A, 0x86, 0x48, 0x86, 0xF7,
            0x0D, 0x01, 0x09, 0x10, 0x01, 0x17
        };
        const byte signedAndEnveloped[] =
        {
            0x2A, 0x86, 0x48, 0x86, 0xF7,
            0x0D, 0x01, 0x07, 0x04
        };
        const byte digestedData[] =
        {
            0x2A, 0x86, 0x48, 0x86, 0xF7,
            0x0D, 0x01, 0x07, 0x05
        };
        ...
        #endif /* if !defined( NO_PWDBASED ) && !defined( NO_SHA ) */
...
/* get ASN.1 contentType OID sum, return 0 on success, <0 on failure */
    static int wc_GetContentType( const byte * input,
                                  word32 * inOutIdx,
                                  word32 * oid,
                                  word32 maxIdx )
    {
 ...
 * return 0 */
    static int wc_PKCS7_RecipientListIncludesType( PKCS7 * pkcs7,
                                                   int type )
    {
        Pkcs7EncodedRecip * tmp = NULL;
 ...
 * Returns 0 on success, negative upon error */
    int wc_PKCS7_AddCertificate( PKCS7 * pkcs7,
                                 byte * derCert,
                                 word32 derCertSz )
    {
        Pkcs7Cert * cert;
...
/* free linked list of PKCS7DecodedAttrib structs */
    static void wc_PKCS7_FreeDecodedAttrib( PKCS7DecodedAttrib * attrib,
                                            void * heap )
    {
 ...
 * returns 0 on success
 */
    static int wc_PKCS7_SignerInfoSetSID( PKCS7 * pkcs7,
                                          byte * in,
                                          int inSz )
    {
 ...
 * returns PKCS7DecodedAttrib pointer on success */
    static PKCS7DecodedAttrib * findAttrib( PKCS7 * pkcs7,
                                            const byte * oid,
                                            word32 oidSz )
    {
 ...
 */
    int wc_PKCS7_GetAttributeValue( PKCS7 * pkcs7,
                                    const byte * oid,
                                    word32 oidSz,
                                    byte * out,
                                    word32 * outSz )
...
/* build PKCS#7 data content type */
    ...
    static int EncodeAttributes( EncodedAttrib * ea,
                                 int eaSz,
                                 PKCS7Attrib * attribs,
                                 int attribsSz )
    {
...
/* Free FlatAttrib array and memory allocated to internal struct members */
    static void FreeAttribArray( PKCS7 * pkcs7,
                                 FlatAttrib ** arr,
                                 int rows )
    {
        int i;
...
/* Sort FlatAttrib array in ascending order */
    static int SortAttribArray( FlatAttrib ** arr,
                                int rows )
    {
        int i, j;
        word32 minSz, minIdx;
 ...
 * holds flattened DER encoding of each attribute */
    static int FlattenEncodedAttribs( PKCS7 * pkcs7,
                                      FlatAttrib ** derArr,
                                      int rows,
                                      EncodedAttrib * ea,
                                      int eaSz )
...
/* Sort and Flatten EncodedAttrib attributes into output buffer */
    static int FlattenAttributes( PKCS7 * pkcs7,
                                  byte * output,
                                  EncodedAttrib * ea,
                                  int eaSz )
    {
...
/* returns size of signature put into out, negative on error */
        static int wc_PKCS7_RsaSign( PKCS7 * pkcs7,
                                     byte * in,
                                     word32 inSz,
                                     ESD * esd )
        {
...
/* returns size of signature put into out, negative on error */
        static int wc_PKCS7_EcdsaSign( PKCS7 * pkcs7,
                                       byte * in,
                                       word32 inSz,
                                       ESD * esd )
        {
 ...
 * return 0 on success, negative on error */
    static int wc_PKCS7_BuildSignedAttributes( PKCS7 * pkcs7,
                                               ESD * esd,
                                               const byte * contentType,
                                               word32 contentTypeSz,
                                               const byte * contentTypeOid,
                                               word32 contentTypeOidSz,
                                               const byte * messageDigestOid,
                                               word32 messageDigestOidSz,
                                               const byte * signingTimeOid,
                                               word32 signingTimeOidSz,
                                               byte * signingTime,
                                               word32 signingTimeSz )
    {
        int hashSz;
 ...
 *
 * return 0 on success, negative on error */
    static int wc_PKCS7_SignedDataGetEncAlgoId( PKCS7 * pkcs7,
                                                int * digEncAlgoId,
                                                int * digEncAlgoType )
    {
        int algoId = 0;
 ...
 *
 * return 0 on success, negative on error */
    static int wc_PKCS7_BuildDigestInfo( PKCS7 * pkcs7,
 ...
 * returns length of signature on success, negative on error */
                                                  ...
                                                  ESD * esd )
    {
        ...
        #endif /* if defined( HAVE_ECC ) || ( defined( HAVE_PKCS7_RSA_RAW_SIGN_CALLBACK ) && !defined( NO_RSA ) ) */
        ...
        switch( pkcs7->publicKeyOID )
        {
                ...
                case RSAk:
                    ...
                    #endif /* ifdef HAVE_PKCS7_RSA_RAW_SIGN_CALLBACK */
 ...
 *
 * Returns 0 on success, negative upon error. */
    int wc_PKCS7_SetDetached( PKCS7 * pkcs7,
                              word16 flag )
    {
 ...
 * Returns length of generated bundle on success, negative upon error. */
    int wc_PKCS7_EncodeSignedFPD( PKCS7 * pkcs7,
                                  byte * privateKey,
                                  word32 privateKeySz,
                                  int signOID,
                                  int hashOID,
 ...
 *
 * Returns length of generated bundle on success, negative upon error. */
        int wc_PKCS7_EncodeSignedEncryptedFPD( PKCS7 * pkcs7,
                                               byte * encryptKey,
                                               word32 encryptKeySz,
                                               byte * privateKey,
                                               word32 privateKeySz,
 ...
 *
 * Returns length of generated bundle on success, negative upon error. */
        int wc_PKCS7_EncodeSignedCompressedFPD( PKCS7 * pkcs7,
                                                byte * privateKey,
                                                word32 privateKeySz,
                                                int signOID,
                                                int hashOID,
 ...
 *
 * Returns length of generated bundle on success, negative upon error. */
            int wc_PKCS7_EncodeSignedEncryptedCompressedFPD( PKCS7 * pkcs7,
                                                             byte * encryptKey,
                                                             word32 encryptKeySz,
                                                             byte * privateKey,
                                                             word32 privateKeySz,
...
/* register raw RSA sign digest callback */
            int wc_PKCS7_SetRsaSignRawDigestCb( PKCS7 * pkcs7,
...
/* returns size of signature put into out, negative on error */
        static int wc_PKCS7_RsaVerify( PKCS7 * pkcs7,
                                       byte * sig,
                                       int sigSz,
                                       byte * hash,
                                       word32 hashSz )
...
/* returns size of signature put into out, negative on error */
        static int wc_PKCS7_EcdsaVerify( PKCS7 * pkcs7,
                                         byte * sig,
                                         int sigSz,
                                         byte * hash,
                                         word32 hashSz )
 ...
 * returns 0 on success, negative on error */
    static int wc_PKCS7_BuildSignedDataDigest( PKCS7 * pkcs7,
                                               byte * signedAttrib,
 ...
 *
 * return 0 on success, negative on error */
    static int wc_PKCS7_SignedDataVerifySignature( PKCS7 * pkcs7,
                                                   byte * sig,
                                                   word32 sigSz,
                                                   byte * signedAttrib,
                                                   word32 signedAttribSz,
 ...
 * pkcs7->publicKeyOID and returns same value */
    static int wc_PKCS7_SetPublicKeyOID( PKCS7 * pkcs7,
                                         int sigOID )
    {
        if( pkcs7 == NULL )
        {
 ...
 */
    static int wc_PKCS7_ParseAttribs( PKCS7 * pkcs7,
                                      byte * in,
                                      int inSz )
    {
        int found = 0;
 ...
 */
    void wc_PKCS7_AllowDegenerate( PKCS7 * pkcs7,
                                   word16 flag )
    {
        if( pkcs7 )
        {
 ...
 * returns 0 on success
 */
    static int wc_PKCS7_ParseSignerInfo( PKCS7 * pkcs7,
                                         byte * in,
                                         word32 inSz,
                                         word32 * idxIn,
                                         int degenerate,
 ...
 */
    static int PKCS7_VerifySignedData( PKCS7 * pkcs7,
                                       const byte * hashBuf,
                                       word32 hashSz,
                                       byte * in,
                                       word32 inSz,
 ...
 *  length needed.
 */
    int wc_PKCS7_GetSignerSID( PKCS7 * pkcs7,
                               byte * out,
                               word32 * outSz )
    {
 ...
 *
 * Returns 0 on success, negative upon error */
    static int PKCS7_GenerateContentEncryptionKey( PKCS7 * pkcs7,
                                                   word32 len )
    {
        int ret;
        WC_RNG rng;
...
/* wrap CEK (content encryption key) with KEK, 0 on success, < 0 on error */
    static int wc_PKCS7_KeyWrap( byte * cek,
                                 word32 cekSz,
                                 byte * kek,
                                 word32 kekSz,
                                 byte * out,
 ...
 * returns struct pointer on success, NULL on failure */
        static WC_PKCS7_KARI * wc_PKCS7_KariNew( PKCS7 * pkcs7,
                                                 byte direction )
        {
 ...
 * key/keySz only needed during decoding (WC_PKCS7_DECODE) */
        static int wc_PKCS7_KariParseRecipCert( WC_PKCS7_KARI * kari,
                                                const byte * cert,
                                                word32 certSz,
                                                const byte * key,
                                                word32 keySz )
 ...
 * place in kari->sharedInfo. returns 0 on success, negative on error */
        static int wc_PKCS7_KariGenerateSharedInfo( WC_PKCS7_KARI * kari,
                                                    int keyWrapOID )
        {
            int idx = 0;
 ...
 * algorithm, place in kari->kek. return 0 on success, <0 on error. */
                                             ...
                                             int keyEncOID )
        {
            ...
            #else  /* if defined( ECC_TIMING_RESISTANT ) && ( !defined( HAVE_FIPS ) || ( !defined( HAVE_FIPS_VERSION ) || ( HAVE_FIPS_VERSION != 2 ) ) ) && !defined( HAVE_SELFTEST ) */
                ( void ) rng;
            #endif /* if defined( ECC_TIMING_RESISTANT ) && ( !defined( HAVE_FIPS ) || ( !defined( HAVE_FIPS_VERSION ) || ( HAVE_FIPS_VERSION != 2 ) ) ) && !defined( HAVE_SELFTEST ) */
 ...
 *
 * Returns 0 on success, negative upon error */
        int wc_PKCS7_AddRecipient_KARI( PKCS7 * pkcs7,
                                        const byte * cert,
                                        word32 certSz,
                                        int keyWrapOID,
                                        int keyAgreeOID,
 ...
 *
 * Returns 0 on success, negative upon error */
        int wc_PKCS7_AddRecipient_KTRI( PKCS7 * pkcs7,
                                        const byte * cert,
                                        word32 certSz,
                                        int options )
        {
...
/* encrypt content using encryptOID algo */
    static int wc_PKCS7_EncryptContent( int encryptOID,
                                        byte * key,
                                        int keySz,
                                        byte * iv,
                                        int ivSz,
        ...
        switch( encryptOID )
        {
                ...
                break;
                    ...
                    defined( WOLFSSL_AES_256 )
                        ...
                        break;
                    #endif /* if defined( WOLFSSL_AES_128 ) || defined( WOLFSSL_AES_192 ) || defined( WOLFSSL_AES_256 ) */
                #endif /* HAVE_AESGCM */
                #ifdef HAVE_AESCCM
                    #ifdef WOLFSSL_AES_128
                        case AES128CCMb:
 ...
 * returns 0 on success */
    static int wc_PKCS7_DecryptContent( PKCS7 * pkcs7,
                                        int encryptOID,
                                        byte * key,
                                        int keySz,
                                        byte * iv,
 ...
 * Used for generation of IV, nonce, etc */
    static int wc_PKCS7_GenerateBlock( PKCS7 * pkcs7,
                                       WC_RNG * rng,
                                       byte * out,
                                       word32 outSz )
    {
 ...
 * return 0 on success, negative upon error */
    int wc_PKCS7_SetSignerIdentifierType( PKCS7 * pkcs7,
                                          int type )
    {
        if( pkcs7 == NULL )
        {
 ...
 *
 * return 0 on success, negative upon error */
    int wc_PKCS7_SetContentType( PKCS7 * pkcs7,
                                 byte * contentType,
                                 word32 sz )
    {
...
/* return size of padded data, padded to blockSz chunks, or negative on error */
    int wc_PKCS7_GetPadSize( word32 inputSz,
                             word32 blockSz )
    {
        int padSz;
 ...
 *
 * Return 0 on success, negative upon error */
    int wc_PKCS7_AddRecipient_ORI( PKCS7 * pkcs7,
                                   ...
                                   int options )
    {
        ...
        static int wc_PKCS7_GenerateKEK_PWRI( PKCS7 * pkcs7,
                                              byte * passwd,
                                              word32 pLen,
                                              byte * salt,
                                              word32 saltSz,
 ...
 * Returns output size on success, negative upon error */
        static int wc_PKCS7_PwriKek_KeyWrap( PKCS7 * pkcs7,
                                             const byte * kek,
                                             word32 kekSz,
                                             const byte * cek,
                                             word32 cekSz,
 ...
 * Returns cek size on success, negative upon error */
        static int wc_PKCS7_PwriKek_KeyUnWrap( PKCS7 * pkcs7,
                                               const byte * kek,
                                               word32 kekSz,
                                               const byte * in,
                                               word32 inSz,
 ...
 *
 * Return 0 on success, negative upon error */
        int wc_PKCS7_AddRecipient_PWRI( PKCS7 * pkcs7,
                                        byte * passwd,
                                        word32 pLen,
                                        byte * salt,
                                        word32 saltSz,
 ...
 *
 * Returns 0 on success, negative upon error */
        int wc_PKCS7_SetPassword( PKCS7 * pkcs7,
                                  byte * passwd,
                                  word32 pLen )
        {
            if( ( pkcs7 == NULL ) || ( passwd == NULL ) || ( pLen == 0 ) )
 ...
 *
 * Returns 0 on success, negative upon error */
    int wc_PKCS7_AddRecipient_KEKRI( PKCS7 * pkcs7,
                                     int keyWrapOID,
                                     byte * kek,
                                     word32 kekSz,
                                     byte * keyId,
    ...
    static int wc_PKCS7_GetCMSVersion( PKCS7 * pkcs7,
                                       int cmsContentType )
    {
        int version = -1;
...
/* decode KeyTransRecipientInfo (ktri), return 0 on success, <0 on error */
        static int wc_PKCS7_DecryptKtri( PKCS7 * pkcs7,
                                         byte * in,
                                         word32 inSz,
                                         word32 * idx,
                                         byte * decryptedKey,
...
/* remove ASN.1 RecipientEncryptedKeys, return 0 on success, < 0 on error */
    ...
    int wc_PKCS7_SetOriEncryptCtx( PKCS7 * pkcs7,
                                   void * ctx )
    {
        if( pkcs7 == NULL )
        {
    ...
    int wc_PKCS7_SetOriDecryptCtx( PKCS7 * pkcs7,
                                   void * ctx )
    {
        if( pkcs7 == NULL )
        {
    ...
    int wc_PKCS7_SetOriDecryptCb( PKCS7 * pkcs7,
...
/* return 0 on success */
    int wc_PKCS7_SetWrapCEKCb( PKCS7 * pkcs7,
                               CallbackWrapCEK cb )
    {
        if( pkcs7 == NULL )
        {
 ...
 * Return 0 on success, negative upon error.
 */
    static int wc_PKCS7_DecryptOri( PKCS7 * pkcs7,
                                    byte * in,
                                    word32 inSz,
                                    word32 * idx,
                                    byte * decryptedKey,
 ...
 * < 0 on error */
        static int wc_PKCS7_DecryptPwri( PKCS7 * pkcs7,
                                         byte * in,
                                         word32 inSz,
                                         word32 * idx,
                                         byte * decryptedKey,
 ...
 * < 0 on error */
    static int wc_PKCS7_DecryptKekri( PKCS7 * pkcs7,
                                      byte * in,
                                      word32 inSz,
                                      word32 * idx,
                                      byte * decryptedKey,
 ...
 * < 0 on error */
    static int wc_PKCS7_DecryptKari( PKCS7 * pkcs7,
                                     byte * in,
                                     word32 inSz,
                                     word32 * idx,
                                     byte * decryptedKey,
...
/* decode ASN.1 RecipientInfos SET, return 0 on success, < 0 on error */
    static int wc_PKCS7_DecryptRecipientInfos( PKCS7 * pkcs7,
                                               byte * in,
                                               word32 inSz,
                                               word32 * idx,
                                               byte * decryptedKey,
            ...
            else
            {
                ...
                *idx = savedIdx;
                ...
                else if( tag == ( ASN_CONSTRUCTED | ASN_CONTEXT_SPECIFIC | 3 ) )
                {
                    ...
                    #else  /* if !defined( NO_PWDBASED ) && !defined( NO_SHA ) */
                        return NOT_COMPILED_IN;
                    #endif /* if !defined( NO_PWDBASED ) && !defined( NO_SHA ) */
 ...
 * return size of RecipientInfo SET on success, negative upon error */
    static int wc_PKCS7_ParseToRecipientInfoSet( PKCS7 * pkcs7,
                                                 byte * in,
                                                 word32 inSz,
                                                 word32 * idx,
                                                 int type )
 ...
 *
 * Returns 0 on success, negative upon error */
    WOLFSSL_API int wc_PKCS7_SetKey( PKCS7 * pkcs7,
                                     byte * key,
                                     word32 keySz )
    {
 ...
 * return 0 on success, negative on error */
    static int PKCS7_CacheEncryptedContent( PKCS7 * pkcs7,
                                            byte * in,
                                            word32 inSz )
    {
        byte * oldCache;
...
/* unwrap and decrypt PKCS#7 envelopedData object, return decoded size */
    WOLFSSL_API int wc_PKCS7_DecodeEnvelopedData( PKCS7 * pkcs7,
                                                  byte * in,
                                                  word32 inSz,
                                                  byte * output,
                                                  word32 outputSz )
...
/* build PKCS#7 authEnvelopedData content type, return enveloped size */
    int wc_PKCS7_EncodeAuthEnvelopedData( PKCS7 * pkcs7,
                                          byte * output,
                                          word32 outputSz )
    {
            ...
            return idx;
        #else  /* if defined( HAVE_AESGCM ) || defined( HAVE_AESCCM ) */
...
/* unwrap and decrypt PKCS#7 AuthEnvelopedData object, return decoded size */
    WOLFSSL_API int wc_PKCS7_DecodeAuthEnvelopedData( PKCS7 * pkcs7,
                                                      byte * in,
                                                      word32 inSz,
                                                      byte * output,
                                                      word32 outputSz )
...
/* build PKCS#7 encryptedData content type, return encrypted size */
        int wc_PKCS7_EncodeEncryptedData( PKCS7 * pkcs7,
                                          byte * output,
                                          word32 outputSz )
        {
            int ret, idx = 0;
 ...
 * 0 on success, negative on error. User must call wc_PKCS7_Free(). */
        static int wc_PKCS7_DecodeUnprotectedAttributes( PKCS7 * pkcs7,
                                                         byte * pkiMsg,
                                                         word32 pkiMsgSz,
                                                         word32 * inOutIdx )
        {
...
/* unwrap and decrypt PKCS#7/CMS encrypted-data object, returned decoded size */
        int wc_PKCS7_DecodeEncryptedData( PKCS7 * pkcs7,
                                          byte * in,
                                          word32 inSz,
                                          byte * output,
                                          word32 outputSz )
 ...
 * returns 0 on success
 */
        int wc_PKCS7_SetDecodeEncryptedCtx( PKCS7 * pkcs7,
                                            void * ctx )
        {
            if( pkcs7 != NULL )
            {
...
/* build PKCS#7 compressedData content type, return encrypted size */
        int wc_PKCS7_EncodeCompressedData( PKCS7 * pkcs7,
                                           byte * output,
                                           word32 outputSz )
        {
            byte contentInfoSeq[ MAX_SEQ_SZ ];
 ...
 * returned decoded size */
        int wc_PKCS7_DecodeCompressedData( PKCS7 * pkcs7,
                                           byte * pkiMsg,
                                           word32 pkiMsgSz,
                                           byte * output,
                                           word32 outputSz )
