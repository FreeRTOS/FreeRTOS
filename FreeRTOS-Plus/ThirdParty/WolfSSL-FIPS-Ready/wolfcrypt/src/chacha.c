 ...
 */
    ...
    #include <wolfssl/wolfcrypt/settings.h>
        ...
        #endif /* ifdef USE_INTEL_CHACHA_SPEEDUP */
 ...
 */
        int wc_Chacha_SetIV( ChaCha * ctx,
                             const byte * inIv,
                             word32 counter )
        {
 ...
 */
        int wc_Chacha_SetKey( ChaCha * ctx,
                              const byte * key,
                              word32 keySz )
        {
 ...
 */
        ...
        extern void chacha_encrypt_x64( ChaCha * ctx,
                                        const byte * m,
                                        byte * c,
                                        word32 bytes );
        extern void chacha_encrypt_avx1( ChaCha * ctx,
                                         const byte * m,
                                         byte * c,
                                         word32 bytes );
        extern void chacha_encrypt_avx2( ChaCha * ctx,
                                         const byte * m,
                                         byte * c,
                                         word32 bytes );
 ...
 */
        static void wc_Chacha_encrypt_bytes( ChaCha * ctx,
                                             const byte * m,
                                             byte * c,
                                             word32 bytes )
        {
 ...
 */
        int wc_Chacha_Process( ChaCha * ctx,
                               byte * output,
                               const byte * input,
                               word32 msglen )
        {
