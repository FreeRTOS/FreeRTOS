...
#include <wolfssl/wolfcrypt/settings.h>
        ...
        void ed25519_smult( ge_p3 * r,
                            const ge_p3 * a,
                            const byte * e );
        void ed25519_add( ge_p3 * r,
                          const ge_p3 * a,
                          const ge_p3 * b );
        void ed25519_double( ge_p3 * r,
                             const ge_p3 * a );
 ...
 * 7237005577332262213973186563042994240857116359379907606001950938285454250989 */
        ...
        static word32 lt( word32 a,
                          word32 b ) /* 16-bit inputs */
        {
            word32 x = a;
...
/* Reduce coefficients of x before calling barrett_reduce */
        static void barrett_reduce( word32 * r,
                                    word32 x[ 64 ] )
        {
            /* See HAC, Alg. 14.42 */
            int i, j;
...
/* k = 2d */
        ...
        void ed25519_smult( ge_p3 * r_out,
                            const ge_p3 * p,
                            const byte * e )
        {
            ge_p3 r;
        ...
        void ge_scalarmult_base( ge_p3 * R,
 ...
 * return 0 on success
 */
        int ge_frombytes_negate_vartime( ge_p3 * p,
