...
/* Buffer for benchmark tests */
    ...
    static WC_INLINE word32 min( word32 a,
                                 word32 b )
    {
        return a > b ? b : a;
    }
 ...
 * _XOPEN_SOURCE_EXTENDED is defined */
    ...
    #define WOLFSSL_THREAD
        ...
        #define WOLFSSL_THREAD
    #else  /* if defined( _POSIX_THREADS ) && !defined( __MINGW32__ ) */
        typedef unsigned int    THREAD_RETURN;
        typedef intptr_t        THREAD_TYPE;
        #define WOLFSSL_THREAD    __stdcall
    #endif /* if defined( _POSIX_THREADS ) && !defined( __MINGW32__ ) */
...
/* all certs relative to wolfSSL home directory now */
    ...
    #endif
#else  /* if defined( WOLFSSL_NO_CURRDIR ) || defined( WOLFSSL_MDK_SHELL ) */
    #define caCertFile           "./certs/ca-cert.pem"
    #define eccCertFile          "./certs/server-ecc.pem"
    #define eccKeyFile           "./certs/ecc-key.pem"
    #define eccRsaCertFile       "./certs/server-ecc-rsa.pem"
    ...
    #define caEd448CertFile      "./certs/ed448/ca-ed448.pem"
        ...
        #define wnrConfig        "./wnr-example.conf"
    #endif
#endif /* if defined( WOLFSSL_NO_CURRDIR ) || defined( WOLFSSL_MDK_SHELL ) */
...
static WC_INLINE int mygetopt( int argc,
                               char ** argv,
                               const char * optstring )
{
    ...
    static WC_INLINE int PasswordCallBack( char * passwd,
                                           int sz,
                                           int rw,
                                           void * userdata )
    {
...
static const char * client_showpeer_msg[][ 8 ] =
{
    ...
    #endif /* ifndef NO_MULTIBYTE_PRINT */
};
...
/* 0:English, 1:Japanese                                                     */
    static WC_INLINE void ShowX509Ex( WOLFSSL_X509 * x509,
                                      const char * hdr,
                                      int lng_index )
    {
        char * altName;
...
/* original ShowX509 to maintain compatibility */
    static WC_INLINE void ShowX509( WOLFSSL_X509 * x509,
                                    const char * hdr )
    {
    ...
    ( defined( OPENSSL_EXTRA ) || defined( OPENSSL_EXTRA_X509_SMALL ) )
    static WC_INLINE void ShowX509Chain( WOLFSSL_X509_CHAIN * chain,
                                         int count,
                                         const char * hdr )
    {
        int i;
...
/* lng_index is to specify the language for displaying message.              */
/* 0:English, 1:Japanese                                                     */
static WC_INLINE void showPeerEx( WOLFSSL * ssl,
                                  int lng_index )
{
...
static WC_INLINE void build_addr( SOCKADDR_IN_T * addr,
                                  const char * peer,
                                  word16 port,
                                  int udp,
                                  int sctp )
{
    ...
    XMEMSET( addr, 0, sizeof( SOCKADDR_IN_T ) );
        ...
        if( ( ( size_t ) peer != INADDR_ANY ) && isalpha( ( int ) peer[ 0 ] ) )
        {
            ...
            #else  /* ifndef WOLFSSL_USE_GETADDRINFO */
            ...
            #endif /* ifndef WOLFSSL_USE_GETADDRINFO */
            else
            {
                err_sys( "no entry for host" );
            }
        }
    #endif /* ifndef TEST_IPV6 */
        ...
        else
        {
                ...
                freeaddrinfo( answer );
            #else  /* if defined( HAVE_GETADDRINFO ) || defined( WOLF_C99 ) */
                printf( "no ipv6 getaddrinfo, loopback only tests/examples\n" );
                addr->sin6_addr = in6addr_loopback;
            #endif /* if defined( HAVE_GETADDRINFO ) || defined( WOLF_C99 ) */
        }
    #endif /* ifndef TEST_IPV6 */
}
...
static WC_INLINE void tcp_connect( SOCKET_T * sockfd,
                                   const char * ip,
                                   word16 port,
                                   int udp,
                                   int sctp,
...
static WC_INLINE void udp_connect( SOCKET_T * sockfd,
                                   void * addr,
                                   int addrSz )
{
...
enum
{
    ...
    static WC_INLINE int tcp_select_ex( SOCKET_T socketfd,
                                        int to_sec,
                                        int rx )
    {
        fd_set fds, errfds;
    ...
    static WC_INLINE int tcp_select( SOCKET_T socketfd,
                                     int to_sec )
    {
        return tcp_select_ex( socketfd, to_sec, 1 );
    }

    static WC_INLINE int tcp_select_tx( SOCKET_T socketfd,
                                        int to_sec )
    {
...
static WC_INLINE void tcp_listen( SOCKET_T * sockfd,
                                  word16 * port,
                                  int useAnyAddr,
                                  int udp,
                                  int sctp )
{
    ...
    #endif /* if !defined( USE_WINDOWS_API ) && !defined( WOLFSSL_MDK_ARM ) && !defined( WOLFSSL_KEIL_TCP_NET ) && !defined( WOLFSSL_ZEPHYR ) */
    ...
    #endif /* if !defined( USE_WINDOWS_API ) && !defined( WOLFSSL_TIRTOS ) && !defined( WOLFSSL_ZEPHYR ) */
}
...
static WC_INLINE void udp_accept( SOCKET_T * sockfd,
                                  SOCKET_T * clientfd,
                                  int useAnyAddr,
                                  word16 port,
                                  func_args * args )
{
    ...
    #endif /* if ( defined( NO_MAIN_DRIVER ) && !defined( USE_WINDOWS_API ) ) && !defined( WOLFSSL_TIRTOS ) */
    ...
    /* signal ready to accept data */
    {
        ...
        ready->ready = 1;
        ready->port = port;
    #else  /* if defined( _POSIX_THREADS ) && defined( NO_MAIN_DRIVER ) && !defined( __MINGW32__ ) */
        ( void ) port;
    #endif /* if defined( _POSIX_THREADS ) && defined( NO_MAIN_DRIVER ) && !defined( __MINGW32__ ) */

    *clientfd = *sockfd;
}

static WC_INLINE void tcp_accept( SOCKET_T * sockfd,
                                  SOCKET_T * clientfd,
                                  func_args * args,
                                  word16 port,
                                  int useAnyAddr,
                                  ...
                                  int do_listen )
{
    ...
    if( do_listen )
    {
        ...
        if( ready_file )
        {
            ...
            #endif /* if !defined( NO_FILESYSTEM ) || defined( FORCE_BUFFER_TEST ) */
        }
    }
...
/* identity is OpenSSL testing default for openssl s_client, keep same */
    ...
    static WC_INLINE unsigned int my_psk_client_cb( WOLFSSL * ssl,
                                                    const char * hint,
                                                    char * identity,
    ...
    static WC_INLINE unsigned int my_psk_server_cb( WOLFSSL * ssl,
                                                    const char * identity,
                                                    unsigned char * key,
                                                    unsigned int key_max_len )
    {
...
#elif defined( WOLFSSL_ZEPHYR )
    extern double current_time();
#else  /* if defined( WOLFSSL_USER_CURRTIME ) */
    ...
    #else  /* if !defined( WOLFSSL_MDK_ARM ) && !defined( WOLFSSL_KEIL_TCP_NET ) && !defined( WOLFSSL_CHIBIOS ) */
        extern double current_time( int reset );
    #endif /* if !defined( WOLFSSL_MDK_ARM ) && !defined( WOLFSSL_KEIL_TCP_NET ) && !defined( WOLFSSL_CHIBIOS ) */
#endif /* USE_WINDOWS_API */


#if defined( HAVE_OCSP ) && defined( WOLFSSL_NONBLOCK_OCSP )
    static WC_INLINE int OCSPIOCb( void * ioCtx,
                                   const char * url,
                                   int urlSz,
                                   ...
                                   unsigned char ** response )
    {
        ...
        #else  /* ifdef TEST_NONBLOCK_CERTS */
            return EmbedOcspLookup( ioCtx, url, urlSz, request, requestSz, response );
        #endif /* ifdef TEST_NONBLOCK_CERTS */
    }

    static WC_INLINE void OCSPRespFreeCb( void * ioCtx,
                                          unsigned char * response )
    {
        ( void ) ioCtx;
        ( void ) response;
    }
#endif /* if defined( HAVE_OCSP ) && defined( WOLFSSL_NONBLOCK_OCSP ) */
...
/* reads file size, allocates buffer, reads into buffer, returns buffer */
        static WC_INLINE int load_file( const char * fname,
                                        byte ** buf,
                                        size_t * bufLen )
        {
            int ret;
        ...
        static WC_INLINE void load_buffer( WOLFSSL_CTX * ctx,
                                           const char * fname,
                                           int type )
        {
        ...
        static WC_INLINE void load_ssl_buffer( WOLFSSL * ssl,
                                               const char * fname,
                                               int type )
        {
            int format = WOLFSSL_FILETYPE_PEM;
            ...
            static WC_INLINE int load_key_file( const char * fname,
                                                byte ** derBuf,
                                                word32 * derLen )
            {
                int ret;
...
static WC_INLINE int myVerify( int preverify,
                               WOLFSSL_X509_STORE_CTX * store )
{
    ...
    printf( "In verification callback, error = %d, %s\n", store->error,
        ...
        if( peer )
        {
            ...
            #endif /* if defined( SHOW_CERTS ) && !defined( NO_FILESYSTEM ) */
        }
        else
        {
            printf( "\tPeer has no cert!\n" );
        }
    #else  /* if defined( OPENSSL_EXTRA ) || defined( OPENSSL_EXTRA_X509_SMALL ) */
        printf( "\tPeer certs: %d\n", store->totalCerts );
    #ifdef SHOW_CERTS
        {
            int i;
    ...
    static WC_INLINE int mySessNewCb( WOLFSSL * ssl,
    ...
    static WC_INLINE void mySessRemCb( WOLFSSL_CTX * ctx,
                                       WOLFSSL_SESSION * session )
    {
        ( void ) ctx;
        ( void ) session;
    ...
    static WC_INLINE void CaCb( unsigned char * der,
                                int sz,
                                int type )
    {
        ( void ) der;
...
/* KEIL-RL File System does not support relative directory */
    ...
    static WC_INLINE int ChangeToWolfRoot( void )
    {
            ...
            return -1;
        #else  /* if !defined( NO_FILESYSTEM ) || defined( FORCE_BUFFER_TEST ) */
            return 0;
        #endif /* if !defined( NO_FILESYSTEM ) || defined( FORCE_BUFFER_TEST ) */
    }
    ...
    static WC_INLINE int StackSizeCheck( func_args * args,
                                         thread_func tf )
    {
        int ret, i, used;
        void * status;
...
/* Atomic Decrypt Context example */
    ...
    static WC_INLINE int myMacEncryptCb( WOLFSSL * ssl,
                                            ...
                                            void * ctx )
    {
        ...
        *padSz = wolfSSL_GetHmacSize( ssl ) + pad + padByte;
        ...
        static WC_INLINE int myEncryptMacCb( WOLFSSL * ssl,
                                             unsigned char * macOut,
                                             int content,
                                             int macVerify,
                                             unsigned char * encOut,
    ...
    #endif /* if defined( HAVE_ENCRYPT_THEN_MAC ) */


    static WC_INLINE void SetupAtomicUser( WOLFSSL_CTX * ctx,
                                           WOLFSSL * ssl )
    {
        AtomicEncCtx * encCtx;
        AtomicDecCtx * decCtx;
    ...
    typedef struct PkCbInfo
    {
        ...
        static WC_INLINE int myEccKeyGen( WOLFSSL * ssl,
                                          ecc_key * key,
                                          word32 keySz,
                                          int ecc_curve,
                                          void * ctx )
        ...
        static WC_INLINE int myEccSign( WOLFSSL * ssl,
                                        const byte * in,
                                        word32 inSz,
                                        byte * out,
                                        word32 * outSz,
        ...
        static WC_INLINE int myEccVerify( WOLFSSL * ssl,
                                          const byte * sig,
                                          word32 sigSz,
                                          const byte * hash,
                                          word32 hashSz,
        ...
        static WC_INLINE int myEccSharedSecret( WOLFSSL * ssl,
                                                ecc_key * otherKey,
                                                ...
                                                void * ctx )
        {
        ...
        #ifdef HAVE_ED25519
            static WC_INLINE int myEd25519Sign( WOLFSSL * ssl,
                                                const byte * in,
                                                word32 inSz,
                                                byte * out,
                                                word32 * outSz,
            ...
            static WC_INLINE int myEd25519Verify( WOLFSSL * ssl,
                                                  const byte * sig,
                                                  word32 sigSz,
                                                  const byte * msg,
                                                  word32 msgSz,
        ...
        #ifdef HAVE_CURVE25519
            static WC_INLINE int myX25519KeyGen( WOLFSSL * ssl,
                                                 curve25519_key * key,
                                                 unsigned int keySz,
                                                 void * ctx )
            {
            ...
            static WC_INLINE int myX25519SharedSecret( WOLFSSL * ssl,
                                                       curve25519_key * otherKey,
                                                       unsigned char * pubKeyDer,
                                                       unsigned int * pubKeySz,
                                                       unsigned char * out,
                                                       unsigned int * outlen,
        ...
        #ifdef HAVE_ED448
            static WC_INLINE int myEd448Sign( WOLFSSL * ssl,
                                              const byte * in,
                                              word32 inSz,
                                              byte * out,
                                              word32 * outSz,
            ...
            static WC_INLINE int myEd448Verify( WOLFSSL * ssl,
                                                const byte * sig,
                                                word32 sigSz,
                                                const byte * msg,
                                                word32 msgSz,
        ...
        #ifdef HAVE_CURVE448
            static WC_INLINE int myX448KeyGen( WOLFSSL * ssl,
                                               curve448_key * key,
                                               unsigned int keySz,
                                               void * ctx )
            {
            ...
            static WC_INLINE int myX448SharedSecret( WOLFSSL * ssl,
                                                     curve448_key * otherKey,
                                                     unsigned char * pubKeyDer,
                                                     unsigned int * pubKeySz,
                                                     unsigned char * out,
                                                     unsigned int * outlen,
    ...
    #ifndef NO_DH
        static WC_INLINE int myDhCallback( WOLFSSL * ssl,
                                           struct DhKey * key,
                                           const unsigned char * priv,
                                           unsigned int privSz,
                                           const unsigned char * pubKeyDer,
                                           unsigned int pubKeySz,
                                           unsigned char * out,
                                           unsigned int * outlen,
                                           void * ctx )
        ...
        static WC_INLINE int myRsaSign( WOLFSSL * ssl,
                                        const byte * in,
                                        word32 inSz,
                                        byte * out,
                                        word32 * outSz,
        ...
        static WC_INLINE int myRsaVerify( WOLFSSL * ssl,
                                          byte * sig,
                                          word32 sigSz,
                                          byte ** out,
                                          const byte * key,
        ...
        static WC_INLINE int myRsaSignCheck( WOLFSSL * ssl,
                                             byte * sig,
                                             word32 sigSz,
                                             byte ** out,
                                             const byte * key,
                                             ...
                                             void * ctx )
        {
        ...
        #ifdef WC_RSA_PSS
            static WC_INLINE int myRsaPssSign( WOLFSSL * ssl,
                                               const byte * in,
                                               word32 inSz,
                                               byte * out,
                                               word32 * outSz,
            ...
            static WC_INLINE int myRsaPssVerify( WOLFSSL * ssl,
                                                 byte * sig,
                                                 word32 sigSz,
                                                 byte ** out,
                                                 int hash,
            ...
            static WC_INLINE int myRsaPssSignCheck( WOLFSSL * ssl,
                                                    byte * sig,
                                                    word32 sigSz,
                                                    byte ** out,
                                                    int hash,
        ...
        static WC_INLINE int myRsaEnc( WOLFSSL * ssl,
                                       const byte * in,
                                       word32 inSz,
                                       byte * out,
                                       word32 * outSz,
        ...
        static WC_INLINE int myRsaDec( WOLFSSL * ssl,
                                       byte * in,
                                       word32 inSz,
                                       byte ** out,
                                       const byte * key,
    ...
    static WC_INLINE void SetupPkCallbackContexts( WOLFSSL * ssl,
                                                   void * myCtx )
    {
        #ifdef HAVE_ECC
...
/* HP/UX doesn't have strsep, needed by test/suites.c */
    static WC_INLINE char * strsep( char ** stringp,
                                    const char * delim )
    {
        char * start;
        char * end;
...
static WC_INLINE const char * mymktemp( char * tempfn,
                                        int len,
                                        int num )
{
    int x, size;
