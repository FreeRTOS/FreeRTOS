...
/* If building for old FIPS. */
    ...
    ( !defined( HAVE_FIPS_VERSION ) || ( HAVE_FIPS_VERSION < 2 ) )
        ...
        int wc_InitRsaKey_ex( RsaKey * key,
                              void * ptr,
                              int devId )
        {
            ( void ) devId;
        ...
        #endif /* ifndef WOLFSSL_RSA_VERIFY_ONLY */
        ...
        #endif /* ifndef WOLFSSL_RSA_PUBLIC_ONLY */
 ...
 */
        ...
        static void wc_RsaCleanup( RsaKey * key )
        {
            ...
            #else  /* ifndef WOLFSSL_RSA_VERIFY_INLINE */
                ( void ) key;
            #endif /* ifndef WOLFSSL_RSA_VERIFY_INLINE */
        }
                              ...
                              int devId )
        {
            ...
            #else  /* ifndef WOLFSSL_RSA_PUBLIC_ONLY */
                ret = mp_init( &key->n );
 ...
 */
            int wc_InitRsaHw( RsaKey * key )
            {
                ...
                #endif /* ifdef WOLFSSL_XILINX_PATCH */
                return 0;
            ...
            static int cc310_RSA_GenerateKeyPair( RsaKey * key,
                                                  int size,
                                                  long e )
            {
                CRYSError_t ret = 0;
        ...
        int wc_FreeRsaKey( RsaKey * key )
        {
            ...
            #endif /* ifdef WOLFSSL_AFALG_XILINX_RSA */
 ...
 */
                ...
                static int RsaMGF1( enum wc_HashType hType,
                                    byte * seed,
                                    word32 seedSz,
                                    byte * out,
                                    word32 outSz,
...
/* Padding */
                    ...
                    static int RsaPad_OAEP( const byte * input,
                                            word32 inputLen,
                                            byte * pkcsBlock,
                                            word32 pkcsBlockLen,
                                            byte padValue,
 ...
 */
                    static int RsaPad_PSS( const byte * input,
                                           word32 inputLen,
                                           byte * pkcsBlock,
                                           word32 pkcsBlockLen,
                                           WC_RNG * rng,
                                           ...
                                           void * heap )
                    {
                        ...
                        #endif /* ifndef WOLFSSL_PSS_SALT_LEN_DISCOVER */
                        ...
                        #else  /* if defined( WOLFSSL_PSS_LONG_SALT ) || defined( WOLFSSL_PSS_SALT_LEN_DISCOVER ) */
                            s = m = pkcsBlock;
                            XMEMSET( m, 0, RSA_PSS_PAD_SZ );
                            m += RSA_PSS_PAD_SZ;
                            XMEMCPY( m, input, inputLen );
                        ...
                        #endif /* if defined( WOLFSSL_PSS_LONG_SALT ) || defined( WOLFSSL_PSS_SALT_LEN_DISCOVER ) */
            ...
            static int RsaPad( const byte * input,
                               word32 inputLen,
                               byte * pkcsBlock,
                               word32 pkcsBlockLen,
                               byte padValue,
                               WC_RNG * rng )
            {
                ...
                else
                {
                    ...
                    #else  /* if !defined( WOLFSSL_RSA_VERIFY_ONLY ) && !defined( WC_NO_RNG ) */
                        ( void ) rng;
                        return RSA_WRONG_TYPE_E;
                    #endif /* if !defined( WOLFSSL_RSA_VERIFY_ONLY ) && !defined( WC_NO_RNG ) */
                }
...
/* helper function to direct which padding is used */
            int wc_RsaPad_ex( const byte * input,
                              word32 inputLen,
                              byte * pkcsBlock,
                              word32 pkcsBlockLen,
                              byte padValue,
 ...
 * < 0 on error */
            static int RsaUnPad_OAEP( byte * pkcsBlock,
 ...
 *               and other negative values on error.
 */
            static int RsaUnPad_PSS( byte * pkcsBlock,
                                     unsigned int pkcsBlockLen,
                                     byte ** output,
                                     enum wc_HashType hType,
                                     int mgf,
                                     ...
                                     void * heap )
            {
                ...
                #endif /* ifdef WOLFSSL_PSS_SALT_LEN_DISCOVER */
                {
...
/* UnPad plaintext, set start to *output, return length of plaintext,
 * < 0 on error */
        static int RsaUnPad( const byte * pkcsBlock,
                             unsigned int pkcsBlockLen,
                             byte ** output,
                             byte padValue )
        {
 ...
 */
        int wc_RsaUnPad_ex( byte * pkcsBlock,
                            word32 pkcsBlockLen,
                            byte ** out,
                            byte padValue,
                            int padType,
                            ...
                            void * heap )
        {
            ...
            static int wc_RsaFunctionNonBlock( const byte * in,
                                               word32 inLen,
                                               byte * out,
                                               word32 * outLen,
                                               int type,
 ...
 */
            static int wc_RsaFunctionSync( const byte * in,
                                           word32 inLen,
                                           byte * out,
                                           word32 * outLen,
                                           int type,
                                           ...
                                           WC_RNG * rng )
            {
                ...
                switch( type )
                {
                    ...
                    case RSA_PRIVATE_ENCRYPT:
                        ...
                        #endif /* ifdef WOLFSSL_XILINX_CRYPTO_OLD */
                        break;
...
/* AF_ALG implementation of RSA */
        ...
        #else  /* ifdef WOLFSSL_XILINX_CRYPT */
            static int wc_RsaFunctionSync( const byte * in,
                                           word32 inLen,
                                           byte * out,
                                           word32 * outLen,
                                           ...
                                           WC_RNG * rng )
            {
                    ...
                    #endif /* ifndef WOLFSSL_SP_NO_2048 */
                    #ifndef WOLFSSL_SP_NO_3072
                    ...
                    #endif /* ifndef WOLFSSL_SP_NO_3072 */
                    #ifdef WOLFSSL_SP_4096
                    ...
                    if( mp_init( tmp ) != MP_OKAY )
                    {
                        ...
                        #endif
                    #else  /* ifndef TEST_UNPAD_CONSTANT_TIME */
                        ( void ) type;
                        ( void ) key;
                        ( void ) keyLen;
                        XMEMCPY( out, in, inLen );
                        *outLen = inLen;
                    #endif /* ifndef TEST_UNPAD_CONSTANT_TIME */
        ...
        #endif /* ifdef WOLFSSL_XILINX_CRYPT */

        #if defined( WOLFSSL_ASYNC_CRYPT ) && defined( WC_ASYNC_ENABLE_RSA )
            static int wc_RsaFunctionAsync( const byte * in,
                                            word32 inLen,
                                            byte * out,
                                            word32 * outLen,
                                            int type,
 ...
 */
        ...
        #if defined( WOLFSSL_CRYPTOCELL )
            static int cc310_RsaPublicEncrypt( const byte * in,
                                               word32 inLen,
                                               byte * out,
                                               word32 outLen,
                                               RsaKey * key )
            ...
            static int cc310_RsaPublicDecrypt( const byte * in,
                                               word32 inLen,
                                               byte * out,
                                               word32 outLen,
                                               RsaKey * key )
            ...
            int cc310_RsaSSL_Sign( const byte * in,
                                   word32 inLen,
                                   byte * out,
                                   word32 outLen,
                                   RsaKey * key,
                                   CRYS_RSA_HASH_OpMode_t mode )
            {
                CRYSError_t ret = 0;
            ...
            int cc310_RsaSSL_Verify( const byte * in,
                                     word32 inLen,
                                     byte * sig,
                                     RsaKey * key,
                                     CRYS_RSA_HASH_OpMode_t mode )
        ...
        int wc_RsaFunction( const byte * in,
                            word32 inLen,
                            byte * out,
                            word32 * outLen,
                            int type,
 ...
 * rng : random number generator */
            static int RsaPublicEncryptEx( const byte * in,
                                           word32 inLen,
                                           byte * out,
                                           word32 outLen,
                                           RsaKey * key,
 ...
 * saltLen : Length of salt used in PSS
 * rng : random number generator */
        static int RsaPrivateDecryptEx( byte * in,
                                        word32 inLen,
                                        byte * out,
                                        word32 outLen,
                                        byte ** outPtr,
                                        ...
                                        WC_RNG * rng )
        {
            ...
            #endif /* if !defined( WOLFSSL_RSA_VERIFY_ONLY ) && !defined( WOLFSSL_RSA_VERIFY_INLINE ) */
            ...
            case RSA_STATE_DECRYPT_RES:
                ...
                #endif /* if defined( WOLFSSL_ASYNC_CRYPT ) && defined( WC_ASYNC_ENABLE_RSA ) && defined( HAVE_CAVIUM ) */
                break;
...
/* Public RSA Functions */
        ...
        #endif /* if !defined( WOLFSSL_CRYPTOCELL ) */
        ...
        int wc_RsaSSL_Verify_ex( const byte * in,
                                 word32 inLen,
                                 byte * out,
                                 word32 outLen,
                                 RsaKey * key,
 ...
 * returns the length of the PSS data on success and negative indicates failure.
 */
        int wc_RsaPSS_VerifyInline_ex( byte * in,
                                       word32 inLen,
                                       byte ** out,
                                       enum wc_HashType hash,
                                       int mgf,
 ...
 * returns the length of the PSS data on success and negative indicates failure.
 */
        int wc_RsaPSS_Verify_ex( byte * in,
                                 word32 inLen,
                                 byte * out,
                                 word32 outLen,
                                 enum wc_HashType hash,
 ...
 */
                                       ...
                                       int bits )
        {
            ...
            #endif /* ifdef WOLFSSL_PSS_LONG_SALT */
 ...
 * indicates failure.
 */
            int wc_RsaPSS_Sign_ex( const byte * in,
                                   word32 inLen,
                                   byte * out,
                                   word32 outLen,
                                   enum wc_HashType hash,
            ...
            #endif /* ifdef WC_RSA_PSS */
        #endif /* if !defined( WOLFSSL_RSA_PUBLIC_ONLY ) && !defined( WOLFSSL_RSA_VERIFY_ONLY ) */
    ...
    defined( WC_RSA_PSS )
        ...
        #endif /* if !defined( WOLFSSL_RSA_VERIFY_ONLY ) || !defined( WOLFSSL_SP_MATH ) || defined( WC_RSA_PSS ) */
...
/* flatten RsaKey structure into individual elements (e, n) */
    ...
    #ifndef WOLFSSL_RSA_VERIFY_ONLY
        static int RsaGetValue( mp_int * in,
                                byte * out,
                                word32 * outSz )
        {
            word32 sz;
...
/* Check that |p-q| > 2^((size/2)-100) */
        static int wc_CompareDiffPQ( mp_int * p,
                                     mp_int * q,
                                     int size )
        {
            mp_int c, d;
...
/* returns 1 on key size ok and 0 if not ok */
        static WC_INLINE int RsaSizeCheck( int size )
        {
            if( ( size < RSA_MIN_SIZE ) || ( size > RSA_MAX_SIZE ) )
            {
                ...
                return 0;
            #else  /* ifdef HAVE_FIPS */
                return 1; /* allow unusual key sizes in non FIPS mode */
            #endif /* HAVE_FIPS */
        }


        static int _CheckProbablePrime( mp_int * p,
                                        mp_int * q,
                                        mp_int * e,
                                        int nlen,
                                        int * isPrime,
...
notOkay:
        ...
        int wc_CheckProbablePrime_ex( const byte * pRaw,
                                      word32 pRawSz,
                                      const byte * qRaw,
                                      word32 qRawSz,
                                      const byte * eRaw,
        ...
        int wc_CheckProbablePrime( const byte * pRaw,
                                   word32 pRawSz,
                                   const byte * qRaw,
                                   word32 qRawSz,
                                   const byte * eRaw,
...
/* Make an RSA key for size bits, with e specified, 65537 is a good e */
                               ...
                               WC_RNG * rng )
            {
                    ...
                    #endif /* if defined( WOLFSSL_ASYNC_CRYPT ) && defined( WC_ASYNC_ENABLE_RSA ) && defined( WC_ASYNC_ENABLE_RSA_KEYGEN ) */
                    ...
                    #endif /* ifdef WOLFSSL_MP_INVMOD_CONSTANT_TIME */
