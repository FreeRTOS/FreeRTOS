 ...
 */
void HW_set_32bit_reg( addr_t reg_addr,
                       uint32_t value );
 ...
 */
void HW_set_32bit_reg_field( addr_t reg_addr,
                             int_fast8_t shift,
                             uint32_t mask,
                             uint32_t value );
 ...
 *                  as parameter.
 */
uint32_t HW_get_32bit_reg_field( addr_t reg_addr,
                                 int_fast8_t shift,
                                 uint32_t mask );
 ...
 * @param value     Value to be written into the peripheral register.
 */
void HW_set_16bit_reg( addr_t reg_addr,
                       uint_fast16_t value );
 ...
 */
uint16_t HW_get_16bit_reg( addr_t reg_addr );
 ...
 * @param value     Value to be written in the specified field.
 */
void HW_set_16bit_reg_field( addr_t reg_addr,
                             int_fast8_t shift,
                             uint_fast16_t mask,
                             uint_fast16_t value );
 ...
 *                  as parameter.
 */
uint16_t HW_get_16bit_reg_field( addr_t reg_addr,
                                 int_fast8_t shift,
                                 uint_fast16_t mask );
 ...
 * @param value     Value to be written into the peripheral register.
 */
void HW_set_8bit_reg( addr_t reg_addr,
                      uint_fast8_t value );
 ...
 * @param value     Value to be written in the specified field.
 */
void HW_set_8bit_reg_field( addr_t reg_addr,
                            int_fast8_t shift,
                            uint_fast8_t mask,
                            uint_fast8_t value );
 ...
 *                  as parameter.
 */
uint8_t HW_get_8bit_reg_field( addr_t reg_addr,
                               int_fast8_t shift,
                               uint_fast8_t mask );
