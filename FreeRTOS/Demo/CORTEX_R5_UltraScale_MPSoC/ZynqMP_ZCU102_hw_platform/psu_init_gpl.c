...
static int mask_pollOnValue( u32 add,
                             u32 mask,
                             u32 value );

static int mask_poll( u32 add,
                      u32 mask );

static void mask_delay( u32 delay );

static u32 mask_read( u32 add,
                      u32 mask );

static void dpll_prog( int ddr_pll_fbdiv,
                       int d_lock_dly,
                       int d_lock_cnt,
                       int d_lfhf,
                       int d_cp,
...
static
void PSU_Mask_Write( unsigned long offset,
                     unsigned long mask,
                     unsigned long val )
{
...
static
void prog_reg( unsigned long addr,
               unsigned long mask,
               unsigned long shift,
               unsigned long value )
{
