...
/*! @brief USART transfer callback function. */
    typedef void (* usart_transfer_callback_t)( USART_Type * base,
...
/*! @brief Typedef for usart interrupt handler. */
    typedef void (* flexcomm_usart_irq_handler_t)( USART_Type * base,
                                                   usart_handle_t * handle );
 ...
 */
        void USART_SetRxTimeoutConfig( USART_Type * base,
                                       usart_rx_timeout_config * config );
    #endif /* if defined( FSL_FEATURE_USART_HAS_FIFORXTIMEOUTCFG ) && FSL_FEATURE_USART_HAS_FIFORXTIMEOUTCFG */
 ...
 */
    static inline void USART_SetMatchAddress( USART_Type * base,
                                              uint8_t address )
    {
 ...
 */
    static inline void USART_EnableMatchAddress( USART_Type * base,
                                                 bool match )
    {
 ...
 */
    static inline void USART_ClearStatusFlags( USART_Type * base,
                                               uint32_t mask )
    {
 ...
 */
    static inline void USART_EnableInterrupts( USART_Type * base,
                                               uint32_t mask )
    {
 ...
 */
    static inline void USART_DisableInterrupts( USART_Type * base,
                                                uint32_t mask )
    {
        mask &= ( uint32_t ) kUSART_AllInterruptEnables;
 ...
 */
    static inline void USART_EnableTxDMA( USART_Type * base,
                                          bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void USART_EnableRxDMA( USART_Type * base,
                                          bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void USART_EnableCTS( USART_Type * base,
                                        bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void USART_EnableContinuousSCLK( USART_Type * base,
                                                   bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void USART_EnableAutoClearSCLK( USART_Type * base,
                                                  bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void USART_SetRxFifoWatermark( USART_Type * base,
                                                 uint8_t water )
    {
 ...
 */
    static inline void USART_SetTxFifoWatermark( USART_Type * base,
                                                 uint8_t water )
    {
 ...
 */
    static inline void USART_WriteByte( USART_Type * base,
                                        uint8_t data )
    {
        base->FIFOWR = data;
    }
