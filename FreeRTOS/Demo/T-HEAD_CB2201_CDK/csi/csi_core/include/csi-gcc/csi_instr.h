 ...
 */
__ALWAYS_INLINE uint32_t __ROR( uint32_t op1,
                                uint32_t op2 )
{
 ...
 */
__ALWAYS_INLINE int32_t __SSAT( int32_t x,
                                uint32_t y )
{
 ...
 * \return             Saturated value
 */
__ALWAYS_INLINE uint32_t __USAT( uint32_t value,
                                 uint32_t sat )
{
    uint32_t result;
 ...
 * \return             Saturated value
 */
__ALWAYS_INLINE uint32_t __IUSAT( uint32_t value,
                                  uint32_t sat )
{
    uint32_t result;
 ...
 * \param [in]    addr  Pointer to location
 */
__ALWAYS_INLINE void __STRBT( uint8_t value,
 ...
 * \param [in]    addr  Pointer to location
 */
__ALWAYS_INLINE void __STRHT( uint16_t value,
 ...
 * \param [in]    addr  Pointer to location
 */
__ALWAYS_INLINE void __STRT( uint32_t value,
