...
/*PLL control register */
        ...
        /* RESERVE11                         [30:1]  RSVD */
        /* LOCK_B                            [31:1]  RO */
    #endif /* if !defined( LIBERO_SETTING_SGMII_PLL_CTRL ) */
...
/*PLL reference and feedback registers */
        ...
        /* RESERVE15                         [28:4]  RSVD */
    #endif /* if !defined( LIBERO_SETTING_SGMII_PLL_REF_FB ) */
...
/*PLL 0/1 division registers */
        ...
        /* RESERVE21                         [31:1]  RSVD */
    #endif /* if !defined( LIBERO_SETTING_SGMII_PLL_DIV_0_1 ) */
...
/*PLL 2/3 division registers */
    ...
    #endif /* if !defined( LIBERO_SETTING_SGMII_PLL_DIV_2_3 ) */
...
/*PLL control register */
    ...
    #endif /* if !defined( LIBERO_SETTING_SGMII_PLL_CTRL2 ) */
...
/*PLL calibration register */
        ...
        /* DSKEWCALOUT                       [16:7]  RO */
        /* RESERVE30                         [23:9]  RSVD */
    #endif /* if !defined( LIBERO_SETTING_SGMII_PLL_CAL ) */
...
/*PLL phase registers */
    ...
    #endif /* if !defined( LIBERO_SETTING_SGMII_PLL_PHADJ ) */
...
/*SSCG registers 3 */
        ...
        /* RESERVE03                         [22:1]  RSVD */
        /* RESERVE04                         [23:9]  RSVD */
    #endif /* if !defined( LIBERO_SETTING_SGMII_SSCG_REG_3 ) */
