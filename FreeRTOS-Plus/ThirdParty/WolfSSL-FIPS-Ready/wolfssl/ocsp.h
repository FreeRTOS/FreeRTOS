...
/* wolfSSL OCSP API */
    ...
    #define WOLFSSL_OCSP_H
        ...
        WOLFSSL_LOCAL int InitOCSP( WOLFSSL_OCSP *,
                                    WOLFSSL_CERT_MANAGER * );
        WOLFSSL_LOCAL void FreeOCSP( WOLFSSL_OCSP *,
                                     int dynamic );

        WOLFSSL_LOCAL int CheckCertOCSP( WOLFSSL_OCSP *,
                                         DecodedCert *,
        ...
        defined( WOLFSSL_APACHE_HTTPD )
            ...
            WOLFSSL_API WOLFSSL_OCSP_CERTID * wolfSSL_OCSP_cert_to_id( const WOLFSSL_EVP_MD * dgst,
            ...
            WOLFSSL_API WOLFSSL_OCSP_BASICRESP * wolfSSL_OCSP_response_get1_basic( OcspResponse * response );
        ...
        #endif /* if defined( OPENSSL_ALL ) || defined( WOLFSSL_NGINX ) || defined( WOLFSSL_HAPROXY ) || defined( WOLFSSL_APACHE_HTTPD ) */
        #ifdef OPENSSL_EXTRA
