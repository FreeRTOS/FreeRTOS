...
#define writel( b, addr )    ( void ) ( ( *( volatile unsigned int * ) ( addr ) ) = ( b ) )
    ...
    int32_t target_gpio_port_init( port_name_t port,
                                   uint32_t * base,
                                   uint32_t * irq,
                                   uint32_t * pin_num )
    {
 ...
 */
    int32_t target_gpio_pin_init( pin_t gpio_pin,
                                  uint32_t * port_idx )
    {
        uint32_t idx;
    ...
    int32_t target_get_timer( int32_t idx,
                              uint32_t * base,
                              uint32_t * irq )
    {
    ...
    int32_t target_get_pmu( int32_t idx,
                            uint32_t * base,
                            uint32_t * irq )
    {
    ...
    int32_t target_get_rtc( int32_t idx,
                            uint32_t * base,
                            uint32_t * irq )
    {
        unsigned int value;
 ...
 */
    int32_t target_get_trng( int32_t idx,
                             uint32_t * base )
    {
 ...
 */
    int32_t target_get_crc( int32_t idx,
                            uint32_t * base )
    {
 ...
 */
    int32_t target_usart_init( pin_t tx,
                               pin_t rx,
                               uint32_t * base,
                               uint32_t * irq )
    {
 ...
 */
    int32_t target_usart_flowctrl_init( pin_t tx_flow,
                                        pin_t rx_flow,
                                        uint32_t flag )
    {
        uint32_t idx;
 ...
 */
    int32_t target_spi_init( pin_t mosi,
                             pin_t miso,
                             pin_t sclk,
                             pin_t ssel,
                             uint32_t * base,
 ...
 */
    int32_t target_get_aes( int32_t idx,
                            uint32_t * base,
                            uint32_t * irq )
    {
 ...
 */
    int32_t target_get_rsa( int32_t idx,
                            uint32_t * base,
                            uint32_t * irq )
    {
 ...
 */
    int32_t target_get_eflash( int32_t idx,
                               uint32_t * base,
                               eflash_info_t * info )
    {
    ...
    int32_t target_get_wdt( int32_t idx,
                            uint32_t * base,
                            uint32_t * irq )
    {
    ...
    int32_t target_get_dmac( int32_t idx,
                             uint32_t * base,
                             uint32_t * irq )
    {
 ...
 */
    int32_t target_iic_init( pin_t scl,
                             pin_t sda,
                             uint32_t * base,
                             uint32_t * irq )
    {
 ...
 */
    int32_t target_pwm_init( pin_t pwm_pin,
                             uint32_t * ch_num,
                             uint32_t * base,
                             uint32_t * irq )
    {
 ...
 */
    int32_t target_get_sha( int32_t idx,
                            uint32_t * base,
                            uint32_t * irq )
    {
