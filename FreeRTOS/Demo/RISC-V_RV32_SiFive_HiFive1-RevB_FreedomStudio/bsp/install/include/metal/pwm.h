...
struct metal_pwm_vtable
{
    ...
    int (* set_freq)( struct metal_pwm * pwm,
                      unsigned int idx,
                      unsigned int freq );
    int (* set_duty)( struct metal_pwm * pwm,
                      unsigned int idx,
                      unsigned int duty,
                      metal_pwm_phase_correct_t phase_corr );
    unsigned int (* get_duty)( struct metal_pwm * pwm,
                               unsigned int idx );
    unsigned int (* get_freq)( struct metal_pwm * pwm,
                               unsigned int idx );
    int (* trigger)( struct metal_pwm * pwm,
                     unsigned int idx,
                     metal_pwm_run_mode_t mode );
    int (* stop)( struct metal_pwm * pwm,
                  unsigned int idx );
    int (* cfg_interrupt)( struct metal_pwm * pwm,
                           metal_pwm_interrupt_t flag );
    int (* clr_interrupt)( struct metal_pwm * pwm,
                           unsigned int idx );
    struct metal_interrupt *(* get_interrupt_controller)( struct metal_pwm * pwm );
    int (* get_interrupt_id)( struct metal_pwm * pwm,
                              unsigned int idx );
};
 ...
 * @return 0 If no error.*/
inline int metal_pwm_set_freq( struct metal_pwm * pwm,
                               unsigned int idx,
                               unsigned int freq )
{
 ...
 * @return 0 If no error.*/
inline int metal_pwm_set_duty( struct metal_pwm * pwm,
                               unsigned int idx,
                               unsigned int duty,
                               metal_pwm_phase_correct_t phase_corr )
{
 ...
 * @param idx PWM channel id.
 * @return 0 If no error.*/
inline int metal_pwm_trigger( struct metal_pwm * pwm,
                              unsigned int idx,
                              metal_pwm_run_mode_t mode )
{
 ...
 * @param idx PWM channel id.
 * @return 0 If no error.*/
inline int metal_pwm_stop( struct metal_pwm * pwm,
                           unsigned int idx )
{
 ...
 * @param idx PWM channel id.
 * @return 0 If no error.*/
inline int metal_pwm_clr_interrupt( struct metal_pwm * pwm,
                                    unsigned int idx )
{
...
inline int metal_pwm_get_interrupt_id( struct metal_pwm * pwm,
                                       unsigned int idx )
{
    return pwm->vtable->get_interrupt_id( pwm, idx );
}

#endif /* ifndef METAL__PWM_H */
