...
/* Have QSH : Quantum-safe Handshake */
        ...
        #define BUILD_TLS_QSH
                ...
                #undef HAVE_AES_CBC
                    ...
                    && defined( WOLFSSL_STATIC_RSA )
                    ...
                    #endif
                #endif /* if !defined( NO_RSA ) && !defined( NO_RC4 ) */
                        ...
                        #endif
                    #endif
                #endif /* if !defined( NO_SHA ) && defined( HAVE_AES_CBC ) */
                #if defined( WOLFSSL_STATIC_RSA )
                        ...
                        #endif
                    #endif
                #endif /* if defined( WOLFSSL_STATIC_RSA ) */
            #endif /* if !defined( NO_RSA ) && !defined( NO_AES ) && !defined( NO_TLS ) */
                    ...
                    #endif
                #endif /* ifndef NO_RSA */
            #endif /* if defined( HAVE_CAMELLIA ) && !defined( NO_TLS ) && !defined( NO_CAMELLIA_CBC ) */
                        ...
                        #endif
                    #endif
                #endif /* if !defined( NO_PSK ) && !defined( NO_AES ) && !defined( NO_TLS ) */
            #endif /* if defined( WOLFSSL_STATIC_PSK ) */
                    ...
                    #endif
                #endif
            #endif /* if !defined( NO_TLS ) && defined( HAVE_NULL_CIPHER ) */
            ...
            !defined( NO_RSA )
                    ...
                    #endif
                #endif
            #endif /* if !defined( NO_DH ) && !defined( NO_AES ) && !defined( NO_TLS ) && !defined( NO_RSA ) */
            ...
            !defined( NO_AES ) && !defined( NO_SHA ) && defined( WOLFSSL_AES_128 )
                    ...
                    #endif
                #endif
            #endif /* if !defined( NO_DH ) && !defined( NO_PSK ) && !defined( NO_TLS ) */
            ...
            defined( HAVE_CURVE448 ) ) && !defined( NO_TLS )
                    ...
                    defined( HAVE_AES_CBC )
                        ...
                        #endif
                    #endif /* if !defined( NO_SHA256 ) && defined( WOLFSSL_AES_128 ) && defined( HAVE_AES_CBC ) */
                    ...
                    defined( HAVE_AES_CBC )
                        ...
                        #endif
                    #endif /* if defined( WOLFSSL_SHA384 ) && defined( WOLFSSL_AES_256 ) && defined( HAVE_AES_CBC ) */
                        ...
                        #endif
                    #endif /* if !defined( NO_SHA ) */
                #endif /* if !defined( NO_RC4 ) */
                #if !defined( NO_DES3 )
                    #ifndef NO_SHA
                        #if !defined( NO_RSA )
                    ...
                    #endif
                #endif /* if defined( HAVE_NULL_CIPHER ) */
                ...
                defined( WOLFSSL_AES_128 ) && defined( HAVE_AES_CBC )
                ...
                #endif
            #endif /* if ( defined( HAVE_ECC ) || defined( HAVE_CURVE25519 ) || defined( HAVE_CURVE448 ) ) && !defined( NO_TLS ) */
                    ...
                    #endif
                #endif /* !NO_PSK */
            #endif /* if defined( HAVE_CHACHA ) && defined( HAVE_POLY1305 ) && !defined( NO_SHA256 ) */
        ...
        && !defined( NO_TLS ) && !defined( NO_AES )
                ...
                ( defined( HAVE_CURVE448 ) && defined( HAVE_ED448 ) )
                    ...
                    #endif
                #endif
            #endif /* if defined( HAVE_AESCCM ) && !defined( NO_SHA256 ) */
        #endif /* if ( defined( HAVE_ECC ) || defined( HAVE_CURVE25519 ) || defined( HAVE_CURVE448 ) ) && !defined( NO_TLS ) && !defined( NO_AES ) */
            ...
            #endif
        #endif
    #endif /* if defined( WOLFSSL_TLS13 ) */
    ...
    defined( BUILD_TLS_AES_256_GCM_SHA384 )
        #define BUILD_AESGCM
    #else  /* if defined( BUILD_TLS_RSA_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_DHE_RSA_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_PSK_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_RSA_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_PSK_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_DHE_PSK_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_AES_256_GCM_SHA384 ) */
        /* No AES-GCM cipher suites available with build */
        #define NO_AESGCM_AEAD
    #endif /* if defined( BUILD_TLS_RSA_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_DHE_RSA_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_PSK_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_DHE_PSK_WITH_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_RSA_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_PSK_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_DHE_PSK_WITH_AES_256_GCM_SHA384 ) || defined( BUILD_TLS_AES_128_GCM_SHA256 ) || defined( BUILD_TLS_AES_256_GCM_SHA384 ) */
    ...
    #else  /* if defined( BUILD_TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_DHE_RSA_WITH_CHACHA20_OLD_POLY1305_SHA256 ) || defined( BUILD_TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_ECDSA_WITH_CHACHA20_OLD_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_RSA_WITH_CHACHA20_OLD_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_PSK_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_CHACHA20_POLY1305_SHA256 ) */
        /* No ChaCha Poly cipher suites available with build */
        #define NO_CHAPOL_AEAD
    #endif /* if defined( BUILD_TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_DHE_RSA_WITH_CHACHA20_OLD_POLY1305_SHA256 ) || defined( BUILD_TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_ECDSA_WITH_CHACHA20_OLD_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_RSA_WITH_CHACHA20_OLD_POLY1305_SHA256 ) || defined( BUILD_TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_PSK_WITH_CHACHA20_POLY1305_SHA256 ) || defined( BUILD_TLS_CHACHA20_POLY1305_SHA256 ) */
...
/* set maximum DH key size allowed */
    ...
    enum Misc
    {
        ...
        ( defined( USE_FAST_MATH ) && defined( FP_MAX_BITS ) && FP_MAX_BITS >= 16384 )
            ...
            #endif
        #endif /* if defined( WOLFSSL_MYSQL_COMPATIBLE ) || ( defined( USE_FAST_MATH ) && defined( FP_MAX_BITS ) && FP_MAX_BITS >= 16384 ) */
        ...
        *  digest sz + BLOC_SZ (iv) + pad byte (1) */
        ...
        ( !defined( HAVE_FIPS_VERSION ) || ( HAVE_FIPS_VERSION < 2 ) )
            MAX_SYM_KEY_SIZE = AES_256_KEY_SIZE,
                ...
                MAX_SYM_KEY_SIZE = WC_MAX_SYM_KEY_SIZE,
            #endif
        #endif /* if defined( HAVE_FIPS ) && ( !defined( HAVE_FIPS_VERSION ) || ( HAVE_FIPS_VERSION < 2 ) ) */
...
/* SSL Version */
    ...
    WOLFSSL_LOCAL ProtocolVersion MakeTLSv1_3( void );
        ...
        WOLFSSL_LOCAL ProtocolVersion MakeDTLSv1_2( void );
            ...
            WOLFSSL_LOCAL int wolfSSL_dtls_import_internal( WOLFSSL * ssl,
                                                            byte * buf,
                                                            word32 sz );
            WOLFSSL_LOCAL int wolfSSL_dtls_export_internal( WOLFSSL * ssl,
                                                            byte * buf,
                                                            word32 sz );
        ...
        #endif /* ifdef WOLFSSL_SESSION_EXPORT */
    #endif /* ifdef WOLFSSL_DTLS */
...
/* defaults to client */
    WOLFSSL_LOCAL void InitSSL_Method( WOLFSSL_METHOD *,
                                       ProtocolVersion );

    WOLFSSL_LOCAL int InitSSL_Suites( WOLFSSL * ssl );
    WOLFSSL_LOCAL int InitSSL_Side( WOLFSSL * ssl,
                                    word16 side );

/* for sniffer */
    WOLFSSL_LOCAL int DoFinished( WOLFSSL * ssl,
                                  const byte * input,
                                  word32 * inOutIdx,
                                  word32 size,
                                  word32 totalSz,
                                  int sniff );
    #ifdef WOLFSSL_TLS13
        WOLFSSL_LOCAL int DoTls13Finished( WOLFSSL * ssl,
                                           const byte * input,
                                           word32 * inOutIdx,
                                           word32 size,
                                           word32 totalSz,
                                           int sniff );
    #endif
    WOLFSSL_LOCAL int DoApplicationData( WOLFSSL * ssl,
                                         byte * input,
                                         word32 * inOutIdx );
/* TLS v1.3 needs these */
    WOLFSSL_LOCAL int HandleTlsResumption( WOLFSSL * ssl,
                                           int bogusID,
                                           Suites * clSuites );
    #ifdef WOLFSSL_TLS13
        WOLFSSL_LOCAL int FindSuite( Suites * suites,
                                     byte first,
                                     byte second );
    #endif
    WOLFSSL_LOCAL int DoClientHello( WOLFSSL * ssl,
                                     const byte * input,
                                     word32 *,
                                     word32 );
    #ifdef WOLFSSL_TLS13
        WOLFSSL_LOCAL int DoTls13ClientHello( WOLFSSL * ssl,
                                              const byte * input,
                                              word32 * inOutIdx,
                                              word32 helloSz );
    #endif
    WOLFSSL_LOCAL int DoServerHello( WOLFSSL * ssl,
                                     const byte * input,
                                     word32 *,
                                     word32 );
    WOLFSSL_LOCAL int CompleteServerHello( WOLFSSL * ssl );
    WOLFSSL_LOCAL int CheckVersion( WOLFSSL * ssl,
                                    ProtocolVersion pv );
    WOLFSSL_LOCAL int PickHashSigAlgo( WOLFSSL * ssl,
                                       const byte * hashSigAlgo,
                                       word32 hashSigAlgoSz );
    WOLFSSL_LOCAL int DecodePrivateKey( WOLFSSL * ssl,
                                        word16 * length );
    #ifdef HAVE_PK_CALLBACKS
        WOLFSSL_LOCAL int GetPrivateKeySigSize( WOLFSSL * ssl );
        #ifndef NO_ASN
            WOLFSSL_LOCAL int InitSigPkCb( WOLFSSL * ssl,
                                           SignatureCtx * sigCtx );
        #endif
    #endif
    WOLFSSL_LOCAL void FreeKeyExchange( WOLFSSL * ssl );
    WOLFSSL_LOCAL void FreeSuites( WOLFSSL * ssl );
    WOLFSSL_LOCAL int ProcessPeerCerts( WOLFSSL * ssl,
                                        byte * input,
                                        word32 * inOutIdx,
                                        word32 size );
    WOLFSSL_LOCAL int MatchDomainName( const char * pattern,
                                       int len,
                                       const char * str );
    #ifndef NO_CERTS
        WOLFSSL_LOCAL int CheckForAltNames( DecodedCert * dCert,
                                            const char * domain,
                                            int * checkCN );
        WOLFSSL_LOCAL int CheckIPAddr( DecodedCert * dCert,
                                       const char * ipasc );
    #endif
    WOLFSSL_LOCAL int CreateTicket( WOLFSSL * ssl );
    WOLFSSL_LOCAL int HashRaw( WOLFSSL * ssl,
                               const byte * output,
                               int sz );
    WOLFSSL_LOCAL int HashOutput( WOLFSSL * ssl,
                                  const byte * output,
                                  int sz,
                                  int ivSz );
    WOLFSSL_LOCAL int HashInput( WOLFSSL * ssl,
                                 const byte * input,
                                 int sz );
    ...
    #endif
    #ifdef WOLFSSL_TLS13
        WOLFSSL_LOCAL int DecryptTls13( WOLFSSL * ssl,
                                        byte * output,
                                        const byte * input,
                                        word16 sz,
                                        const byte * aad,
                                        word16 aadSz );
        WOLFSSL_LOCAL int DoTls13HandShakeMsgType( WOLFSSL * ssl,
                                                   byte * input,
                                                   word32 * inOutIdx,
                                                   byte type,
                                                   word32 size,
                                                   word32 totalSz );
        WOLFSSL_LOCAL int DoTls13HandShakeMsg( WOLFSSL * ssl,
                                               byte * input,
                                               word32 * inOutIdx,
                                               word32 totalSz );
        WOLFSSL_LOCAL int DoTls13ServerHello( WOLFSSL * ssl,
                                              const byte * input,
                                              word32 * inOutIdx,
                                              word32 helloSz,
                                              byte * extMsgType );
    #endif /* ifdef WOLFSSL_TLS13 */
    int TimingPadVerify( WOLFSSL * ssl,
                         const byte * input,
                         int padLen,
                         int t,
                         int pLen,
 ...
 */
    #if defined( LARGE_STATIC_BUFFERS )
        #define STATIC_BUFFER_LEN                 \
    RECORD_HEADER_SZ + RECORD_SIZE + COMP_EXTRA + \
...
/* Cipher Suites holder */
    ...
    WOLFSSL_LOCAL void InitSuitesHashSigAlgo( Suites * suites,
                                              int haveECDSAsig,
                                              int haveRSAsig,
                                              int haveAnon,
                                              int tls1_2,
                                              int keySz );
    WOLFSSL_LOCAL void InitSuites( Suites *,
                                   ProtocolVersion,
                                   int,
                                   word16,
                                   word16,
                                   ...
                                   word16,
                                   int );
    WOLFSSL_LOCAL int MatchSuite( WOLFSSL * ssl,
                                  Suites * peerSuites );
    WOLFSSL_LOCAL int SetCipherList( WOLFSSL_CTX *,
                                     Suites *,
                                     const char * list );
...
/* wolfSSL Certificate Manager */
    ...
    WOLFSSL_LOCAL int CM_SaveCertCache( WOLFSSL_CERT_MANAGER *,
                                        const char * );
    WOLFSSL_LOCAL int CM_RestoreCertCache( WOLFSSL_CERT_MANAGER *,
                                           const char * );
    WOLFSSL_LOCAL int CM_MemSaveCertCache( WOLFSSL_CERT_MANAGER *,
                                           void *,
                                           int,
                                           int * );
    WOLFSSL_LOCAL int CM_MemRestoreCertCache( WOLFSSL_CERT_MANAGER *,
                                              const void *,
                                              int );
    WOLFSSL_LOCAL int CM_GetCertCacheMemSize( WOLFSSL_CERT_MANAGER * );
    WOLFSSL_LOCAL int CM_VerifyBuffer_ex( WOLFSSL_CERT_MANAGER * cm,
                                          const byte * buff,
                                          long sz,
                                          int format,
                                          int err_val );
        ...
        ( !defined( NO_WOLFSSL_CLIENT ) || !defined( WOLFSSL_NO_CLIENT_AUTH ) )
            ...
            WOLFSSL_LOCAL int DoVerifyCallback( WOLFSSL_CERT_MANAGER * cm,
                                                WOLFSSL * ssl,
                                                int ret,
...
/** TLS Extensions - RFC 6066 */
        ...
        WOLFSSL_LOCAL TLSX * TLSX_Find( TLSX * list,
                                        TLSX_Type type );
        WOLFSSL_LOCAL void TLSX_Remove( TLSX ** list,
                                        TLSX_Type type,
                                        void * heap );
        WOLFSSL_LOCAL void TLSX_FreeAll( TLSX * list,
                                         void * heap );
        WOLFSSL_LOCAL int TLSX_SupportExtensions( WOLFSSL * ssl );
        WOLFSSL_LOCAL int TLSX_PopulateExtensions( WOLFSSL * ssl,
                                                   byte isRequest );

        #if defined( WOLFSSL_TLS13 ) || !defined( NO_WOLFSSL_CLIENT )
            WOLFSSL_LOCAL int TLSX_GetRequestSize( WOLFSSL * ssl,
                                                   byte msgType,
                                                   word16 * pLength );
            WOLFSSL_LOCAL int TLSX_WriteRequest( WOLFSSL * ssl,
                                                 byte * output,
                                                 byte msgType,
                                                 word16 * pOffset );
        #endif
...
/* TLS 1.3 Certificate messages have extensions. */
            WOLFSSL_LOCAL int TLSX_GetResponseSize( WOLFSSL * ssl,
                                                    byte msgType,
                                                    word16 * pLength );
            WOLFSSL_LOCAL int TLSX_WriteResponse( WOLFSSL * ssl,
                                                  byte * output,
                                                  byte msgType,
                                                  word16 * pOffset );
        #endif

        WOLFSSL_LOCAL int TLSX_ParseVersion( WOLFSSL * ssl,
                                             byte * input,
                                             word16 length,
                                             byte msgType,
                                             int * found );
        WOLFSSL_LOCAL int TLSX_Parse( WOLFSSL * ssl,
                                      byte * input,
                                      word16 length,
                                      byte msgType,
                                      Suites * suites );
...
/** Server Name Indication - RFC 6066 (session 3) */
        ...
        WOLFSSL_LOCAL int TLSX_UseSNI( TLSX ** extensions,
                                       byte type,
                                       const void * data,
                                       word16 size,
                                       void * heap );
        WOLFSSL_LOCAL byte TLSX_SNI_Status( TLSX * extensions,
                                            byte type );
        WOLFSSL_LOCAL word16 TLSX_SNI_GetRequest( TLSX * extensions,
                                                  byte type,
                                                  void ** data );

        #ifndef NO_WOLFSSL_SERVER
            WOLFSSL_LOCAL void TLSX_SNI_SetOptions( TLSX * extensions,
                                                    byte type,
                                                    byte options );
            WOLFSSL_LOCAL int TLSX_SNI_GetFromBuffer( const byte * buffer,
                                                      word32 bufferSz,
                                                      byte type,
                                                      byte * sni,
                                                      word32 * inOutSz );
...
/* Trusted CA Key Indication - RFC 6066 (section 6) */
        ...
        WOLFSSL_LOCAL int TLSX_UseTrustedCA( TLSX ** extensions,
                                             byte type,
                                             const byte * id,
                                             word16 idSz,
                                             void * heap );
...
/* Application-Layer Protocol Negotiation - RFC 7301 */
        ...
        WOLFSSL_LOCAL int TLSX_UseALPN( TLSX ** extensions,
                                        const void * data,
                                        word16 size,
                                        byte options,
                                        void * heap );

        WOLFSSL_LOCAL int TLSX_ALPN_SetOptions( TLSX ** extensions,
                                                const byte option );
...
/** Maximum Fragment Length Negotiation - RFC 6066 (session 4) */
        ...
        WOLFSSL_LOCAL int TLSX_UseMaxFragment( TLSX ** extensions,
                                               byte mfl,
                                               void * heap );
...
/** Certificate Status Request - RFC 6066 (session 8) */
        ...
        WOLFSSL_LOCAL int TLSX_UseCertificateStatusRequest( TLSX ** extensions,
                                                            ...
                                                            int devId );
        #ifndef NO_CERTS
            WOLFSSL_LOCAL int TLSX_CSR_InitRequest( TLSX * extensions,
                                                    DecodedCert * cert,
                                                    void * heap );
        #endif
...
/** Certificate Status Request v2 - RFC 6961 */
        ...
        WOLFSSL_LOCAL int TLSX_UseCertificateStatusRequestV2( TLSX ** extensions,
                                                              ...
                                                              int devId );
        #ifndef NO_CERTS
            WOLFSSL_LOCAL int TLSX_CSR2_InitRequests( TLSX * extensions,
                                                      DecodedCert * cert,
                                                      byte isPeer,
                                                      void * heap );
        #endif
        WOLFSSL_LOCAL void * TLSX_CSR2_GetRequest( TLSX * extensions,
                                                   byte status_type,
                                                   byte index );
...
/** Supported Elliptic Curves - RFC 4492 (session 4) */
        ...
        WOLFSSL_LOCAL int TLSX_UseSupportedCurve( TLSX ** extensions,
                                                  word16 name,
                                                  void * heap );

        WOLFSSL_LOCAL int TLSX_UsePointFormat( TLSX ** extensions,
                                               byte point,
                                               void * heap );

        #ifndef NO_WOLFSSL_SERVER
            WOLFSSL_LOCAL int TLSX_ValidateSupportedCurves( WOLFSSL * ssl,
                                                            byte first,
                                                            byte second );
...
/* used in key exchange during handshake */
        WOLFSSL_LOCAL int TLSX_QSHCipher_Parse( WOLFSSL * ssl,
                                                const byte * input,
                                                word16 length,
                                                byte isServer );
        WOLFSSL_LOCAL word16 TLSX_QSHPK_Write( QSHScheme * list,
                                               byte * output );
        WOLFSSL_LOCAL word16 TLSX_QSH_GetSize( QSHScheme * list,
                                               byte isRequest );

/* used by api for setting a specific QSH scheme */
        WOLFSSL_LOCAL int TLSX_UseQSHScheme( TLSX ** extensions,
                                             word16 name,
                                             byte * pKey,
                                             word16 pKeySz,
                                             void * heap );
...
/* used when parsing in QSHCipher structs */
        WOLFSSL_LOCAL int QSH_Decrypt( QSHKey * key,
                                       byte * in,
                                       word32 szIn,
                                       byte * out,
                                       word16 * szOut );
        #ifndef NO_WOLFSSL_SERVER
            WOLFSSL_LOCAL int TLSX_ValidateQSHScheme( TLSX ** extensions,
                                                      word16 name );
        #endif
...
/* Cookie extension information - cookie data. */
        ...
        WOLFSSL_LOCAL int TLSX_Cookie_Use( WOLFSSL * ssl,
                                           byte * data,
                                           word16 len,
                                           byte * mac,
                                           byte macSz,
...
/* The KeyShare extension information - entry in a linked list. */
        ...
        WOLFSSL_LOCAL int TLSX_KeyShare_Use( WOLFSSL * ssl,
                                             word16 group,
                                             word16 len,
                                             byte * data,
                                             KeyShareEntry ** kse );
...
/* The PreSharedKey extension information - entry in a linked list. */
            ...
            WOLFSSL_LOCAL int TLSX_PreSharedKey_GetSizeBinders( PreSharedKey * list,
                                                                byte msgType,
                                                                word16 * pSz );
            WOLFSSL_LOCAL int TLSX_PreSharedKey_Use( WOLFSSL * ssl,
                                                     byte * identity,
                                                     word16 len,
                                                     word32 age,
                                                     byte hmac,
...
/* User can define this. */
            ...
            WOLFSSL_LOCAL int TLSX_PskKeModes_Use( WOLFSSL * ssl,
                                                   byte modes );

            #ifdef WOLFSSL_EARLY_DATA
                WOLFSSL_LOCAL int TLSX_EarlyData_Use( WOLFSSL * ssl,
                                                      word32 max );
            #endif
...
/* The types of keys to derive for. */
        ...
        WOLFSSL_LOCAL int DeriveTls13Keys( WOLFSSL * ssl,
                                           int secret,
                                           int side,
                                           int store );
        WOLFSSL_LOCAL int DeriveMasterSecret( WOLFSSL * ssl );
        WOLFSSL_LOCAL int DeriveResumptionPSK( WOLFSSL * ssl,
                                               byte * nonce,
                                               byte nonceLen,
                                               byte * secret );
        WOLFSSL_LOCAL int DeriveResumptionSecret( WOLFSSL * ssl,
                                                  byte * key );
...
/* wolfSSL context type */
    struct WOLFSSL_CTX
    {
        ...
        int devId;                     /* async device id to use */
            ...
            #endif
        #endif /* ifdef HAVE_TLS_EXTENSIONS */
        #ifdef ATOMIC_USER
        ...
        #ifdef HAVE_EXT_CACHE
            WOLFSSL_SESSION *(* get_sess_cb)( WOLFSSL *,
                                              unsigned char *,
                                              int,
                                              int * );
            int (* new_sess_cb)( WOLFSSL *,
                                 WOLFSSL_SESSION * );
            void (* rem_sess_cb)( WOLFSSL_CTX *,
                                  WOLFSSL_SESSION * );
        #endif
    ...
    WOLFSSL_LOCAL
    int ProcessOldClientHello( WOLFSSL * ssl,
                               const byte * input,
                               word32 * inOutIdx,
                               word32 inSz,
                               word16 sz );
    ...
    #ifndef NO_CERTS
        WOLFSSL_LOCAL
        int AddCA( WOLFSSL_CERT_MANAGER * cm,
                   DerBuffer ** pDer,
                   int type,
                   int verify );
        WOLFSSL_LOCAL
        int AlreadySigner( WOLFSSL_CERT_MANAGER * cm,
                           byte * hash );
        #ifdef WOLFSSL_TRUST_PEER_CERT
            WOLFSSL_LOCAL
            int AddTrustedPeer( WOLFSSL_CERT_MANAGER * cm,
                                DerBuffer ** pDer,
                                int verify );
            WOLFSSL_LOCAL
            int AlreadyTrustedPeer( WOLFSSL_CERT_MANAGER * cm,
                                    byte * hash );
        #endif
    #endif /* ifndef NO_CERTS */
...
/* hashes type */
    ...
    WOLFSSL_LOCAL int BuildCertHashes( WOLFSSL * ssl,
                                       Hashes * hashes );
...
/* wolfSSL session type */
    ...
    WOLFSSL_LOCAL
    WOLFSSL_SESSION * GetSession( WOLFSSL *,
                                  byte *,
                                  byte );
    WOLFSSL_LOCAL
    int SetSession( WOLFSSL *,
                    WOLFSSL_SESSION * );

    typedef int (* hmacfp) ( WOLFSSL *,
                             byte *,
                             const byte *,
                             word32,
                             int,
    ...
    #ifndef NO_CLIENT_CACHE
        WOLFSSL_SESSION * GetSessionClient( WOLFSSL *,
                                            const byte *,
                                            int );
    #endif
...
/* Persistable BuildMessage arguments */
        ...
        typedef void (* FreeArgsCb)( struct WOLFSSL * ssl,
                                     void * pArgs );
    ...
    #endif /* ifdef WOLFSSL_ASYNC_CRYPT */
        ...
        WOLFSSL_LOCAL int NotifyWriteSide( WOLFSSL * ssl,
                                           int err );
...
/* wolfSSL ssl type */
    ...
    WOLFSSL_LOCAL int SSL_CTX_RefCount( WOLFSSL_CTX * ctx,
                                        int incr );
    WOLFSSL_LOCAL int SetSSL_CTX( WOLFSSL *,
                                  WOLFSSL_CTX *,
                                  int );
    WOLFSSL_LOCAL int InitSSL( WOLFSSL *,
                               WOLFSSL_CTX *,
                               int );
    ...
    WOLFSSL_API void SSL_ResourceFree( WOLFSSL * ); /* Micrium uses */
        ...
        WOLFSSL_LOCAL int ProcessBuffer( WOLFSSL_CTX * ctx,
                                         ...
                                         int userChain,
                                         int verify );
        WOLFSSL_LOCAL int ProcessFile( WOLFSSL_CTX * ctx,
                                       const char * fname,
                                       int format,
                                       int type,
                                       WOLFSSL * ssl,
        ...
        WOLFSSL_LOCAL int CheckHostName( DecodedCert * dCert,
        ...
        WOLFSSL_LOCAL
        void AddPacketName( WOLFSSL * ssl,
                            const char * name );
        ...
        void FreeTimeoutInfo( TimeoutInfo *,
                              void * );
        WOLFSSL_LOCAL
        void AddPacketInfo( WOLFSSL * ssl,
                            const char * name,
                            int type,
                            const byte * data,
                            int sz,
                            ...
                            void * heap );
        WOLFSSL_LOCAL
        void AddLateName( const char *,
                          TimeoutInfo * );
        WOLFSSL_LOCAL
        void AddLateRecordHeader( const RecordLayerHeader * rl,
                                  TimeoutInfo * info );
    #endif /* if defined( WOLFSSL_CALLBACKS ) || defined( OPENSSL_EXTRA ) */
...
/* internal functions */
    ...
    WOLFSSL_LOCAL int DoClientTicket( WOLFSSL *,
                                      const byte *,
                                      word32 );
    WOLFSSL_LOCAL int SendData( WOLFSSL *,
                                const void *,
                                int );
    #ifdef WOLFSSL_TLS13
    ...
    #if defined( HAVE_CERTIFICATE_STATUS_REQUEST ) \
    || defined( HAVE_CERTIFICATE_STATUS_REQUEST_V2 )
        WOLFSSL_LOCAL int CreateOcspResponse( WOLFSSL *,
                                              OcspRequest **,
                                              buffer * );
    #endif
    #if defined( HAVE_SECURE_RENEGOTIATION ) && \
    ...
    WOLFSSL_LOCAL int ReceiveData( WOLFSSL *,
                                   byte *,
                                   int,
                                   int );
    WOLFSSL_LOCAL int SendFinished( WOLFSSL * );
    WOLFSSL_LOCAL int SendAlert( WOLFSSL *,
                                 int,
                                 int );
    ...
    WOLFSSL_LOCAL int StoreKeys( WOLFSSL * ssl,
                                 const byte * keyData,
                                 int side );
    ...
    WOLFSSL_LOCAL void ShrinkInputBuffer( WOLFSSL * ssl,
                                          int forcedFree );
    WOLFSSL_LOCAL void ShrinkOutputBuffer( WOLFSSL * ssl );

    WOLFSSL_LOCAL int VerifyClientSuite( WOLFSSL * ssl );

    WOLFSSL_LOCAL int SetTicket( WOLFSSL *,
                                 const byte *,
                                 word32 );
    WOLFSSL_LOCAL int wolfSSL_GetMaxRecordSize( WOLFSSL * ssl,
                                                int maxFragment );
    ...
    WOLFSSL_LOCAL WC_RNG * WOLFSSL_RSA_GetRNG( WOLFSSL_RSA * rsa,
                                               WC_RNG ** tmpRNG,
                                               int * initTmpRng );
        ...
        #ifndef NO_RSA
            #ifdef WC_RSA_PSS
                WOLFSSL_LOCAL int CheckRsaPssPadding( const byte * plain,
                                                      word32 plainSz,
                                                      byte * out,
                                                      word32 sigSz,
            ...
            WOLFSSL_LOCAL int RsaSign( WOLFSSL * ssl,
                                       const byte * in,
                                       word32 inSz,
                                       byte * out,
                                       word32 * outSz,
                                       ...
                                       RsaKey * key,
                                       DerBuffer * keyBufInfo );
            WOLFSSL_LOCAL int RsaVerify( WOLFSSL * ssl,
                                         byte * in,
                                         word32 inSz,
                                         byte ** out,
                                         int sigAlgo,
                                         ...
                                         RsaKey * key,
                                         buffer * keyBufInfo );
            WOLFSSL_LOCAL int RsaDec( WOLFSSL * ssl,
                                      byte * in,
                                      word32 inSz,
                                      byte ** out,
                                      word32 * outSz,
                                      RsaKey * key,
                                      DerBuffer * keyBufInfo );
            WOLFSSL_LOCAL int RsaEnc( WOLFSSL * ssl,
                                      const byte * in,
                                      word32 inSz,
                                      byte * out,
                                      word32 * outSz,
        ...
        #ifdef HAVE_ECC
            WOLFSSL_LOCAL int EccSign( WOLFSSL * ssl,
                                       const byte * in,
                                       word32 inSz,
                                       byte * out,
                                       word32 * outSz,
                                       ecc_key * key,
                                       DerBuffer * keyBufInfo );
            WOLFSSL_LOCAL int EccVerify( WOLFSSL * ssl,
                                         const byte * in,
                                         word32 inSz,
                                         const byte * out,
                                         word32 outSz,
                                         ecc_key * key,
                                         buffer * keyBufInfo );
            WOLFSSL_LOCAL int EccSharedSecret( WOLFSSL * ssl,
                                               ecc_key * priv_key,
                                               ecc_key * pub_key,
                                               byte * pubKeyDer,
                                               word32 * pubKeySz,
            ...
            WOLFSSL_LOCAL int Ed25519Sign( WOLFSSL * ssl,
                                           const byte * in,
                                           word32 inSz,
                                           byte * out,
                                           word32 * outSz,
                                           ed25519_key * key,
                                           DerBuffer * keyBufInfo );
            WOLFSSL_LOCAL int Ed25519Verify( WOLFSSL * ssl,
                                             const byte * in,
                                             word32 inSz,
                                             const byte * msg,
                                             word32 msgSz,
            ...
            WOLFSSL_LOCAL int Ed448Sign( WOLFSSL * ssl,
                                         const byte * in,
                                         word32 inSz,
                                         byte * out,
                                         word32 * outSz,
                                         ed448_key * key,
                                         DerBuffer * keyBufInfo );
            WOLFSSL_LOCAL int Ed448Verify( WOLFSSL * ssl,
                                           const byte * in,
                                           word32 inSz,
                                           const byte * msg,
                                           word32 msgSz,
...
/* options for searching hash table for a matching trusted peer cert */
            ...
            WOLFSSL_LOCAL TrustedPeerCert * GetTrustedPeer( void * vp,
                                                            byte * hash,
                                                            int type );
            WOLFSSL_LOCAL int MatchTrustedPeer( TrustedPeerCert * tp,
                                                DecodedCert * cert );
        #endif /* ifdef WOLFSSL_TRUST_PEER_CERT */

        WOLFSSL_LOCAL Signer * GetCA( void * cm,
                                      byte * hash );
        #ifndef NO_SKID
            WOLFSSL_LOCAL Signer * GetCAByName( void * cm,
                                                byte * hash );
        #endif
    #endif /* !NO_CERTS */
    WOLFSSL_LOCAL int BuildTlsHandshakeHash( WOLFSSL * ssl,
                                             byte * hash,
                                             word32 * hashLen );
    WOLFSSL_LOCAL int BuildTlsFinished( WOLFSSL * ssl,
                                        Hashes * hashes,
                                        const byte * sender );
    WOLFSSL_LOCAL void FreeArrays( WOLFSSL * ssl,
                                   int keep );
    WOLFSSL_LOCAL int CheckAvailableSize( WOLFSSL * ssl,
                                          int size );
    WOLFSSL_LOCAL int GrowInputBuffer( WOLFSSL * ssl,
                                       int size,
                                       int usedLength );
        ...
        #ifndef WOLFSSL_AEAD_ONLY
            WOLFSSL_LOCAL int TLS_hmac( WOLFSSL * ssl,
                                        byte * digest,
                                        const byte * in,
                                        word32 sz,
                                        int padSz,
    ...
    #ifdef WOLFSSL_DTLS
        WOLFSSL_LOCAL DtlsMsg * DtlsMsgNew( word32,
                                            void * );
        WOLFSSL_LOCAL void DtlsMsgDelete( DtlsMsg *,
                                          void * );
        WOLFSSL_LOCAL void DtlsMsgListDelete( DtlsMsg *,
                                              void * );
        WOLFSSL_LOCAL void DtlsTxMsgListClean( WOLFSSL * ssl );
        WOLFSSL_LOCAL int DtlsMsgSet( DtlsMsg *,
                                      word32,
                                      word16,
                                      const byte *,
                                      byte,
                                      ...
                                      word32,
                                      void * );
        WOLFSSL_LOCAL DtlsMsg * DtlsMsgFind( DtlsMsg *,
                                             word32,
                                             word32 );
        WOLFSSL_LOCAL void DtlsMsgStore( WOLFSSL *,
                                         word32,
                                         word32,
                                         const byte *,
                                         word32,
                                         ...
                                         word32,
                                         void * );
        WOLFSSL_LOCAL DtlsMsg * DtlsMsgInsert( DtlsMsg *,
                                               DtlsMsg * );

        WOLFSSL_LOCAL int DtlsMsgPoolSave( WOLFSSL *,
                                           const byte *,
                                           word32,
                                           enum HandShakeType );
        WOLFSSL_LOCAL int DtlsMsgPoolTimeout( WOLFSSL * );
        WOLFSSL_LOCAL int VerifyForDtlsMsgPoolSend( WOLFSSL *,
                                                    byte,
                                                    word32 );
        WOLFSSL_LOCAL int VerifyForTxDtlsMsgDelete( WOLFSSL * ssl,
                                                    DtlsMsg * head );
        WOLFSSL_LOCAL void DtlsMsgPoolReset( WOLFSSL * );
        WOLFSSL_LOCAL int DtlsMsgPoolSend( WOLFSSL *,
                                           int );
    #endif /* WOLFSSL_DTLS */
        ...
        WOLFSSL_LOCAL int DtlsCheckOrder( WOLFSSL * ssl,
                                          int order );
    #endif

    WOLFSSL_LOCAL void WriteSEQ( WOLFSSL * ssl,
                                 int verifyOrder,
                                 byte * out );
    ...
    #ifndef NO_CERTS
        WOLFSSL_LOCAL void InitX509Name( WOLFSSL_X509_NAME *,
                                         int,
                                         void * );
        WOLFSSL_LOCAL void FreeX509Name( WOLFSSL_X509_NAME * name );
        WOLFSSL_LOCAL void InitX509( WOLFSSL_X509 *,
                                     int,
                                     void * heap );
        WOLFSSL_LOCAL void FreeX509( WOLFSSL_X509 * );
        WOLFSSL_LOCAL int CopyDecodedToX509( WOLFSSL_X509 *,
                                             DecodedCert * );
    #endif /* ifndef NO_CERTS */
    ...
    WOLFSSL_LOCAL const char * GetCipherNameInternal( const byte cipherSuite0,
...
/* used in wolfSSL_sk_CIPHER_description */
    ...
    #endif /* if defined( OPENSSL_ALL ) || defined( WOLFSSL_QT ) */
    WOLFSSL_LOCAL const char * GetCipherNameIana( const byte cipherSuite0,
                                                  const byte cipherSuite );
    WOLFSSL_LOCAL const char * wolfSSL_get_cipher_name_internal( WOLFSSL * ssl );
    WOLFSSL_LOCAL const char * wolfSSL_get_cipher_name_iana( WOLFSSL * ssl );
    WOLFSSL_LOCAL int GetCipherSuiteFromName( const char * name,
                                              byte * cipherSuite0,
                                              byte * cipherSuite );
    ...
    WOLFSSL_LOCAL int SetKeysSide( WOLFSSL *,
                                   enum encrypt_side );
...
/* Set*Internal and Set*External functions */
    ...
    #ifdef HAVE_ECC
        WOLFSSL_LOCAL int EccMakeKey( WOLFSSL * ssl,
                                      ecc_key * key,
                                      ecc_key * peer );
    ...
    #ifndef WOLFSSL_NO_TLS12
        WOLFSSL_LOCAL void FreeBuildMsgArgs( WOLFSSL * ssl,
                                             BuildMsgArgs * args );
    #endif
    WOLFSSL_LOCAL int BuildMessage( WOLFSSL * ssl,
                                    byte * output,
                                    int outSz,
                                    const byte * input,
                                    int inSz,
    ...
    #ifdef WOLFSSL_TLS13
        int BuildTls13Message( WOLFSSL * ssl,
                               byte * output,
                               int outSz,
                               const byte * input,
                               int inSz,
    ...
    WOLFSSL_LOCAL int AllocKey( WOLFSSL * ssl,
                                int type,
                                void ** pKey );
    WOLFSSL_LOCAL void FreeKey( WOLFSSL * ssl,
                                int type,
                                void ** pKey );

    #ifdef WOLFSSL_ASYNC_CRYPT
        WOLFSSL_LOCAL int wolfSSL_AsyncInit( WOLFSSL * ssl,
                                             WC_ASYNC_DEV * asyncDev,
                                             word32 flags );
        WOLFSSL_LOCAL int wolfSSL_AsyncPop( WOLFSSL * ssl,
                                            byte * state );
        WOLFSSL_LOCAL int wolfSSL_AsyncPush( WOLFSSL * ssl,
                                             WC_ASYNC_DEV * asyncDev );
    #endif
