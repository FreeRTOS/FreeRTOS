                                       ...
                                       list_element_handle_t newElement )
{
    ...
    #endif /* if ( defined( GENERIC_LIST_DUPLICATED_CHECKING ) && ( GENERIC_LIST_DUPLICATED_CHECKING > 0U ) ) */
    return listStatus;
}
...
list_status_t LIST_RemoveElement( list_element_handle_t element )
{
    ...
    else
    {
        ...
        #else  /* if ( defined( GENERIC_LIST_LIGHT ) && ( GENERIC_LIST_LIGHT > 0U ) ) */
