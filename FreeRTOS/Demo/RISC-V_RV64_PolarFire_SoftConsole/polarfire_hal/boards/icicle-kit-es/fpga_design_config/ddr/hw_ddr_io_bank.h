...
/*DPC Bits Register */
    ...
    #endif /* if !defined( LIBERO_SETTING_DPC_BITS ) */
 ...
 * to an IO in corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC_EN_ADDCMD0_OVRT9 ) */
 ...
 * to an IO in corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC_EN_ADDCMD1_OVRT10 ) */
 ...
 * to an IO in corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC_EN_ADDCMD2_OVRT11 ) */
 ...
 * to an IO in corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC_EN_DATA0_OVRT12 ) */
 ...
 * to an IO in corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC_EN_DATA1_OVRT13 ) */
 ...
 * to an IO in corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC_EN_DATA2_OVRT14 ) */
 ...
 * to an IO in corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC_EN_DATA3_OVRT15 ) */
 ...
 * to an IO in corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC_EN_ECC_OVRT16 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC235_WPD_ADD_CMD0 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC236_WPD_ADD_CMD1 ) */
 ...
 * wpu == 0 , wpd == 1 ) */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC237_WPD_ADD_CMD2 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
        ...
        /* MSS_DDR_DQ7                       [9:1]   RW value= 0x0 */
        /* MSS_DDR_DM0                       [10:1]  RW value= 0x0 */
    #endif /* if !defined( LIBERO_SETTING_RPC238_WPD_DATA0 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
        ...
        /* MSS_DDR_DQ15                      [9:1]   RW value= 0x0 */
        /* MSS_DDR_DM1                       [10:1]  RW value= 0x0 */
    #endif /* if !defined( LIBERO_SETTING_RPC239_WPD_DATA1 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
        ...
        /* MSS_DDR_DQ23                      [9:1]   RW value= 0x0 */
        /* MSS_DDR_DM2                       [10:1]  RW value= 0x0 */
    #endif /* if !defined( LIBERO_SETTING_RPC240_WPD_DATA2 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
        ...
        /* MSS_DDR_DQ31                      [9:1]   RW value= 0x0 */
        /* MSS_DDR_DM3                       [10:1]  RW value= 0x0 */
    #endif /* if !defined( LIBERO_SETTING_RPC241_WPD_DATA3 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC242_WPD_ECC ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
        ...
        /* MSS_DDR_A8                        [10:1]  RW value= 0x1 */
        /* MSS_DDR_A9                        [11:1]  RW value= 0x1 */
    #endif /* if !defined( LIBERO_SETTING_RPC243_WPU_ADD_CMD0 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
        ...
        /* MSS_DDR_BA0                       [10:1]  RW value= 0x1 */
        /* MSS_DDR_BA1                       [11:1]  RW value= 0x1 */
    #endif /* if !defined( LIBERO_SETTING_RPC244_WPU_ADD_CMD1 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
        ...
        /* MSS_DDR_PARITY                    [10:1]  RW value= 0x1 */
        /* MSS_DDR_ALERT_N                   [11:1]  RW value= 0x1 */
    #endif /* if !defined( LIBERO_SETTING_RPC245_WPU_ADD_CMD2 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC246_WPU_DATA0 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC247_WPU_DATA1 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC248_WPU_DATA2 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
    ...
    #endif /* if !defined( LIBERO_SETTING_RPC249_WPU_DATA3 ) */
 ...
 * corresponding IOG lane, starting from p_pair0 to n_pair5. */
        ...
        /* MSS_DDR_DQS_N4                    [5:1]   RW value= 0x1 */
        /* MSS_DDR_DM4                       [6:1]   RW value= 0x1 */
    #endif /* if !defined( LIBERO_SETTING_RPC250_WPU_ECC ) */
