...
#include <metal/machine/platform.h>
    ...
    unsigned int __metal_driver_sifive_global_external_interrupt_get_priority( struct metal_interrupt * controller,
                                                                               int id )
    {
        struct metal_interrupt * intc =
            __metal_driver_sifive_global_external_interrupts0_interrupt_parent(
...
#endif /* ifdef METAL_SIFIVE_GLOBAL_EXTERNAL_INTERRUPTS0 */
