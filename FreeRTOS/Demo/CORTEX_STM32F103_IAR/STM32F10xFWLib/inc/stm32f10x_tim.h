...
#define IS_TIM_IC_MODE( MODE )       \
    ( ( MODE == TIM_ICMode_ICAP ) || \
...
#define IS_TIM_TIX_TRIGGER_SELECTION( SELECTION ) \
    ( ( SELECTION == TIM_TS_TI1F_ED ) ||          \
      ( SELECTION == TIM_TS_TI1FP1 ) ||           \
      ( SELECTION == TIM_TS_TI2FP2 ) )
...
void TIM_OCInit( TIM_TypeDef * TIMx,
