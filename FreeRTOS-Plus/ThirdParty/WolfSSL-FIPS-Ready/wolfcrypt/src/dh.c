 ...
 * return 0 on success, -1 on error */
            static int CheckDhLN( int modLen,
                                  int divLen )
            {
                int ret = -1;
 ...
 * return 0 on success, negative on error */
            static int GeneratePrivateDh186( DhKey * key,
                                             WC_RNG * rng,
                                             byte * priv,
                                             word32 * privSz )
            {
    ...
    static int GeneratePrivateDh( DhKey * key,
                                  WC_RNG * rng,
                                  byte * priv,
                                  word32 * privSz )
    {
    ...
    static int GeneratePublicDh( DhKey * key,
                                 byte * priv,
                                 word32 privSz,
                                 byte * pub,
                                 word32 * pubSz )
    {
        int ret = 0;
            ...
            #endif
        #endif /* ifdef WOLFSSL_HAVE_SP_DH */
    ...
    static int wc_DhGenerateKeyPair_Sync( DhKey * key,
                                          WC_RNG * rng,
                                          byte * priv,
                                          word32 * privSz,
                                          byte * pub,
                                          word32 * pubSz )
    {
    ...
    #if defined( WOLFSSL_ASYNC_CRYPT ) && defined( WC_ASYNC_ENABLE_DH )
        static int wc_DhGenerateKeyPair_Async( DhKey * key,
                                               WC_RNG * rng,
                                               byte * priv,
                                               word32 * privSz,
                                               byte * pub,
                                               word32 * pubSz )
        {
            ...
            #endif /* if defined( HAVE_INTEL_QA ) */
 ...
 */
    int wc_DhCheckPubValue( const byte * prime,
                            word32 primeSz,
                            const byte * pub,
                            word32 pubSz )
    {
 ...
 */
    ...
    static int wc_DhAgree_Sync( DhKey * key,
                                byte * agree,
                                word32 * agreeSz,
                                const byte * priv,
                                word32 privSz,
                                ...
                                word32 pubSz )
    {
        ...
        #endif /* ifdef WOLFSSL_VALIDATE_FFC_IMPORT */
    ...
    #if defined( WOLFSSL_ASYNC_CRYPT ) && defined( WC_ASYNC_ENABLE_DH )
        static int wc_DhAgree_Async( DhKey * key,
                                     byte * agree,
                                     word32 * agreeSz,
                                     const byte * priv,
                                     word32 privSz,
 ...
 *  either private or public key, depending on which is available. */
        int wc_DhImportKeyPair( DhKey * key,
                                const byte * priv,
                                word32 privSz,
                                const byte * pub,
                                word32 pubSz )
 ...
 *  wc_DhKeyDecode or wc_DhImportKeyPair */
        int wc_DhExportKeyPair( DhKey * key,
                                byte * priv,
                                word32 * pPrivSz,
                                byte * pub,
                                word32 * pPubSz )
    ...
    static int _DhSetKey( DhKey * key,
                          const byte * p,
                          word32 pSz,
                          const byte * g,
                          word32 gSz,
