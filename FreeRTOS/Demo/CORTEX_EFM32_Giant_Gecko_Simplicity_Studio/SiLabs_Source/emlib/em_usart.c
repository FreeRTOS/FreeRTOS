...
/** Validation of USART register block pointer reference for assert statements. */
    ...
    #elif ( USART_COUNT == 3 )
        #define USART_REF_VALID( ref )                  \
    ( ( ( ref ) == USART0 ) || ( ( ref ) == USART1 ) || \
      ( ( ref ) == USART2 ) )
    #elif ( USART_COUNT == 4 )
        #define USART_REF_VALID( ref )                  \
    ( ( ( ref ) == USART0 ) || ( ( ref ) == USART1 ) || \
    ...
    #else  /* if ( USART_COUNT == 1 ) && defined( USART0 ) */
        #error "Undefined number of USARTs."
    #endif /* if ( USART_COUNT == 1 ) && defined( USART0 ) */
 ...
 ******************************************************************************/
                                ...
                                uint32_t baudrate )
    {
        ...
        if( !refFreq )
        {
            ...
            clkdiv += 0xc0;
            clkdiv &= 0xffffff00;
        #endif /* if defined( _USART_CLKDIV_DIV_MASK ) && ( _USART_CLKDIV_DIV_MASK >= 0x7FFFF8UL ) */
 ...
 ******************************************************************************/
                          ...
                          const USART_InitAsync_TypeDef * init )
    {
        ...
        #endif /* if defined( USART_INPUT_RXPRS ) && defined( USART_CTRL_MVDIS ) */
 ...
 ******************************************************************************/
    ...
    #endif /* if defined( USART0 ) || ( ( USART_COUNT == 1 ) && defined( USART1 ) ) */
 ...
 ******************************************************************************/
    ...
    #endif /* if defined( _USART_I2SCTRL_MASK ) */
