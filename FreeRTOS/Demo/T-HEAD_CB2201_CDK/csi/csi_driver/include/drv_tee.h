 ...
 * \return      return 0 if successful,otherwise error code
 */
    int32_t csi_tee_get_cid( uint8_t * out,
                             uint32_t * out_len );
 ...
 * \return      return 0 if successful,otherwise error code
 */
    int32_t csi_tee_enter_lpm( uint32_t gate,
                               uint32_t irqid,
                               tee_lpm_mode_e mode );
 ...
 * \return      return 0 if successful,otherwise error code
 */
    int32_t csi_tee_rand_generate( uint8_t * out,
                                   uint32_t out_len );
 ...
 * \return      return  0 if successful,otherwise error code
 */
    int32_t csi_tee_set_sys_freq( uint32_t clk_src,
                                  uint32_t clk_val );
 ...
 */
    ...
    int32_t csi_tee_xor( uint8_t * out,
                         uint32_t * out_len );
    #ifdef __cplusplus
}
    #endif
