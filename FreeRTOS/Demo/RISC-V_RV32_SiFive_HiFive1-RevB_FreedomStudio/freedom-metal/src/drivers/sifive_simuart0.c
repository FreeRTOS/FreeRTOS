...
/* TXDATA Fields */
    ...
    struct metal_interrupt * __metal_driver_sifive_simuart0_interrupt_controller( struct metal_uart * uart )
    {
    ...
    int __metal_driver_sifive_simuart0_putc( struct metal_uart * uart,
                                             int c )
    {
    ...
    int __metal_driver_sifive_simuart0_getc( struct metal_uart * uart,
                                             int * c )
    {
        return 0;
    }
