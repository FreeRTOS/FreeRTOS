...
/*! @brief GPIO checker attribute */
    ...
    #endif /* if defined( FSL_FEATURE_GPIO_HAS_ATTRIBUTE_CHECKER ) && FSL_FEATURE_GPIO_HAS_ATTRIBUTE_CHECKER */
 ...
 */
    static inline void GPIO_WritePinOutput( GPIO_Type * base,
                                            uint32_t pin,
                                            uint8_t output )
    {
        if( output == 0U )
 ...
 */
    static inline void GPIO_SetPinsOutput( GPIO_Type * base,
                                           uint32_t mask )
    {
        base->PSOR = mask;
    }
 ...
 * @param mask GPIO pin number macro
 */
    static inline void GPIO_ClearPinsOutput( GPIO_Type * base,
                                             uint32_t mask )
    {
        base->PCOR = mask;
    }
 ...
 * @param mask GPIO pin number macro
 */
    static inline void GPIO_TogglePinsOutput( GPIO_Type * base,
                                              uint32_t mask )
    {
        base->PTOR = mask;
    }
 ...
 */
    static inline uint32_t GPIO_ReadPinInput( GPIO_Type * base,
                                              uint32_t pin )
    {
 ...
 *        - 1: corresponding pin output high-logic level.
 */
        static inline void FGPIO_WritePinOutput( FGPIO_Type * base,
                                                 uint32_t pin,
                                                 uint8_t output )
        {
            if( output == 0U )
 ...
 */
        static inline void FGPIO_SetPinsOutput( FGPIO_Type * base,
                                                uint32_t mask )
        {
            base->PSOR = mask;
        }
 ...
 * @param mask FGPIO pin number macro
 */
        static inline void FGPIO_ClearPinsOutput( FGPIO_Type * base,
                                                  uint32_t mask )
        {
            base->PCOR = mask;
        }
 ...
 * @param mask FGPIO pin number macro
 */
        static inline void FGPIO_TogglePinsOutput( FGPIO_Type * base,
                                                   uint32_t mask )
        {
            base->PTOR = mask;
        }
 ...
 *        - 1: corresponding pin input high-logic level.
 */
        static inline uint32_t FGPIO_ReadPinInput( FGPIO_Type * base,
                                                   uint32_t pin )
        {
            return( ( ( base->PDIR ) >> pin ) & 0x01U );
        }
