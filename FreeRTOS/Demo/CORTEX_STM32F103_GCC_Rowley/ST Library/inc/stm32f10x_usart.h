...
#define IS_USART_PERIPH_HFC( PERIPH, HFC )              \
    ( ( ( ( *( u32 * ) &( PERIPH ) ) != UART4_BASE ) && \
        ( ( *( u32 * ) &( PERIPH ) ) != UART5_BASE ) )  \
...
#define IS_USART_CLEAR_IT( IT )                                     \
    ( ( ( IT ) == USART_IT_PE ) || ( ( IT ) == USART_IT_TC ) ||     \
      ( ( IT ) == USART_IT_RXNE ) || ( ( IT ) == USART_IT_IDLE ) || \
      ( ( IT ) == USART_IT_LBD ) || ( ( IT ) == USART_IT_CTS ) ||   \
      ( ( IT ) == USART_IT_ORE ) || ( ( IT ) == USART_IT_NE ) ||    \
      ( ( IT ) == USART_IT_FE ) )

#define IS_USART_PERIPH_IT( PERIPH, USART_IT )          \
    ( ( ( ( *( u32 * ) &( PERIPH ) ) != UART4_BASE ) && \
        ( ( *( u32 * ) &( PERIPH ) ) != UART5_BASE ) )  \
