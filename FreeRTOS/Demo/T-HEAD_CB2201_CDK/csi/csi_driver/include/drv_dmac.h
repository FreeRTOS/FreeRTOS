...
/****** DMA Event *****/
    ...
    typedef void (* dma_event_cb_t)( dma_event_e event,
                                     int32_t ch );               /*/< Pointer to \ref dma_event_cb_t : CRC Event call back. */
 ...
 */
    int32_t csi_dma_alloc_channel( dmac_handle_t handle,
                                   int32_t ch );
 ...
 * \return       error code
 */
    int32_t csi_dma_release_channel( dmac_handle_t handle,
                                     int32_t ch );
 ...
 * \return       error code
 */
    int32_t csi_dma_config( dmac_handle_t handle,
                            int32_t ch,
                            void * psrcaddr,
                            void * pstdaddr,
                            uint32_t length,
 ...
 * \return      error code
 */
    int32_t csi_dma_start( dmac_handle_t handle,
                           int32_t ch );
 ...
 * \return      error code
 */
    int32_t csi_dma_stop( dmac_handle_t handle,
                          int32_t ch );
 ...
 */
    dma_status_e csi_dma_get_status( dmac_handle_t handle,
                                     int32_t ch );
