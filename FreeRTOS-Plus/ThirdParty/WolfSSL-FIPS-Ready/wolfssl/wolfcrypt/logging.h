...
/* turn logging off */
    WOLFSSL_API void wolfSSL_Debugging_OFF( void );
        ...
        WOLFSSL_LOCAL int wc_AddErrorNode( int error,
                                           int line,
                                           char * buf,
                                           char * file );
        WOLFSSL_LOCAL int wc_PeekErrorNode( int index,
                                            const char ** file,
                                            const char ** reason,
                                            int * line );
        WOLFSSL_LOCAL void wc_RemoveErrorNode( int index );
        WOLFSSL_LOCAL void wc_ClearErrorNodes( void );
        WOLFSSL_LOCAL int wc_PullErrorNode( const char ** file,
                                            const char ** reason,
                                            int * line );
...
/* a is prepended to m and b is appended, creating a log msg a + m + b */
        ...
        WOLFSSL_API void WOLFSSL_LEAVE( const char * msg,
                                        int ret );
    ...
    WOLFSSL_MSG( WOLFSSL_LOG_CAT( wolfSSL Stub, m, not implemented ) )
        ...
        WOLFSSL_API void WOLFSSL_BUFFER( const byte * buffer,
                                         word32 length );

    #else  /* if defined( DEBUG_WOLFSSL ) && !defined( WOLFSSL_DEBUG_ERRORS_ONLY ) */
    ...
    defined( WOLFSSL_HAPROXY ) || defined( OPENSSL_EXTRA )
        ...
        || defined( DEBUG_WOLFSSL_VERBOSE )
            WOLFSSL_API void WOLFSSL_ERROR_LINE( int err,
                                                 const char * func,
                                                 unsigned int line,
                                                 const char * file,
                                                 void * ctx );
    ...
    #else  /* if defined( DEBUG_WOLFSSL ) || defined( OPENSSL_ALL ) || defined( WOLFSSL_NGINX ) || defined( WOLFSSL_HAPROXY ) || defined( OPENSSL_EXTRA ) */
        #define WOLFSSL_ERROR( e )
        #define WOLFSSL_ERROR_MSG( m )
    #endif /* if defined( DEBUG_WOLFSSL ) || defined( OPENSSL_ALL ) || defined( WOLFSSL_NGINX ) || defined( WOLFSSL_HAPROXY ) || defined( OPENSSL_EXTRA ) */
