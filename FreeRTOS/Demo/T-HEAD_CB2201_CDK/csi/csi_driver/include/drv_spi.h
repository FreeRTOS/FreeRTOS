...
/****** SPI Event *****/
    ...
    typedef void (* spi_event_cb_t)( spi_event_e event,
                                     void * arg );             /*/< Pointer to \ref spi_event_cb_t : SPI Event call back. */
 ...
 */
    spi_handle_t csi_spi_initialize( pin_t mosi,
                                     pin_t miso,
                                     pin_t sclk,
                                     pin_t ssel,
 ...
 * \return      error code
 */
    int32_t csi_spi_set_default_tx_value( spi_handle_t handle,
                                          uint32_t value );
 ...
 * \return      error code
 */
    int32_t csi_spi_send( spi_handle_t handle,
                          const void * data,
                          uint32_t num,
                          uint8_t block_mode );
 ...
 * \return      error code
 */
    int32_t csi_spi_receive( spi_handle_t handle,
                             void * data,
                             uint32_t num,
                             uint8_t block_mode );
 ...
 * \return      error code
 */
    int32_t csi_spi_transfer( spi_handle_t handle,
                              const void * data_out,
                              void * data_in,
                              uint32_t num_out,
                              uint32_t num_in,
 ...
 * \return      error code
 */
    int32_t csi_spi_config_mode( spi_handle_t handle,
                                 spi_mode_e mode );
 ...
 * \return      error code
 */
    int32_t csi_spi_config_baudrate( spi_handle_t handle,
                                     int32_t baud,
                                     int32_t apbfreq );
 ...
 * \return      error code
 */
    int32_t csi_spi_config_bit_order( spi_handle_t handle,
                                      spi_bit_order_e order );
 ...
 * \return      error code
 */
    int32_t csi_spi_config_datawidth( spi_handle_t handle,
                                      int32_t datawidth );
 ...
 * \return      error code
 */
    int32_t csi_spi_config_format( spi_handle_t handle,
                                   spi_format_e format );
 ...
 * \return      error code
 */
    int32_t csi_spi_config_ss_mode( spi_handle_t handle,
                                    spi_ss_mode_e ss_mode );
 ...
 * \return      error code
 */
    int32_t csi_spi_power_control( spi_handle_t handle,
 ...
 * \return      error code
 */
    int32_t csi_spi_ss_control( spi_handle_t handle,
                                spi_ss_stat_e stat );
