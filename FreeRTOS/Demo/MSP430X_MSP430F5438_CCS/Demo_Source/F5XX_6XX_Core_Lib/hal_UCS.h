 ...
 *
 */
extern uint16_t LFXT_Start_Timeout( uint16_t xtdrive,
                                    uint16_t timeout );
 ...
 *
 */
extern uint16_t XT1_Start_Timeout( uint16_t xtdrive,
                                   uint16_t timeout );
 ...
 *
 */
extern uint16_t XT2_Start_Timeout( uint16_t xtdrive,
                                   uint16_t timeout );
 ...
 */
extern void Init_FLL_Settle( uint16_t fsystem,
                             uint16_t ratio );
 ...
 * \param ratio    ratio between fsystem and FLLREFCLK
 */
static void Init_FLL( uint16_t fsystem,
                      uint16_t ratio );
