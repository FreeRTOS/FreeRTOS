 ...
 * unrolling. */
    ...
    #endif /* if defined( WOLFSSL_CONTIKI ) */
        ...
        #define WOLFSSL_USER_IO
        #define BENCH_EMBEDDED
    #endif /* if defined( WOLFSSL_IAR_ARM ) || defined( WOLFSSL_ROWLEY_ARM ) */
        ...
        #define NO_DEV_RANDOM
        #define NO_FILESYSTEM
    #endif /* ifdef WOLFSSL_PICOTCP_DEMO */
...
/* use uTasker std library replacements where available */
        ...
        #define NO_WOLFSSL_DIR
            ...
            extern void * nucleus_malloc( unsigned long size,
                                          void * heap,
                                          int type );
            extern void * nucleus_realloc( void * ptr,
                                           unsigned long size,
                                           void * heap,
                                           int type );
            extern void nucleus_free( void * ptr,
                                      void * heap,
                                      int type );
        ...
        #endif /* if !defined( XMALLOC_OVERRIDE ) && !defined( XMALLOC_USER ) */
    #endif /* ifdef WOLFSSL_NUCLEUS_1_2 */
...
/* Micrium will use Visual Studio for compilation but not the Win32 API */
    ...
    !defined( WOLFSSL_UTASKER ) && !defined( INTIME_RTOS )
        ...
        extern void * uITRON4_realloc( void * p,
                                       size_t sz );
    ...
    #endif /* if defined( WOLFSSL_uITRON4 ) */
...
/* static char* gets(char *buff); */
    ...
    #endif /* if defined( WOLFSSL_uTKERNEL2 ) */
...
/* Enable curves up to 384 bits */
            ...
            #endif /* if defined( FSL_FEATURE_LTC_HAS_PKHA ) && FSL_FEATURE_LTC_HAS_PKHA */
        #endif /* if defined( FSL_FEATURE_SOC_LTC_COUNT ) && FSL_FEATURE_SOC_LTC_COUNT */
...
/* if LTC has AES engine but doesn't have GCM, use software with LTC AES ECB mode */
    ...
    defined( WOLFSSL_STM32WB ) || defined( WOLFSSL_STM32H7 )
        ...
        #define NO_OLD_RNGNAME
            ...
            #elif defined( WOLFSSL_STM32F1 )
                #include "stm32f1xx.h"
            #endif /* if defined( WOLFSSL_STM32F2 ) */
...
/* file system has not been ported since it is a separate product. */
    ...
    ( ( void ) Mem_Set( ( void * ) ( pmem ),         \
                        ( CPU_INT08U ) ( data_val ), \
                        ( CPU_SIZE_T ) ( size ) ) )
        #define XMEMCPY( pdest, psrc, size )   \
...
/* AES Config */
    ...
    #endif /* if defined( HAVE_FFDHE_8192 ) */
...
#endif /* ifndef WOLF_CRYPT_SETTINGS_H */
