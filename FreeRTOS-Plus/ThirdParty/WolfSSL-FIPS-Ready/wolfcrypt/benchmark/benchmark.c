 ...
 */
        ...
        extern XFILE wolfSSL_fopen( const char * fname,
                                    const char * mode );
    ...
    defined( HAVE_CURVE448_SHARED_SECRET ) || defined( HAVE_ED448 )
        ...
        #endif /* if defined( HAVE_ECC ) || !defined( WOLFSSL_RSA_PUBLIC_ONLY ) || defined( WOLFSSL_PUBLIC_MP ) || !defined( NO_DH ) */
    #endif /* if !defined( NO_RSA ) || defined( WOLFSSL_KEY_GEN ) || defined( HAVE_NTRU ) || defined( HAVE_ECC ) || !defined( NO_DH ) || defined( HAVE_ECC_ENCRYPT ) || defined( HAVE_CURVE25519 ) || defined( HAVE_CURVE25519_SHARED_SECRET ) || defined( HAVE_ED25519 ) || defined( HAVE_CURVE448 ) || defined( HAVE_CURVE448_SHARED_SECRET ) || defined( HAVE_ED448 ) */
...
/* s == size in bytes that 1 count represents, normally BENCH_SIZE */
    ...
    #else  /* if defined( __GNUC__ ) && defined( __x86_64__ ) && !defined( NO_ASM ) && !defined( WOLFSSL_SGX ) */
        #define INIT_CYCLE_COUNTER
        #define BEGIN_INTEL_CYCLES
        #define END_INTEL_CYCLES
        #define SHOW_INTEL_CYCLES( b, n, s )        b[ XSTRLEN( b ) ] = '\n'
        #define SHOW_INTEL_CYCLES_CSV( b, n, s )    b[ XSTRLEN( b ) ] = '\n'
    #endif /* if defined( __GNUC__ ) && defined( __x86_64__ ) && !defined( NO_ASM ) && !defined( WOLFSSL_SGX ) */
...
/* Asynchronous helper macros */
    static THREAD_LS_T int devId = INVALID_DEVID;
        ...
        static int bench_async_handle( int * ret,
                                       WC_ASYNC_DEV * asyncDev,
                                       int callAgain,
                                       int * times,
                                       int * pending )
        ...
        static WC_INLINE int bench_async_handle( int * ret,
                                                 void * asyncDev,
                                                 int callAgain,
                                                 int * times,
                                                 int * pending )
...
/******************************************************************************/
    ...
    #else  /* if defined( WOLFSSL_ASYNC_CRYPT ) && !defined( WC_NO_ASYNC_THREADING ) */
    ...
    static WC_INLINE void bench_stats_start( int * count,
                                             double * start )
    {
        *count = 0;
 ...
 * except for AES direct that operates on AES_BLOCK_SIZE blocks */
    static void bench_stats_sym_finish( const char * desc,
                                        int doAsync,
                                        int count,
                                        int countSz,
                                        double start,
                                        int ret )
    {
        ...
        #if defined( HAVE_ECC ) || !defined( WOLFSSL_RSA_PUBLIC_ONLY ) || \
        defined( WOLFSSL_PUBLIC_MP ) || !defined( NO_DH )
            static void bench_stats_asym_finish( const char * algo,
                                                 int strength,
                                                 const char * desc,
                                                 int doAsync,
                                                 int count,
    ...
    static WC_INLINE void bench_stats_free( void )
    {
            ...
            bench_stats_head = NULL;
            bench_stats_tail = NULL;
        #endif /* if defined( WOLFSSL_ASYNC_CRYPT ) && !defined( WC_NO_ASYNC_THREADING ) */
    }
/******************************************************************************/
/* End Stats Functions */
/******************************************************************************/
    ...
    static void * benchmarks_do( void * args )
    {
        ...
        #endif /* if defined( HAVE_LOCAL_RNG ) */
        ...
        XMEMSET( bench_cipher, 0, ( size_t ) bench_buf_size );
        ...
        #else  /* if defined( WOLFSSL_ASYNC_CRYPT ) || defined( HAVE_INTEL_QA_SYNC ) */
            bench_key = ( byte * ) bench_key_buf;
            bench_iv = ( byte * ) bench_iv_buf;
        #endif /* if defined( WOLFSSL_ASYNC_CRYPT ) || defined( HAVE_INTEL_QA_SYNC ) */
            ...
            #endif /* ifdef WOLFSSL_AES_DIRECT */
            #ifdef WOLFSSL_AES_XTS
            ...
            if( bench_all || ( bench_other_algs & BENCH_SCRYPT ) )
            {
                ...
                if( bench_all || ( bench_asym_algs & BENCH_RSA_KEYGEN ) )
                {
                    ...
                    #endif /* if defined( WOLFSSL_ASYNC_CRYPT ) && defined( WC_ASYNC_ENABLE_RSA_KEYGEN ) && !defined( NO_HW_BENCH ) */
                }
...
exit:
        ...
        #ifdef WOLFSSL_AES_DIRECT
            static void bench_aesecb_internal( int doAsync,
                                               const byte * key,
                                               word32 keySz,
                                               const char * encLabel,
                                               const char * decLabel )
...
exit:
        ...
        #ifdef WOLFSSL_AES_COUNTER
            static void bench_aesctr_internal( const byte * key,
                                               word32 keySz,
                                               const byte * iv,
                                               const char * label )
            {
...
exit:
    ...
    #endif /* if defined( HAVE_BLAKE2S ) */


    #ifdef WOLFSSL_CMAC

        static void bench_cmac_helper( int keySz,
                                       const char * outMsg )
        {
            Cmac cmac;
...
exit:
        ...
        static void bench_hmac( int doAsync,
                                int type,
                                int digestSz,
                                byte * key,
                                word32 keySz,
...
exit:
            ...
            static void bench_rsaKeyGen_helper( int doAsync,
                                                int keySz )
            {
...
exit:
            ...
            void bench_rsaKeyGen_size( int doAsync,
                                       int keySz )
            {
                bench_rsaKeyGen_helper( doAsync, keySz );
            }
        ...
        !defined( USE_CERT_BUFFERS_3072 )
            ...
            #endif
        #endif /* if !defined( USE_CERT_BUFFERS_1024 ) && !defined( USE_CERT_BUFFERS_2048 ) && !defined( USE_CERT_BUFFERS_3072 ) */
        ...
        #define RSA_BUF_SIZE    384/* for up to 3072 bit */
            ...
            #else  /* if defined( USE_CERT_BUFFERS_2048 ) */
                #error Not Supported Yet!
            #endif /* if defined( USE_CERT_BUFFERS_2048 ) */
        #endif /* if !defined( WOLFSSL_RSA_VERIFY_INLINE ) && !defined( WOLFSSL_RSA_PUBLIC_ONLY ) */
...
exit_rsa_verify:
        ...
        #endif /* if !defined( WOLFSSL_RSA_PUBLIC_ONLY ) || defined( WOLFSSL_PUBLIC_MP ) */
        ...
        void bench_rsa( int doAsync )
        {
            ...
            RsaKey rsaKey[ BENCH_MAX_PENDING ];
                ...
                word32 idx;
                    ...
                    rsaKeySz = 3072;
                #else  /* ifdef USE_CERT_BUFFERS_1024 */
            ...
            for( i = 0; i < BENCH_MAX_PENDING; i++ )
            {
                                              ...
                                              doAsync ? devId : INVALID_DEVID ) ) < 0 )
                {
                    ...
                    #else  /* ifdef USE_CERT_BUFFERS_2048 */
                    #error Not supported yet!
                    #endif /* ifdef USE_CERT_BUFFERS_2048 */
                    ( void ) idx;
                    ( void ) bytes;
                #endif /* ifndef WOLFSSL_RSA_PUBLIC_ONLY */
            }
...
exit_bench_rsa_key:
        ...
        !defined( USE_CERT_BUFFERS_3072 )
            ...
            #else  /* if defined( WOLFSSL_MDK_SHELL ) */
                static const char * certDHname = "certs/dh2048.der";
            #endif /* if defined( WOLFSSL_MDK_SHELL ) */
        #endif /* if !defined( USE_CERT_BUFFERS_1024 ) && !defined( USE_CERT_BUFFERS_2048 ) && !defined( USE_CERT_BUFFERS_3072 ) */
...
exit:
    ...
    #ifdef HAVE_NTRU
        byte GetEntropy( ENTROPY_CMD cmd,
                         byte * out );
...
exit_ed_verify:
        ...
        #else  /* if defined( _WIN32 ) && !defined( INTIME_RTOS ) */
 ...
 */
                static void print_alg( const char * str,
                                       int * line )
                {
                    int optLen;
            ...
            #endif /* ifndef WOLFSSL_BENCHMARK_ALL */
 ...
 */
            static int string_matches( const char * arg,
                                       const char * str )
            {
...
#else  /* ifndef NO_CRYPT_BENCHMARK */
    #ifndef NO_MAIN_DRIVER
        int main()
        {
            return 0;
