...
/* We need the old SSL names */
    ...
    typedef int (* WOLFSSL_X509_STORE_CTX_verify_cb)( int,
...
/* custom method with user set callbacks */
    typedef int (* wolfSSL_BIO_meth_write_cb)( WOLFSSL_BIO *,
                                               const char *,
                                               int );
    typedef int (* wolfSSL_BIO_meth_read_cb)( WOLFSSL_BIO *,
                                              char *,
                                              int );
    typedef int (* wolfSSL_BIO_meth_puts_cb)( WOLFSSL_BIO *,
                                              const char * );
    typedef int (* wolfSSL_BIO_meth_gets_cb)( WOLFSSL_BIO *,
                                              char *,
                                              int );
    typedef long (* wolfSSL_BIO_meth_ctrl_get_cb)( WOLFSSL_BIO *,
                                                   int,
                                                   long,
                                                   void * );
    ...
    typedef long (* wolfssl_BIO_meth_ctrl_info_cb)( WOLFSSL_BIO *,
                                                    int,
                                                    wolfSSL_BIO_info_cb * );
...
/* wolfSSL BIO type */
    typedef long (* wolf_bio_info_cb)( WOLFSSL_BIO * bio,
                                       int event,
                                       const char * parg,
                                       int iarg,
                                       long larg,
...
/* Maximum number of groups that can be set */
    ...
    #endif /* if defined( HAVE_SECRET_CALLBACK ) && defined( WOLFSSL_TLS13 ) */
...
/* CTX Method Constructor Functions */
    ...
    WOLFSSL_ABI WOLFSSL_API WOLFSSL_METHOD * wolfTLSv1_2_client_method( void );
        ...
        WOLFSSL_API int wolfSSL_use_old_poly( WOLFSSL *,
            ...
            WOLFSSL_API int wolfSSL_dtls_export( WOLFSSL * ssl,
                                                 unsigned char * buf,
                                                 unsigned int * sz );
            WOLFSSL_API int wolfSSL_dtls_export_state_only( WOLFSSL * ssl,
                                                            unsigned char * buf,
                                                            unsigned int * sz );
        #endif /* WOLFSSL_DTLS */
    ...
    #endif /* ifdef WOLFSSL_STATIC_MEMORY */
        ...
        WOLFSSL_API int wolfSSL_CTX_load_verify_locations_ex( WOLFSSL_CTX *,
                                                              const char *,
                                                              const char *,
                                                              unsigned int );
        WOLFSSL_ABI WOLFSSL_API int wolfSSL_CTX_load_verify_locations( WOLFSSL_CTX *,
            ...
            WOLFSSL_API int wolfSSL_CTX_trust_peer_cert( WOLFSSL_CTX *,
                                                         ...
                                                         int );
        #endif
        WOLFSSL_ABI WOLFSSL_API int wolfSSL_CTX_use_certificate_chain_file( WOLFSSL_CTX *,
                                                                            const char * );
        WOLFSSL_API int wolfSSL_CTX_use_certificate_chain_file_format( WOLFSSL_CTX *,
                                                                       const char * file,
                                                                       int format );
        WOLFSSL_API int wolfSSL_CTX_use_RSAPrivateKey_file( WOLFSSL_CTX *,
                                                            const char *,
                                                            int );

        WOLFSSL_API long wolfSSL_get_verify_depth( WOLFSSL * ssl );
        WOLFSSL_API long wolfSSL_CTX_get_verify_depth( WOLFSSL_CTX * ctx );
        WOLFSSL_API void wolfSSL_CTX_set_verify_depth( WOLFSSL_CTX * ctx,
                                                       int depth );
        WOLFSSL_ABI WOLFSSL_API int wolfSSL_use_certificate_file( WOLFSSL *,
                                                                  const char *,
                                                                  int );
        WOLFSSL_ABI WOLFSSL_API int wolfSSL_use_PrivateKey_file( WOLFSSL *,
                                                                 const char *,
                                                                 int );
        ...
        WOLFSSL_API int wolfSSL_use_certificate_chain_file_format( WOLFSSL *,
                                                                   const char * file,
                                                                   int format );
        WOLFSSL_API int wolfSSL_use_RSAPrivateKey_file( WOLFSSL *,
                                                        const char *,
                                                        int );
        ...
        #ifdef HAVE_NTRU
            WOLFSSL_API int wolfSSL_CTX_use_NTRUPrivateKey_file( WOLFSSL_CTX *,
                                                                 const char * );
    ...
    WOLFSSL_API WOLFSSL_CTX * wolfSSL_CTX_new_ex( WOLFSSL_METHOD * method,
                                                  void * heap );
    ...
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_set_fd( WOLFSSL *,
                                                int );
    WOLFSSL_API int wolfSSL_set_write_fd( WOLFSSL *,
                                          int );
    WOLFSSL_API int wolfSSL_set_read_fd( WOLFSSL *,
                                         int );
    WOLFSSL_API char * wolfSSL_get_cipher_list( int priority );
    WOLFSSL_API char * wolfSSL_get_cipher_list_ex( WOLFSSL * ssl,
                                                   int priority );
    WOLFSSL_API int wolfSSL_get_ciphers( char *,
                                         int );
    WOLFSSL_API int wolfSSL_get_ciphers_iana( char *,
                                              int );
    ...
    WOLFSSL_API const char * wolfSSL_get_cipher_name_from_suite( const unsigned char,
                                                                 const unsigned char );
    WOLFSSL_API const char * wolfSSL_get_cipher_name_iana_from_suite( const unsigned char,
                                                                      const unsigned char );
    WOLFSSL_API const char * wolfSSL_get_shared_ciphers( WOLFSSL * ssl,
                                                         char * buf,
                                                         int len );
...
/* please see note at top of README if you get an error from connect */
    ...
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_write( WOLFSSL *,
                                               const void *,
                                               int );
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_read( WOLFSSL *,
                                              void *,
                                              int );
    WOLFSSL_API int wolfSSL_peek( WOLFSSL *,
                                  void *,
                                  int );
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_accept( WOLFSSL * );
    WOLFSSL_API int wolfSSL_CTX_mutual_auth( WOLFSSL_CTX * ctx,
                                             int req );
    WOLFSSL_API int wolfSSL_mutual_auth( WOLFSSL * ssl,
                                         int req );
    #ifdef WOLFSSL_TLS13
        ...
        WOLFSSL_API int wolfSSL_CTX_set1_groups_list( WOLFSSL_CTX * ctx,
                                                      char * list );
        WOLFSSL_API int wolfSSL_set1_groups_list( WOLFSSL * ssl,
                                                  char * list );

        WOLFSSL_API int wolfSSL_preferred_group( WOLFSSL * ssl );
        WOLFSSL_API int wolfSSL_CTX_set_groups( WOLFSSL_CTX * ctx,
                                                int * groups,
                                                int count );
        WOLFSSL_API int wolfSSL_set_groups( WOLFSSL * ssl,
                                            int * groups,
                                            int count );
        ...
        WOLFSSL_API int wolfSSL_accept_TLSv13( WOLFSSL * );
            ...
            WOLFSSL_API int wolfSSL_CTX_set_max_early_data( WOLFSSL_CTX * ctx,
                                                            unsigned int sz );
            WOLFSSL_API int wolfSSL_set_max_early_data( WOLFSSL * ssl,
                                                        unsigned int sz );
            WOLFSSL_API int wolfSSL_write_early_data( WOLFSSL * ssl,
                                                      const void * data,
                                                      int sz,
                                                      int * outSz );
            WOLFSSL_API int wolfSSL_read_early_data( WOLFSSL * ssl,
                                                     void * data,
                                                     int sz,
                                                     int * outSz );
    ...
    WOLFSSL_API int wolfSSL_send( WOLFSSL *,
                                  const void *,
                                  int sz,
                                  int flags );
    WOLFSSL_API int wolfSSL_recv( WOLFSSL *,
                                  void *,
                                  int sz,
                                  int flags );

    WOLFSSL_API void wolfSSL_CTX_set_quiet_shutdown( WOLFSSL_CTX *,
                                                     int );
    WOLFSSL_API void wolfSSL_set_quiet_shutdown( WOLFSSL *,
                                                 int );

    WOLFSSL_ABI WOLFSSL_API int wolfSSL_get_error( WOLFSSL *,
                                                   int );
    WOLFSSL_API int wolfSSL_get_alert_history( WOLFSSL *,
                                               WOLFSSL_ALERT_HISTORY * );

    WOLFSSL_ABI WOLFSSL_API int wolfSSL_set_session( WOLFSSL *,
                                                     WOLFSSL_SESSION * );
    WOLFSSL_API long wolfSSL_SSL_SESSION_set_timeout( WOLFSSL_SESSION *,
                                                      long );
    WOLFSSL_ABI WOLFSSL_API WOLFSSL_SESSION * wolfSSL_get_session( WOLFSSL * );
    WOLFSSL_ABI WOLFSSL_API void wolfSSL_flush_sessions( WOLFSSL_CTX *,
                                                         long );
    WOLFSSL_API int wolfSSL_SetServerID( WOLFSSL *,
                                         const unsigned char *,
                                         int,
                                         int );
    ...
    || defined( WOLFSSL_NGINX )
        WOLFSSL_API int wolfSSL_BIO_new_bio_pair( WOLFSSL_BIO **,
                                                  size_t,
                                                  WOLFSSL_BIO **,
                                                  size_t );
        ...
        WOLFSSL_API int wolfSSL_RSA_padding_add_PKCS1_PSS( WOLFSSL_RSA * rsa,
                                                           ...
                                                           int saltLen );
        WOLFSSL_API int wolfSSL_RSA_verify_PKCS1_PSS( WOLFSSL_RSA * rsa,
                                                      const unsigned char * mHash,
                                                      const WOLFSSL_EVP_MD * hashAlg,
                                                      const unsigned char * EM,
                                                      int saltLen );
        WOLFSSL_API WOLFSSL_RSA * wolfSSL_d2i_RSAPrivateKey_bio( WOLFSSL_BIO *,
                                                                 WOLFSSL_RSA ** );
        WOLFSSL_API int wolfSSL_CTX_use_certificate_ASN1( WOLFSSL_CTX *,
                                                          int,
                                                          const unsigned char * );
        WOLFSSL_API int wolfSSL_CTX_use_RSAPrivateKey( WOLFSSL_CTX *,
                                                       WOLFSSL_RSA * );
        WOLFSSL_API WOLFSSL_EVP_PKEY * wolfSSL_d2i_PrivateKey_bio( WOLFSSL_BIO *,
                                                                   WOLFSSL_EVP_PKEY ** );
    ...
    typedef int (* VerifyCallback)( int,
                                    WOLFSSL_X509_STORE_CTX * );
    typedef void (CallbackInfoState)( const WOLFSSL *,
                                      int,
                                      int );

    #if defined( HAVE_EX_DATA ) || defined( FORTRESS )
        typedef int (WOLFSSL_CRYPTO_EX_new)( void * p,
                                             void * ptr,
                                             WOLFSSL_CRYPTO_EX_DATA * a,
                                             int idx,
                                             long argValue,
                                             void * arg );
        typedef int (WOLFSSL_CRYPTO_EX_dup)( WOLFSSL_CRYPTO_EX_DATA * out,
                                             WOLFSSL_CRYPTO_EX_DATA * in,
                                             void * inPtr,
                                             int idx,
                                             long argV,
                                             void * arg );
        typedef void (WOLFSSL_CRYPTO_EX_free)( void * p,
                                               void * ptr,
                                               WOLFSSL_CRYPTO_EX_DATA * a,
                                               int idx,
                                               long argValue,
        ...
        WOLFSSL_API int wolfSSL_get_ex_new_index( long argValue,
                                                  void * arg,
                                                  WOLFSSL_CRYPTO_EX_new * a,
                                                  WOLFSSL_CRYPTO_EX_dup * b,
                                                  WOLFSSL_CRYPTO_EX_free * c );
    #endif /* if defined( HAVE_EX_DATA ) || defined( FORTRESS ) */
    ...
    #ifdef OPENSSL_ALL
        typedef int (* CertVerifyCallback)( WOLFSSL_X509_STORE_CTX * store,
                                            void * arg );
    ...
    WOLFSSL_API void wolfSSL_set_verify( WOLFSSL *,
                                         int,
                                         VerifyCallback verify_callback );
    WOLFSSL_API void wolfSSL_set_verify_result( WOLFSSL *,
                                                long );
    WOLFSSL_API void wolfSSL_SetCertCbCtx( WOLFSSL *,
                                           void * );
    ...
    WOLFSSL_ABI WOLFSSL_API long wolfSSL_CTX_set_session_cache_mode( WOLFSSL_CTX *,
        ...
        typedef int (* SessionSecretCb)( WOLFSSL * ssl,
                                         ...
                                         int * secretSz,
                                         void * ctx );
        WOLFSSL_API int wolfSSL_set_session_secret_cb( WOLFSSL *,
                                                       SessionSecretCb,
                                                       void * );
        #ifdef WOLFSSL_TLS13
            typedef int (* Tls13SecretCb)( WOLFSSL * ssl,
                                           int id,
                                           const unsigned char * secret,
                                           int secretSz,
                                           void * ctx );
            WOLFSSL_API int wolfSSL_set_tls13_secret_cb( WOLFSSL *,
                                                         Tls13SecretCb,
                                                         void * );
        #endif
...
/* session cache persistence */
    ...
    WOLFSSL_API int wolfSSL_memsave_session_cache( void *,
                                                   int );
    WOLFSSL_API int wolfSSL_memrestore_session_cache( const void *,
                                                      int );
    WOLFSSL_API int wolfSSL_get_session_cache_memsize( void );

/* certificate cache persistence, uses ctx since certs are per ctx */
    WOLFSSL_API int wolfSSL_CTX_save_cert_cache( WOLFSSL_CTX *,
                                                 const char * );
    WOLFSSL_API int wolfSSL_CTX_restore_cert_cache( WOLFSSL_CTX *,
                                                    const char * );
    WOLFSSL_API int wolfSSL_CTX_memsave_cert_cache( WOLFSSL_CTX *,
                                                    void *,
                                                    int,
                                                    int * );
...
/* Nonblocking DTLS helper functions */
    WOLFSSL_API void wolfSSL_dtls_set_using_nonblock( WOLFSSL *,
                                                      int );
    ...
    WOLFSSL_API int wolfSSL_dtls_set_peer( WOLFSSL *,
                                           void *,
                                           unsigned int );
    WOLFSSL_API int wolfSSL_dtls_get_peer( WOLFSSL *,
                                           void *,
                                           unsigned int * );

    WOLFSSL_API int wolfSSL_CTX_dtls_set_sctp( WOLFSSL_CTX * );
    WOLFSSL_API int wolfSSL_dtls_set_sctp( WOLFSSL * );
    WOLFSSL_API int wolfSSL_CTX_dtls_set_mtu( WOLFSSL_CTX *,
                                              unsigned short );
    WOLFSSL_API int wolfSSL_dtls_set_mtu( WOLFSSL *,
                                          unsigned short );

    WOLFSSL_API int wolfSSL_dtls_get_drop_stats( WOLFSSL *,
                                                 unsigned int *,
                                                 unsigned int * );
    WOLFSSL_API int wolfSSL_CTX_mcast_set_member_id( WOLFSSL_CTX *,
                                                     unsigned short );
    WOLFSSL_API int wolfSSL_set_secret( WOLFSSL *,
                                        unsigned short,
                                        const unsigned char *,
                                        unsigned int,
                                        const unsigned char *,
                                        const unsigned char *,
                                        const unsigned char * );
    WOLFSSL_API int wolfSSL_mcast_read( WOLFSSL *,
                                        unsigned short *,
                                        void *,
                                        int );
    WOLFSSL_API int wolfSSL_mcast_peer_add( WOLFSSL *,
                                            unsigned short,
                                            int );
    WOLFSSL_API int wolfSSL_mcast_peer_known( WOLFSSL *,
                                              unsigned short );
    ...
    WOLFSSL_API int wolfSSL_mcast_set_highwater_ctx( WOLFSSL *,
                                                     void * );
...
/* for now LHASH is not implemented */
    ...
    WOLFSSL_API int wolfSSL_sk_push_node( WOLFSSL_STACK ** stack,
                                          WOLFSSL_STACK * in );
    WOLFSSL_API WOLFSSL_STACK * wolfSSL_sk_get_node( WOLFSSL_STACK * sk,
                                                     int idx );
    WOLFSSL_API int wolfSSL_sk_push( WOLFSSL_STACK * st,
                                     const void * data );
    ...
    WOLFSSL_API WOLFSSL_GENERAL_NAMES * wolfSSL_GENERAL_NAMES_dup( WOLFSSL_GENERAL_NAMES * gns );
    WOLFSSL_API int wolfSSL_sk_GENERAL_NAME_push( WOLFSSL_GENERAL_NAMES * sk,
                                                  WOLFSSL_GENERAL_NAME * gn );
    WOLFSSL_API WOLFSSL_GENERAL_NAME * wolfSSL_sk_GENERAL_NAME_value( WOLFSSL_STACK * sk,
                                                                      int i );
    ...
    WOLFSSL_API WOLFSSL_ACCESS_DESCRIPTION * wolfSSL_sk_ACCESS_DESCRIPTION_value( WOLFSSL_STACK * sk,
                                                                                  int idx );
    ...
    WOLFSSL_API void wolfSSL_sk_X509_EXTENSION_pop_free( WOLF_STACK_OF( WOLFSSL_X509_EXTENSION ) * sk,
    ...
    WOLFSSL_API WOLFSSL_X509_EXTENSION * wolfSSL_sk_X509_EXTENSION_value( WOLF_STACK_OF( WOLFSSL_X509_EXTENSION ) * sk,
                                                                          int idx );
    WOLFSSL_API int wolfSSL_set_ex_data( WOLFSSL *,
                                         int,
                                         void * );
    WOLFSSL_API int wolfSSL_get_shutdown( const WOLFSSL * );
    WOLFSSL_API int wolfSSL_set_rfd( WOLFSSL *,
                                     int );
    WOLFSSL_API int wolfSSL_set_wfd( WOLFSSL *,
                                     int );
    WOLFSSL_API void wolfSSL_set_shutdown( WOLFSSL *,
                                           int );
    WOLFSSL_API int wolfSSL_set_session_id_context( WOLFSSL *,
                                                    const unsigned char *,
                                                    unsigned int );
    ...
    WOLFSSL_API char * wolfSSL_CIPHER_description( const WOLFSSL_CIPHER *,
                                                   char *,
                                                   int );
    ...
    WOLFSSL_API int wolfSSL_OCSP_parse_url( char * url,
                                            char ** host,
                                            char ** port,
                                            char ** path,
                                            int * ssl );
    ...
    WOLFSSL_API int wolfSSL_BIO_gets( WOLFSSL_BIO * bio,
                                      char * buf,
                                      int sz );
    WOLFSSL_API int wolfSSL_BIO_puts( WOLFSSL_BIO * bio,
                                      const char * buf );
    WOLFSSL_API WOLFSSL_BIO * wolfSSL_BIO_next( WOLFSSL_BIO * bio );
    WOLFSSL_API WOLFSSL_BIO * wolfSSL_BIO_find_type( WOLFSSL_BIO * bio,
                                                     int type );
    WOLFSSL_API int wolfSSL_BIO_read( WOLFSSL_BIO *,
                                      void *,
                                      int );
    WOLFSSL_API int wolfSSL_BIO_write( WOLFSSL_BIO *,
                                       const void *,
                                       int );
    WOLFSSL_API WOLFSSL_BIO * wolfSSL_BIO_push( WOLFSSL_BIO *,
                                                WOLFSSL_BIO * append );
    ...
    WOLFSSL_API void wolfSSL_BIO_set_callback_arg( WOLFSSL_BIO * bio,
                                                   char * arg );
    ...
    WOLFSSL_API long wolfSSL_BIO_set_write_buffer_size( WOLFSSL_BIO *,
                                                        long size );
    WOLFSSL_API WOLFSSL_BIO_METHOD * wolfSSL_BIO_f_ssl( void );
    WOLFSSL_API WOLFSSL_BIO * wolfSSL_BIO_new_socket( int sfd,
                                                      int flag );
    ...
    WOLFSSL_API void wolfSSL_BIO_set_flags( WOLFSSL_BIO *,
                                            int );
    WOLFSSL_API void wolfSSL_BIO_clear_flags( WOLFSSL_BIO * bio,
                                              int flags );
    WOLFSSL_API int wolfSSL_BIO_set_ex_data( WOLFSSL_BIO * bio,
                                             int idx,
                                             void * data );
    WOLFSSL_API void * wolfSSL_BIO_get_ex_data( WOLFSSL_BIO * bio,
                                                int idx );
    WOLFSSL_API long wolfSSL_BIO_set_nbio( WOLFSSL_BIO *,
                                           long );

    WOLFSSL_API int wolfSSL_BIO_get_mem_data( WOLFSSL_BIO * bio,
                                              void * p );

    WOLFSSL_API void wolfSSL_BIO_set_init( WOLFSSL_BIO *,
                                           int );
    WOLFSSL_API void wolfSSL_BIO_set_data( WOLFSSL_BIO *,
                                           void * );
    WOLFSSL_API void * wolfSSL_BIO_get_data( WOLFSSL_BIO * );
    WOLFSSL_API void wolfSSL_BIO_set_shutdown( WOLFSSL_BIO *,
                                               int );
    ...
    WOLFSSL_API WOLFSSL_BIO_METHOD * wolfSSL_BIO_meth_new( int,
                                                           const char * );
    WOLFSSL_API void wolfSSL_BIO_meth_free( WOLFSSL_BIO_METHOD * );
    WOLFSSL_API int wolfSSL_BIO_meth_set_write( WOLFSSL_BIO_METHOD *,
                                                wolfSSL_BIO_meth_write_cb );
    WOLFSSL_API int wolfSSL_BIO_meth_set_read( WOLFSSL_BIO_METHOD *,
                                               wolfSSL_BIO_meth_read_cb );
    WOLFSSL_API int wolfSSL_BIO_meth_set_puts( WOLFSSL_BIO_METHOD *,
                                               wolfSSL_BIO_meth_puts_cb );
    WOLFSSL_API int wolfSSL_BIO_meth_set_gets( WOLFSSL_BIO_METHOD *,
                                               wolfSSL_BIO_meth_gets_cb );
    WOLFSSL_API int wolfSSL_BIO_meth_set_ctrl( WOLFSSL_BIO_METHOD *,
                                               wolfSSL_BIO_meth_ctrl_get_cb );
    WOLFSSL_API int wolfSSL_BIO_meth_set_create( WOLFSSL_BIO_METHOD *,
                                                 wolfSSL_BIO_meth_create_cb );
    WOLFSSL_API int wolfSSL_BIO_meth_set_destroy( WOLFSSL_BIO_METHOD *,
                                                  wolfSSL_BIO_meth_destroy_cb );
    WOLFSSL_API WOLFSSL_BIO * wolfSSL_BIO_new_mem_buf( const void * buf,
                                                       int len );

    WOLFSSL_API long wolfSSL_BIO_set_ssl( WOLFSSL_BIO *,
                                          WOLFSSL *,
                                          int flag );
    ...
    WOLFSSL_API int wolfSSL_BIO_set_close( WOLFSSL_BIO * b,
                                           long flag );
    WOLFSSL_API void wolfSSL_set_bio( WOLFSSL *,
                                      WOLFSSL_BIO * rd,
                                      WOLFSSL_BIO * wr );
    ...
    WOLFSSL_API long wolfSSL_BIO_ctrl( WOLFSSL_BIO * bp,
                                       int cmd,
                                       long larg,
                                       void * parg );
    WOLFSSL_API long wolfSSL_BIO_int_ctrl( WOLFSSL_BIO * bp,
                                           int cmd,
                                           long larg,
                                           int iarg );
    ...
    WOLFSSL_API const char * wolfSSL_RAND_file_name( char *,
                                                     unsigned long );
    WOLFSSL_API int wolfSSL_RAND_write_file( const char * );
    WOLFSSL_API int wolfSSL_RAND_load_file( const char *,
                                            long );
    WOLFSSL_API int wolfSSL_RAND_egd( const char * );
    WOLFSSL_API int wolfSSL_RAND_seed( const void *,
                                       int );
    WOLFSSL_API void wolfSSL_RAND_Cleanup( void );
    WOLFSSL_API void wolfSSL_RAND_add( const void *,
                                       int,
                                       double );
    ...
    WOLFSSL_API int wolfSSL_COMP_add_compression_method( int,
                                                         void * );
    ...
    WOLFSSL_API WOLFSSL_X509_NAME * wolfSSL_d2i_X509_NAME( WOLFSSL_X509_NAME ** name,
                                                           ...
                                                           long length );
    #ifndef NO_RSA
        WOLFSSL_API int wolfSSL_RSA_print( WOLFSSL_BIO * bio,
                                           WOLFSSL_RSA * rsa,
                                           int offset );
    #endif
    WOLFSSL_API int wolfSSL_X509_print_ex( WOLFSSL_BIO * bio,
                                           WOLFSSL_X509 * x509,
                                           unsigned long nmflags,
                                           unsigned long cflag );
    WOLFSSL_API int wolfSSL_X509_print( WOLFSSL_BIO * bio,
                                        WOLFSSL_X509 * x509 );
    WOLFSSL_ABI WOLFSSL_API char * wolfSSL_X509_NAME_oneline( WOLFSSL_X509_NAME *,
                                                              char *,
                                                              int );
    #if defined( OPENSSL_EXTRA ) && defined( XSNPRINTF )
        WOLFSSL_API char * wolfSSL_X509_get_name_oneline( WOLFSSL_X509_NAME *,
                                                          char *,
                                                          int );
    #endif
    ...
    WOLFSSL_API int wolfSSL_X509_ext_isSet_by_NID( WOLFSSL_X509 *,
                                                   int );
    WOLFSSL_API int wolfSSL_X509_ext_get_critical_by_NID( WOLFSSL_X509 *,
                                                          int );
    ...
    WOLFSSL_API unsigned char * wolfSSL_X509_get_authorityKeyID( WOLFSSL_X509 *,
                                                                 unsigned char *,
                                                                 int * );
    WOLFSSL_API unsigned char * wolfSSL_X509_get_subjectKeyID( WOLFSSL_X509 *,
                                                               unsigned char *,
                                                               int * );

    WOLFSSL_API int wolfSSL_X509_verify( WOLFSSL_X509 * x509,
                                         WOLFSSL_EVP_PKEY * pkey );
    ...
    WOLFSSL_API int wolfSSL_X509_set_version( WOLFSSL_X509 * x509,
                                              long v );
    WOLFSSL_API int wolfSSL_X509_sign( WOLFSSL_X509 * x509,
                                       WOLFSSL_EVP_PKEY * pkey,
                                       const WOLFSSL_EVP_MD * md );


    WOLFSSL_API int wolfSSL_X509_NAME_entry_count( WOLFSSL_X509_NAME * );
    WOLFSSL_API int wolfSSL_X509_NAME_get_text_by_NID( WOLFSSL_X509_NAME *,
                                                       int,
                                                       char *,
                                                       int );
    WOLFSSL_API int wolfSSL_X509_NAME_get_index_by_NID( WOLFSSL_X509_NAME *,
                                                        int,
                                                        int );
    ...
    WOLFSSL_API WOLFSSL_ASN1_STRING * wolfSSL_d2i_DISPLAYTEXT( WOLFSSL_ASN1_STRING ** asn,
    ...
    WOLFSSL_API int wolfSSL_X509_get_signature( WOLFSSL_X509 *,
                                                unsigned char *,
                                                int * );
    WOLFSSL_API int wolfSSL_X509_get_pubkey_buffer( WOLFSSL_X509 *,
                                                    unsigned char *,
                                                    int * );
    WOLFSSL_API int wolfSSL_X509_get_pubkey_type( WOLFSSL_X509 * x509 );

    WOLFSSL_API int wolfSSL_X509_LOOKUP_add_dir( WOLFSSL_X509_LOOKUP *,
                                                 const char *,
                                                 long );
    WOLFSSL_API int wolfSSL_X509_LOOKUP_load_file( WOLFSSL_X509_LOOKUP *,
                                                   const char *,
                                                   long );
    ...
    WOLFSSL_API int wolfSSL_X509_STORE_add_cert( WOLFSSL_X509_STORE *,
                                                 WOLFSSL_X509 * );
    ...
    WOLFSSL_API int wolfSSL_X509_CRL_verify( WOLFSSL_X509_CRL *,
                                             WOLFSSL_EVP_PKEY * );
    WOLFSSL_API void wolfSSL_X509_OBJECT_free_contents( WOLFSSL_X509_OBJECT * );
    WOLFSSL_API WOLFSSL_PKCS8_PRIV_KEY_INFO * wolfSSL_d2i_PKCS8_PKEY_bio( WOLFSSL_BIO * bio,
    ...
    WOLFSSL_API WOLFSSL_EVP_PKEY * wolfSSL_d2i_PUBKEY( WOLFSSL_EVP_PKEY ** key,
                                                       const unsigned char ** in,
                                                       long inSz );
    WOLFSSL_API int wolfSSL_i2d_PUBKEY( const WOLFSSL_EVP_PKEY * key,
                                        unsigned char ** der );
    ...
    WOLFSSL_API int wolfSSL_X509_cmp_current_time( const WOLFSSL_ASN1_TIME * );
        ...
        WOLFSSL_API void wolfSSL_X509_STORE_CTX_set_time( WOLFSSL_X509_STORE_CTX *,
                                                          unsigned long flags,
                                                          time_t t );
        WOLFSSL_API void wolfSSL_X509_VERIFY_PARAM_set_hostflags( WOLFSSL_X509_VERIFY_PARAM * param,
                                                                  unsigned int flags );
        WOLFSSL_API int wolfSSL_X509_VERIFY_PARAM_set1_host( WOLFSSL_X509_VERIFY_PARAM * pParam,
                                                             const char * name,
                                                             unsigned int nameSz );
        WOLFSSL_API int wolfSSL_X509_VERIFY_PARAM_set1_ip_asc( WOLFSSL_X509_VERIFY_PARAM * param,
                                                               const char * ipasc );
    #endif /* ifdef OPENSSL_EXTRA */
    WOLFSSL_API WOLFSSL_X509_REVOKED * wolfSSL_X509_CRL_get_REVOKED( WOLFSSL_X509_CRL * );
    WOLFSSL_API WOLFSSL_X509_REVOKED * wolfSSL_sk_X509_REVOKED_value( WOLFSSL_X509_REVOKED *,
                                                                      int );
    ...
    WOLFSSL_API int wolfSSL_ASN1_INTEGER_set( WOLFSSL_ASN1_INTEGER * a,
                                              long v );

    WOLFSSL_API int wolfSSL_ASN1_TIME_print( WOLFSSL_BIO *,
    ...
    WOLFSSL_API long wolfSSL_ASN1_INTEGER_get( const WOLFSSL_ASN1_INTEGER * );
        ...
        WOLFSSL_API WOLFSSL_BIGNUM * wolfSSL_ASN1_INTEGER_to_BN( const WOLFSSL_ASN1_INTEGER * ai,
                                                                 WOLFSSL_BIGNUM * bn );
        WOLFSSL_API WOLFSSL_ASN1_TIME * wolfSSL_ASN1_TIME_adj( WOLFSSL_ASN1_TIME *,
                                                               time_t,
                                                               int,
                                                               long );
...
/* deprecated function name */
    ...
    typedef int (* client_cert_cb)( WOLFSSL * ssl,
                                    WOLFSSL_X509 ** x509,
                                    WOLFSSL_EVP_PKEY ** pkey );
    WOLFSSL_API void wolfSSL_CTX_set_client_cert_cb( WOLFSSL_CTX * ctx,
                                                     client_cert_cb );

    WOLFSSL_API void * wolfSSL_X509_STORE_CTX_get_ex_data( WOLFSSL_X509_STORE_CTX * ctx,
                                                           int idx );
    ...
    WOLFSSL_API void wolfSSL_X509_STORE_CTX_set_error( WOLFSSL_X509_STORE_CTX * ctx,
                                                       int er );
    void wolfSSL_X509_STORE_CTX_set_error_depth( WOLFSSL_X509_STORE_CTX * ctx,
                                                 int depth );
    WOLFSSL_API void * wolfSSL_get_ex_data( const WOLFSSL *,
                                            int );
    ...
    WOLFSSL_API WOLFSSL_RSA * wolfSSL_RSA_generate_key( int,
                                                        unsigned long,
                                                        void ( * )( int, int, void * ),
                                                        void * );
    ...
    WOLFSSL_API WOLFSSL_RSA * wolfSSL_d2i_RSAPrivateKey( WOLFSSL_RSA **,
                                                         const unsigned char **,
                                                         long );
    WOLFSSL_API int wolfSSL_i2d_RSAPublicKey( WOLFSSL_RSA * r,
                                              const unsigned char ** pp );
    WOLFSSL_API int wolfSSL_i2d_RSAPrivateKey( WOLFSSL_RSA * r,
                                               unsigned char ** pp );
    WOLFSSL_API void wolfSSL_CTX_set_tmp_rsa_callback( WOLFSSL_CTX *,
                                                       WOLFSSL_RSA *( * )( WOLFSSL *, int, int ) );

    WOLFSSL_API int wolfSSL_PEM_def_callback( char *,
                                              int num,
                                              int w,
                                              void * key );
    ...
    WOLFSSL_API long wolfSSL_CTX_add_extra_chain_cert( WOLFSSL_CTX *,
                                                       WOLFSSL_X509 * );
    WOLFSSL_API long wolfSSL_CTX_sess_set_cache_size( WOLFSSL_CTX *,
                                                      long );
    ...
    WOLFSSL_API long wolfSSL_CTX_set_tlsext_opaque_prf_input_callback_arg( WOLFSSL_CTX *,
                                                                           void * arg );
    WOLFSSL_API int wolfSSL_CTX_add_client_CA( WOLFSSL_CTX *,
                                               WOLFSSL_X509 * );
    WOLFSSL_API int wolfSSL_CTX_set_srp_password( WOLFSSL_CTX *,
                                                  char * );
    WOLFSSL_API int wolfSSL_CTX_set_srp_username( WOLFSSL_CTX *,
                                                  char * );

    WOLFSSL_API long wolfSSL_set_options( WOLFSSL * s,
                                          long op );
    WOLFSSL_API long wolfSSL_get_options( const WOLFSSL * s );
    WOLFSSL_API long wolfSSL_clear_options( WOLFSSL * s,
                                            long op );
    ...
    WOLFSSL_API long wolfSSL_set_tmp_dh( WOLFSSL * s,
                                         WOLFSSL_DH * dh );
    WOLFSSL_API long wolfSSL_set_tlsext_debug_arg( WOLFSSL * s,
                                                   void * arg );
    WOLFSSL_API long wolfSSL_set_tlsext_status_type( WOLFSSL * s,
                                                     int type );
    WOLFSSL_API long wolfSSL_set_tlsext_status_exts( WOLFSSL * s,
                                                     void * arg );
    WOLFSSL_API long wolfSSL_get_tlsext_status_ids( WOLFSSL * s,
                                                    void * arg );
    WOLFSSL_API long wolfSSL_set_tlsext_status_ids( WOLFSSL * s,
                                                    void * arg );
    WOLFSSL_API long wolfSSL_get_tlsext_status_ocsp_resp( WOLFSSL * s,
                                                          unsigned char ** resp );
    ...
    WOLFSSL_API long wolfSSL_get_tlsext_status_exts( WOLFSSL * s,
                                                     void * arg );
...
/* for compatibility these must be macros */
    ...
    #endif /* if defined( OPENSSL_EXTRA ) || defined( OPENSSL_EXTRA_X509_SMALL ) || defined( HAVE_WEBSERVER ) */
 ...
 * since not using thread storage error queue */
        #include <stdio.h>
        WOLFSSL_API void wolfSSL_ERR_print_errors_fp( XFILE,
                                                      int err );
            ...
            WOLFSSL_API void wolfSSL_ERR_print_errors_cb( int ( * cb )( const char * str,
                                                          ...
                                                          void * u );
        #endif
    #endif /* if !defined( NO_FILESYSTEM ) && !defined( NO_STDIO_FILESYSTEM ) */
    ...
    enum                               /* ssl Constants */
    {
    ...
    #ifndef NO_PSK
        typedef unsigned int (* wc_psk_client_callback)( WOLFSSL *,
                                                         const char *,
                                                         char *,
                                                         unsigned int,
                                                         unsigned char *,
        ...
        WOLFSSL_API void wolfSSL_set_psk_client_callback( WOLFSSL *,
                                                          wc_psk_client_callback );
        #ifdef WOLFSSL_TLS13
            typedef unsigned int (* wc_psk_client_tls13_callback)( WOLFSSL *,
                                                                   const char *,
                                                                   char *,
                                                                   unsigned int,
                                                                   unsigned char *,
        ...
        WOLFSSL_API int wolfSSL_CTX_use_psk_identity_hint( WOLFSSL_CTX *,
                                                           const char * );
        WOLFSSL_API int wolfSSL_use_psk_identity_hint( WOLFSSL *,
                                                       const char * );

        typedef unsigned int (* wc_psk_server_callback)( WOLFSSL *,
                                                         const char *,
                                                         unsigned char *,
                                                         unsigned int );
        ...
        WOLFSSL_API void wolfSSL_set_psk_server_callback( WOLFSSL *,
                                                          wc_psk_server_callback );
        #ifdef WOLFSSL_TLS13
            typedef unsigned int (* wc_psk_server_tls13_callback)( WOLFSSL *,
                                                                   const char *,
                                                                   unsigned char *,
                                                                   unsigned int,
                                                                   const char ** );
        ...
        WOLFSSL_API int wolfSSL_set_psk_callback_ctx( WOLFSSL *,
                                                      void * );

        WOLFSSL_API void * wolfSSL_CTX_get_psk_callback_ctx( WOLFSSL_CTX * );
        WOLFSSL_API int wolfSSL_CTX_set_psk_callback_ctx( WOLFSSL_CTX *,
                                                          void * );
...
/* bio misc */
    ...
    WOLFSSL_API void wolfSSL_ERR_put_error( int lib,
                                            int fun,
                                            int err,
                                            const char * file,
                                            int line );
    WOLFSSL_API unsigned long wolfSSL_ERR_get_error_line( const char **,
                                                          int * );
    WOLFSSL_API unsigned long wolfSSL_ERR_get_error_line_data( const char **,
                                                               int *,
                                                               const char **,
                                                               int * );
    ...
    WOLFSSL_API int wolfSSL_RAND_pseudo_bytes( unsigned char * buf,
                                               int num );
    WOLFSSL_API int wolfSSL_RAND_bytes( unsigned char * buf,
                                        int num );
    WOLFSSL_API WOLFSSL_METHOD * wolfSSLv23_server_method( void );
    WOLFSSL_API long wolfSSL_CTX_set_options( WOLFSSL_CTX *,
                                              long );
    ...
    WOLFSSL_API long wolfSSL_CTX_set_mode( WOLFSSL_CTX * ctx,
                                           long mode );
    WOLFSSL_API long wolfSSL_CTX_get_mode( WOLFSSL_CTX * ctx );
    WOLFSSL_API void wolfSSL_CTX_set_default_read_ahead( WOLFSSL_CTX * ctx,
                                                         int m );
    ...
    WOLFSSL_API int wolfSSL_want_write( WOLFSSL * );
        ...
        WOLFSSL_API int wolfSSL_BIO_vprintf( WOLFSSL_BIO * bio,
                                             const char * format,
                                             va_list args );
    #endif
    WOLFSSL_API int wolfSSL_BIO_printf( WOLFSSL_BIO *,
                                        const char *,
                                        ... );
    WOLFSSL_API int wolfSSL_BIO_dump( WOLFSSL_BIO * bio,
                                      const char *,
                                      int );
    ...
    WOLFSSL_API int wolfSSL_ASN1_TIME_diff( int * pday,
                                            int * psec,
                                            const WOLFSSL_ASN1_TIME * from,
                                            const WOLFSSL_ASN1_TIME * to );
    #ifdef OPENSSL_EXTRA
        WOLFSSL_API WOLFSSL_ASN1_TIME * wolfSSL_ASN1_TIME_set( WOLFSSL_ASN1_TIME * s,
                                                               time_t t );
    #endif

    WOLFSSL_API int wolfSSL_sk_num( WOLFSSL_STACK * sk );
    WOLFSSL_API void * wolfSSL_sk_value( WOLFSSL_STACK * sk,
                                         int i );
    ...
    ( defined( OPENSSL_EXTRA ) || defined( WOLFSSL_WPAS_SMALL ) )
        WOLFSSL_API void * wolfSSL_CRYPTO_get_ex_data( const WOLFSSL_CRYPTO_EX_DATA * ex_data,
                                                       int idx );
        WOLFSSL_API int wolfSSL_CRYPTO_set_ex_data( WOLFSSL_CRYPTO_EX_DATA * ex_data,
                                                    int idx,
                                                    void * data );
    #endif

/* stunnel 4.28 needs */
    WOLFSSL_API void * wolfSSL_CTX_get_ex_data( const WOLFSSL_CTX *,
                                                int );
    WOLFSSL_API int wolfSSL_CTX_set_ex_data( WOLFSSL_CTX *,
                                             int,
                                             void * );
    ...
    WOLFSSL_API int wolfSSL_i2d_SSL_SESSION( WOLFSSL_SESSION *,
                                             unsigned char ** );
    ...
    WOLFSSL_API int wolfSSL_CTX_get_ex_new_index( long,
                                                  void *,
                                                  void *,
                                                  void *,
                                                  void * );
 ...
 * date check and signature check */
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_check_domain_name( WOLFSSL *,
                                                           const char * );
...
/* turn on wolfSSL data compression */
    ...
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_set_timeout( WOLFSSL *,
                                                     unsigned int );
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_CTX_set_timeout( WOLFSSL_CTX *,
                                                         unsigned int );
...
/* index cert length */
    WOLFSSL_API int wolfSSL_get_chain_length( WOLFSSL_X509_CHAIN *,
                                              int idx );
/* index cert */
    WOLFSSL_API unsigned char * wolfSSL_get_chain_cert( WOLFSSL_X509_CHAIN *,
                                                        int idx );
/* index cert in X509 */
    WOLFSSL_API WOLFSSL_X509 * wolfSSL_get_chain_X509( WOLFSSL_X509_CHAIN *,
                                                       int idx );
/* free X509 */
    #define wolfSSL_FreeX509( x509 )    wolfSSL_X509_free( ( x509 ) )
    WOLFSSL_ABI WOLFSSL_API void wolfSSL_X509_free( WOLFSSL_X509 * );
/* get index cert in PEM */
    WOLFSSL_API int wolfSSL_get_chain_cert_pem( WOLFSSL_X509_CHAIN *,
                                                int idx,
                                                unsigned char * buf,
                                                int inLen,
                                                int * outLen );
    WOLFSSL_ABI WOLFSSL_API const unsigned char * wolfSSL_get_sessionID( const WOLFSSL_SESSION * s );
    WOLFSSL_API int wolfSSL_X509_get_serial_number( WOLFSSL_X509 *,
                                                    unsigned char *,
                                                    int * );
    WOLFSSL_API char * wolfSSL_X509_get_subjectCN( WOLFSSL_X509 * );
    WOLFSSL_API const unsigned char * wolfSSL_X509_get_der( WOLFSSL_X509 *,
                                                            int * );
    WOLFSSL_API const unsigned char * wolfSSL_X509_get_tbs( WOLFSSL_X509 *,
                                                            int * );
    ...
    WOLFSSL_API int wolfSSL_cmp_peer_cert_to_file( WOLFSSL *,
                                                   const char * );

    WOLFSSL_ABI WOLFSSL_API char * wolfSSL_X509_get_next_altname( WOLFSSL_X509 * );
    WOLFSSL_API int wolfSSL_X509_add_altname_ex( WOLFSSL_X509 *,
                                                 const char *,
                                                 word32,
                                                 int );
    WOLFSSL_API int wolfSSL_X509_add_altname( WOLFSSL_X509 *,
                                              const char *,
                                              int );
    ...
    WOLFSSL_API WOLFSSL_X509 * wolfSSL_d2i_X509( WOLFSSL_X509 ** x509,
                                                 const unsigned char ** in,
                                                 int len );
    WOLFSSL_API WOLFSSL_X509 * wolfSSL_X509_d2i( WOLFSSL_X509 ** x509,
                                                 const unsigned char * in,
                                                 int len );
    WOLFSSL_API int wolfSSL_i2d_X509( WOLFSSL_X509 * x509,
                                      unsigned char ** out );
    ...
    WOLFSSL_API void wolfSSL_X509_CRL_free( WOLFSSL_X509_CRL * crl );
            ...
            WOLFSSL_API WOLFSSL_X509 * wolfSSL_X509_d2i_fp( WOLFSSL_X509 ** x509,
                                                            XFILE file );
        #endif
        WOLFSSL_ABI WOLFSSL_API WOLFSSL_X509 * wolfSSL_X509_load_certificate_file( const char * fname,
                                                                                   int format );
    #endif
    WOLFSSL_API WOLFSSL_X509 * wolfSSL_X509_load_certificate_buffer( const unsigned char * buf,
                                                                     int sz,
                                                                     int format );

    #ifdef WOLFSSL_SEP
        WOLFSSL_API unsigned char * wolfSSL_X509_get_device_type( WOLFSSL_X509 *,
                                                                  unsigned char *,
                                                                  int * );
        WOLFSSL_API unsigned char * wolfSSL_X509_get_hw_type( WOLFSSL_X509 *,
                                                              unsigned char *,
                                                              int * );
        WOLFSSL_API unsigned char * wolfSSL_X509_get_hw_serial_number( WOLFSSL_X509 *,
                                                                       unsigned char *,
                                                                       int * );
    #endif
...
/* PKCS12 compatibility */
    ...
    WOLFSSL_API WC_PKCS12 * wolfSSL_d2i_PKCS12_bio( WOLFSSL_BIO * bio,
                                                    WC_PKCS12 ** pkcs12 );
    WOLFSSL_API int wolfSSL_i2d_PKCS12_bio( WOLFSSL_BIO * bio,
                                            WC_PKCS12 * pkcs12 );
    #ifndef NO_FILESYSTEM
        WOLFSSL_API WOLFSSL_X509_PKCS12 * wolfSSL_d2i_PKCS12_fp( XFILE fp,
                                                                 WOLFSSL_X509_PKCS12 ** pkcs12 );
    #endif
    WOLFSSL_API int wolfSSL_PKCS12_parse( WC_PKCS12 * pkcs12,
                                          const char * psw,
                                          WOLFSSL_EVP_PKEY ** pkey,
                                          WOLFSSL_X509 ** cert,
                                          WOLF_STACK_OF( WOLFSSL_X509 ) ** ca );
    WOLFSSL_API WC_PKCS12 * wolfSSL_PKCS12_create( char * pass,
                                                   char * name,
                                                   WOLFSSL_EVP_PKEY * pkey,
                                                   WOLFSSL_X509 * cert,
                                                   WOLF_STACK_OF( WOLFSSL_X509 ) * ca,
...
/* server Diffie-Hellman parameters */
        WOLFSSL_API int wolfSSL_SetTmpDH( WOLFSSL *,
                                          const unsigned char * p,
                                          int pSz,
                                          const unsigned char * g,
                                          int gSz );
        WOLFSSL_API int wolfSSL_SetTmpDH_buffer( WOLFSSL *,
                                                 const unsigned char * b,
                                                 long sz,
                                                 int format );
        WOLFSSL_API int wolfSSL_SetEnableDhKeyTest( WOLFSSL *,
                                                    int );
        #ifndef NO_FILESYSTEM
            WOLFSSL_API int wolfSSL_SetTmpDH_file( WOLFSSL *,
                                                   const char * f,
                                                   int format );
        #endif

/* server ctx Diffie-Hellman parameters */
        WOLFSSL_API int wolfSSL_CTX_SetTmpDH( WOLFSSL_CTX *,
                                              const unsigned char * p,
                                              int pSz,
                                              const unsigned char * g,
                                              int gSz );
        WOLFSSL_API int wolfSSL_CTX_SetTmpDH_buffer( WOLFSSL_CTX *,
                                                     const unsigned char * b,
                                                     long sz,
                                                     int format );

        #ifndef NO_FILESYSTEM
            WOLFSSL_API int wolfSSL_CTX_SetTmpDH_file( WOLFSSL_CTX *,
                                                       const char * f,
                                                       int format );
        #endif

        WOLFSSL_API int wolfSSL_CTX_SetMinDhKey_Sz( WOLFSSL_CTX *,
                                                    word16 );
        WOLFSSL_API int wolfSSL_SetMinDhKey_Sz( WOLFSSL *,
                                                word16 );
        WOLFSSL_API int wolfSSL_CTX_SetMaxDhKey_Sz( WOLFSSL_CTX *,
                                                    word16 );
        WOLFSSL_API int wolfSSL_SetMaxDhKey_Sz( WOLFSSL *,
                                                word16 );
        WOLFSSL_API int wolfSSL_GetDhKey_Sz( WOLFSSL * );
    #endif /* NO_DH */

    #ifndef NO_RSA
        WOLFSSL_API int wolfSSL_CTX_SetMinRsaKey_Sz( WOLFSSL_CTX *,
                                                     short );
        WOLFSSL_API int wolfSSL_SetMinRsaKey_Sz( WOLFSSL *,
                                                 short );
    #endif /* NO_RSA */

    #ifdef HAVE_ECC
        WOLFSSL_API int wolfSSL_CTX_SetMinEccKey_Sz( WOLFSSL_CTX *,
                                                     short );
        WOLFSSL_API int wolfSSL_SetMinEccKey_Sz( WOLFSSL *,
                                                 short );
    #endif /* NO_RSA */

    WOLFSSL_API int wolfSSL_SetTmpEC_DHE_Sz( WOLFSSL *,
                                             word16 );
    WOLFSSL_API int wolfSSL_CTX_SetTmpEC_DHE_Sz( WOLFSSL_CTX *,
                                                 word16 );

/* keyblock size in bytes or -1 */
/* need to call wolfSSL_KeepArrays before handshake to save keys */
    WOLFSSL_API int wolfSSL_get_keyblock_size( WOLFSSL * );
    WOLFSSL_API int wolfSSL_get_keys( WOLFSSL *,
                                      unsigned char ** ms,
                                      unsigned int * msLen,
                                      unsigned char ** sr,
                                      unsigned int * srLen,
...
/* Computes EAP-TLS and EAP-TTLS keying material from the master_secret. */
    WOLFSSL_API int wolfSSL_make_eap_keys( WOLFSSL *,
                                           void * key,
                                           unsigned int len,
                                           const char * label );
...
/* SSL versions */
        ...
        WOLFSSL_API int wolfSSL_use_certificate_ASN1( WOLFSSL * ssl,
                                                      ...
                                                      int derSz );
        WOLFSSL_API int wolfSSL_use_PrivateKey_buffer( WOLFSSL *,
                                                       const unsigned char *,
                                                       long,
                                                       int );
        WOLFSSL_API int wolfSSL_use_PrivateKey_id( WOLFSSL *,
                                                   const unsigned char *,
                                                   long,
                                                   int,
                                                   long );
    ...
    WOLFSSL_API int wolfSSL_set_group_messages( WOLFSSL * );
        ...
        typedef int (* CallbackFuzzer)( WOLFSSL * ssl,
...
/* CA cache callbacks */
    ...
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_CTX_SetMinVersion( WOLFSSL_CTX *,
                                                           int );
    WOLFSSL_API int wolfSSL_SetMinVersion( WOLFSSL *,
                                           int );
    ...
    WOLFSSL_API int wolfSSL_GetOutputSize( WOLFSSL *,
                                           int );
...
/* moved to asn.c, old names kept for backwards compatibility */
    ...
    typedef void (* CallbackCACache)( unsigned char * der,
                                      int sz,
                                      int type );
    ...
    typedef int (* CbOCSPIO)( void *,
                              ...
                              int,
                              unsigned char ** );
    typedef void (* CbOCSPRespFree)( void *,
                                     unsigned char * );
...
/* User Atomic Record Layer CallBacks */
    ...
    typedef int (* CallbackEncryptMac)( WOLFSSL * ssl,
                                        unsigned char * macOut,
                                        int content,
                                        int macVerify,
                                        unsigned char * encOut,
                                        ...
                                        unsigned int encSz,
                                        void * ctx );
    WOLFSSL_API void wolfSSL_CTX_SetEncryptMacCb( WOLFSSL_CTX *,
                                                  CallbackEncryptMac );
    ...
    WOLFSSL_API const unsigned char * wolfSSL_GetMacSecret( WOLFSSL *,
                                                            int );
    WOLFSSL_API const unsigned char * wolfSSL_GetDtlsMacSecret( WOLFSSL *,
                                                                int,
                                                                int );
    ...
    WOLFSSL_API int wolfSSL_SetTlsHmacInner( WOLFSSL *,
                                             unsigned char *,
                                             word32,
                                             int,
                                             int );
...
/* Public Key Callback support */
            ...
            typedef int (* CallbackEccKeyGen)( WOLFSSL * ssl,
                                               struct ecc_key * key,
                                               unsigned int keySz,
                                               int ecc_curve,
                                               void * ctx );
            WOLFSSL_API void wolfSSL_CTX_SetEccKeyGenCb( WOLFSSL_CTX *,
                                                         CallbackEccKeyGen );
            WOLFSSL_API void wolfSSL_SetEccKeyGenCtx( WOLFSSL * ssl,
                                                      void * ctx );
            ...
            typedef int (* CallbackEccVerify)( WOLFSSL * ssl,
                                               ...
                                               int * result,
                                               void * ctx );
            WOLFSSL_API void wolfSSL_CTX_SetEccVerifyCb( WOLFSSL_CTX *,
                                                         CallbackEccVerify );
            ...
            typedef int (* CallbackEccSharedSecret)( WOLFSSL * ssl,
                                                     ...
                                                     word32 * outlen,
                                                     int side,
                                                     void * ctx ); /* side is WOLFSSL_CLIENT_END or WOLFSSL_SERVER_END */
            WOLFSSL_API void wolfSSL_CTX_SetEccSharedSecretCb( WOLFSSL_CTX *,
                                                               CallbackEccSharedSecret );
            WOLFSSL_API void wolfSSL_SetEccSharedSecretCtx( WOLFSSL * ssl,
                                                            void * ctx );
...
/* Public DH Key Callback support */
            struct DhKey;
            typedef int (* CallbackDhAgree)( WOLFSSL * ssl,
                                             struct DhKey * key,
                                             ...
                                             word32 * outlen,
                                             void * ctx );
            WOLFSSL_API void wolfSSL_CTX_SetDhAgreeCb( WOLFSSL_CTX *,
                                                       CallbackDhAgree );
            WOLFSSL_API void wolfSSL_SetDhAgreeCtx( WOLFSSL * ssl,
                                                    void * ctx );
            ...
            WOLFSSL_API void wolfSSL_CTX_SetEd25519SignCb( WOLFSSL_CTX *,
                                                           CallbackEd25519Sign );
            WOLFSSL_API void wolfSSL_SetEd25519SignCtx( WOLFSSL * ssl,
                                                        void * ctx );
            ...
            WOLFSSL_API void wolfSSL_SetEd25519VerifyCtx( WOLFSSL * ssl,
                                                          void * ctx );
            WOLFSSL_API void * wolfSSL_GetEd25519VerifyCtx( WOLFSSL * ssl );
        #endif /* ifdef HAVE_ED25519 */

        #ifdef HAVE_CURVE25519
            struct curve25519_key;

            typedef int (* CallbackX25519KeyGen)( WOLFSSL * ssl,
                                                  struct curve25519_key * key,
                                                  unsigned int keySz,
                                                  void * ctx );
            WOLFSSL_API void wolfSSL_CTX_SetX25519KeyGenCb( WOLFSSL_CTX *,
                                                            CallbackX25519KeyGen );
            WOLFSSL_API void wolfSSL_SetX25519KeyGenCtx( WOLFSSL * ssl,
                                                         void * ctx );
            ...
            WOLFSSL_API void wolfSSL_SetX25519SharedSecretCtx( WOLFSSL * ssl,
                                                               void * ctx );
            WOLFSSL_API void * wolfSSL_GetX25519SharedSecretCtx( WOLFSSL * ssl );
        #endif /* ifdef HAVE_CURVE25519 */
            ...
            WOLFSSL_API void wolfSSL_CTX_SetEd448SignCb( WOLFSSL_CTX *,
                                                         CallbackEd448Sign );
            WOLFSSL_API void wolfSSL_SetEd448SignCtx( WOLFSSL * ssl,
                                                      void * ctx );
            ...
            WOLFSSL_API void wolfSSL_CTX_SetEd448VerifyCb( WOLFSSL_CTX *,
                                                           CallbackEd448Verify );
            WOLFSSL_API void wolfSSL_SetEd448VerifyCtx( WOLFSSL * ssl,
                                                        void * ctx );
            WOLFSSL_API void * wolfSSL_GetEd448VerifyCtx( WOLFSSL * ssl );
        #endif /* ifdef HAVE_ED448 */

        #ifdef HAVE_CURVE448
            struct curve448_key;

            typedef int (* CallbackX448KeyGen)( WOLFSSL * ssl,
                                                struct curve448_key * key,
                                                unsigned int keySz,
                                                void * ctx );
            WOLFSSL_API void wolfSSL_CTX_SetX448KeyGenCb( WOLFSSL_CTX *,
                                                          CallbackX448KeyGen );
            WOLFSSL_API void wolfSSL_SetX448KeyGenCtx( WOLFSSL * ssl,
                                                       void * ctx );
            ...
            WOLFSSL_API void wolfSSL_SetX448SharedSecretCtx( WOLFSSL * ssl,
                                                             void * ctx );
            WOLFSSL_API void * wolfSSL_GetX448SharedSecretCtx( WOLFSSL * ssl );
        #endif /* ifdef HAVE_CURVE448 */
            ...
            typedef int (* CallbackRsaSign)( WOLFSSL * ssl,
                                             ...
                                             unsigned int keySz,
                                             void * ctx );
            WOLFSSL_API void wolfSSL_CTX_SetRsaSignCb( WOLFSSL_CTX *,
                                                       CallbackRsaSign );
            ...
            typedef int (* CallbackRsaVerify)( WOLFSSL * ssl,
                                               ...
                                               unsigned int keySz,
                                               void * ctx );
            WOLFSSL_API void wolfSSL_CTX_SetRsaVerifyCb( WOLFSSL_CTX *,
                                                         CallbackRsaVerify );
            WOLFSSL_API void wolfSSL_CTX_SetRsaSignCheckCb( WOLFSSL_CTX *,
                                                            CallbackRsaVerify );
            ...
            WOLFSSL_API void * wolfSSL_GetRsaVerifyCtx( WOLFSSL * ssl );
                ...
                typedef int (* CallbackRsaPssSign)( WOLFSSL * ssl,
                                                    ...
                                                    unsigned int keySz,
                                                    void * ctx );
                WOLFSSL_API void wolfSSL_CTX_SetRsaPssSignCb( WOLFSSL_CTX *,
                                                              CallbackRsaPssSign );
                WOLFSSL_API void wolfSSL_SetRsaPssSignCtx( WOLFSSL * ssl,
                                                           void * ctx );
                ...
                WOLFSSL_API void wolfSSL_CTX_SetRsaPssSignCheckCb( WOLFSSL_CTX *,
                                                                   CallbackRsaPssVerify );
                WOLFSSL_API void wolfSSL_SetRsaPssVerifyCtx( WOLFSSL * ssl,
                                                             void * ctx );
...
/* RSA Public Encrypt cb */
            typedef int (* CallbackRsaEnc)( WOLFSSL * ssl,
                                            ...
                                            unsigned int keySz,
                                            void * ctx );
            WOLFSSL_API void wolfSSL_CTX_SetRsaEncCb( WOLFSSL_CTX *,
                                                      CallbackRsaEnc );
...
/* RSA Private Decrypt cb */
            typedef int (* CallbackRsaDec)( WOLFSSL * ssl,
                                            ...
                                            unsigned int keySz,
                                            void * ctx );
            WOLFSSL_API void wolfSSL_CTX_SetRsaDecCb( WOLFSSL_CTX *,
                                                      CallbackRsaDec );
    ...
    #ifndef NO_CERTS
        WOLFSSL_API void wolfSSL_CTX_SetCACb( WOLFSSL_CTX *,
                                              CallbackCACache );
        ...
        WOLFSSL_API int wolfSSL_LoadCRL( WOLFSSL *,
                                         const char *,
                                         int,
                                         int );
        WOLFSSL_API int wolfSSL_LoadCRLBuffer( WOLFSSL *,
                                               ...
                                               long sz,
                                               int );
        WOLFSSL_API int wolfSSL_SetCRL_Cb( WOLFSSL *,
                                           CbMissingCRL );
        #ifdef HAVE_CRL_IO
            WOLFSSL_API int wolfSSL_SetCRL_IOCb( WOLFSSL * ssl,
                                                 CbCrlIO cb );
        #endif
        WOLFSSL_API int wolfSSL_EnableOCSP( WOLFSSL *,
                                            int options );
        WOLFSSL_API int wolfSSL_DisableOCSP( WOLFSSL * );
        WOLFSSL_API int wolfSSL_SetOCSP_OverrideURL( WOLFSSL *,
                                                     const char * );
        WOLFSSL_API int wolfSSL_SetOCSP_Cb( WOLFSSL *,
                                            CbOCSPIO,
                                            CbOCSPRespFree,
                                            void * );
        ...
        WOLFSSL_API int wolfSSL_CTX_LoadCRL( WOLFSSL_CTX *,
                                             const char *,
                                             int,
                                             int );
        WOLFSSL_API int wolfSSL_CTX_LoadCRLBuffer( WOLFSSL_CTX *,
                                                   ...
                                                   long sz,
                                                   int );
        WOLFSSL_API int wolfSSL_CTX_SetCRL_Cb( WOLFSSL_CTX *,
                                               CbMissingCRL );
        #ifdef HAVE_CRL_IO
            WOLFSSL_API int wolfSSL_CTX_SetCRL_IOCb( WOLFSSL_CTX *,
                                                     CbCrlIO );
        #endif

        WOLFSSL_API int wolfSSL_CTX_EnableOCSP( WOLFSSL_CTX *,
                                                int options );
        WOLFSSL_API int wolfSSL_CTX_DisableOCSP( WOLFSSL_CTX * );
        WOLFSSL_API int wolfSSL_CTX_SetOCSP_OverrideURL( WOLFSSL_CTX *,
                                                         const char * );
...
/* async additions */
    ...
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_SetDevId( WOLFSSL *,
                                                  int devId );
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_CTX_SetDevId( WOLFSSL_CTX *,
                                                      int devId );

/* helpers to get device id and heap */
    WOLFSSL_ABI WOLFSSL_API int wolfSSL_CTX_GetDevId( WOLFSSL_CTX *,
                                                      WOLFSSL * );
    WOLFSSL_API void * wolfSSL_CTX_GetHeap( WOLFSSL_CTX * ctx,
                                            WOLFSSL * ssl );
...
/* SNI types */
        ...
        WOLFSSL_ABI WOLFSSL_API int wolfSSL_UseSNI( WOLFSSL *,
                                                    unsigned char,
                                                    const void *,
                                                    unsigned short );
        WOLFSSL_ABI WOLFSSL_API int wolfSSL_CTX_UseSNI( WOLFSSL_CTX *,
                                                        unsigned char,
                                                        const void *,
                                                        unsigned short );
...
/* SNI options */
            ...
            WOLFSSL_API void wolfSSL_CTX_SNI_SetOptions( WOLFSSL_CTX * ctx,
                                                         unsigned char type,
                                                         unsigned char options );
            WOLFSSL_API int wolfSSL_SNI_GetFromBuffer( const unsigned char * clientHello,
...
/* TCA Identifier Type */
        ...
        WOLFSSL_API int wolfSSL_UseTrustedCA( WOLFSSL * ssl,
                                              unsigned char type,
...
/* ALPN status code */
        ...
        enum
        {
            ...
            typedef int (* CallbackALPNSelect)( WOLFSSL * ssl,
        ...
        WOLFSSL_API int wolfSSL_ALPN_FreePeerProtocol( WOLFSSL * ssl,
                                                       char ** list );
    #endif /* HAVE_ALPN */
...
/* Certificate Status Options (flags) */
    enum
    {
        ...
        #endif
    #endif /* ifdef HAVE_CERTIFICATE_STATUS_REQUEST */
...
/* Certificate Status v2 Options (flags) */
    enum
    {
        ...
        #endif
    #endif /* ifdef HAVE_CERTIFICATE_STATUS_REQUEST_V2 */
...
/* Named Groups */
    ...
    #ifdef WOLFSSL_TLS13
        WOLFSSL_API int wolfSSL_UseKeyShare( WOLFSSL * ssl,
                                             word16 group );
...
/* Secure Renegotiation */
        ...
        WOLFSSL_API int wolfSSL_StartSecureRenegotiation( WOLFSSL * ssl,
                                                          int resume );
...
/* Session Ticket */
            ...
            WOLFSSL_API int wolfSSL_get_SessionTicket( WOLFSSL *,
                                                       unsigned char *,
                                                       word32 * );
            WOLFSSL_API int wolfSSL_set_SessionTicket( WOLFSSL *,
                                                       const unsigned char *,
                                                       word32 );
            typedef int (* CallbackSessionTicket)( WOLFSSL *,
                                                   const unsigned char *,
                                                   int,
                                                   void * );
 ...
 * then will not send keys in the hello extension */
            WOLFSSL_API int wolfSSL_UseClientQSHKeys( WOLFSSL * ssl,
                                                      unsigned char flag );
        #endif
...
/* notify user the handshake is done */
    typedef int (* HandShakeDoneCb)( WOLFSSL *,
                                     void * );
    WOLFSSL_API int wolfSSL_SetHsDoneCb( WOLFSSL *,
                                         HandShakeDoneCb,
                                         void * );
...
/* External facing KDF */
    ...
    WOLFSSL_API
    int wolfSSL_MakeTlsExtendedMasterSecret( unsigned char * ms,
                                             word32 msLen,
                                             const unsigned char * pms,
                                             word32 pmsLen,
 ...
 * for diagnostics */
        WOLFSSL_API int wolfSSL_connect_ex( WOLFSSL *,
                                            HandShakeCallBack,
                                            TimeoutCallBack,
                                            WOLFSSL_TIMEVAL );
        WOLFSSL_API int wolfSSL_accept_ex( WOLFSSL *,
                                           HandShakeCallBack,
                                           TimeoutCallBack,
                                           WOLFSSL_TIMEVAL );
...
/* Object functions */
        ...
        WOLFSSL_API WOLFSSL_ASN1_OBJECT * wolfSSL_OBJ_txt2obj( const char * s,
                                                               int no_name );

        WOLFSSL_API WOLFSSL_ASN1_OBJECT * wolfSSL_OBJ_nid2obj( int n );
        WOLFSSL_LOCAL WOLFSSL_ASN1_OBJECT * wolfSSL_OBJ_nid2obj_ex( int n,
                                                                    WOLFSSL_ASN1_OBJECT * arg_obj );
        WOLFSSL_API int wolfSSL_OBJ_obj2txt( char * buf,
                                             int buf_len,
                                             WOLFSSL_ASN1_OBJECT * a,
                                             int no_name );

        WOLFSSL_API void wolfSSL_OBJ_cleanup( void );
        WOLFSSL_API int wolfSSL_OBJ_create( const char * oid,
                                            const char * sn,
                                            const char * ln );
        #ifdef HAVE_ECC
...
/* end of object functions */
        ...
        WOLFSSL_API unsigned long wolfSSL_ERR_peek_last_error_line( const char ** file,
                                                                    int * line );
        WOLFSSL_API long wolfSSL_ctrl( WOLFSSL * ssl,
                                       int cmd,
                                       long opt,
                                       void * pt );
        WOLFSSL_API long wolfSSL_CTX_ctrl( WOLFSSL_CTX * ctx,
                                           int cmd,
                                           long opt,
                                           void * pt );
        WOLFSSL_API long wolfSSL_CTX_callback_ctrl( WOLFSSL_CTX * ctx,
                                                    int cmd,
                                                    void ( * fp )( void ) );
        WOLFSSL_API long wolfSSL_CTX_clear_extra_chain_certs( WOLFSSL_CTX * ctx );

        #ifndef NO_CERTS
            WOLFSSL_API WOLFSSL_X509_NAME_ENTRY * wolfSSL_X509_NAME_ENTRY_create_by_NID( WOLFSSL_X509_NAME_ENTRY ** out,
                                                                                         int nid,
                                                                                         int type,
                                                                                         const unsigned char * data,
                                                                                         int dataSz );
            WOLFSSL_API WOLFSSL_X509_NAME_ENTRY * wolfSSL_X509_NAME_ENTRY_create_by_txt( WOLFSSL_X509_NAME_ENTRY ** neIn,
                                                                                         const char * txt,
                                                                                         int format,
                                                                                         const unsigned char * data,
                                                                                         int dataSz );
            ...
            WOLFSSL_API int wolfSSL_X509_NAME_add_entry_by_txt( WOLFSSL_X509_NAME * name,
                                                                ...
                                                                int loc,
                                                                int set );
            WOLFSSL_API int wolfSSL_X509_NAME_add_entry_by_NID( WOLFSSL_X509_NAME * name,
                                                                int nid,
                                                                int type,
                                                                const unsigned char * bytes,
                                                                int len,
            ...
            WOLFSSL_API int wolfSSL_X509_NAME_copy( WOLFSSL_X509_NAME *,
                                                    WOLFSSL_X509_NAME * );
        ...
        WOLFSSL_API void * wolfSSL_X509_get_ext_d2i( const WOLFSSL_X509 * x509,
            ...
            WOLFSSL_API int wolfSSL_X509_get_ext_by_NID( const WOLFSSL_X509 * x,
                                                         int nid,
                                                         int lastpos );
            WOLFSSL_API int wolfSSL_X509_add_ext( WOLFSSL_X509 * x,
                                                  WOLFSSL_X509_EXTENSION * ex,
                                                  int loc );
            WOLFSSL_API WOLFSSL_X509_EXTENSION * wolfSSL_X509V3_EXT_i2d( int nid,
                                                                         int crit,
                                                                         void * data );
            WOLFSSL_API WOLFSSL_X509_EXTENSION * wolfSSL_X509V3_EXT_conf_nid( WOLF_LHASH_OF( CONF_VALUE ) * conf,
            ...
            WOLFSSL_API int wolfSSL_use_certificate( WOLFSSL * ssl,
                                                     WOLFSSL_X509 * x509 );
            WOLFSSL_API int wolfSSL_use_PrivateKey( WOLFSSL * ssl,
                                                    WOLFSSL_EVP_PKEY * pkey );
            WOLFSSL_API int wolfSSL_use_PrivateKey_ASN1( int pri,
                                                         WOLFSSL * ssl,
                                                         const unsigned char * der,
                                                         long derSz );
            WOLFSSL_API WOLFSSL_EVP_PKEY * wolfSSL_get_privatekey( const WOLFSSL * ssl );
            #ifndef NO_RSA
                WOLFSSL_API int wolfSSL_use_RSAPrivateKey_ASN1( WOLFSSL * ssl,
                                                                unsigned char * der,
                                                                long derSz );
            #endif
            WOLFSSL_API int wolfSSL_CTX_use_PrivateKey_ASN1( int pri,
                                                             WOLFSSL_CTX * ctx,
                                                             unsigned char * der,
                                                             long derSz );

            #if defined( WOLFSSL_QT ) || defined( OPENSSL_ALL )
                WOLFSSL_API int wolfSSL_X509_cmp( const WOLFSSL_X509 * a,
                                                  const WOLFSSL_X509 * b );
                WOLFSSL_API WOLFSSL_X509_EXTENSION * wolfSSL_X509_get_ext( const WOLFSSL_X509 * x,
                                                                           int loc );
                WOLFSSL_API WOLFSSL_X509_EXTENSION * wolfSSL_X509_set_ext( WOLFSSL_X509 * x,
                                                                           int loc );
            ...
            #endif /* if defined( WOLFSSL_QT ) || defined( OPENSSL_ALL ) */
        ...
        WOLFSSL_API int wolfSSL_i2d_X509_bio( WOLFSSL_BIO * bio,
                                              WOLFSSL_X509 * x509 );
        ...
        WOLFSSL_API int wolfSSL_get_server_tmp_key( const WOLFSSL *,
                                                    WOLFSSL_EVP_PKEY ** );

        WOLFSSL_API int wolfSSL_CTX_set_min_proto_version( WOLFSSL_CTX *,
                                                           int );
        WOLFSSL_API int wolfSSL_CTX_set_max_proto_version( WOLFSSL_CTX *,
                                                           int );
        ...
        WOLFSSL_API WOLFSSL_X509_CRL * wolfSSL_PEM_read_bio_X509_CRL( WOLFSSL_BIO * bp,
                                                                      ...
                                                                      pem_password_cb * cb,
                                                                      void * u );
        WOLFSSL_API WOLFSSL_X509 * wolfSSL_PEM_read_bio_X509_AUX( WOLFSSL_BIO * bp,
                                                                  WOLFSSL_X509 ** x,
                                                                  pem_password_cb * cb,
                                                                  void * u );
...
/*lighttp compatibility */
    ...
    defined( OPENSSL_EXTRA_X509_SMALL )
        ...
        WOLFSSL_API WOLFSSL_X509_NAME_ENTRY * wolfSSL_X509_NAME_get_entry( WOLFSSL_X509_NAME * name,
                                                                           int loc );
    #endif /* OPENSSL_EXTRA || WOLFSSL_WPAS_SMALL */
    ...
    defined( OPENSSL_EXTRA_X509_SMALL )
        ...
        || defined( OPENSSL_EXTRA_X509_SMALL )
            ...
            WOLFSSL_API char wolfSSL_CTX_use_certificate( WOLFSSL_CTX *,
                                                          WOLFSSL_X509 * );
            WOLFSSL_API int wolfSSL_CTX_add1_chain_cert( WOLFSSL_CTX *,
                                                         WOLFSSL_X509 * );
            WOLFSSL_API int wolfSSL_BIO_read_filename( WOLFSSL_BIO * b,
                                                       const char * name );
/* These are to be merged shortly */
            WOLFSSL_API void wolfSSL_set_verify_depth( WOLFSSL * ssl,
                                                       int depth );
            WOLFSSL_API void * wolfSSL_get_app_data( const WOLFSSL * ssl );
            WOLFSSL_API int wolfSSL_set_app_data( WOLFSSL * ssl,
                                                  void * arg );
            WOLFSSL_API WOLFSSL_ASN1_OBJECT * wolfSSL_X509_NAME_ENTRY_get_object( WOLFSSL_X509_NAME_ENTRY * ne );
            WOLFSSL_API unsigned char * wolfSSL_SHA1( const unsigned char * d,
                                                      size_t n,
                                                      unsigned char * md );
            WOLFSSL_API unsigned char * wolfSSL_SHA256( const unsigned char * d,
                                                        size_t n,
                                                        unsigned char * md );
            WOLFSSL_API unsigned char * wolfSSL_SHA384( const unsigned char * d,
                                                        size_t n,
                                                        unsigned char * md );
            WOLFSSL_API unsigned char * wolfSSL_SHA512( const unsigned char * d,
                                                        size_t n,
                                                        unsigned char * md );
            WOLFSSL_API int wolfSSL_X509_check_private_key( WOLFSSL_X509 *,
                                                            WOLFSSL_EVP_PKEY * );
            ...
            WOLFSSL_API int wolfSSL_X509_check_ca( WOLFSSL_X509 * x509 );
                ...
                WOLFSSL_API long wolfSSL_BIO_get_fp( WOLFSSL_BIO * bio,
                                                     XFILE * fp );
                WOLFSSL_API WOLFSSL_BIO * wolfSSL_BIO_new_fp( XFILE fp,
                                                              int c );
            #endif
    ...
    || defined( OPENSSL_EXTRA )
        ...
        WOLFSSL_API WOLFSSL_BIO * wolfSSL_BIO_new_file( const char * filename,
                                                        const char * mode );
        WOLFSSL_API long wolfSSL_CTX_set_tmp_dh( WOLFSSL_CTX *,
                                                 WOLFSSL_DH * );
        ...
        WOLFSSL_API WOLFSSL_DSA * wolfSSL_PEM_read_bio_DSAparams( WOLFSSL_BIO * bp,
                                                                  ...
                                                                  pem_password_cb * cb,
                                                                  void * u );
        WOLFSSL_API int wolfSSL_PEM_write_bio_X509_REQ( WOLFSSL_BIO * bp,
                                                        WOLFSSL_X509 * x );
        WOLFSSL_API int wolfSSL_PEM_write_bio_X509_AUX( WOLFSSL_BIO * bp,
                                                        WOLFSSL_X509 * x );
        WOLFSSL_API int wolfSSL_PEM_write_bio_X509( WOLFSSL_BIO * bp,
                                                    WOLFSSL_X509 * x );
    #endif /* HAVE_STUNNEL || HAVE_LIGHTY */

    #if defined( OPENSSL_EXTRA ) && !defined( NO_CERTS ) && defined( WOLFSSL_CERT_GEN ) && \
    defined( WOLFSSL_CERT_REQ )
        WOLFSSL_API int wolfSSL_i2d_X509_REQ( WOLFSSL_X509 * req,
                                              unsigned char ** out );
        WOLFSSL_API WOLFSSL_X509 * wolfSSL_X509_REQ_new( void );
        WOLFSSL_API void wolfSSL_X509_REQ_free( WOLFSSL_X509 * req );
        WOLFSSL_API int wolfSSL_X509_REQ_sign( WOLFSSL_X509 * req,
                                               WOLFSSL_EVP_PKEY * pkey,
                                               const WOLFSSL_EVP_MD * md );
        ...
        WOLFSSL_API int wolfSSL_X509_REQ_set_pubkey( WOLFSSL_X509 * req,
                                                     WOLFSSL_EVP_PKEY * pkey );
    #endif /* if defined( OPENSSL_EXTRA ) && !defined( NO_CERTS ) && defined( WOLFSSL_CERT_GEN ) && defined( WOLFSSL_CERT_REQ ) */
...
/* SNI received callback type */
        typedef int (* CallbackSniRecv)( WOLFSSL * ssl,
                                         int * ret,
                                         void * exArg );
        ...
        WOLFSSL_API int wolfSSL_CRYPTO_memcmp( const void * a,
                                               const void * b,
                                               size_t size );
        ...
        WOLFSSL_API WOLFSSL_DH * wolfSSL_DH_generate_parameters( int prime_len,
                                                                 int generator,
                                                                 void ( * callback )( int, int, void * ),
                                                                 void * cb_arg );

        WOLFSSL_API int wolfSSL_DH_generate_parameters_ex( WOLFSSL_DH *,
                                                           int,
                                                           int,
                                                           void ( * callback )( int, int, void * ) );
        ...
        WOLFSSL_API int wolfSSL_CIPHER_get_bits( const WOLFSSL_CIPHER * c,
                                                 int * alg_bits );
        ...
        WOLFSSL_API WOLFSSL_X509_INFO * wolfSSL_sk_X509_INFO_value( const WOLF_STACK_OF( WOLFSSL_X509_INFO ) *,
                                                                    int );
        ...
        WOLFSSL_API int wolfSSL_sk_X509_NAME_find( const WOLF_STACK_OF( WOLFSSL_X509_NAME ) *,
                                                   WOLFSSL_X509_NAME * );
        WOLFSSL_API int wolfSSL_sk_X509_NAME_set_cmp_func( WOLF_STACK_OF( WOLFSSL_X509_NAME ) *,
                                                           wolf_sk_compare_cb );
        WOLFSSL_API WOLFSSL_X509_NAME * wolfSSL_sk_X509_NAME_value( const WOLF_STACK_OF( WOLFSSL_X509_NAME ) *,
                                                                    int );
        ...
        WOLFSSL_API int wolfSSL_X509_NAME_print_ex( WOLFSSL_BIO *,
                                                    WOLFSSL_X509_NAME *,
                                                    int,
                                                    unsigned long );
        ...
        WOLFSSL_API int wolfSSL_ASN1_BIT_STRING_get_bit( const WOLFSSL_ASN1_BIT_STRING *,
                                                         int );
        WOLFSSL_API int wolfSSL_ASN1_BIT_STRING_set_bit( WOLFSSL_ASN1_BIT_STRING *,
                                                         int,
                                                         int );
    #endif /* OPENSSL_EXTRA || WOLFSSL_WPAS_SMALL */
    ...
    || defined( WOLFSSL_HAPROXY ) || defined( OPENSSL_EXTRA ) || defined( HAVE_LIGHTY )
        ...
        WOLFSSL_API int wolfSSL_CTX_add_session( WOLFSSL_CTX *,
                                                 WOLFSSL_SESSION * );
        ...
        WOLFSSL_API WOLFSSL_X509 * wolfSSL_sk_X509_value( WOLF_STACK_OF( WOLFSSL_X509 ) *,
                                                          int );

        WOLFSSL_API WOLFSSL_X509 * wolfSSL_sk_X509_shift( WOLF_STACK_OF( WOLFSSL_X509 ) * );

        WOLFSSL_API void * wolfSSL_sk_X509_OBJECT_value( WOLF_STACK_OF( WOLFSSL_X509_OBJECT ) *,
                                                         int );
    #endif /* OPENSSL_ALL || HAVE_STUNNEL || WOLFSSL_NGINX || WOLFSSL_HAPROXY || OPENSSL_EXTRA || HAVE_LIGHTY */

    #if defined( OPENSSL_EXTRA ) || defined( WOLFSSL_WPAS_SMALL )
        WOLFSSL_API void * wolfSSL_SESSION_get_ex_data( const WOLFSSL_SESSION *,
                                                        int );

        WOLFSSL_API int wolfSSL_SESSION_set_ex_data( WOLFSSL_SESSION *,
                                                     int,
                                                     void * );
    #endif /* OPENSSL_EXTRA || WOLFSSL_WPAS_SMALL */
    ...
    || defined( WOLFSSL_HAPROXY ) || defined( OPENSSL_EXTRA ) || defined( HAVE_LIGHTY )
        ...
        WOLFSSL_API int wolfSSL_SESSION_get_ex_new_index( long,
                                                          void *,
                                                          void *,
                                                          void *,
                                                          CRYPTO_free_func * );
        ...
        WOLFSSL_API int wolfSSL_SESSION_print( WOLFSSL_BIO *,
                                               const WOLFSSL_SESSION * );

        WOLFSSL_API int wolfSSL_set_tlsext_host_name( WOLFSSL *,
                                                      const char * );

        WOLFSSL_API const char * wolfSSL_get_servername( WOLFSSL *,
                                                         unsigned char );

        WOLFSSL_API WOLFSSL_CTX * wolfSSL_set_SSL_CTX( WOLFSSL *,
                                                       WOLFSSL_CTX * );
        ...
        WOLFSSL_API int wolfSSL_CTX_set_servername_arg( WOLFSSL_CTX *,
                                                        void * );
...
/* support for deprecated old name */
        ...
        WOLFSSL_API void wolfSSL_THREADID_set_numeric( void * id,
                                                       unsigned long val );
        ...
        WOLFSSL_API WOLFSSL_X509_OBJECT * wolfSSL_sk_X509_OBJECT_delete( WOLF_STACK_OF( WOLFSSL_X509_OBJECT ) * sk,
                                                                         int i );
        ...
        WOLFSSL_API void wolfSSL_sk_X509_pop_free( WOLF_STACK_OF( WOLFSSL_X509 ) * sk,
                                                   void ( * f )( WOLFSSL_X509 * ) );
    #endif /* OPENSSL_EXTRA || WOLFSSL_WPAS_SMALL */

    #if defined( OPENSSL_EXTRA ) && defined( HAVE_ECC )
        WOLFSSL_API int wolfSSL_CTX_set1_curves_list( WOLFSSL_CTX * ctx,
                                                      const char * names );
        WOLFSSL_API int wolfSSL_set1_curves_list( WOLFSSL * ssl,
                                                  const char * names );
    ...
    defined( WOLFSSL_NGINX ) || defined( WOLFSSL_HAPROXY )
        ...
        WOLFSSL_API int wolfSSL_AsyncPoll( WOLFSSL * ssl,
                                           WOLF_EVENT_FLAG flags );
        WOLFSSL_API int wolfSSL_CTX_AsyncPoll( WOLFSSL_CTX * ctx,
                                               WOLF_EVENT ** events,
                                               int maxEvents,
                                               WOLF_EVENT_FLAG flags,
                                               int * eventCount );
    ...
    #ifdef OPENSSL_EXTRA
        typedef void (* SSL_Msg_Cb)( int write_p,
                                     int version,
                                     int content_type,
                                     const void * buf,
                                     size_t len,
        ...
        WOLFSSL_API int wolfSSL_CTX_set_msg_callback( WOLFSSL_CTX * ctx,
                                                      SSL_Msg_Cb cb );
        WOLFSSL_API int wolfSSL_set_msg_callback( WOLFSSL * ssl,
                                                  SSL_Msg_Cb cb );
        WOLFSSL_API int wolfSSL_CTX_set_msg_callback_arg( WOLFSSL_CTX * ctx,
                                                          void * arg );
    ...
    #if defined( OPENSSL_ALL ) || defined( WOLFSSL_NGINX ) || defined( WOLFSSL_HAPROXY )
/* Not an OpenSSL API. */
        WOLFSSL_LOCAL int wolfSSL_get_ocsp_response( WOLFSSL * ssl,
                                                     byte ** response );
/* Not an OpenSSL API. */
        WOLFSSL_LOCAL char * wolfSSL_get_ocsp_url( WOLFSSL * ssl );
/* Not an OpenSSL API. */
        WOLFSSL_API int wolfSSL_set_ocsp_url( WOLFSSL * ssl,
                                              char * url );
    #endif

    #if defined( OPENSSL_EXTRA ) || defined( WOLFSSL_WPAS_SMALL )
        WOLFSSL_API void * wolfSSL_X509_get_ex_data( WOLFSSL_X509 * x509,
                                                     int idx );
        WOLFSSL_API int wolfSSL_X509_set_ex_data( WOLFSSL_X509 * x509,
                                                  int idx,
                                                  void * data );
    #endif /* OPENSSL_EXTRA || WOLFSSL_WPAS_SMALL */
    ...
    || defined( OPENSSL_EXTRA ) || defined( HAVE_LIGHTY )
        ...
        WOLFSSL_API int wolfSSL_X509_get_ex_new_index( int idx,
                                                       void * arg,
                                                       void * a,
                                                       void * b,
                                                       void * c );
        ...
        #ifdef HAVE_SESSION_TICKET
            WOLFSSL_API int wolfSSL_CTX_set_tlsext_ticket_key_cb( WOLFSSL_CTX *,
                                                                  int ( * )(
        ...
        defined( WOLFSSL_NGINX ) || defined( WOLFSSL_HAPROXY )
            ...
            WOLFSSL_API char * wolfSSL_sk_WOLFSSL_STRING_value( WOLF_STACK_OF( WOLFSSL_STRING ) * strings,
                                                                int idx );
    ...
    WOLFSSL_API void wolfSSL_CTX_set_next_proto_select_cb( WOLFSSL_CTX * s,
                                                           int ( * cb )( WOLFSSL * ssl,
                                                                         ...
                                                                         void * arg ),
                                                           void * arg );
    WOLFSSL_API void wolfSSL_get0_next_proto_negotiated( const WOLFSSL * s,
                                                         const unsigned char ** data,
                                                         unsigned * len );

    #ifndef NO_ASN
        WOLFSSL_API int wolfSSL_X509_check_host( WOLFSSL_X509 * x,
                                                 const char * chk,
                                                 size_t chklen,
                                                 unsigned int flags,
                                                 char ** peername );
        WOLFSSL_API int wolfSSL_X509_check_ip_asc( WOLFSSL_X509 * x,
                                                   const char * ipasc,
                                                   unsigned int flags );
    #endif
    ...
    #if defined( OPENSSL_EXTRA ) || defined( OPENSSL_EXTRA_X509_SMALL )
        #if defined( OPENSSL_ALL ) || defined( WOLFSSL_NGINX ) || defined( WOLFSSL_HAPROXY )
            WOLFSSL_API const unsigned char * SSL_SESSION_get0_id_context( const WOLFSSL_SESSION * sess,
                                                                           unsigned int * sid_ctx_length );
            WOLFSSL_API size_t SSL_get_finished( const WOLFSSL * s,
                                                 void * buf,
                                                 size_t count );
            WOLFSSL_API size_t SSL_get_peer_finished( const WOLFSSL * s,
                                                      void * buf,
                                                      size_t count );
        #endif

        WOLFSSL_API int SSL_SESSION_set1_id( WOLFSSL_SESSION * s,
                                             const unsigned char * sid,
                                             unsigned int sid_len );
        WOLFSSL_API int SSL_SESSION_set1_id_context( WOLFSSL_SESSION * s,
        ...
        WOLFSSL_API void wolfSSL_X509_ALGOR_get0( const WOLFSSL_ASN1_OBJECT ** paobj,
                                                  int * pptype,
                                                  const void ** ppval,
        ...
        WOLFSSL_API int wolfSSL_X509_PUBKEY_get0_param( WOLFSSL_ASN1_OBJECT ** ppkalg,
        ...
        WOLFSSL_API int wolfSSL_X509_PUBKEY_set( WOLFSSL_X509_PUBKEY ** x,
                                                 WOLFSSL_EVP_PKEY * key );
        WOLFSSL_API int i2t_ASN1_OBJECT( char * buf,
                                         int buf_len,
                                         WOLFSSL_ASN1_OBJECT * a );
        WOLFSSL_API int wolfSSL_i2a_ASN1_OBJECT( WOLFSSL_BIO * bp,
                                                 WOLFSSL_ASN1_OBJECT * a );
        WOLFSSL_API int wolfSSL_i2d_ASN1_OBJECT( WOLFSSL_ASN1_OBJECT * a,
                                                 unsigned char ** pp );
        WOLFSSL_API void SSL_CTX_set_tmp_dh_callback( WOLFSSL_CTX * ctx,
        ...
        WOLFSSL_API int wolfSSL_X509_STORE_load_locations( WOLFSSL_X509_STORE * str,
                                                           const char * file,
                                                           const char * dir );
        WOLFSSL_API int wolfSSL_X509_STORE_add_crl( WOLFSSL_X509_STORE * ctx,
                                                    WOLFSSL_X509_CRL * x );
        WOLFSSL_API int wolfSSL_sk_SSL_CIPHER_num( const WOLF_STACK_OF( WOLFSSL_CIPHER ) * p );
        WOLFSSL_API int wolfSSL_sk_SSL_CIPHER_find( WOLF_STACK_OF( WOLFSSL_CIPHER ) * sk,
                                                    const WOLFSSL_CIPHER * toFind );
        ...
        WOLFSSL_API WOLFSSL_CIPHER * wolfSSL_sk_SSL_CIPHER_value( void * ciphers,
                                                                  int idx );
        WOLFSSL_API void ERR_load_SSL_strings( void );
        WOLFSSL_API void wolfSSL_EC_POINT_dump( const char * msg,
                                                const WOLFSSL_EC_POINT * p );

        WOLFSSL_API const char * wolfSSL_ASN1_tag2str( int tag );
        WOLFSSL_API int wolfSSL_ASN1_STRING_print_ex( WOLFSSL_BIO * out,
                                                      WOLFSSL_ASN1_STRING * str,
                                                      unsigned long flags );
        WOLFSSL_API int wolfSSL_ASN1_STRING_print( WOLFSSL_BIO * out,
                                                   WOLFSSL_ASN1_STRING * str );
        ...
        WOLFSSL_API int wolfSSL_i2c_ASN1_INTEGER( WOLFSSL_ASN1_INTEGER * a,
                                                  unsigned char ** pp );
        ...
        WOLFSSL_API WOLFSSL_EVP_PKEY * wolfSSL_d2i_PKCS8PrivateKey_bio( WOLFSSL_BIO * bio,
                                                                        ...
                                                                        pem_password_cb * cb,
                                                                        void * u );
        WOLFSSL_API WOLFSSL_EVP_PKEY * wolfSSL_d2i_AutoPrivateKey( WOLFSSL_EVP_PKEY ** pkey,
                                                                   const unsigned char ** data,
                                                                   long length );
        ...
        WOLFSSL_API int wolfSSL_CTX_AllowEncryptThenMac( WOLFSSL_CTX *,
                                                         int );
        WOLFSSL_API int wolfSSL_AllowEncryptThenMac( WOLFSSL * s,
                                                     int );
    #endif
...
/* Currently allows ECDHE and DHE only */
        ...
        WOLFSSL_API int wolfSSL_CTX_set_ephemeral_key( WOLFSSL_CTX * ctx,
                                                       int keyAlgo,
                                                       const char * key,
                                                       unsigned int keySz,
                                                       int format );
        WOLFSSL_API int wolfSSL_set_ephemeral_key( WOLFSSL * ssl,
                                                   int keyAlgo,
                                                   const char * key,
                                                   unsigned int keySz,
                                                   int format );
    #endif /* ifdef WOLFSSL_STATIC_EPHEMERAL */
