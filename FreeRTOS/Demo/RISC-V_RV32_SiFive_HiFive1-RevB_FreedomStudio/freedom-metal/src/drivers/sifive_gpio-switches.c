...
#include <metal/machine/platform.h>
    ...
    int __metal_driver_switch_exist( struct metal_switch * flip,
                                     char * label )
    {
    ...
    struct metal_interrupt * __metal_driver_switch_interrupt_controller( struct metal_switch * flip )
    {
...
#endif /* ifdef METAL_SIFIVE_GPIO_SWITCHES */
