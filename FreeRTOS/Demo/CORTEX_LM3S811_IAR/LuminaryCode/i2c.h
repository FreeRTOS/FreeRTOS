...
/* */
/****************************************************************************** */
    extern void I2CIntRegister( unsigned long ulBase,
                                void( fnHandler )( void ) );
    ...
    extern void I2CMasterControl( unsigned long ulBase,
                                  unsigned long ulCmd );
    ...
    extern void I2CMasterInit( unsigned long ulBase,
                               tBoolean bFast );
    ...
    extern tBoolean I2CSlaveIntStatus( unsigned long ulBase,
                                       tBoolean bMasked );
    extern unsigned long I2CSlaveStatus( unsigned long ulBase );
    extern void I2CMasterInitExpClk( unsigned long ulBase,
