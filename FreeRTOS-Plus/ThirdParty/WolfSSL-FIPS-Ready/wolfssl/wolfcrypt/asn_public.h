...
/* DER buffer */
    ...
    typedef int (pem_password_cb)( char * passwd,
                                   int sz,
                                   int rw,
                                   void * userdata );
 ...
 */
        ...
        WOLFSSL_API int wc_MakeCert_ex( Cert * cert,
                                        byte * derBuffer,
                                        word32 derSz,
                                        int keyType,
                                        void * key,
        ...
        WOLFSSL_API int wc_MakeCert( Cert *,
                                     ...
                                     WC_RNG * );
        #ifdef WOLFSSL_CERT_REQ
            WOLFSSL_API int wc_MakeCertReq_ex( Cert *,
                                               byte * derBuffer,
                                               word32 derSz,
                                               int,
                                               void * );
        ...
        WOLFSSL_API int wc_SignCert_ex( int requestSz,
                                        int sType,
                                        byte * buffer,
                                        word32 buffSz,
                                        int keyType,
        ...
        WOLFSSL_API int wc_SetDatesBuffer( Cert *,
        ...
        #ifndef NO_ASN_TIME
            WOLFSSL_API int wc_GetCertDates( Cert * cert,
                                             struct tm * before,
                                             struct tm * after );
        #endif

        #ifdef WOLFSSL_CERT_EXT
            WOLFSSL_API int wc_SetAuthKeyIdFromPublicKey_ex( Cert * cert,
                                                             int keyType,
                                                             void * key );
            ...
            WOLFSSL_API int wc_SetAuthKeyId( Cert * cert,
                                             const char * file );
            WOLFSSL_API int wc_SetSubjectKeyIdFromPublicKey_ex( Cert * cert,
                                                                int keyType,
                                                                void * key );
 ...
 */
            WOLFSSL_API int wc_SetExtKeyUsage( Cert * cert,
                                               const char * value );
 ...
 */
                WOLFSSL_API int wc_SetExtKeyUsageOID( Cert * cert,
                                                      const char * oid,
                                                      word32 sz,
                                                      byte idx,
                                                      void * heap );
    ...
    WOLFSSL_API int wc_GetDateInfo( const byte * certDate,
                                    int certDateSz,
                                    const byte ** date,
                                    byte * format,
                                    int * length );
    #ifndef NO_ASN_TIME
        WOLFSSL_API int wc_GetDateAsCalendarTime( const byte * date,
                                                  int length,
                                                  byte format,
                                                  struct tm * time );
    #endif
        ...
        WOLFSSL_API int wc_PemGetHeaderFooter( int type,
                                               const char ** header,
                                               const char ** footer );

    #endif

    WOLFSSL_API int wc_AllocDer( DerBuffer ** pDer,
                                 word32 length,
                                 int type,
                                 void * heap );
    WOLFSSL_API void wc_FreeDer( DerBuffer ** pDer );
        ...
        WOLFSSL_API int wc_PemToDer( const unsigned char * buff,
                                     long longSz,
                                     int type,
                                     DerBuffer ** pDer,
                                     void * heap,
        ...
        WOLFSSL_API int wc_KeyPemToDer( const unsigned char *,
                                        int,
                                        unsigned char *,
                                        int,
                                        const char * );
        WOLFSSL_API int wc_CertPemToDer( const unsigned char *,
                                         int,
                                         unsigned char *,
                                         int,
                                         int );
        ...
        WOLFSSL_API int wc_DerToPemEx( const byte * der,
                                       ...
                                       byte * cipherIno,
                                       int type );
    #endif /* ifdef WOLFSSL_DER_TO_PEM */

    #ifndef NO_RSA
        #if !defined( HAVE_USER_RSA )
            WOLFSSL_API int wc_RsaPublicKeyDecode_ex( const byte * input,
                                                      word32 * inOutIdx,
                                                      word32 inSz,
                                                      const byte ** n,
                                                      word32 * nSz,
                                                      ...
                                                      word32 * eSz );
        #endif
        WOLFSSL_API int wc_RsaPublicKeyDerSize( RsaKey * key,
                                                int with_header );
    #endif /* ifndef NO_RSA */
        ...
        WOLFSSL_API int wc_EccKeyToDer( ecc_key *,
                                        byte * output,
                                        word32 inLen );
        WOLFSSL_API int wc_EccPrivateKeyToDer( ecc_key * key,
                                               byte * output,
                                               word32 inLen );
        WOLFSSL_API int wc_EccPrivateKeyToPKCS8( ecc_key * key,
                                                 byte * output,
                                                 word32 * outLen );
...
/* public key helper */
        ...
        WOLFSSL_API int wc_EccPublicKeyToDer( ecc_key *,
                                              ...
                                              word32 inLen,
                                              int with_AlgCurve );
        WOLFSSL_API int wc_EccPublicKeyDerSize( ecc_key *,
                                                int with_AlgCurve );
    #endif /* ifdef HAVE_ECC */

    #ifdef HAVE_ED25519
        /* private key helpers */
        WOLFSSL_API int wc_Ed25519PrivateKeyDecode( const byte *,
                                                    word32 *,
                                                    ed25519_key *,
                                                    word32 );
        WOLFSSL_API int wc_Ed25519KeyToDer( ed25519_key * key,
                                            byte * output,
                                            word32 inLen );
        WOLFSSL_API int wc_Ed25519PrivateKeyToDer( ed25519_key * key,
                                                   byte * output,
                                                   word32 inLen );
...
/* public key helper */
        WOLFSSL_API int wc_Ed25519PublicKeyDecode( const byte *,
            ...
            WOLFSSL_API int wc_Ed25519PublicKeyToDer( ed25519_key *,
                                                      byte * output,
                                                      word32 inLen,
                                                      int with_AlgCurve );
        #endif
    ...
    #ifdef HAVE_ED448
        /* private key helpers */
        WOLFSSL_API int wc_Ed448PrivateKeyDecode( const byte *,
                                                  word32 *,
                                                  ed448_key *,
                                                  word32 );
        WOLFSSL_API int wc_Ed448KeyToDer( ed448_key * key,
                                          byte * output,
                                          word32 inLen );
        WOLFSSL_API int wc_Ed448PrivateKeyToDer( ed448_key * key,
                                                 byte * output,
                                                 word32 inLen );
...
/* public key helper */
        WOLFSSL_API int wc_Ed448PublicKeyDecode( const byte *,
                                                 ...
                                                 word32 );
        #if ( defined( WOLFSSL_CERT_GEN ) || defined( WOLFSSL_KEY_GEN ) )
            WOLFSSL_API int wc_Ed448PublicKeyToDer( ed448_key *,
                                                    byte * output,
                                                    word32 inLen,
                                                    int with_AlgCurve );
        #endif
...
/* DER encode signature */
    ...
    WOLFSSL_API int wc_GetPkcs8TraditionalOffset( byte * input,
                                                  word32 * inOutIdx,
                                                  word32 sz );
    WOLFSSL_API int wc_CreatePKCS8Key( byte * out,
                                       word32 * outSz,
                                       byte * key,
                                       word32 keySz,
                                       int algoID,
 ...
 */
        WOLFSSL_API int wc_GetTime( void * timePtr,
                                    word32 timeSize );
    #endif
        ...
        WOLFSSL_API int wc_ParseCertPIV( wc_CertPIV * cert,
                                         const byte * buf,
                                         word32 totalSz );
