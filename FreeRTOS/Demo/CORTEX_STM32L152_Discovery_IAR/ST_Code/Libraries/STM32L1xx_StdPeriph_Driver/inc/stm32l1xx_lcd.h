 ...
 */
    ...
    #define IS_LCD_PRESCALER( PRESCALER )         \
    ( ( ( PRESCALER ) == LCD_Prescaler_1 ) ||     \
 ...
 */
    ...
    #define IS_LCD_PULSE_ON_DURATION( DURATION )   \
 ...
 */
    ...
    #define IS_LCD_BLINK_MODE( MODE )              \
    ( ( ( MODE ) == LCD_BlinkMode_Off ) ||         \
 ...
 */
    ...
    #define IS_LCD_BLINK_FREQUENCY( FREQUENCY )         \
    ( ( ( FREQUENCY ) == LCD_BlinkFrequency_Div8 ) ||   \
 ...
 */
    ...
    #define IS_LCD_GET_FLAG( FLAG )                                   \
    ( ( ( FLAG ) == LCD_FLAG_ENS ) || ( ( FLAG ) == LCD_FLAG_SOF ) || \
...
/* Initialization and Configuration functions *********************************/
    ...
    void LCD_BlinkConfig( uint32_t LCD_BlinkMode,
                          uint32_t LCD_BlinkFrequency );
    void LCD_ContrastConfig( uint32_t LCD_Contrast );

/* LCD RAM memory write functions *********************************************/
    void LCD_Write( uint32_t LCD_RAMRegister,
                    uint32_t LCD_Data );
    void LCD_UpdateDisplayRequest( void );

/* Interrupts and flags management functions **********************************/
    void LCD_ITConfig( uint32_t LCD_IT,
