 ...
 */
        static int Tls13_HKDF_Extract( byte * prk,
                                       const byte * salt,
                                       int saltLen,
                                       byte * ikm,
                                       int ikmLen,
 ...
 * returns 0 on success, otherwise failure.
 */
        static int HKDF_Expand_Label( byte * okm,
                                      word32 okmLen,
                                      const byte * prk,
                                      word32 prkLen,
                                      const byte * protocol,
 ...
 * returns 0 on success, otherwise failure.
 */
        static int DeriveKeyMsg( WOLFSSL * ssl,
                                 byte * output,
                                 int outputLen,
                                 const byte * secret,
                                 const byte * label,
                                 ...
                                 int hashAlgo )
        {
            ...
            switch( hashAlgo )
            {
                    ...
                    case sha256_mac:
                        ...
                        digestAlg = WC_SHA256;
                        break;
                #endif /* ifndef NO_WOLFSSL_SHA256 */
                #ifdef WOLFSSL_SHA384
                    case sha384_mac:
                    ...
                    case sha512_mac:
                        ...
                        digestAlg = WC_SHA512;
                        break;
                #endif /* ifdef WOLFSSL_TLS13_SHA512 */
                default:
                    digestAlg = -1;
                    break;
            }
 ...
 * returns 0 on success, otherwise failure.
 */
        static int DeriveKey( WOLFSSL * ssl,
                              byte * output,
                              int outputLen,
                              const byte * secret,
                              const byte * label,
 ...
 * returns 0 on success, otherwise failure.
 */
            static int DeriveBinderKey( WOLFSSL * ssl,
                                        byte * key )
            {
 ...
 * returns 0 on success, otherwise failure.
 */
            static int DeriveBinderKeyResume( WOLFSSL * ssl,
                                              byte * key )
            {
 ...
 * returns 0 on success, otherwise failure.
 */
            static int DeriveEarlyTrafficSecret( WOLFSSL * ssl,
                                                 byte * key )
            {
                int ret;
 ...
 * returns 0 on success, otherwise failure.
 */
                static int DeriveEarlyExporterSecret( WOLFSSL * ssl,
                                                      byte * key )
                {
                    int ret;
            ...
            #endif /* ifdef TLS13_SUPPORTS_EXPORTERS */
 ...
 * returns 0 on success, otherwise failure.
 */
        static int DeriveClientHandshakeSecret( WOLFSSL * ssl,
                                                byte * key )
        {
            int ret;
 ...
 * returns 0 on success, otherwise failure.
 */
        static int DeriveServerHandshakeSecret( WOLFSSL * ssl,
                                                byte * key )
        {
            int ret;
 ...
 * returns 0 on success, otherwise failure.
 */
        static int DeriveClientTrafficSecret( WOLFSSL * ssl,
                                              byte * key )
        {
            int ret;
 ...
 * returns 0 on success, otherwise failure.
 */
        static int DeriveServerTrafficSecret( WOLFSSL * ssl,
                                              byte * key )
        {
            int ret;
 ...
 * returns 0 on success, otherwise failure.
 */
            static int DeriveExporterSecret( WOLFSSL * ssl,
                                             byte * key )
            {
                int ret;
 ...
 * returns 0 on success, otherwise failure.
 */
            int DeriveResumptionSecret( WOLFSSL * ssl,
                                        byte * key )
            {
 ...
 * returns 0 on success, otherwise failure.
 */
        static int DeriveFinishedSecret( WOLFSSL * ssl,
                                         byte * key,
                                         byte * secret )
        {
 ...
 * returns 0 on success, otherwise failure.
 */
        static int DeriveTrafficSecret( WOLFSSL * ssl,
                                        byte * secret )
        {
 ...
 * returns 0 on success, otherwise failure.
 */
            int DeriveResumptionPSK( WOLFSSL * ssl,
                                     byte * nonce,
                                     byte nonceLen,
                                     byte * secret )
            {
 ...
 */
        static int BuildTls13HandshakeHmac( WOLFSSL * ssl,
                                            byte * key,
                                            byte * hash,
                                            word32 * pHashSz )
        {
 ...
 * returns 0 on success, otherwise failure.
 */
        int DeriveTls13Keys( WOLFSSL * ssl,
                             int secret,
                             int side,
                             int store )
        {
 ...
 */
                ...
                #endif /* if defined( MICROCHIP_MPLAB_HARMONY ) */
 ...
 */
        static int GetHandshakeHeader( WOLFSSL * ssl,
                                       const byte * input,
                                       word32 * inOutIdx,
                                       byte * type,
                                       word32 * size,
 ...
 * ssl     The SSL/TLS object.
 */
        static void AddTls13RecordHeader( byte * output,
                                          word32 length,
                                          byte type,
                                          WOLFSSL * ssl )
        {
 ...
 */
        static void AddTls13HandShakeHeader( byte * output,
                                             word32 length,
                                             word32 fragOffset,
                                             word32 fragLength,
                                             byte type,
 ...
 * ssl         The SSL/TLS object. (DTLS)
 */
        static void AddTls13Headers( byte * output,
                                     word32 length,
                                     byte type,
                                     WOLFSSL * ssl )
        {
 ...
 * ssl         The SSL/TLS object. (DTLS)
 */
            static void AddTls13FragHeaders( byte * output,
                                             word32 fragSz,
                                             word32 fragOffset,
                                             word32 length,
                                             byte type,
 ...
 */
        static WC_INLINE void WriteSEQTls13( WOLFSSL * ssl,
                                             int verifyOrder,
                                             byte * out )
        {
            word32 seq[ 2 ] = { 0, 0 };
 ...
 */
        static WC_INLINE void BuildTls13Nonce( WOLFSSL * ssl,
                                               byte * nonce,
                                               const byte * iv,
                                               int order )
        {
 ...
 * returns 0 on success, otherwise failure.
 */
            static int ChaCha20Poly1305_Encrypt( WOLFSSL * ssl,
                                                 byte * output,
                                                 const byte * input,
                                                 word16 sz,
                                                 byte * nonce,
        ...
        #endif /* if defined( HAVE_CHACHA ) && defined( HAVE_POLY1305 ) */
 ...
 * returns 0 on success, otherwise failure.
 */
            static int Tls13IntegrityOnly_Encrypt( WOLFSSL * ssl,
                                                   byte * output,
                                                   const byte * input,
                                                   word16 sz,
                                                   const byte * nonce,
 ...
 * returns 0 on success, otherwise failure.
 */
        static int EncryptTls13( WOLFSSL * ssl,
                                 byte * output,
                                 const byte * input,
                                 word16 sz,
                                 const byte * aad,
                ...
                case CIPHER_STATE_DO:
                   {
                       switch( ssl->specs.bulk_cipher_algorithm )
                       {
                               ...
                               case wolfssl_aes_gcm:
                                   ...
                                   #endif /* if ( ( defined( HAVE_FIPS ) || defined( HAVE_SELFTEST ) ) && ( !defined( HAVE_FIPS_VERSION ) || ( HAVE_FIPS_VERSION < 2 ) ) ) */
                                   break;
                           #endif /* ifdef BUILD_AESGCM */
 ...
 * returns 0 on success, otherwise failure.
 */
            static int ChaCha20Poly1305_Decrypt( WOLFSSL * ssl,
                                                 byte * output,
                                                 const byte * input,
                                                 word16 sz,
                                                 byte * nonce,
 ...
 * returns 0 on success, otherwise failure.
 */
            static int Tls13IntegrityOnly_Decrypt( WOLFSSL * ssl,
                                                   byte * output,
                                                   const byte * input,
                                                   word16 sz,
                                                   const byte * nonce,
...
/* Persistable BuildTls13Message arguments */
        ...
        static void FreeBuildMsg13Args( WOLFSSL * ssl,
                                        void * pArgs )
        {
 ...
 */
            static int FindSuiteSSL( WOLFSSL * ssl,
                                     byte * suite )
            {
                word16 i;
 ...
 * returns 0 on success, otherwise failure.
 */
            static int CreateCookie( WOLFSSL * ssl,
                                     byte * hash,
                                     byte hashSz )
            {
                int ret;
        ...
        #endif /* if defined( WOLFSSL_SEND_HRR_COOKIE ) && !defined( NO_WOLFSSL_SERVER ) */
 ...
 */
                static int SetupPskKey( WOLFSSL * ssl,
                                        PreSharedKey * psk )
                {
                    int ret;
                    byte suite[ 2 ];
 ...
 */
                static int WritePSKBinders( WOLFSSL * ssl,
                                            byte * output,
                                            word32 idx )
                {
                    int ret;
 ...
 * returns 0 on success and otherwise failure.
 */
            int DoTls13ServerHello( WOLFSSL * ssl,
                                    const byte * input,
                                    word32 * inOutIdx,
                                    word32 helloSz,
                                    byte * extMsgType )
            {
                ...
                *inOutIdx = i;
                ...
                #else  /* ifdef WOLFSSL_TLS13_MIDDLEBOX_COMPAT */
 ...
 * returns 0 on success and otherwise failure.
 */
            static int DoTls13EncryptedExtensions( WOLFSSL * ssl,
                                                   const byte * input,
                                                   word32 * inOutIdx,
                                                   word32 totalSz )
            {
 ...
 * returns 0 on success and otherwise failure.
 */
                static int DoTls13CertificateRequest( WOLFSSL * ssl,
                                                      const byte * input,
                                                      word32 * inOutIdx,
                                                      word32 size )
                {
 ...
 */
                static void RefineSuites( WOLFSSL * ssl,
                                          Suites * peerSuites )
                {
 ...
 * returns 0 on success and otherwise failure.
 */
                static int DoPreSharedKeys( WOLFSSL * ssl,
                                            const byte * input,
                                            word32 helloSz,
                                            int * usingPSK )
                {
 ...
 */
                static int CheckCookie( WOLFSSL * ssl,
                                        byte * cookie,
                                        byte cookieSz )
                {
                    int ret;
...
/* PV | Random | Session Id | CipherSuite | Compression | Ext Len */
                #define HRR_BODY_SZ              \
    ( VERSION_SZ + RAN_LEN + ENUM_LEN + ID_LEN + \
 ...
 * returns 0 on success, otherwise failure.
 */
                static int RestartHandshakeHashWithCookie( WOLFSSL * ssl,
                                                           Cookie * cookie )
                {
                    byte header[ HANDSHAKE_HEADER_SZ ] = { 0 };
            ...
            #endif /* if defined( WOLFSSL_SEND_HRR_COOKIE ) */
 ...
 * returns 0 on success and otherwise failure.
 */
            static int DoTls13SupportedVersions( WOLFSSL * ssl,
                                                 const byte * input,
                                                 word32 i,
                                                 word32 helloSz,
                                                 int * wantDowngrade )
 ...
 * returns 0 on success and otherwise failure.
 */
            int DoTls13ClientHello( WOLFSSL * ssl,
                                    const byte * input,
                                    word32 * inOutIdx,
                                    word32 helloSz )
            {
                ...
                *inOutIdx = i;
                ...
                #endif /* if ( defined( HAVE_SESSION_TICKET ) || !defined( NO_PSK ) ) && defined( HAVE_TLS_EXTENSIONS ) */
                {
                    #ifdef WOLFSSL_EARLY_DATA
                        ssl->earlyData = no_early_data;
                    #endif
 ...
 * returns 0 on success, otherwise failure.
 */
                static int SendTls13CertificateRequest( WOLFSSL * ssl,
                                                        byte * reqCtx,
                                                        int reqCtxLen )
                {
                    byte * output;
 ...
 */
                static WC_INLINE void EncodeSigAlg( byte hashAlgo,
                                                    byte hsType,
                                                    byte * output )
                {
                    switch( hsType )
 ...
 */
                static WC_INLINE int DecodeTls13SigAlg( byte * input,
                                                        byte * hashAlgo,
                                                        byte * hsType )
                {
                    int ret = 0;
 ...
 */
                static WC_INLINE int GetMsgHash( WOLFSSL * ssl,
                                                 byte * hash )
                {
                    int ret = 0;
...
/* Maximum length of the signature data. */
                #define MAX_SIG_DATA_SZ \
    ( SIGNING_DATA_PREFIX_SZ +          \
      CERT_VFY_LABEL_SZ +               \
      WC_MAX_DIGEST_SIZE )
 ...
 */
                static int CreateSigData( WOLFSSL * ssl,
                                          byte * sigData,
                                          word16 * sigDataSz,
                                          int check )
                {
 ...
 */
                    static int CreateRSAEncodedSig( byte * sig,
                                                    byte * sigData,
                                                    int sigDataSz,
                                                    int sigAlgo,
                                                    int hashAlgo )
 ...
 * returns the length of the encoded signature or negative on error.
 */
                    static int CreateECCEncodedSig( byte * sigData,
                                                    int sigDataSz,
                                                    int hashAlgo )
                    {
                        Digest digest;
 ...
 * returns 0 on success, otherwise failure.
 */
                    static int CheckRSASignature( WOLFSSL * ssl,
                                                  int sigAlgo,
                                                  int hashAlgo,
                                                  byte * decSig,
                                                  word32 decSigSz )
 ...
 * in the list.
 */
            static word32 NextCert( byte * data,
                                    word32 length,
                                    word32 * idx )
            {
                word32 len;
 ...
 */
            static word32 AddCertExt( WOLFSSL * ssl,
                                      byte * cert,
                                      word32 len,
                                      word16 extSz,
                                      word32 idx,
 ...
 */
            ...
            defined( HAVE_ED448 )
                ...
                static void FreeScv13Args( WOLFSSL * ssl,
                                           void * pArgs )
                {
...
exit_scv:
            ...
            #endif /* if !defined( NO_RSA ) || defined( HAVE_ECC ) || defined( HAVE_ED25519 ) || defined( HAVE_ED448 ) */
 ...
 * returns 0 on success and otherwise failure.
 */
            static int DoTls13Certificate( WOLFSSL * ssl,
                                           byte * input,
                                           word32 * inOutIdx,
                                           word32 totalSz )
            {
            ...
            defined( HAVE_ED448 )
                ...
                static void FreeDcv13Args( WOLFSSL * ssl,
                                           void * pArgs )
                {
 ...
 * returns 0 on success and otherwise failure.
 */
                static int DoTls13CertificateVerify( WOLFSSL * ssl,
                                                     byte * input,
                                                     word32 * inOutIdx,
                                                     word32 totalSz )
                {
 ...
 * returns 0 on success and otherwise failure.
 */
        int DoTls13Finished( WOLFSSL * ssl,
                             const byte * input,
                             word32 * inOutIdx,
                             word32 size,
                             word32 totalSz,
 ...
 * returns 0 on success and otherwise failure.
 */
        static int DoTls13KeyUpdate( WOLFSSL * ssl,
                                     const byte * input,
                                     word32 * inOutIdx,
                                     word32 totalSz )
        {
 ...
 * returns 0 on success and otherwise failure.
 */
                static int DoTls13EndOfEarlyData( WOLFSSL * ssl,
                                                  const byte * input,
                                                  word32 * inOutIdx,
                                                  word32 size )
                {
 ...
 * returns 0 on success, otherwise failure.
 */
            static int DoTls13NewSessionTicket( WOLFSSL * ssl,
                                                const byte * input,
                                                word32 * inOutIdx,
                                                word32 size )
            {
 ...
 */
                ...
                #endif /* ifdef WOLFSSL_TLS13_TICKET_BEFORE_FINISHED */
 ...
 * returns 0 on success, otherwise failure.
 */
        static int SanityCheckTls13MsgReceived( WOLFSSL * ssl,
                                                byte type )
        {
                ...
                case certificate:
                    ...
                    break;
                        ...
                        case certificate_request:
                            ...
                            #endif /* ifndef WOLFSSL_POST_HANDSHAKE_AUTH */
                            #if defined( HAVE_SESSION_TICKET ) || !defined( NO_PSK )
                                /* Server's authenticating with PSK must not send this. */
                                if( ( ssl->options.serverState ==
                                      SERVER_ENCRYPTED_EXTENSIONS_COMPLETE ) &&
 ...
 * returns 0 on success and otherwise failure.
 */
        int DoTls13HandShakeMsgType( WOLFSSL * ssl,
                                     byte * input,
                                     word32 * inOutIdx,
                                     byte type,
                                     word32 size,
                                     word32 totalSz )
        {
            ...
            switch( type )
            {
                    ...
                    case server_hello:
                        ...
                        #endif /* if !defined( WOLFSSL_NO_CLIENT_AUTH ) && ( ( defined( HAVE_ED25519 ) && !defined( NO_ED25519_CLIENT_AUTH ) ) || ( defined( HAVE_ED448 ) && !defined( NO_ED448_CLIENT_AUTH ) ) ) */
                        break;
                ...
                switch( ssl->options.connectState )
                {
                    ...
                    case HELLO_AGAIN:
                            ...
                            SERVER_HELLO_RETRY_REQUEST_COMPLETE )
                        {
                            ...
                            #endif /* if defined( WOLFSSL_TLS13_MIDDLEBOX_COMPAT ) */
                    ...
                    case FIRST_REPLY_THIRD:
                        ...
                        #endif /* if !defined( NO_CERTS ) && ( !defined( NO_RSA ) || defined( HAVE_ECC ) || defined( HAVE_ED25519 ) || defined( HAVE_ED448 ) ) */
 ...
 */
        ...
        #endif /* if !defined( WOLFSSL_NO_SERVER_GROUPS_EXT ) */
            ...
            int wolfSSL_accept_TLSv13( WOLFSSL * ssl )
            {
                ...
                switch( ssl->options.acceptState )
                {
                    ...
                    case TLS13_ACCEPT_HELLO_RETRY_REQUEST_DONE:
                        ...
                        #endif /* ifdef WOLFSSL_TLS13_MIDDLEBOX_COMPAT */
 ...
 */
        ...
        #ifdef HAVE_SECRET_CALLBACK
            int wolfSSL_set_tls13_secret_cb( WOLFSSL * ssl,
                                             Tls13SecretCb cb,
                                             void * ctx )
            {
        ...
        #endif /* ifdef HAVE_SECRET_CALLBACK */
