...
def check_uncrustify(changed_files, uncrustify=False):
    ...
    for changed_file in changed_files:
        if subprocess.call(
            (
                "uncrustify --check -q -c FreeRTOS-Plus/Source/FreeRTOS-Plus-TCP/uncrustify.cfg " +
                changed_file
            ), shell=True
        ):
...
def run_uncrustify(changed_files):
    ...
    for file in changed_files:
        format_call = ( 'uncrustify -q -c FreeRTOS-Plus/Source/FreeRTOS-Plus-TCP/uncrustify.cfg -f {} -o {}'.format(file, file) )
