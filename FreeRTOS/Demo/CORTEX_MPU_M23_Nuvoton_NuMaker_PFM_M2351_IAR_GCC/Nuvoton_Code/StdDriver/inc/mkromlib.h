 ...
 */
    typedef void (* ISPCallback)( uint32_t * pu32Buf,
                                  uint32_t u32Data );
 ...
 */
    int32_t BL_FlashWrite( uint32_t u32NSAddr,
                           uint32_t u32Data );
 ...
 */
    uint32_t BL_FlashChecksum( uint32_t u32NSAddr,
 ...
 */
    int32_t BL_TrgKPROMCompare( uint32_t key0,
                                uint32_t key1,
                                uint32_t key2 );
 ...
 */
    int32_t XECC_IsPrivateKeyValid( XCRPT_T * xcrpt,
 ...
 */
    int32_t XECC_GeneratePublicKey( XCRPT_T * xcrpt,
                                    E_ECC_CURVE ecc_curve,
                                    char * private_k,
                                    char public_k1[],
                                    char public_k2[] );
 ...
 */
    int32_t XECC_GenerateSignature( XCRPT_T * xcrpt,
                                    E_ECC_CURVE ecc_curve,
                                    char * message,
                                    char * d,
                                    char * k,
 ...
 */
    int32_t XECC_VerifySignature( XCRPT_T * xcrpt,
                                  E_ECC_CURVE ecc_curve,
                                  char * message,
                                  char * public_k1,
                                  char * public_k2,
 ...
 */
    int32_t XECC_GenerateSecretZ( XCRPT_T * xcrpt,
                                  E_ECC_CURVE ecc_curve,
                                  char * private_k,
                                  char public_k1[],
                                  char public_k2[],
 ...
 */
    void XECC_Reg2Hex( int32_t count,
 ...
 */
    int32_t XECC_GetIDECCSignature( uint32_t * R,
                                    uint32_t * S );
 ...
 */
    void XTDES_Start( XCRPT_T * xcrpt,
                      int32_t u32Channel,
                      uint32_t u32DMAMode );
 ...
 */
    void XTDES_SetKey( XCRPT_T * xcrpt,
                       uint32_t u32Channel,
 ...
 */
    void XTDES_SetInitVect( XCRPT_T * xcrpt,
                            uint32_t u32Channel,
                            uint32_t u32IVH,
                            uint32_t u32IVL );
 ...
 */
    void XTDES_SetDMATransfer( XCRPT_T * xcrpt,
                               uint32_t u32Channel,
                               uint32_t u32SrcAddr,
                               uint32_t u32DstAddr,
 ...
 */
    void XSHA_SetDMATransfer( XCRPT_T * xcrpt,
                              uint32_t u32SrcAddr,
                              uint32_t u32TransCnt );
 ...
 */
    void XAES_SetKey( XCRPT_T * xcrpt,
                      uint32_t u32Channel,
                      uint32_t au32Keys[],
                      uint32_t u32KeySize );
 ...
 */
    void XAES_SetInitVect( XCRPT_T * xcrpt,
                           uint32_t u32Channel,
                           uint32_t au32IV[] );
 ...
 */
    void XAES_SetDMATransfer( XCRPT_T * xcrpt,
                              uint32_t u32Channel,
                              uint32_t u32SrcAddr,
                              uint32_t u32DstAddr,
                              uint32_t u32TransCnt );
 ...
 */
    int32_t XTRNG_RandomInit( XTRNG_T * rng,
                              uint32_t opt );
 ...
 */
    int32_t XTRNG_Random( XTRNG_T * rng,
                          uint8_t * p,
                          uint32_t size );
 ...
 * @details    This API will return ECC R, S digital signature of chip ID, include PDID, UID0~2 and UCID0~3.
 */
    int32_t BL_GetIDECCSignature( uint32_t * R,
                                  uint32_t * S );
 ...
 */
    int32_t BL_RandomInit( BL_RNG_T * rng,
                           uint32_t opt );
 ...
 * @details    This API is used to generate random number.
 */
    int32_t BL_Random( BL_RNG_T * rng,
                       uint8_t * p,
                       uint32_t size );
 ...
 */
    int32_t BL_SecureISPInit( ISP_INFO_T * pISPInfo,
 ...
 */
    int32_t BL_ProcessUSBDInterrupt( uint32_t * pfnEPTable,
                                     uint32_t * pInfo,
                                     uint32_t * pUSBDInfo );
 ...
 */
    int32_t BL_GetVendorData( uint32_t * pInfo,
                              uint32_t * pu32Data,
                              uint32_t * pu32Buf );
 ...
 */
    int32_t BL_ReturnVendorData( uint32_t * pu32Data,
                                 uint32_t u32Len,
                                 uint32_t * pu32Buf );
 ...
 */
    int32_t Cmd_GenRspPacket( CMD_PACKET_T * pCMD,
                              ISP_INFO_T * pISPInfo );
 ...
 */
    int32_t Cmd_ParseReqPacket( CMD_PACKET_T * pCMD,
                                ISP_INFO_T * pISPInfo );
 ...
 */
    int32_t BL_USBDOpen( const S_USBD_INFO_T * param,
 ...
 */
    int32_t BL_USBDInstallEPHandler( uint32_t ep,
                                     void * pfnEPHandler,
                                     uint32_t * pfnEPTable );
