...
/* TODO: Consider linked list with mutex */
    ...
    void wc_CryptoCb_UnRegisterDevice( int devId )
    {
    ...
    #ifndef NO_RSA
        int wc_CryptoCb_Rsa( const byte * in,
                             word32 inLen,
                             byte * out,
                             word32 * outLen,
                             int type,
                             ...
                             WC_RNG * rng )
        {
            ...
            int wc_CryptoCb_MakeRsaKey( RsaKey * key,
                                        int size,
                                        long e,
                                        WC_RNG * rng )
            {
    ...
    #ifdef HAVE_ECC
        int wc_CryptoCb_MakeEccKey( WC_RNG * rng,
                                    int keySize,
                                    ecc_key * key,
                                    int curveId )
        {
        ...
        int wc_CryptoCb_Ecdh( ecc_key * private_key,
                              ecc_key * public_key,
                              byte * out,
                              word32 * outlen )
        {
        ...
        int wc_CryptoCb_EccSign( const byte * in,
                                 word32 inlen,
                                 byte * out,
                                 word32 * outlen,
                                 WC_RNG * rng,
        ...
        int wc_CryptoCb_EccVerify( const byte * sig,
                                   word32 siglen,
                                   const byte * hash,
                                   word32 hashlen,
                                   int * res,
                                   ecc_key * key )
        {
    ...
    #ifndef NO_AES
        #ifdef HAVE_AESGCM
            int wc_CryptoCb_AesGcmEncrypt( Aes * aes,
                                           byte * out,
                                           const byte * in,
                                           word32 sz,
                                           const byte * iv,
            ...
            int wc_CryptoCb_AesGcmDecrypt( Aes * aes,
                                           byte * out,
                                           const byte * in,
                                           word32 sz,
                                           const byte * iv,
        ...
        #ifdef HAVE_AES_CBC
            int wc_CryptoCb_AesCbcEncrypt( Aes * aes,
                                           byte * out,
                                           const byte * in,
                                           word32 sz )
            {
            ...
            int wc_CryptoCb_AesCbcDecrypt( Aes * aes,
                                           byte * out,
                                           const byte * in,
                                           word32 sz )
            {
    ...
    #ifndef NO_DES3
        int wc_CryptoCb_Des3Encrypt( Des3 * des3,
                                     byte * out,
                                     const byte * in,
                                     word32 sz )
        {
        ...
        int wc_CryptoCb_Des3Decrypt( Des3 * des3,
                                     byte * out,
                                     const byte * in,
                                     word32 sz )
        {
    ...
    #ifndef NO_SHA
        int wc_CryptoCb_ShaHash( wc_Sha * sha,
                                 const byte * in,
                                 word32 inSz,
                                 byte * digest )
        {
    ...
    #ifndef NO_SHA256
        int wc_CryptoCb_Sha256Hash( wc_Sha256 * sha256,
                                    const byte * in,
                                    word32 inSz,
                                    byte * digest )
        {
    ...
    #ifndef NO_HMAC
        int wc_CryptoCb_Hmac( Hmac * hmac,
                              int macType,
                              const byte * in,
                              word32 inSz,
                              byte * digest )
    ...
    #ifndef WC_NO_RNG
        int wc_CryptoCb_RandomBlock( WC_RNG * rng,
                                     byte * out,
                                     word32 sz )
        {
            int ret = CRYPTOCB_UNAVAILABLE;
        ...
        int wc_CryptoCb_RandomSeed( OS_Seed * os,
                                    byte * seed,
                                    word32 sz )
        {
            int ret = CRYPTOCB_UNAVAILABLE;
