 ...
 */
    ...
    #endif /* ifdef WOLFSSL_FORCE_MALLOC_FAIL_TEST */
 ...
 */
        static int create_memory_buckets( byte * buffer,
                                          word32 bufSz,
                                          word32 buckSz,
                                          word32 buckNum,
                                          wc_Memory ** list )
 ...
 * returns the suggested size rounded down to the nearest bucket. */
        ...
        int FreeFixedIO( WOLFSSL_HEAP * heap,
                         wc_Memory ** io )
        {
        ...
        int SetFixedIO( WOLFSSL_HEAP * heap,
                        wc_Memory ** io )
        {
        ...
        #endif
        {
            ...
            void * wolfSSL_Realloc( void * ptr,
                                    ...
                                    void * heap,
                                    int type )
        #endif /* ifdef WOLFSSL_DEBUG_MEMORY */
        {
            void * res = 0;
            wc_Memory * pt = NULL;
            word32 prvSz;
...
/* Note: this code only works with GCC using -finstrument-functions. */
    void __attribute__( ( no_instrument_function ) ) __cyg_profile_func_enter( void * func,
                                                                               void * caller )
    {
    ...
    void __attribute__( ( no_instrument_function ) ) __cyg_profile_func_exit( void * func,
                                                                              void * caller )
    {
        register void * sp asm ( "sp" );
