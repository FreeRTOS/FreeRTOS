...
#define IS_TIM1_OCN_POLARITY( POLARITY )       \
    ( ( POLARITY == TIM1_OCNPolarity_High ) || \
...
#define IS_TIM1_AUTOMATIC_OUTPUT_STATE( STATE )   \
    ( ( STATE == TIM1_AutomaticOutput_Enable ) || \
...
#define IS_TIM1_OSSR_STATE( STATE )         \
    ( ( STATE == TIM1_OSSRState_Enable ) || \
...
#define IS_TIM1_DMA_BASE( BASE )        \
    ( ( BASE == TIM1_DMABase_CR1 ) ||   \
...
#define IS_TIM1_DMA_LENGTH( LENGTH )               \
    ( ( LENGTH == TIM1_DMABurstLength_1Byte ) ||   \
...
#define IS_TIM1_INTERNAL_TRIGGER_SELECTION( SELECTION ) \
    ( ( SELECTION == TIM1_TS_ITR0 ) ||                  \
      ( SELECTION == TIM1_TS_ITR1 ) ||                  \
      ( SELECTION == TIM1_TS_ITR2 ) ||                  \
      ( SELECTION == TIM1_TS_ITR3 ) )
...
#define IS_TIM1_OCPRELOAD_STATE( STATE )    \
    ( ( STATE == TIM1_OCPreload_Enable ) || \
...
#define IS_TIM1_OCFAST_STATE( STATE )    \
    ( ( STATE == TIM1_OCFast_Enable ) || \
...
#define IS_TIM1_MSM_STATE( STATE )                \
    ( ( STATE == TIM1_MasterSlaveMode_Enable ) || \
...
void TIM1_ITConfig( u16 TIM1_IT,
                    FunctionalState NewState );
void TIM1_DMAConfig( u16 TIM1_DMABase,
                     u16 TIM1_DMABurstLength );
void TIM1_DMACmd( u16 TIM1_DMASource,
                  FunctionalState Newstate );
void TIM1_InternalClockConfig( void );
void TIM1_ETRClockMode1Config( u16 TIM1_ExtTRGPrescaler,
                               u16 TIM1_ExtTRGPolarity,
                               u16 ExtTRGFilter );
void TIM1_ETRClockMode2Config( u16 TIM1_ExtTRGPrescaler,
                               u16 TIM1_ExtTRGPolarity,
                               u16 ExtTRGFilter );
...
void TIM1_EncoderInterfaceConfig( u16 TIM1_EncoderMode,
                                  u16 TIM1_IC1Polarity,
                                  u16 TIM1_IC2Polarity );
void TIM1_PrescalerConfig( u16 Prescaler,
                           u16 TIM1_PSCReloadMode );
...
void TIM1_CCxCmd( u16 TIM1_Channel,
                  FunctionalState Newstate );
void TIM1_CCxNCmd( u16 TIM1_Channel,
                   FunctionalState Newstate );
void TIM1_SelectOCxM( u16 TIM1_Channel,
                      u16 TIM1_OCMode );
