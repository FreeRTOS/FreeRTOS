                       ...
                       word32 helloSz, byte* extMsgType)
{
    ...
    if ((i - begin) < helloSz) {
        ...
        ret = TLSX_ParseVersion(ssl, (byte*)input + i, totalExtSz,
                                      ...
                                      word32* inOutIdx, word32 totalSz)
{
    ...
    if (i - begin + totalExtSz > totalSz)
        return BUFFER_ERROR;
    ret = TLSX_Parse(ssl, (byte*)(input + i), totalExtSz,
                                     ...
                                     word32* inOutIdx, word32 size)
{
    ...
    *inOutIdx += OPAQUE16_LEN;
    ...
    if (len == 0)
        return INVALID_PARAMETER;
    ret = TLSX_Parse(ssl, (byte*)(input + *inOutIdx), len,
                       ...
                       word32 helloSz)
{
    ...
    /* Parse extensions */
    ret = TLSX_Parse(ssl, (byte*)input + i, totalExtSz, client_hello, &clSuites);
    if (ret != 0 ) {
        return ret;
    }
