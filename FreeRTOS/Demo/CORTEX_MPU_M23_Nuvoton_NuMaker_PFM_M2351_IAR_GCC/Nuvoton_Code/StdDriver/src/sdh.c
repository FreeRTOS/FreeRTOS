...
uint32_t SDH_SDCommand( SDH_T * sdh,
                        uint32_t u32Cmd,
                        uint32_t u32Arg );
uint32_t SDH_SDCmdAndRsp( SDH_T * sdh,
                          uint32_t u32Cmd,
                          uint32_t u32Arg,
                          uint32_t u32TickCount );
uint32_t SDH_Swap32( uint32_t u32Val );
uint32_t SDH_SDCmdAndRsp2( SDH_T * sdh,
                           uint32_t u32Cmd,
                           uint32_t u32Arg,
                           uint32_t pu32R2ptr[] );
uint32_t SDH_SDCmdAndRspDataIn( SDH_T * sdh,
                                uint32_t u32Cmd,
                                uint32_t u32Arg );
void SDH_Set_clock( SDH_T * sdh,
                    uint32_t u32SDClockKhz );
uint32_t SDH_CardDetection( SDH_T * sdh );
uint32_t SDH_Init( SDH_T * sdh );
uint32_t SDH_SwitchToHighSpeed( SDH_T * sdh,
                                SDH_INFO_T * pSD );
