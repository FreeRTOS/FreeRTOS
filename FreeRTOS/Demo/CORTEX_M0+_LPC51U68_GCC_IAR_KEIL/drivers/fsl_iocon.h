 ...
 */
    ...
    #else  /* if defined( FSL_FEATURE_IOCON_FUNC_FIELD_WIDTH ) && ( FSL_FEATURE_IOCON_FUNC_FIELD_WIDTH == 4 ) */
        #define IOCON_FUNC0                0x0 /*!< Selects pin function 0 */
        #define IOCON_FUNC1                0x1 /*!< Selects pin function 1 */
        #define IOCON_FUNC2                0x2 /*!< Selects pin function 2 */
        #define IOCON_FUNC3                0x3 /*!< Selects pin function 3 */
    ...
    #endif /* if defined( FSL_FEATURE_IOCON_FUNC_FIELD_WIDTH ) && ( FSL_FEATURE_IOCON_FUNC_FIELD_WIDTH == 4 ) */
 ...
 */
    ...
    #endif /* if ( defined( FSL_FEATURE_IOCON_ONE_DIMENSION ) && ( FSL_FEATURE_IOCON_ONE_DIMENSION == 1 ) ) */
