 ...
 */
    static inline void EMC_Enable( EMC_Type * base,
                                   bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void EMC_EnableDynamicMemControl( EMC_Type * base,
                                                    bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void EMC_MirrorChipAddr( EMC_Type * base,
                                           bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void EMC_EnterSelfRefreshCommand( EMC_Type * base,
                                                    bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void EMC_EnterLowPowerMode( EMC_Type * base,
                                              bool enable )
    {
        if( enable )
        {
