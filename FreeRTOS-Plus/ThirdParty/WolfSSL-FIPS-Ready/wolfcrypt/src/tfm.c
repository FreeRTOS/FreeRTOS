 ...
 */
        ...
        extern "C" {
        #endif
        WOLFSSL_LOCAL int sp_ModExp_1024( mp_int * base,
                                          mp_int * exp,
                                          mp_int * mod,
                                          mp_int * res );
        WOLFSSL_LOCAL int sp_ModExp_1536( mp_int * base,
                                          mp_int * exp,
                                          mp_int * mod,
                                          mp_int * res );
        WOLFSSL_LOCAL int sp_ModExp_2048( mp_int * base,
                                          mp_int * exp,
                                          mp_int * mod,
                                          mp_int * res );
        WOLFSSL_LOCAL int sp_ModExp_3072( mp_int * base,
                                          mp_int * exp,
                                          mp_int * mod,
                                          mp_int * res );
        WOLFSSL_LOCAL int sp_ModExp_4096( mp_int * base,
                                          mp_int * exp,
                                          mp_int * mod,
                                          mp_int * res );
        #ifdef __cplusplus
        ...
        #endif
    #endif /* if defined( WOLFSSL_HAVE_SP_RSA ) || defined( WOLFSSL_HAVE_SP_DH ) */
...
/* Functions */
    ...
    static int fp_cmp_mag_ct( fp_int * a,
                              fp_int * b,
                              int len )
    {
        int i;
...
/* generic PxQ multiplier */
        ...
        WC_INLINE static int fp_mul_comba_mulx( fp_int * A,
                                                fp_int * B,
                                                fp_int * C )
    ...
    #endif /* if defined( HAVE_INTEL_MULX ) */

    int fp_mul_comba( fp_int * A,
                      fp_int * B,
                      fp_int * C )
    {
        int ret = 0;
...
/* c = a mod 2**d */
    ...
    static int fp_invmod_slow( fp_int * a,
                               fp_int * b,
                               fp_int * c )
    {
        #ifndef WOLFSSL_SMALL_STACK
...
/* modulus (b) must be greater than 2 and a prime */
    int fp_invmod_mont_ct( fp_int * a,
                           fp_int * b,
                           fp_int * c,
                           fp_digit mp )
    {
...
/* supports cache resistance */
            int fp_exptmod_nb( exptModNb_t * nb,
                               fp_int * G,
                               fp_int * X,
                               fp_int * P,
                               fp_int * Y )
 ...
 */
        static int _fp_exptmod_ct( fp_int * G,
                                   fp_int * X,
                                   int digits,
                                   fp_int * P,
                                   fp_int * Y )
 ...
 */
    static int _fp_exptmod_nct( fp_int * G,
                                fp_int * X,
                                fp_int * P,
                                fp_int * Y )
    {
 ...
 * Some restrictions... x must be positive and < b
 */
        static int _fp_exptmod_base_2( fp_int * X,
                                       int digits,
                                       fp_int * P,
                                       fp_int * Y )
        {
        ...
        #undef WINSIZE
    #else  /* ifdef TFM_TIMING_RESISTANT */
        #if DIGIT_BIT < 16
            #define WINSIZE    3
        #elif DIGIT_BIT < 32
            #define WINSIZE    4
 ...
 */
        ...
        #undef WINSIZE
    #endif /* ifdef TFM_TIMING_RESISTANT */


    int fp_exptmod( fp_int * G,
                    fp_int * X,
                    fp_int * P,
                    fp_int * Y )
    {
        ...
        if( X->sign == FP_NEG )
        {
                ...
                #endif
                return err;
            #else  /* ifndef POSITIVE_EXP_ONLY */
                return FP_VAL;
            #endif /* ifndef POSITIVE_EXP_ONLY */
        }
...
/* sets up the montgomery reduction */
    int fp_montgomery_setup( fp_int * a,
                             fp_digit * rho )
    {
        fp_digit x, b;
 ...
 */
    int fp_montgomery_calc_normalization( fp_int * a,
                                          fp_int * b )
    {
        int x, bits;
        ...
        static WC_INLINE void innermul8_mulx( fp_digit * c_mulx,
                                              fp_digit * cy_mulx,
                                              fp_digit * tmpm,
                                              fp_digit mu )
        {
...
/* computes x/R == x (mod N) via Montgomery Reduction */
        static int fp_montgomery_reduce_mulx( fp_int * a,
                                              fp_int * m,
                                              fp_digit mp,
                                              int ct )
        {
            ...
            #endif /* ifdef WOLFSSL_MONT_RED_NCT */
    ...
    #endif /* ifdef HAVE_INTEL_MULX */

/* computes x/R == x (mod N) via Montgomery Reduction */
    int fp_montgomery_reduce_ex( fp_int * a,
                                 fp_int * m,
                                 fp_digit mp,
                                 int ct )
    {
        ...
        #endif /* ifndef WOLFSSL_MONT_RED_CT */
    ...
    int fp_montgomery_reduce( fp_int * a,
                              fp_int * m,
                              fp_digit mp )
    {
    ...
    int fp_read_unsigned_bin( fp_int * a,
                              ...
                              int c )
    {
        ...
        #else  /* if ( defined( LITTLE_ENDIAN_ORDER ) || defined( BIG_ENDIAN_ORDER ) ) && defined( FP_32BIT ) */
            /* read the bytes in */
            for( ; c > 0; c-- )
            {
        ...
        #endif /* if ( defined( LITTLE_ENDIAN_ORDER ) || defined( BIG_ENDIAN_ORDER ) ) && defined( FP_32BIT ) */
        fp_clamp( a );

        return FP_OKAY;
    }

    int fp_to_unsigned_bin_at_pos( int x,
                                   fp_int * t,
                                   unsigned char * b )
    {
            ...
            return x;
        #else  /* if DIGIT_BIT == 64 || DIGIT_BIT == 32 */
            ...
            return x;
        #endif /* if DIGIT_BIT == 64 || DIGIT_BIT == 32 */
    }

    int fp_to_unsigned_bin( fp_int * a,
                            unsigned char * b )
    {
        int x;
    ...
    int fp_to_unsigned_bin_len( fp_int * a,
                                unsigned char * b,
                                int c )
    {
        #if DIGIT_BIT == 64 || DIGIT_BIT == 32
...
/* reverse an array, used for radix code */
    void fp_reverse( unsigned char * s,
                     int len )
    {
        int ix, iy;
        unsigned char t;
...
/* d = a * b (mod c) */
    #if defined( FREESCALE_LTC_TFM )
        int wolfcrypt_mp_mulmod( mp_int * a,
                                 mp_int * b,
                                 mp_int * c,
                                 mp_int * d )
    #else
...
/* hac 14.61, pp608 */
    #if defined( FREESCALE_LTC_TFM )
        int wolfcrypt_mp_invmod( mp_int * a,
                                 mp_int * b,
                                 mp_int * c )
    #else
...
/* hac 14.61, pp608 */
    int mp_invmod_mont_ct( mp_int * a,
                           mp_int * b,
                           mp_int * c,
                           mp_digit mp )
    {
 ...
 */
    #if defined( FREESCALE_LTC_TFM )
        int wolfcrypt_mp_exptmod( mp_int * G,
                                  mp_int * X,
                                  mp_int * P,
                                  mp_int * Y )
    #else
        int mp_exptmod( mp_int * G,
                        mp_int * X,
                        mp_int * P,
                        mp_int * Y )
    #endif
...
/* get the size for an unsigned equivalent */
    ...
    int mp_to_unsigned_bin_at_pos( int x,
                                   fp_int * t,
                                   unsigned char * b )
    {
...
/* store in unsigned [big endian] format */
    ...
    int mp_to_unsigned_bin_len( mp_int * a,
                                unsigned char * b,
                                int c )
    {
...
/* reads a unsigned char array, assumes the msb is stored first [big endian] */
                  ...
                  fp_int * b )
    {
        ...
        if( a != b )
        {
            ...
            #else  /* if defined( ALT_ECC_SIZE ) || defined( HAVE_WOLF_BIGINT ) */
                /* all dp's are same size, so do straight copy */
                b->used = a->used;
                b->sign = a->sign;
                XMEMCPY( b->dp, a->dp, FP_SIZE * sizeof( fp_digit ) );
            #endif /* if defined( ALT_ECC_SIZE ) || defined( HAVE_WOLF_BIGINT ) */
        }
    }

    void fp_init_copy( fp_int * a,
                       fp_int * b )
    {
        if( a != b )
        {
...
/* fast math wrappers */
    ...
    int mp_is_bit_set( mp_int * a,
                       mp_digit b )
    {
        return fp_is_bit_set( a, b );
    }

    int mp_set_bit( mp_int * a,
                    mp_digit b )
    {
...
/* Counts the number of lsbs which are zero before the first zero bit */
        ...
        static int s_is_power_of_two( fp_digit b,
                                      int * p )
        {
            int x;
...
/* c = a mod b, 0 <= c < b  */
    ...
    defined( WOLFSSL_KEY_GEN )
        ...
        static int fp_isprime_ex( fp_int * a,
                                  int t,
                                  int * result );
 ...
 * very much lower.
 */
        static int fp_prime_miller_rabin_ex( fp_int * a,
                                             fp_int * b,
                                             int * result,
                                             fp_int * n1,
                                             fp_int * y,
                                             fp_int * r )
        {
            ...
            *result = FP_NO;
            ...
            defined( WOLFSSL_HAVE_SP_DH )
                ...
                #endif
            #endif /* if ( defined( WOLFSSL_HAVE_SP_RSA ) && !defined( WOLFSSL_RSA_PUBLIC_ONLY ) ) || defined( WOLFSSL_HAVE_SP_DH ) */
            fp_exptmod( b, r, a, y );
        ...
        static int fp_prime_miller_rabin( fp_int * a,
                                          fp_int * b,
                                          int * result )
        {
            int err;
...
/* a few primes */
        ...
        int mp_prime_is_prime_ex( mp_int * a,
                                  int t,
                                  int * result,
                                  WC_RNG * rng )
        {
        ...
        static int fp_gcd( fp_int * a,
                           fp_int * b,
                           fp_int * c );
        static int fp_lcm( fp_int * a,
                           fp_int * b,
                           fp_int * c );
        static int fp_randprime( fp_int * N,
                                 int len,
                                 WC_RNG * rng,
                                 void * heap );
...
/* chars used in radix conversions */
        ...
        #if DIGIT_BIT == 64 || DIGIT_BIT == 32
            static int fp_read_radix_16( fp_int * a,
                                         const char * str )
            {
                int i, j, k, neg;
                char ch;
        ...
        static int fp_read_radix( fp_int * a,
                                  const char * str,
                                  int radix )
        {
            int y, neg;
...
/* fast math conversion */
        int mp_montgomery_reduce( fp_int * a,
                                  fp_int * m,
                                  fp_digit mp )
        {
        ...
        int mp_montgomery_reduce_ex( fp_int * a,
                                     fp_int * m,
                                     fp_digit mp,
                                     int ct )
        {
...
/* fast math conversion */
        int mp_montgomery_setup( fp_int * a,
                                 fp_digit * rho )
        {
