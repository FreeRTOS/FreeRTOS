...
/* try to set SIZEOF_LONG or SIZEOF_LONG_LONG if user didn't */
            ...
            ( defined( LP64 ) || defined( _LP64 ) ) ) )
                ...
                #define SIZEOF_LONG_LONG    8
            #endif
        #endif /* if !defined( SIZEOF_LONG_LONG ) && !defined( SIZEOF_LONG ) */
    #endif /* if defined( _MSC_VER ) || defined( HAVE_LIMITS_H ) */
        ...
        #define W64LIT( x )    x ## LL
        typedef unsigned long long   word64;
    #endif /* if defined( _MSC_VER ) || defined( __BCPLUSPLUS__ ) */
 ...
 * uses LP64 for checking 64 bit CPU arch. */
            typedef word64 wolfssl_word;
            #define WC_64BIT_CPU
        #else  /* if ( defined( __alpha__ ) || defined( __ia64__ ) || defined( _ARCH_PPC64 ) || defined( __mips64 ) || defined( __x86_64__ ) || defined( _M_X64 ) ) || defined( __aarch64__ ) || defined( __sparc64__ ) || defined( __s390x__ ) || ( defined( __riscv_xlen ) && ( __riscv_xlen == 64 ) ) */
            typedef word32 wolfssl_word;
            #ifdef WORD64_AVAILABLE
                #define WOLFCRYPT_SLOW_WORD64
            #endif
        #endif /* if ( defined( __alpha__ ) || defined( __ia64__ ) || defined( _ARCH_PPC64 ) || defined( __mips64 ) || defined( __x86_64__ ) || defined( _M_X64 ) ) || defined( __aarch64__ ) || defined( __sparc64__ ) || defined( __s390x__ ) || ( defined( __riscv_xlen ) && ( __riscv_xlen == 64 ) ) */
    ...
    #else  /* if !defined( NO_64BIT ) && defined( WORD64_AVAILABLE ) && !defined( WC_16BIT_CPU ) */
        #undef WORD64_AVAILABLE
        typedef word32 wolfssl_word;
        #define MP_16BIT    /* for mp_int, mp_word needs to be twice as big as
                             * mp_digit, no 64 bit type so make mp_digit 16 bit */
    #endif /* if !defined( NO_64BIT ) && defined( WORD64_AVAILABLE ) && !defined( WC_16BIT_CPU ) */
 ...
 * instructions  */
        #define FAST_ROTATE
    #endif /* if ( defined( _MSC_VER ) || defined( __BCPLUSPLUS__ ) ) && !defined( WOLFSSL_SGX ) && !defined( INTIME_RTOS ) */
...
/* XFREE on some embedded systems doesn't like free(0) so test  */
        ...
        WOLFSSL_API void * XMALLOC( size_t n,
                                    void * heap,
                                    int type );
        WOLFSSL_API void * XREALLOC( void * p,
                                     size_t n,
                                     void * heap,
                                     int type );
        WOLFSSL_API void XFREE( void * p,
                                void * heap,
                                int type );
    ...
    defined( HAVE_INTEL_QA_SYNC )
        ...
        #else  /* ifndef HAVE_INTEL_QA_SYNC */
            ...
            #endif /* WOLFSSL_DEBUG_MEMORY */
        #endif /* ifndef HAVE_INTEL_QA_SYNC */
 ...
 * not required for wolfCrypt only */
        ...
        #define XSTRNCAT( s1, s2, n )    strncat( ( s1 ), ( s2 ), ( n ) )
            ...
            defined( WOLFSSL_ZEPHYR )
                ...
                #endif
            #endif /* if defined( MICROCHIP_PIC32 ) || defined( WOLFSSL_TIRTOS ) || defined( WOLFSSL_ZEPHYR ) */
        #endif /* !XSTRNCASECMP */
 ...
 * instead of _snprintf */
                ...
                #endif /* (_MSC_VER >= 1900) */
            #else  /* if defined( _MSC_VER ) || defined( __CYGWIN__ ) || defined( __MINGW32__ ) */
                #define XSNPRINTF        snprintf
            #endif /* _MSC_VER */
        ...
        !defined( NO_CRYPT_BENCHMARK )
            ...
            #endif
        #endif
    #endif /* ifndef STRING_USER */

    #ifdef USE_WOLF_STRTOK
        WOLFSSL_API char * wc_strtok( char * str,
                                      const char * delim,
                                      char ** nextp );
    #endif
    #ifdef USE_WOLF_STRSEP
        WOLFSSL_API char * wc_strsep( char ** stringp,
                                      const char * delim );
    #endif
...
/* settings detection for compile vs runtime math incompatibilities */
    enum
    {
        ...
        #elif defined( USE_FAST_MATH ) && defined( SIZEOF_LONG_LONG ) && ( SIZEOF_LONG_LONG == 4 )
            CTC_SETTINGS = 0x40
        #else  /* if !defined( USE_FAST_MATH ) && !defined( SIZEOF_LONG ) && !defined( SIZEOF_LONG_LONG ) */
        #error "bad math long / long long settings"
                           #endif /* if !defined( USE_FAST_MATH ) && !defined( SIZEOF_LONG ) && !defined( SIZEOF_LONG_LONG ) */
    };
 ...
 * Xilinx RSA operations require alignment */
    ...
    #else  /* if defined( WOLFSSL_AESNI ) || defined( WOLFSSL_ARMASM ) || defined( USE_INTEL_SPEEDUP ) || defined( WOLFSSL_AFALG_XILINX ) */
        #ifndef ALIGN16
            #define ALIGN16
        #endif
        #ifndef ALIGN32
