...
#endif /* if defined( OPENSSL_EXTRA ) || defined( DEBUG_WOLFSSL_VERBOSE ) */
 ...
 */
    ...
    #else  /* if defined( FREESCALE_MQX ) || defined( FREESCALE_KSDK_MQX ) */
    ...
    static void wolfssl_log( const int logLevel,
                             const char * const logMessage )
    {
        ...
        else
        {
            ...
            #else  /* if defined( WOLFSSL_USER_LOG ) */
                fprintf( stderr, "%s\n", logMessage );
            #endif /* if defined( WOLFSSL_USER_LOG ) */
        }
    }
        ...
        void WOLFSSL_MSG( const char * msg )
        {
            ...
            #define LINE_LEN    16
        #endif
        void WOLFSSL_BUFFER( const byte * buffer,
                             word32 length )
        {
        ...
        void WOLFSSL_LEAVE( const char * msg,
                            int ret )
        {
            if( loggingEnabled )
            {
 ...
 */
    ...
    || defined( DEBUG_WOLFSSL_VERBOSE )
        void WOLFSSL_ERROR_LINE( int error,
                                 const char * func,
                                 unsigned int line,
                                 const char * file,
                                 void * usrCtx )
    ...
    #endif
    {
        ...
        #endif
        {
            ...
            #else  /* if ( defined( OPENSSL_EXTRA ) && !defined( _WIN32 ) && !defined( NO_ERROR_QUEUE ) ) || defined( DEBUG_WOLFSSL_VERBOSE ) */
                XSNPRINTF( buffer, sizeof( buffer ),
                           "wolfSSL error occurred, error = %d", error );
            #endif /* if ( defined( OPENSSL_EXTRA ) && !defined( _WIN32 ) && !defined( NO_ERROR_QUEUE ) ) || defined( DEBUG_WOLFSSL_VERBOSE ) */
 ...
 */
    int wc_PullErrorNode( const char ** file,
                          const char ** reason,
                          int * line )
    {
        struct wc_error_queue * err;
 ...
 * function. debug_mutex should be locked before a call to this function. */
                         ...
                         char * file )
    {
        ...
        #endif /* if defined( NO_ERROR_QUEUE ) */
        return 0;
    }
...
/* empties out the error queue into the file */
        static int wc_ERR_dump_to_file( const char * str,
                                        size_t len,
                                        void * u )
        {
            XFILE fp = ( XFILE ) u;
