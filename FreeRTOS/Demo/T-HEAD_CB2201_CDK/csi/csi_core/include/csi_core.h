 ...
 */
    void drv_nvic_set_prio( int32_t irq_num,
                            uint32_t priority );
 ...
 */
    void drv_dcache_invalid_range( uint32_t * addr,
                                   int32_t dsize );
 ...
 * \param[in]   dsize   size of memory block (in number of bytes)
 */
    void drv_dcache_clean_range( uint32_t * addr,
                                 int32_t dsize );
 ...
 * \param[in]   dsize   size of memory block (in number of bytes)
 */
    void drv_dcache_clean_invalid_range( uint32_t * addr,
                                         int32_t dsize );
 ...
 */
    void drv_cache_set_range( uint32_t index,
                              uint32_t baseAddr,
                              uint32_t size,
                              uint32_t enable );
 ...
 */
    uint32_t drv_coret_config( uint32_t ticks,
                               int32_t irq_num );
