            ...
            #include "zlib.h"
                ...
                && !defined( WOLFSSL_GNRC ) && !defined( WOLFSSL_RIOT_OS )
                    ...
                    #include <netdb.h>
                        ...
                        #include <sys/ioctl.h>
                    #endif
                #endif /* if defined( HAVE_RTP_SYS ) */
            #endif /* if defined( WOLFSSL_LWIP ) && !defined( WOLFSSL_APACHE_MYNEWT ) */
...
/* IO API's */
            ...
            WOLFSSL_API int wolfIO_SetBlockingMode( SOCKET_T sockfd,
                                                    int non_blocking );
            WOLFSSL_API void wolfIO_SetTimeout( int to_sec );
            WOLFSSL_API int wolfIO_Select( SOCKET_T sockfd,
                                           int to_sec );
        #endif
        WOLFSSL_API int wolfIO_TcpConnect( SOCKET_T * sockfd,
                                           const char * ip,
                                           unsigned short port,
                                           int to_sec );
        WOLFSSL_API int wolfIO_Send( SOCKET_T sd,
                                     char * buf,
                                     int sz,
                                     int wrFlags );
        WOLFSSL_API int wolfIO_Recv( SOCKET_T sd,
                                     char * buf,
                                     int sz,
                                     int rdFlags );
    ...
    WOLFSSL_API int BioSend( WOLFSSL * ssl,
                             char * buf,
                             int sz,
                             void * ctx );
    WOLFSSL_API int BioReceive( WOLFSSL * ssl,
                                char * buf,
                                int sz,
                                void * ctx );
        ...
        WOLFSSL_API int EmbedSend( WOLFSSL * ssl,
            ...
            WOLFSSL_API int EmbedGenerateCookie( WOLFSSL * ssl,
                ...
                WOLFSSL_API int EmbedGetPeer( WOLFSSL * ssl,
                                              char * ip,
                                              int * ipSz,
                                              unsigned short * port,
                                              int * fam );
                WOLFSSL_API int EmbedSetPeer( WOLFSSL * ssl,
                                              char * ip,
                                              int ipSz,
                                              unsigned short port,
                                              int fam );
        ...
        WOLFSSL_API int EmbedOcspLookup( void *,
                                         const char *,
                                         int,
                                         unsigned char *,
                                         int,
    ...
    #ifdef HAVE_CRL_IO
        WOLFSSL_API int wolfIO_HttpBuildRequestCrl( const char * url,
                                                    int urlSz,
        ...
        WOLFSSL_API int EmbedCrlLookup( WOLFSSL_CRL * crl,
                                        const char * url,
                                        int urlSz );
    #endif /* ifdef HAVE_CRL_IO */


    #if defined( HAVE_HTTP_CLIENT )
        WOLFSSL_API int wolfIO_DecodeUrl( const char * url,
                                          int urlSz,
                                          char * outName,
                                          char * outPath,
        ...
        WOLFSSL_LOCAL int wolfIO_HttpBuildRequest_ex( const char * reqType,
                                                      ...
                                                      unsigned char * buf,
                                                      int bufSize );
        WOLFSSL_API int wolfIO_HttpProcessResponse( int sfd,
...
/* I/O callbacks */
    typedef int (* CallbackIORecv)( WOLFSSL * ssl,
                                    char * buf,
                                    int sz,
                                    void * ctx );
    typedef int (* CallbackIOSend)( WOLFSSL * ssl,
                                    char * buf,
                                    int sz,
                                    void * ctx );
    WOLFSSL_API void wolfSSL_CTX_SetIORecv( WOLFSSL_CTX *,
                                            CallbackIORecv );
    WOLFSSL_API void wolfSSL_CTX_SetIOSend( WOLFSSL_CTX *,
                                            CallbackIOSend );
    WOLFSSL_API void wolfSSL_SSLSetIORecv( WOLFSSL *,
                                           CallbackIORecv );
    WOLFSSL_API void wolfSSL_SSLSetIOSend( WOLFSSL *,
                                           CallbackIOSend );
/* deprecated old name */
    ...
    WOLFSSL_API void wolfSSL_SetIOWriteFlags( WOLFSSL * ssl,
    ...
    #ifdef HAVE_NETX
        WOLFSSL_LOCAL int NetX_Receive( WOLFSSL * ssl,
                                        char * buf,
                                        int sz,
                                        void * ctx );
        WOLFSSL_LOCAL int NetX_Send( WOLFSSL * ssl,
                                     char * buf,
                                     int sz,
                                     void * ctx );
    ...
    #ifdef MICRIUM
        WOLFSSL_LOCAL int MicriumSend( WOLFSSL * ssl,
                                       char * buf,
                                       int sz,
                                       void * ctx );
        WOLFSSL_LOCAL int MicriumReceive( WOLFSSL * ssl,
                                          char * buf,
                                          int sz,
                                          void * ctx );
        WOLFSSL_LOCAL int MicriumReceiveFrom( WOLFSSL * ssl,
                                              char * buf,
                                              int sz,
                                              void * ctx );
        WOLFSSL_LOCAL int MicriumSendTo( WOLFSSL * ssl,
                                         char * buf,
                                         int sz,
                                         void * ctx );
    #endif /* MICRIUM */
        ...
        WOLFSSL_LOCAL int Mynewt_Receive( WOLFSSL * ssl,
                                          char * buf,
                                          int sz,
                                          void * ctx );
        WOLFSSL_LOCAL int Mynewt_Send( WOLFSSL * ssl,
                                       char * buf,
                                       int sz,
                                       void * ctx );
        WOLFSSL_API void wolfSSL_SetIO_Mynewt( WOLFSSL * ssl,
        ...
        WOLFSSL_LOCAL int uIPSend( WOLFSSL * ssl,
                                   char * buf,
                                   int sz,
                                   void * ctx );
        WOLFSSL_LOCAL int uIPReceive( WOLFSSL * ssl,
                                      char * buf,
                                      int sz,
                                      void * ctx );
        WOLFSSL_LOCAL int uIPReceiveFrom( WOLFSSL * ssl,
                                          char * buf,
                                          int sz,
                                          void * ctx );
        WOLFSSL_LOCAL int uIPSendTo( WOLFSSL * ssl,
                                     char * buf,
                                     int sz,
                                     void * ctx );

    #endif /* ifdef WOLFSSL_UIP */
        ...
        WOLFSSL_LOCAL int GNRC_ReceiveFrom( WOLFSSL * ssl,
                                            char * buf,
                                            int sz,
                                            void * ctx );
        WOLFSSL_LOCAL int GNRC_SendTo( WOLFSSL * ssl,
                                       char * buf,
                                       int sz,
                                       void * ctx );

    #endif /* ifdef WOLFSSL_GNRC */


    #ifdef WOLFSSL_DTLS
        typedef int (* CallbackGenCookie)( WOLFSSL * ssl,
                                           unsigned char * buf,
                                           int sz,
                                           void * ctx );
        WOLFSSL_API void wolfSSL_CTX_SetGenCookie( WOLFSSL_CTX *,
                                                   CallbackGenCookie );
        WOLFSSL_API void wolfSSL_SetCookieCtx( WOLFSSL * ssl,
                                               void * ctx );
        WOLFSSL_API void * wolfSSL_GetCookieCtx( WOLFSSL * ssl );

        #ifdef WOLFSSL_SESSION_EXPORT
            typedef int (* CallbackGetPeer)( WOLFSSL * ssl,
                                             char * ip,
                                             int * ipSz,
                                             unsigned short * port,
                                             int * fam );
            typedef int (* CallbackSetPeer)( WOLFSSL * ssl,
                                             char * ip,
                                             int ipSz,
                                             unsigned short port,
                                             int fam );
