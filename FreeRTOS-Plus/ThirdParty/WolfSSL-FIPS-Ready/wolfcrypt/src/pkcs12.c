...
/* for friendlyName, localKeyId .... */
    ...
    static void freeSafe( AuthenticatedSafe * safe,
                          void * heap )
    {
        int i;
...
/* return 0 on success */
    static int GetSafeContent( WC_PKCS12 * pkcs12,
                               const byte * input,
                               word32 * idx,
                               int maxIdx )
    {
        ...
        *idx = localIdx;
        ...
        input = safe->data;
        {
            ...
            while( ( int ) localIdx < CISz )
            {
                ...
                #endif /* ifdef WOLFSSL_DEBUG_PKCS12 */
 ...
 * return 0 on success */
    static int GetSignData( WC_PKCS12 * pkcs12,
                            const byte * mem,
                            word32 * idx,
                            word32 totalSz )
    {
 ...
 */
    static int wc_PKCS12_create_mac( WC_PKCS12 * pkcs12,
                                     byte * data,
                                     word32 dataSz,
                                     const byte * psw,
                                     word32 pswSz,
 ...
 * returns the result of comparison, success is 0 */
    static int wc_PKCS12_verify( WC_PKCS12 * pkcs12,
                                 byte * data,
                                 word32 dataSz,
                                 const byte * psw,
                                 word32 pswSz )
 ...
 */
    int wc_d2i_PKCS12( const byte * der,
                       word32 derSz,
                       WC_PKCS12 * pkcs12 )
    {
        word32 idx = 0;
...
/* helper function to free WC_DerCertList */
    void wc_FreeCertList( WC_DerCertList * list,
                          void * heap )
    {
    ...
    static void freeDecCertList( WC_DerCertList ** list,
                                 byte ** pkey,
                                 word32 * pkeySz,
                                 byte ** cert,
                                 word32 * certSz,
 ...
 */
    static int wc_PKCS12_shroud_key( WC_PKCS12 * pkcs12,
                                     WC_RNG * rng,
                                     byte * out,
                                     word32 * outSz,
                                     byte * key,
 ...
 */
    static int wc_PKCS12_create_key_bag( WC_PKCS12 * pkcs12,
                                         WC_RNG * rng,
                                         byte * out,
                                         word32 * outSz,
                                         byte * key,
 ...
 */
    static int wc_PKCS12_encrypt_content( WC_PKCS12 * pkcs12,
                                          WC_RNG * rng,
                                          byte * out,
                                          word32 * outSz,
                                          byte * content,
 ...
 * returns a pointer to be free'd by caller on success and NULL on failure */
    static byte * PKCS12_create_key_content( WC_PKCS12 * pkcs12,
                                             int nidKey,
                                             word32 * keyCiSz,
                                             WC_RNG * rng,
                                             char * pass,
 ...
 * returns a pointer to be free'd by caller on success and NULL on failure */
    static byte * PKCS12_create_cert_content( WC_PKCS12 * pkcs12,
                                              int nidCert,
                                              WC_DerCertList * ca,
                                              byte * cert,
                                              word32 certSz,
 ...
 * returns 0 on success */
    static int PKCS12_create_safe( WC_PKCS12 * pkcs12,
                                   byte * certCi,
                                   word32 certCiSz,
                                   byte * keyCi,
                                   word32 keyCiSz,
 ...
 */
    WC_PKCS12 * wc_PKCS12_create( char * pass,
                                  word32 passSz,
                                  char * name,
                                  byte * key,
                                  word32 keySz,
