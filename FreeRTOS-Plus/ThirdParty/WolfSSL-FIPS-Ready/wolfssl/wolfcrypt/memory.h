 ...
 */
    ...
    extern "C" {
        ...
        WOLFSSL_API void wolfSSL_SetMemFailCount( int memFailCount );
            ...
            typedef void (* wolfSSL_Free_cb)( void * ptr,
                                              ...
                                              const char * func,
                                              unsigned int line );
            typedef void *(* wolfSSL_Realloc_cb)( void * ptr,
                                                  size_t size,
                                                  void * heap,
                                                  int type,
                                                  const char * func,
            ...
            WOLFSSL_API void * wolfSSL_Realloc( void * ptr,
                                                ...
                                                const char * func,
                                                unsigned int line );
        #else  /* ifdef WOLFSSL_DEBUG_MEMORY */
            typedef void *(* wolfSSL_Malloc_cb)( size_t size,
                                                 void * heap,
                                                 int type );
            typedef void (* wolfSSL_Free_cb)( void * ptr,
    ...
    #else  /* ifdef WOLFSSL_STATIC_MEMORY */
        #ifdef WOLFSSL_DEBUG_MEMORY
            typedef void *(* wolfSSL_Malloc_cb)( size_t size,
                                                 const char * func,
                                                 unsigned int line );
...
/* Public get/set functions */
    ...
    WOLFSSL_API int wolfSSL_GetAllocators( wolfSSL_Malloc_cb *,
        ...
        #define WOLFMEM_DEF_BUCKETS         9     /* number of default memory blocks */
            ...
            #define WOLFMEM_IO_SZ           16992 /* 16 byte aligned */
                ...
                #endif
                #define WOLFMEM_BUCKETS        \
    64, 128, 256, 512, 1024, 2432, 3456, 4544, \
    LARGEST_MEM_BUCKET
                ...
                #endif
                #define WOLFMEM_BUCKETS        \
    64, 128, 256, 512, 1024, 2432, 3360, 4480, \
    LARGEST_MEM_BUCKET
    ...
    64, 128, 256, 512, 1024, 2432, 3456, 4544, \
    LARGEST_MEM_BUCKET
            #endif /* ifndef SESSION_CERTS */
        #endif /* ifndef WOLFMEM_BUCKETS */
        #ifndef WOLFMEM_DIST
 ...
 */
        ...
        WOLFSSL_LOCAL int wolfSSL_load_static_memory( byte * buffer,
                                                      word32 sz,
                                                      int flag,
                                                      WOLFSSL_HEAP * heap );
        WOLFSSL_LOCAL int wolfSSL_GetMemStats( WOLFSSL_HEAP * heap,
                                               WOLFSSL_MEM_STATS * stats );
        WOLFSSL_LOCAL int SetFixedIO( WOLFSSL_HEAP * heap,
                                      wc_Memory ** io );
        WOLFSSL_LOCAL int FreeFixedIO( WOLFSSL_HEAP * heap,
                                       wc_Memory ** io );
        ...
        WOLFSSL_API void __attribute__( ( no_instrument_function ) ) __cyg_profile_func_enter( void * func,
                                                                                               void * caller );
        WOLFSSL_API void __attribute__( ( no_instrument_function ) ) __cyg_profile_func_exit( void * func,
                                                                                              void * caller );
