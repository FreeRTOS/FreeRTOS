...
/* ecc.c uses same table */
    ...
    #endif /* if !defined( WC_NO_CACHE_RESISTANT ) && ( ( defined( HAVE_ECC ) && defined( ECC_TIMING_RESISTANT ) ) || ( defined( USE_FAST_MATH ) && defined( TFM_TIMING_RESISTANT ) ) ) */
                      ...
                      mp_int * b )
    {
                            ...
                            mp_digit * d )
        {
                         ...
                         WC_RNG * rng )
            {
                ...
                #endif /* if !defined( USE_FAST_MATH ) && !defined( WOLFSSL_SP_MATH ) */
 ...
 * return MP_OKAY on success */
                       ...
                       int encType )
    {
        ...
        *len = keySz;
        ...
        int wc_bigint_alloc( WC_BIGINT * a,
                             word32 sz )
        {
            int err = MP_OKAY;
...
/* assumes input is big endian format */
        int wc_bigint_from_unsigned_bin( WC_BIGINT * a,
                                         const byte * in,
                                         word32 inlen )
        {
            int err;
        ...
        int wc_bigint_to_unsigned_bin( WC_BIGINT * a,
                                       byte * out,
                                       word32 * outlen )
        {
            word32 sz;
 ...
 */
        int wc_mp_to_bigint_sz( mp_int * src,
                                WC_BIGINT * dst,
                                word32 sz )
        {
            int err;
        ...
        int wc_mp_to_bigint( mp_int * src,
                             WC_BIGINT * dst )
        {
            if( ( src == NULL ) || ( dst == NULL ) )
            {
        ...
        int wc_bigint_to_mp( WC_BIGINT * src,
                             mp_int * dst )
        {
            int err;
