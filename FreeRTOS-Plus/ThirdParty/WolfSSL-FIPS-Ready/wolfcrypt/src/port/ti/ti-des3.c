...
#include <wolfssl/wolfcrypt/settings.h>
        ...
        static int DesCbcAlign16( Des * des,
                                  byte * out,
                                  const byte * in,
                                  word32 sz,
                                  word32 dir,
        ...
        WOLFSSL_API int wc_Des_SetKey( Des * des,
                                       const byte * key,
                                       const byte * iv,
                                       int dir )
        {
        ...
        WOLFSSL_API void wc_Des_SetIV( Des * des,
                                       const byte * iv )
        {
            DesSetIV( des, iv, DES_CFG_SINGLE );
        }

        WOLFSSL_API int wc_Des3_SetKey( Des3 * des,
                                        const byte * key,
                                        const byte * iv,
                                        int dir )
        {
        ...
        WOLFSSL_API int wc_Des3_SetIV( Des3 * des,
                                       const byte * iv )
        {
        ...
        WOLFSSL_API int wc_Des_CbcEncrypt( Des * des,
                                           byte * out,
                                           const byte * in,
                                           word32 sz )
        {
        ...
        WOLFSSL_API int wc_Des_CbcDecrypt( Des * des,
                                           byte * out,
                                           const byte * in,
                                           word32 sz )
        {
        ...
        WOLFSSL_API int wc_Des3_CbcEncrypt( Des3 * des,
                                            byte * out,
                                            const byte * in,
                                            word32 sz )
        {
        ...
        WOLFSSL_API int wc_Des3_CbcDecrypt( Des3 * des,
                                            byte * out,
                                            const byte * in,
                                            word32 sz )
        {
        ...
        WOLFSSL_API int wc_Des3Init( Des3 * des,
                                     void * heap,
                                     int devId )
        {
            if( des == NULL )
