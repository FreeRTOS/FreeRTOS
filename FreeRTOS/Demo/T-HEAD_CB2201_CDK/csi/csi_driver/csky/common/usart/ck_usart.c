 ...
 * \return      error code
 */
static int32_t dw_usart_set_baudrate( dw_usart_reg_t * addr,
                                      uint32_t baudrate,
                                      uint32_t apbfreq )
{
...
static int32_t dw_usart_set_parity( dw_usart_reg_t * addr,
 ...
 * \return      error code
 */
static int32_t dw_usart_set_stopbit( dw_usart_reg_t * addr,
 ...
 * \return      error code
 */
static int32_t dw_usart_set_databit( dw_usart_reg_t * addr,
