 ...
 */
    static WC_INLINE word16 idea_mult( word16 x,
                                       word16 y )
    {
        long mul, res;
 ...
 */
    ...
    int wc_IdeaCbcEncrypt( Idea * idea,
                           byte * out,
                           const byte * in,
                           word32 len )
    {
    ...
    int wc_IdeaCbcDecrypt( Idea * idea,
                           byte * out,
                           const byte * in,
                           word32 len )
    {
