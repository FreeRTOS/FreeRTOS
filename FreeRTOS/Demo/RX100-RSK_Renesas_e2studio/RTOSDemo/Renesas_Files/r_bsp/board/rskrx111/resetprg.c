...
***********************************************************************************************************************/
    ...
    #endif /* if __RENESAS_VERSION__ < 0x01010000 */
#endif /* if RUN_IN_USER_MODE == 1 */
