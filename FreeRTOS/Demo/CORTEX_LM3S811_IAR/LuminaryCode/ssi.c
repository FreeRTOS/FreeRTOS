...
/****************************************************************************** */
    ...
    void SSIConfig( unsigned long ulBase,
...
#endif /* if defined( GROUP_config ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
/****************************************************************************** */
    ...
    void SSIIntRegister( unsigned long ulBase,
...
/****************************************************************************** */
    ...
    void SSIIntEnable( unsigned long ulBase,
...
/****************************************************************************** */
    ...
    void SSIIntDisable( unsigned long ulBase,
                        unsigned long ulIntFlags )
    {
        /* */
        /* Check the arguments. */
...
/****************************************************************************** */
    ...
    unsigned long SSIIntStatus( unsigned long ulBase,
                                tBoolean bMasked )
    {
        /* */
        /* Check the arguments. */
...
/****************************************************************************** */
    ...
    void SSIIntClear( unsigned long ulBase,
                      unsigned long ulIntFlags )
    {
        /* */
        /* Check the arguments. */
...
/****************************************************************************** */
    ...
    void SSIDataPut( unsigned long ulBase,
...
#endif /* if defined( GROUP_dataput ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
/****************************************************************************** */
    ...
    long SSIDataNonBlockingPut( unsigned long ulBase,
                                unsigned long ulData )
    {
        /* */
        /* Check the arguments. */
...
#endif /* if defined( GROUP_datanonblockingput ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
/****************************************************************************** */
    ...
    void SSIDataGet( unsigned long ulBase,
...
#endif /* if defined( GROUP_dataget ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
/****************************************************************************** */
    ...
    long SSIDataNonBlockingGet( unsigned long ulBase,
                                unsigned long * pulData )
    {
        /* */
        /* Check the arguments. */
...
#endif /* if defined( GROUP_datanonblockingget ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
