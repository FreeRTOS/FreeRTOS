 ...
 *         0 otherwise.
 */
    int wc_ed448_make_public( ed448_key * key,
 ...
 *         0 otherwise.
 */
    int wc_ed448_make_key( WC_RNG * rng,
                           int keySz,
                           ed448_key * key )
    {
        int ret = 0;
 ...
 *          0 otherwise.
 */
        static int ed448_sign_msg( const byte * in,
                                   word32 inLen,
                                   byte * out,
                                   word32 * outLen,
                                   ed448_key * key,
 ...
 *          0 otherwise.
 */
        int wc_ed448_sign_msg( const byte * in,
                               word32 inLen,
                               byte * out,
                               word32 * outLen,
                               ed448_key * key,
 ...
 *          0 otherwise.
 */
        int wc_ed448ph_sign_hash( const byte * hash,
                                  word32 hashLen,
                                  byte * out,
                                  word32 * outLen,
                                  ed448_key * key,
 ...
 *          0 otherwise.
 */
        int wc_ed448ph_sign_msg( const byte * in,
                                 word32 inLen,
                                 byte * out,
                                 word32 * outLen,
                                 ed448_key * key,
 ...
 *          0 otherwise.
 */
        static int ed448_verify_msg( const byte * sig,
                                     word32 sigLen,
                                     const byte * msg,
                                     word32 msgLen,
                                     int * res,
 ...
 *          0 otherwise.
 */
        int wc_ed448_verify_msg( const byte * sig,
                                 word32 sigLen,
                                 const byte * msg,
                                 word32 msgLen,
                                 int * res,
 ...
 *          0 otherwise.
 */
        int wc_ed448ph_verify_hash( const byte * sig,
                                    word32 sigLen,
                                    const byte * hash,
                                    word32 hashLen,
                                    int * res,
 ...
 *          0 otherwise.
 */
        int wc_ed448ph_verify_msg( const byte * sig,
                                   word32 sigLen,
                                   const byte * msg,
                                   word32 msgLen,
                                   int * res,
 ...
 *         0 otherwise.
 */
        int wc_ed448_export_public( ed448_key * key,
                                    byte * out,
                                    word32 * outLen )
        {
            int ret = 0;
 ...
 *         0 otherwise.
 */
        int wc_ed448_import_public( const byte * in,
                                    word32 inLen,
                                    ed448_key * key )
        {
            int ret = 0;
 ...
 *         0 otherwise.
 */
        int wc_ed448_import_private_only( const byte * priv,
                                          word32 privSz,
                                          ed448_key * key )
        {
            int ret = 0;
 ...
 *         0 otherwise.
 */
        int wc_ed448_import_private_key( const byte * priv,
                                         word32 privSz,
                                         const byte * pub,
                                         word32 pubSz,
                                         ed448_key * key )
 ...
 *         0 otherwise.
 */
        int wc_ed448_export_private_only( ed448_key * key,
                                          byte * out,
                                          word32 * outLen )
        {
            int ret = 0;
 ...
 *         0 otherwise.
 */
        int wc_ed448_export_private( ed448_key * key,
                                     byte * out,
                                     word32 * outLen )
        {
            int ret = 0;
