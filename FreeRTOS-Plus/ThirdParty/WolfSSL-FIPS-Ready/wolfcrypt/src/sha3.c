 ...
 * returns 0 on success.
 */
static int Sha3Update( wc_Sha3 * sha3,
                       const byte * data,
                       word32 len,
                       byte p )
{
 ...
 * returns 0 on success.
 */
static int Sha3Final( wc_Sha3 * sha3,
                      byte padChar,
                      byte * hash,
                      byte p,
                      byte l )
 ...
 * returns 0 on success.
 */
static int wc_InitSha3( wc_Sha3 * sha3,
                        void * heap,
                        int devId )
{
    int ret = 0;
 ...
 * returns 0 on success.
 */
static int wc_Sha3Update( wc_Sha3 * sha3,
                          const byte * data,
                          word32 len,
                          byte p )
{
    ...
    if( ( data == NULL ) && ( len == 0 ) )
    {
        ...
        if( sha3->asyncDev.marker == WOLFSSL_ASYNC_MARKER_SHA3 )
        {
            ...
            #endif /* if defined( HAVE_INTEL_QA ) && defined( QAT_V2 ) */
        }
    #endif /* WOLFSSL_ASYNC_CRYPT */
 ...
 * returns 0 on success.
 */
static int wc_Sha3Final( wc_Sha3 * sha3,
                         byte * hash,
                         byte p,
                         byte len )
{
 ...
 * returns 0 on success.
 */
static int wc_Sha3Copy( wc_Sha3 * src,
                        wc_Sha3 * dst )
{
    int ret = 0;
 ...
 * returns 0 on success.
 */
static int wc_Sha3GetHash( wc_Sha3 * sha3,
                           byte * hash,
                           byte p,
                           byte len )
{
 ...
 * returns 0 on success.
 */
int wc_Sha3_224_Update( wc_Sha3 * sha3,
                        const byte * data,
                        word32 len )
{
 ...
 * returns 0 on success.
 */
int wc_Sha3_224_Copy( wc_Sha3 * src,
                      wc_Sha3 * dst )
{
 ...
 * returns 0 on success.
 */
int wc_Sha3_256_Update( wc_Sha3 * sha3,
                        const byte * data,
                        word32 len )
{
 ...
 * returns 0 on success.
 */
int wc_Sha3_256_Copy( wc_Sha3 * src,
                      wc_Sha3 * dst )
{
    return wc_Sha3Copy( src, dst );
}
 ...
 * returns 0 on success.
 */
int wc_Sha3_384_Update( wc_Sha3 * sha3,
                        const byte * data,
                        word32 len )
{
 ...
 * returns 0 on success.
 */
int wc_Sha3_384_Copy( wc_Sha3 * src,
                      wc_Sha3 * dst )
{
    return wc_Sha3Copy( src, dst );
}
 ...
 * returns 0 on success.
 */
int wc_Sha3_512_Update( wc_Sha3 * sha3,
                        const byte * data,
                        word32 len )
{
 ...
 * returns 0 on success.
 */
int wc_Sha3_512_Copy( wc_Sha3 * src,
                      wc_Sha3 * dst )
{
    return wc_Sha3Copy( src, dst );
}
    ...
    #if defined( WOLFSSL_HASH_FLAGS ) || defined( WOLF_CRYPTO_CB )
    int wc_Sha3_SetFlags( wc_Sha3 * sha3,
                          word32 flags )
    {
        if( sha3 )
        {
    ...
    int wc_Sha3_GetFlags( wc_Sha3 * sha3,
                          word32 * flags )
    {
        if( sha3 && flags )
        {
 ...
 * returns 0 on success.
 */
    int wc_Shake256_Update( wc_Shake * shake,
                            const byte * data,
                            word32 len )
    {
 ...
 * returns 0 on success.
 */
    int wc_Shake256_Copy( wc_Shake * src,
                          wc_Shake * dst )
    {
        return wc_Sha3Copy( src, dst );
    }
    #endif /* if defined( WOLFSSL_SHAKE256 ) */
