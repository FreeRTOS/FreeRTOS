 ...
 */
    static inline void SMC_SetPowerModeProtection( SMC_Type * base,
 ...
 */
        ...
        #endif /* FSL_FEATURE_SMC_HAS_STOP_SUBMODE2 */
    #else  /* if ( defined( FSL_FEATURE_SMC_HAS_SUB_STOP_MODE ) && FSL_FEATURE_SMC_HAS_SUB_STOP_MODE ) */
 ...
 */
    static inline void SMC_ClearStickyResetSources( SMC_Type * base,
 ...
 */
    static inline void SMC_SetSystemResetInterruptConfig( SMC_Type * base,
                                                          uint32_t intMask )
    {
        base->SRIE = intMask;
    }
 ...
 */
    static inline void SMC_ClearResetInterruptSourcesStatus( SMC_Type * base,
                                                             uint32_t intMask )
    {
        base->SRIF = intMask;
    }
 ...
 *                  smc_interrupt_enable_t for details.
 */
        static inline void SMC_SetCoreSoftwareResetConfig( SMC_Type * base,
                                                           uint32_t intMask )
        {
            base->CSRE = intMask;
        }
 ...
 */
        static inline void SMC_SetForceBootOptionConfig( SMC_Type * base,
                                                         uint32_t val )
        {
            base->FM = val;
        }
 ...
 */
            static inline void SMC_SRAMEnableLowPowerMode( SMC_Type * base,
                                                           uint32_t arrayIdx,
                                                           bool enable )
            {
                if( enable )
 ...
 */
            static inline void SMC_SRAMEnableDeepSleepMode( SMC_Type * base,
                                                            uint32_t arrayIdx,
                                                            bool enable )
            {
                if( enable )
