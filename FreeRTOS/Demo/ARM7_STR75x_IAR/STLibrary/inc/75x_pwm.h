...
void PWM_ITConfig( u16 PWM_IT,
                   FunctionalState Newstate );
void PWM_DMAConfig( u16 PWM_DMASources,
                    u16 PWM_OCRMState,
                    u16 PWM_DMABase );
void PWM_DMACmd( u16 PWM_DMASources,
                 FunctionalState Newstate );
void PWM_SetPrescaler( u16 Prescaler );
void PWM_SetPeriod( u16 Period );
void PWM_SetPulse( u16 PWM_Channel,
                   u16 Pulse );
...
void PWM_ForcedOCConfig( u16 PWM_Channel,
                         u16 PWM_ForcedAction );
