 ...
 */
    ...
    #endif /* if ( ( defined( __ARM_FEATURE_CMSE ) && ( __ARM_FEATURE_CMSE == 3 ) ) && ( defined( __ARM_ARCH_8M_MAIN__ ) && ( __ARM_ARCH_8M_MAIN__ == 1 ) ) ) */
 ...
 * \return          1  Function failed
 */
    __attribute__( ( always_inline ) ) __STATIC_INLINE uint32_t __STLEXB( uint8_t value,
                                                                          volatile uint8_t * ptr )
    {
        uint32_t result;
 ...
 * \return          1  Function failed
 */
    __attribute__( ( always_inline ) ) __STATIC_INLINE uint32_t __STLEXH( uint16_t value,
                                                                          volatile uint16_t * ptr )
    {
        uint32_t result;
 ...
 * \return          1  Function failed
 */
    __attribute__( ( always_inline ) ) __STATIC_INLINE uint32_t __STLEX( uint32_t value,
                                                                         volatile uint32_t * ptr )
    {
        uint32_t result;
 ...
 */
    ...
    __attribute__( ( always_inline ) ) __STATIC_INLINE int32_t __SMMLA( int32_t op1,
                                                                        int32_t op2,
                                                                        int32_t op3 )
    {
        int32_t result;
