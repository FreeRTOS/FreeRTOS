...
#include <metal/machine/platform.h>
    ...
    int __metal_driver_riscv_clint0_set_vector_mode( struct metal_interrupt * controller,
    ...
    int __metal_driver_riscv_clint0_clear_interrupt( struct metal_interrupt * controller,
                                                     int id )
    {
    ...
    int __metal_driver_riscv_clint0_set_interrupt( struct metal_interrupt * controller,
                                                   int id )
    {
        int hartid = metal_cpu_get_current_hartid();
