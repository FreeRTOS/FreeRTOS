...
extern int32_t target_get_eflash( int32_t idx,
                                  uint32_t * base,
                                  eflash_info_t * info );
...
static int32_t eflash_program_word( eflash_handle_t handle,
                                    uint32_t dstaddr,
                                    uint32_t * srcbuf,
                                    uint32_t len )
{
...
static int32_t eflash_verify( eflash_handle_t handle,
                              uint32_t addr,
                              const void * data,
                              uint32_t cnt )
{
...
#endif /* ifdef CONFIG_CHIP_CH2201 */
 ...
 */
eflash_handle_t csi_eflash_initialize( int32_t idx,
                                       eflash_event_cb_t cb_event )
{
 ...
 */
int32_t csi_eflash_read( eflash_handle_t handle,
                         uint32_t addr,
                         void * data,
                         uint32_t cnt )
{
 ...
 */
int32_t csi_eflash_program( eflash_handle_t handle,
                            uint32_t addr,
                            const void * data,
                            uint32_t cnt )
{
 ...
 * \return      error code
 */
int32_t csi_eflash_erase_sector( eflash_handle_t handle,
                                 uint32_t addr )
{
    EFLASH_NULL_PARAM_CHK( handle );
