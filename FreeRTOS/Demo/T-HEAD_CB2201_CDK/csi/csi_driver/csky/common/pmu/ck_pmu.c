...
extern int32_t target_get_pmu( int32_t idx,
                               uint32_t * base,
                               uint32_t * irq );
...
int32_t ck_pmu_act_callback( pmu_handle_t handle,
                             pmu_event_e event )
{
...
void soc_sleep( pmu_handle_t handle,
                lpm_mode_t mode )
{
    #ifdef CONFIG_TEE_CA
 ...
 */
pmu_handle_t drv_pmu_initialize( int32_t idx,
                                 pmu_event_cb_t cb_event )
{
...
int32_t drv_pmu_power_control( int32_t idx,
 ...
 * \return      error code
 */
int32_t drv_pmu_enter_sleep( pmu_handle_t handle,
                             pmu_mode_e mode )
{
    PMU_NULL_PARAM_CHK( handle );
