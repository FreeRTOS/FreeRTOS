 ...
 */
        static void fe448_cswap( uint8_t * a,
                                 uint8_t * b,
                                 int c )
        {
            int i;
 ...
 */
            void fe448_pow_2_446_222_1( uint8_t * r,
                                        const uint8_t * a )
            {
                int i;
                uint8_t t[ 56 ];
 ...
 * b  [in]  Byte array.
 */
        void fe448_from_bytes( int64_t * r,
 ...
 */
        void fe448_to_bytes( unsigned char * b,
                             const int64_t * a )
        {
            int128_t t;
            /* Mod */
 ...
 * c  [in]  Swap when 1. Valid values: 0, 1.
 */
        static void fe448_cswap( int64_t * a,
                                 int64_t * b,
                                 int c )
        {
 ...
 * a  [in]  Field element to exponentiate.
 */
            void fe448_pow_2_446_222_1( int64_t * r,
                                        const int64_t * a )
            {
                int64_t t1[ 8 ];
                int64_t t2[ 8 ];
 ...
 */
        ...
        #endif /* HAVE_ED448 */
    #else  /* if defined( CURVE448_SMALL ) || defined( ED448_SMALL ) */
 ...
 * b  [in]  Byte array.
 */
        void fe448_from_bytes( int32_t * r,
                               const unsigned char * b )
        {
            r[ 0 ] = ( ( ( int32_t ) ( ( b[ 0 ] ) >> 0 ) ) << 0 )
                     | ( ( ( int32_t ) ( ( b[ 1 ] ) >> 0 ) ) << 8 )
 ...
 * c  [in]  Swap when 1. Valid values: 0, 1.
 */
        static void fe448_cswap( int32_t * a,
                                 int32_t * b,
                                 int c )
        {
 ...
 * b  [in]  Field element to multiply.
 */
        static WC_INLINE void fe448_mul_8( int32_t * r,
                                           const int32_t * a,
                                           const int32_t * b )
        {
            int64_t t;
 ...
 * a  [in]  Field element to square.
 */
        static WC_INLINE void fe448_sqr_8( int32_t * r,
                                           const int32_t * a )
        {
            int64_t t;
 ...
 * a  [in]  Field element to exponentiate.
 */
            void fe448_pow_2_446_222_1( int32_t * r,
                                        const int32_t * a )
            {
                int32_t t1[ 16 ];
                int32_t t2[ 16 ];
 ...
 */
        ...
        #endif /* HAVE_ED448 */
    #endif /* if defined( CURVE448_SMALL ) || defined( ED448_SMALL ) */
