...
#define IS_FSMC_ASYNC_WAIT(WAIT)              \
    ((( WAIT ) == FSMC_AsyncWait_Disable ) || \
...
#define IS_FSMC_DATA_WIDTH(WIDTH)               \
    ((( WIDTH ) == FSMC_MemoryDataWidth_8b ) || \
     (( WIDTH ) == FSMC_MemoryDataWidth_16b ))
...
#define IS_FSMC_ADDRESS_LOW_MAPPING(MAPPING)            \
    ((( MAPPING ) == FSMC_AddressLowMapping_Direct ) || \
...
void FSMC_NORSRAMCmd(u32 FSMC_Bank,
                     FunctionalState NewState);
void FSMC_NANDCmd(u32 FSMC_Bank,
                  FunctionalState NewState);
void FSMC_PCCARDCmd(FunctionalState NewState);
void FSMC_NANDECCCmd(u32 FSMC_Bank,
                     FunctionalState NewState);
u32 FSMC_GetECC(u32 FSMC_Bank);
void FSMC_ITConfig(u32 FSMC_Bank,
                   u32 FSMC_IT,
                   FunctionalState NewState);
FlagStatus FSMC_GetFlagStatus(u32 FSMC_Bank,
                              u32 FSMC_FLAG);
void FSMC_ClearFlag(u32 FSMC_Bank,
                    u32 FSMC_FLAG);
ITStatus FSMC_GetITStatus(u32 FSMC_Bank,
                          u32 FSMC_IT);
void FSMC_ClearITPendingBit(u32 FSMC_Bank,
                            u32 FSMC_IT);
