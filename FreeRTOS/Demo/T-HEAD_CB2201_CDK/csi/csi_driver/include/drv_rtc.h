 ...
 */
    rtc_handle_t csi_rtc_initialize( int32_t idx,
 ...
 * \return      error code
 */
    int32_t csi_rtc_set_time( rtc_handle_t handle,
                              const struct tm * rtctime );
 ...
 * \return      error code
 */
    int32_t csi_rtc_get_time( rtc_handle_t handle,
                              struct tm * rtctime );
 ...
 * \return      error code
 */
    int32_t csi_rtc_timer_config( rtc_handle_t handle,
                                  const struct tm * rtctime );
 ...
 * \return      error code
 */
    int32_t csi_rtc_timer_enable( rtc_handle_t handle,
                                  uint8_t en );
