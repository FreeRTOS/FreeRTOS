...
typedef void (*gpio_irq_callback_t)(uint32_t gpio, uint32_t events);
 ...
 */
static inline bool gpio_is_pulled_up(uint32_t gpio) {
 ...
 */
static inline bool gpio_is_pulled_down(uint32_t gpio) {
 ...
 * \param gpio GPIO number
 */
static inline void gpio_disable_pulls(uint32_t gpio) {
 ...
 */
static inline bool gpio_is_dir_out(uint32_t gpio) {
 ...
 */
static inline uint32_t gpio_get_dir(uint32_t gpio) {
