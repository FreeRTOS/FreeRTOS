...
#include <wolfssl/wolfcrypt/settings.h>
    ...
    #include <wolfssl/wolfcrypt/port/pic32/pic32mz-crypt.h>
        ...
        static int Pic32Crypto( const byte * pIn,
                                int inLen,
                                word32 * pOut,
                                int outLen,
                                int dir,
...
/* Crypt Engine descriptor */
            ...
            static void update_engine( const byte * input,
                                       word32 len,
                                       word32 * hash )
            {
                int total;
        ...
        int wc_Pic32Hash( const byte * in,
                          int inLen,
                          word32 * out,
                          int outLen,
                          int algo )
        ...
        int wc_Pic32HashCopy( hashUpdCache * src,
                              hashUpdCache * dst )
        {
        ...
        static int wc_Pic32HashUpdate( hashUpdCache * cache,
                                       byte * stdBuf,
                                       int stdBufLen,
                                       word32 * digest,
                                       int digestSz,
                                       ...
                                       void * heap )
        {
            ...
            #endif /* ifdef WOLFSSL_PIC32MZ_LARGE_HASH */
        ...
        static int wc_Pic32HashFinal( hashUpdCache * cache,
                                      byte * stdBuf,
                                      word32 * digest,
                                      byte * hash,
                                      int digestSz,
        ...
        static void wc_Pic32HashFree( hashUpdCache * cache,
                                      void * heap )
        {
...
/* API's for compatibility with Harmony wrappers - not used */
            ...
            void wc_Sha256SizeSet( wc_Sha256 * sha256,
                                   word32 len )
            {
                if( sha256 )
                {
    ...
    #ifdef WOLFSSL_PIC32MZ_CRYPT
        #if !defined( NO_AES )
            int wc_Pic32AesCrypt( word32 * key,
                                  int keyLen,
                                  word32 * iv,
                                  int ivLen,
                                  byte * out,
        ...
        #ifndef NO_DES3
            int wc_Pic32DesCrypt( word32 * key,
                                  int keyLen,
                                  word32 * iv,
                                  int ivLen,
                                  byte * out,
