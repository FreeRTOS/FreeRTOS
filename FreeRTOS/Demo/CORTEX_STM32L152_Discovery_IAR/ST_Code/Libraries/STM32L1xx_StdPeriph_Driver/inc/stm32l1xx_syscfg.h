 ...
 */
    ...
    #define IS_RI_RESISTOR( RESISTOR )       \
    ( ( ( RESISTOR ) == COMP_CSR_10KPU ) ||  \
 ...
 */
    ...
    #define IS_RI_CHANNEL( CHANNEL )     \
    ( ( ( CHANNEL ) == RI_Channel_3 ) || \
 ...
 */
    ...
    #define IS_RI_CHANNELSPEED( SPEED )        \
    ( ( ( SPEED ) == RI_ChannelSpeed_Fast ) || \
 ...
 */
    ...
    #define IS_RI_INPUTCAPTURE_ROUTING( ROUTING )     \
    ( ( ( ROUTING ) == RI_InputCaptureRouting_0 ) ||  \
...
/* ASCR2 IO switch: bit 31 is set to '0' to indicate that the mask is in ASCR2 register */
    ...
    #define IS_RI_IOSWITCH( IOSWITCH )          \
    ( ( ( IOSWITCH ) == RI_IOSwitch_CH0 ) ||    \
...
/* RI Initialization and Configuration functions ******************************/
    ...
    void SYSCFG_RIIOSwitchConfig( uint32_t RI_IOSwitch,
                                  FunctionalState NewState );
    void SYSCFG_RIHysteresisConfig( uint8_t RI_Port,
                                    uint16_t RI_Pin,
                                    FunctionalState NewState );
