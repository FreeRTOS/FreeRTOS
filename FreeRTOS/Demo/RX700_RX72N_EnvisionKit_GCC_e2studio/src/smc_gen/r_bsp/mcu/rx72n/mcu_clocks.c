...
***********************************************************************************************************************/
    static void clock_source_select( void )
    {
        ...
        else
        {
            ...
            #endif /* if ( BSP_PRV_SUB_CLK_OPERATING == 1 ) || ( ( BSP_PRV_SUB_CLK_OPERATING == 0 ) && ( BSP_CFG_RTC_ENABLE == 0 ) ) */
            ...
            #endif /* if BSP_PRV_SUB_CLK_OPERATING == 1 */
        ...
        #endif /* if ( BSP_CFG_PHY_CLOCK_SOURCE == 1 ) || ( BSP_CFG_USB_CLOCK_SOURCE == 3 ) */
        ...
        #endif /* if BSP_PRV_PPLL_CLK_OPERATING == 1 */
