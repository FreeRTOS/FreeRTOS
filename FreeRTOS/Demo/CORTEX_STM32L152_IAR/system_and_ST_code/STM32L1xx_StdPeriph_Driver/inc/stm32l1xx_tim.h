 ...
 */
    ...
    #define IS_TIM_23491011_PERIPH( PERIPH ) \
    ( ( ( PERIPH ) == TIM2 ) ||              \
      ( ( PERIPH ) == TIM3 ) ||              \
      ( ( PERIPH ) == TIM4 ) ||              \
      ( ( PERIPH ) == TIM9 ) ||              \
    ...
    #define IS_TIM_234_PERIPH( PERIPH ) \
    ( ( ( PERIPH ) == TIM2 ) ||         \
      ( ( PERIPH ) == TIM3 ) ||         \
      ( ( PERIPH ) == TIM4 ) )

    #define IS_TIM_2349_PERIPH( PERIPH ) \
    ( ( ( PERIPH ) == TIM2 ) ||          \
      ( ( PERIPH ) == TIM3 ) ||          \
      ( ( PERIPH ) == TIM4 ) ||          \
      ( ( PERIPH ) == TIM9 ) )

    #define IS_TIM_234679_PERIPH( PERIPH ) \
    ( ( ( PERIPH ) == TIM2 ) ||            \
      ( ( PERIPH ) == TIM3 ) ||            \
      ( ( PERIPH ) == TIM4 ) ||            \
      ( ( PERIPH ) == TIM6 ) ||            \
    ...
    #define IS_TIM_23467_PERIPH( PERIPH ) \
    ( ( ( PERIPH ) == TIM2 ) ||           \
      ( ( PERIPH ) == TIM3 ) ||           \
      ( ( PERIPH ) == TIM4 ) ||           \
      ( ( PERIPH ) == TIM6 ) ||           \
    ...
    #define IS_TIM_91011_PERIPH( PERIPH ) \
    ( ( ( PERIPH ) == TIM9 ) ||           \
      ( ( PERIPH ) == TIM10 ) ||          \
      ( ( PERIPH ) == TIM11 ) )
 ...
 */
    ...
    ( ( ( SOURCE ) == TIM_OCReferenceClear_ETRF ) || \
