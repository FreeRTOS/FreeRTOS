 ...
 */
    ...
    static word32 cpuid_flag( word32 leaf,
                              word32 sub,
                              word32 num,
                              word32 bit )
    {
...
#else  /* if defined( HAVE_INTEL_MULX ) */
    #define IF_HAVE_INTEL_MULX( func, ret )
...
/******************************************************************/
#else  /* if defined( TFM_X86 ) && !defined( TFM_SSE2 ) */
...
#endif /* if defined( TFM_X86 ) && !defined( TFM_SSE2 ) */
/******************************************************************/
