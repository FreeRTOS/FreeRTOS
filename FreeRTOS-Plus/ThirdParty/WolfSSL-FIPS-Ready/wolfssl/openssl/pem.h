...
/* RSA */
    WOLFSSL_API
    int wolfSSL_PEM_write_bio_RSAPrivateKey( WOLFSSL_BIO * bio,
                                             WOLFSSL_RSA * rsa,
    ...
    WOLFSSL_API
    int wolfSSL_PEM_write_bio_RSA_PUBKEY( WOLFSSL_BIO * bio,
                                          WOLFSSL_RSA * rsa );
    ...
    int wolfSSL_PEM_write_mem_RSAPrivateKey( RSA * rsa,
        ...
        WOLFSSL_API
        int wolfSSL_PEM_write_RSAPrivateKey( XFILE fp,
                                             WOLFSSL_RSA * rsa,
                                             ...
                                             void * u );
        WOLFSSL_API
        WOLFSSL_RSA * wolfSSL_PEM_read_RSAPublicKey( XFILE fp,
                                                     WOLFSSL_RSA ** x,
                                                     pem_password_cb * cb,
                                                     void * u );
        WOLFSSL_API
        int wolfSSL_PEM_write_RSAPublicKey( XFILE fp,
                                            WOLFSSL_RSA * x );

        WOLFSSL_API
        int wolfSSL_PEM_write_RSA_PUBKEY( XFILE fp,
                                          WOLFSSL_RSA * x );
    #endif /* NO_FILESYSTEM */
...
/* DSA */
    ...
    WOLFSSL_API
    int wolfSSL_PEM_write_bio_DSA_PUBKEY( WOLFSSL_BIO * bio,
                                          WOLFSSL_DSA * dsa );
    ...
    #if !defined( NO_FILESYSTEM )
        WOLFSSL_API
        int wolfSSL_PEM_write_DSAPrivateKey( XFILE fp,
                                             WOLFSSL_DSA * dsa,
                                             const EVP_CIPHER * enc,
                                             unsigned char * kstr,
                                             int klen,
                                             ...
                                             void * u );
        WOLFSSL_API
        int wolfSSL_PEM_write_DSA_PUBKEY( XFILE fp,
                                          WOLFSSL_DSA * x );
    #endif /* NO_FILESYSTEM */

/* ECC */
    WOLFSSL_API
    int wolfSSL_PEM_write_bio_ECPrivateKey( WOLFSSL_BIO * bio,
                                            WOLFSSL_EC_KEY * ec,
                                            const EVP_CIPHER * cipher,
                                            unsigned char * passwd,
                                            int len,
    ...
    #if !defined( NO_FILESYSTEM )
        WOLFSSL_API
        int wolfSSL_PEM_write_ECPrivateKey( XFILE fp,
                                            WOLFSSL_EC_KEY * key,
                                            const EVP_CIPHER * enc,
                                            unsigned char * kstr,
                                            int klen,
                                            ...
                                            void * u );
        WOLFSSL_API
        int wolfSSL_PEM_write_EC_PUBKEY( XFILE fp,
                                         WOLFSSL_EC_KEY * key );
...
/* EVP_KEY */
    ...
    int wolfSSL_PEM_write_bio_PrivateKey( WOLFSSL_BIO * bio,
                                          ...
                                          void * arg );
    WOLFSSL_API
    int wolfSSL_PEM_write_bio_PUBKEY( WOLFSSL_BIO * bio,
                                      WOLFSSL_EVP_PKEY * key );


    WOLFSSL_API
    int wolfSSL_PEM_read_bio( WOLFSSL_BIO * bio,
                              char ** name,
                              char ** header,
                              unsigned char ** data,
                              long * len );
    WOLFSSL_API
    int wolfSSL_PEM_write_bio( WOLFSSL_BIO * bio,
                               const char * name,
                               const char * header,
    ...
    #if !defined( NO_FILESYSTEM )
        WOLFSSL_API
        int wolfSSL_PEM_read( XFILE fp,
                              char ** name,
                              char ** header,
                              unsigned char ** data,
                              long * len );
        WOLFSSL_API
        int wolfSSL_PEM_write( XFILE fp,
                               const char * name,
                               const char * header,
                               const unsigned char * data,
                               long len );
    ...
    #if !defined( NO_FILESYSTEM )
        WOLFSSL_API
        WOLFSSL_EVP_PKEY * wolfSSL_PEM_read_PUBKEY( XFILE fp,
                                                    EVP_PKEY ** x,
                                                    pem_password_cb * cb,
                                                    void * u );
        WOLFSSL_API
        WOLFSSL_X509 * wolfSSL_PEM_read_X509( XFILE fp,
                                              WOLFSSL_X509 ** x,
                                              pem_password_cb * cb,
                                              void * u );
        WOLFSSL_API
        ...
        WOLFSSL_API
        int wolfSSL_PEM_write_X509( XFILE fp,
                                    WOLFSSL_X509 * x );
        WOLFSSL_API
        int wolfSSL_PEM_write_DHparams( XFILE fp,
                                        WOLFSSL_DH * dh );
    #endif /* NO_FILESYSTEM */
