...
#include <wolfssl/wolfcrypt/settings.h>
        ...
        #ifdef WOLFSSL_AES_COUNTER
            WOLFSSL_API void wc_AesCtrEncrypt( Aes * aes,
                                               byte * out,
                                               const byte * in,
                                               word32 sz )
            {
...
/* AES-DIRECT */
            ...
            static int AesAuthSetKey( Aes * aes,
                                      const byte * key,
                                      word32 keySz )
            {
            ...
            static int AesAuthArgCheck( Aes * aes,
                                        byte * out,
                                        const byte * in,
                                        word32 inSz,
                                        const byte * nonce,
            ...
            static void AesAuthSetIv( Aes * aes,
                                      const byte * nonce,
                                      word32 len,
                                      word32 L,
                                      int mode )
    ...
    if( nonce_save ) XFREE( nonce_save, NULL, DYNAMIC_TYPE_TMP_BUFFER );
            ...
            static int AesAuthEncrypt( Aes * aes,
                                       byte * out,
                                       const byte * in,
                                       word32 inSz,
                                       const byte * nonce,
            ...
            static int AesAuthDecrypt( Aes * aes,
                                       byte * out,
                                       const byte * in,
                                       word32 inSz,
                                       const byte * nonce,
        ...
        #endif /* if defined( HAVE_AESGCM ) || defined( HAVE_AESCCM ) */
