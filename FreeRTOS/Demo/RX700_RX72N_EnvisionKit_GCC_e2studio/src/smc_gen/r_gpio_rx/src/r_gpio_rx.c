...
***********************************************************************************************************************/
uint8_t volatile * gpio_port_addr_get( uint8_t volatile * base_addr,
                                       uint16_t index );
bool gpio_pin_function_check( uint8_t const * check_array,
                              uint8_t port_number,
                              uint8_t pin_number );
void gpio_set_output_type( gpio_port_pin_t pin,
                           gpio_pin_output_t out_type );
...
#endif /* if ( GPIO_CFG_PARAM_CHECKING_ENABLE == 1 ) */
