...
/*16 steps of HC-128, generate 512 bits keystream*/
    static void generate_keystream( HC128 * ctx,
                                    word32 * keystream )
    {
        word32 cc, dd;
 ...
 */
    ...
    static void Hc128_SetIV( HC128 * ctx,
                             const byte * inIv )
    {
        word32 i;
        word32 iv[ 4 ];
    ...
    static WC_INLINE int DoKey( HC128 * ctx,
                                const byte * key,
                                const byte * iv )
    {
        word32 i;
    ...
    int wc_Hc128_SetHeap( HC128 * ctx,
                          void * heap )
    {
        if( ctx == NULL )
        {
...
/* The following defines the encryption of data stream */
    static WC_INLINE int DoProcess( HC128 * ctx,
                                    byte * output,
                                    const byte * input,
                                    word32 msglen )
    {
...
/* Encrypt/decrypt a message of any size */
    int wc_Hc128_Process( HC128 * ctx,
                          byte * output,
                          const byte * input,
                          word32 msglen )
    {
