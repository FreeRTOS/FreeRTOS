...
/* Unlock the watchdog and then perform a register access */
    ...
    long int __metal_driver_sifive_wdog0_set_rate( const struct metal_watchdog * const wdog,
                                                   const long int rate )
    {
        const uintptr_t base =
            ( uintptr_t ) __metal_driver_sifive_wdog0_control_base( wdog );
    ...
    long int __metal_driver_sifive_wdog0_set_timeout( const struct metal_watchdog * const wdog,
