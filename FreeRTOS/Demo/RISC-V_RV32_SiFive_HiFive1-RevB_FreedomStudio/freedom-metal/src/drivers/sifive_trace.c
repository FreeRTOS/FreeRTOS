...
#include <metal/machine/platform.h>
    ...
    static void write_itc_uint32( struct metal_uart * trace,
                                  uint32_t data )
    {
    ...
    static void write_itc_uint16( struct metal_uart * trace,
                                  uint16_t data )
    {
        long base = __metal_driver_sifive_trace_base( trace );
    ...
    static void write_itc_uint8( struct metal_uart * trace,
                                 uint8_t data )
    {
        long base = __metal_driver_sifive_trace_base( trace );
    ...
    void __metal_driver_sifive_trace_init( struct metal_uart * trace,
                                           int baud_rate )
    {
