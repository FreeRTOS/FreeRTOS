 ...
 */
                static inline void atomic_set( int * v,
                                               int i )
                {
                    *v = i;
                }
 ...
 */
                ...
                static inline int atomic_fetch_add( unsigned int mask,
                                                    int * v )
                {
                    int out;
 ...
 */
                static inline void atomic_sub( int i,
                                               int * v )
                {
                    atomic_add( -i, v );
                }

                static inline int atomic_fetch_sub( unsigned int mask,
                                                    int * v )
                {
                    int out;
 ...
 */
                static inline int atomic_add_return( int i,
                                                     int * v )
                {
                    register int c;
 ...
 */
                static inline int atomic_sub_return( int i,
                                                     int * v )
                {
 ...
 * other cases.
 */
                static inline int atomic_sub_and_test( int i,
                                                       int * v )
                {
 ...
 */
                static inline int atomic_add_negative( int i,
                                                       int * v )
                {
                    return( atomic_add_return( i, v ) < 0 );
                }

                static inline int atomic_xchg( int * v,
                                               int n )
                {
                    register int c;
 ...
 */
                static inline void atomic_and( unsigned int mask,
                                               int * v )
                {
                    __asm__ __volatile__ (
                        "amoand.w zero, %1, %0"
                ...
                static inline int atomic_fetch_and( unsigned int mask,
                                                    int * v )
                {
                    int out;
 ...
 */
                static inline void atomic_or( unsigned int mask,
                                              int * v )
                {
                    __asm__ __volatile__ (
                        "amoor.w zero, %1, %0"
                ...
                static inline int atomic_fetch_or( unsigned int mask,
                                                   int * v )
                {
                    int out;
 ...
 */
                static inline void atomic_xor( unsigned int mask,
                                               int * v )
                {
                    __asm__ __volatile__ (
                        "amoxor.w zero, %1, %0"
                ...
                static inline int atomic_fetch_xor( unsigned int mask,
                                                    int * v )
                {
                    int out;
 ...
 */
                static inline int test_and_set_bit( int nr,
 ...
 * It also implies a memory barrier.
 */
                static inline int test_and_clear_bit( int nr,
                                                      volatile unsigned long * addr )
                {
                    unsigned long __res, __mask;
 ...
 */
                static inline void clear_bit( int nr,
                                              volatile unsigned long * addr )
                {
                    __asm__ __volatile__ (      \
                        "AMOAND.w zero, %1, %0" \
 ...
 */
                static inline void change_bit( int nr,
                                               volatile unsigned long * addr )
                {
                    __asm__ __volatile__ (      \
                        "AMOXOR.w zero, %1, %0" \
