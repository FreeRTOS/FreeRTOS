 ...
 */
    ...
    typedef void (* timer_event_cb_t)( timer_event_e event,
                                       void * arg );                /*/< Pointer to \ref timer_event_cb_t : TIMER Event call back. */
 ...
 * \return      error code
 */
    int32_t csi_timer_config( timer_handle_t handle,
                              timer_mode_e mode );
 ...
 * \return      error code
 */
    int32_t csi_timer_set_timeout( timer_handle_t handle,
                                   uint32_t timeout );
 ...
 * \return      error code
 */
    int32_t csi_timer_get_current_value( timer_handle_t handle,
                                         uint32_t * value );
 ...
 * \return      error code
 */
    int32_t csi_timer_get_load_value( timer_handle_t handle,
                                      uint32_t * value );
