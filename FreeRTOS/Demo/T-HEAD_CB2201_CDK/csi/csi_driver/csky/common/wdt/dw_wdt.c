...
static uint32_t timeout_ms[ 16 ] =
{
    4,     7,     13,    26, 52, 105, 210, 419, 839, 1678, 3355, 6711,
...
extern int32_t target_get_wdt( int32_t idx,
                               uint32_t * base,
                               uint32_t * irq );
 ...
 */
wdt_handle_t csi_wdt_initialize( int32_t idx,
                                 wdt_event_cb_t cb_event )
{
 ...
 * \return      \ref execution_status
 */
int32_t csi_wdt_set_timeout( wdt_handle_t handle,
                             uint32_t value )
{
    WDT_NULL_PARAM_CHK( handle );
    uint32_t i = 0u;
 ...
 * \return      \ref execution_status
 */
int32_t csi_wdt_read_current_value( wdt_handle_t handle,
                                    uint32_t * value )
{
    WDT_NULL_PARAM_CHK( handle );
