 ...
 */
    static int wolfSSL_BIO_BASE64_read( WOLFSSL_BIO * bio,
                                        void * buf,
                                        int len )
    {
        word32 frmtSz = len;
 ...
 */
    static int wolfSSL_BIO_BIO_read( WOLFSSL_BIO * bio,
                                     void * buf,
                                     int len )
    {
        int sz;
 ...
 */
    static int wolfSSL_BIO_MEMORY_read( WOLFSSL_BIO * bio,
                                        void * buf,
                                        int len )
    {
        int sz;
 ...
 */
        static int wolfSSL_BIO_SSL_read( WOLFSSL_BIO * bio,
                                         void * buf,
                                         int len,
                                         WOLFSSL_BIO * front )
        {
        ...
        static int wolfSSL_BIO_MD_read( WOLFSSL_BIO * bio,
                                        void * buf,
                                        int sz )
        {
 ...
 * returns the number of bytes read on success
 */
    int wolfSSL_BIO_read( WOLFSSL_BIO * bio,
                          void * buf,
                          int len )
    {
        int ret = 0;
 ...
 */
    static int wolfSSL_BIO_BASE64_write( WOLFSSL_BIO * bio,
                                         const void * data,
                                         word32 inLen,
                                         byte * out,
                                         word32 * outLen )
    {
        ...
        #else  /* if defined( WOLFSSL_BASE64_ENCODE ) */
            ( void ) bio;
            ( void ) data;
            ( void ) inLen;
            ( void ) out;
        ...
        #endif /* if defined( WOLFSSL_BASE64_ENCODE ) */
        return ret;
    }
 ...
 */
        static int wolfSSL_BIO_SSL_write( WOLFSSL_BIO * bio,
                                          const void * data,
                                          int len,
                                          WOLFSSL_BIO * front )
        {
 ...
 */
    static int wolfSSL_BIO_BIO_write( WOLFSSL_BIO * bio,
                                      const void * data,
                                      int len )
    {
        int sz;
 ...
 */
    static int wolfSSL_BIO_MEMORY_write( WOLFSSL_BIO * bio,
                                         const void * data,
                                         int len )
    {
        int sz;
 ...
 */
        static int wolfSSL_BIO_MD_write( WOLFSSL_BIO * bio,
                                         const void * data,
                                         int len )
        {
            int ret = 0;
 ...
 * returns the amount written in bytes on success
 */
    int wolfSSL_BIO_write( WOLFSSL_BIO * bio,
                           const void * data,
                           int len )
    {
        int ret = 0;
 ...
 */
        ...
        long wolfSSL_BIO_ctrl( WOLFSSL_BIO * bio,
                               int cmd,
                               long larg,
                               void * parg )
        {
    ...
    #endif /* if defined( OPENSSL_ALL ) || defined( OPENSSL_EXTRA ) */
 ...
 */
    static int wolfSSL_getLineLength( char * in,
                                      int inSz )
    {
        int i;
 ...
 */
    int wolfSSL_BIO_gets( WOLFSSL_BIO * bio,
                          char * buf,
                          int sz )
    {
        ...
        switch( bio->type )
        {
                ...
                case WOLFSSL_BIO_FILE:
                    ...
                    #endif /* if defined( MICRIUM ) || defined( LSR_FS ) || defined( EBSNET ) */
                    break;
            #endif /* NO_FILESYSTEM */
 ...
 */
    int wolfSSL_BIO_puts( WOLFSSL_BIO * bio,
                          const char * buf )
    {
        int sz;
 ...
 * returns NULL on failure to find a given type */
    WOLFSSL_BIO * wolfSSL_BIO_find_type( WOLFSSL_BIO * bio,
                                         int type )
    {
...
/* Return the number of pending bytes in read and write buffers */
    ...
    int wolfSSL_BIO_set_write_buf_size( WOLFSSL_BIO * bio,
                                        long size )
    {
...
/* overwrites file */
    ...
    void wolfSSL_BIO_set_callback_arg( WOLFSSL_BIO * bio,
                                       char * arg )
    {
...
/* store a user pointer in the WOLFSSL_BIO structure */
    void wolfSSL_BIO_set_data( WOLFSSL_BIO * bio,
                               void * ptr )
    {
 ...
 * Always returns 1
 */
    long wolfSSL_BIO_set_nbio( WOLFSSL_BIO * bio,
                               long on )
    {
        int ret = 0;
...
/* creates a new custom WOLFSSL_BIO_METHOD */
    WOLFSSL_BIO_METHOD * wolfSSL_BIO_meth_new( int type,
                                               const char * name )
    {
