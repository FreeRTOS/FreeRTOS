...
/****** IIC Event *****/
    ...
    typedef void (* iic_event_cb_t)( iic_event_e event,
                                     void * arg );             /*/< Pointer to \ref iic_event_cb_t : IIC Event call back. */
 ...
 */
    iic_handle_t csi_iic_initialize( pin_t scl,
                                     pin_t sda,
 ...
 * \return      0 for success, negative for error code
 */
    int32_t csi_iic_master_send( iic_handle_t handle,
                                 const void * data,
                                 uint32_t num,
                                 bool xfer_pending );
 ...
 * \return      0 for success, negative for error code
 */
    int32_t csi_iic_master_receive( iic_handle_t handle,
                                    void * data,
                                    uint32_t num,
                                    bool xfer_pending );
 ...
 * \return      0 for success, negative for error code
 */
    int32_t csi_iic_slave_send( iic_handle_t handle,
                                const void * data,
                                uint32_t num );
 ...
 * \return      0 for success, negative for error code
 */
    int32_t csi_iic_slave_receive( iic_handle_t handle,
                                   const void * data,
                                   uint32_t num );
 ...
 * \return      error code
 */
    int32_t csi_iic_power_control( iic_handle_t handle,
 ...
 * \return      error code
 */
    int32_t csi_iic_config_mode( iic_handle_t handle,
                                 iic_mode_e mode );
 ...
 * \return      error code
 */
    int32_t csi_iic_config_speed( iic_handle_t handle,
                                  iic_speed_e speed );
 ...
 * \return      error code
 */
    int32_t csi_iic_config_addr_mode( iic_handle_t handle,
                                      iic_address_mode_e addr_mode );
 ...
 * \return      error code
 */
    int32_t csi_iic_config_slave_addr( iic_handle_t handle,
                                       int32_t slave_addr );
 ...
 */
    int32_t csi_iic_read_byte( iic_handle_t handle,
                               int32_t last );
 ...
 */
    int32_t csi_iic_write_byte( iic_handle_t handle,
                                uint8_t data );
