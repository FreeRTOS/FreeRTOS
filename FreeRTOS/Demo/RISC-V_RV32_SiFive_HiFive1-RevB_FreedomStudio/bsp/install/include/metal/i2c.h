...
typedef enum
{
    METAL_I2C_SLAVE = 0, METAL_I2C_MASTER = 1
} metal_i2c_mode_t;
...
{
    void (* init)( struct metal_i2c * i2c,
                   unsigned int baud_rate,
                   metal_i2c_mode_t mode );
    int (* write)( struct metal_i2c * i2c,
                   unsigned int addr,
                   unsigned int len,
                   unsigned char buf[],
                   metal_i2c_stop_bit_t stop_bit );
    int (* read)( struct metal_i2c * i2c,
                  unsigned int addr,
                  unsigned int len,
                  unsigned char buf[],
                  metal_i2c_stop_bit_t stop_bit );
    int (* transfer)( struct metal_i2c * i2c,
                      unsigned int addr,
                      unsigned char txbuf[],
                      unsigned int txlen,
                      unsigned char rxbuf[],
    ...
    int (* set_baud_rate)( struct metal_i2c * i2c,
                           unsigned int baud_rate );
};
 ...
 */
inline void metal_i2c_init( struct metal_i2c * i2c,
                            unsigned int baud_rate,
                            metal_i2c_mode_t mode )
{
 ...
 */
inline int metal_i2c_read( struct metal_i2c * i2c,
                           unsigned int addr,
                           unsigned int len,
                           unsigned char buf[],
                           metal_i2c_stop_bit_t stop_bit )
 ...
 */
inline int metal_i2c_set_baud_rate( struct metal_i2c * i2c,
                                    int baud_rate )
{
    return i2c->vtable->set_baud_rate( i2c, baud_rate );
}

#endif /* ifndef METAL__I2C_H */
