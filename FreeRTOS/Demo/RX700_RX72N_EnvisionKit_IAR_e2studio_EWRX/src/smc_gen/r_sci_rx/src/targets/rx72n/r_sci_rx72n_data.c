...
/* rom info */
    const sci_ch_rom_t ch0_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI0,
...
/* channel control block */
    sci_ch_ctrl_t ch0_ctrl =
    {
        &ch0_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKB_HZ
...
/* rom info */
    const sci_ch_rom_t ch1_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI1,
...
/* channel control block */
    sci_ch_ctrl_t ch1_ctrl =
    {
        &ch1_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKB_HZ
...
/* rom info */
    const sci_ch_rom_t ch2_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI2,
...
/* channel control block */
    sci_ch_ctrl_t ch2_ctrl =
    {
        &ch2_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKB_HZ
...
/* rom info */
    const sci_ch_rom_t ch3_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI3,
...
/* channel control block */
    sci_ch_ctrl_t ch3_ctrl =
    {
        &ch3_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKB_HZ
...
/* rom info */
    const sci_ch_rom_t ch4_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI4,
...
/* channel control block */
    sci_ch_ctrl_t ch4_ctrl =
    {
        &ch4_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKB_HZ
...
/* rom info */
    const sci_ch_rom_t ch5_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI5,
...
/* channel control block */
    sci_ch_ctrl_t ch5_ctrl =
    {
        &ch5_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKB_HZ
...
/* rom info */
    const sci_ch_rom_t ch6_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI6,
...
/* channel control block */
    sci_ch_ctrl_t ch6_ctrl =
    {
        &ch6_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKB_HZ
...
/* rom info */
    const sci_ch_rom_t ch7_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI7,
...
/* channel control block */
    sci_ch_ctrl_t ch7_ctrl =
    {
        &ch7_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKA_HZ
...
/* rom info */
    const sci_ch_rom_t ch8_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI8,
...
/* channel control block */
    sci_ch_ctrl_t ch8_ctrl =
    {
        &ch8_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKA_HZ
...
/* rom info */
    const sci_ch_rom_t ch9_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI9,
...
/* channel control block */
    sci_ch_ctrl_t ch9_ctrl =
    {
        &ch9_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,     true,         0, 0,    false
        #endif
        ,         BSP_PCLKA_HZ
...
/* rom info */
    const sci_ch_rom_t ch10_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI10,
...
/* channel control block */
    sci_ch_ctrl_t ch10_ctrl =
    {
        &ch10_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,      true,         0, 0,    false
        #endif
        ,          BSP_PCLKA_HZ
...
/* rom info */
    const sci_ch_rom_t ch11_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI11,
...
/* channel control block */
    sci_ch_ctrl_t ch11_ctrl =
    {
        &ch11_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,      true,         0, 0,    false
        #endif
        ,          BSP_PCLKA_HZ
...
/* rom info */
    const sci_ch_rom_t ch12_rom =
    {
        ( volatile struct st_sci7 R_BSP_EVENACCESS_SFR * ) &SCI12,
...
/* channel control block */
    sci_ch_ctrl_t ch12_ctrl =
    {
        &ch12_rom, SCI_MODE_OFF, 0, NULL, NULL, NULL, true
        #if ( SCI_CFG_SSPI_INCLUDED || SCI_CFG_SYNC_INCLUDED )
            ,      true,         0, 0,    false
        #endif
        ,          BSP_PCLKB_HZ
