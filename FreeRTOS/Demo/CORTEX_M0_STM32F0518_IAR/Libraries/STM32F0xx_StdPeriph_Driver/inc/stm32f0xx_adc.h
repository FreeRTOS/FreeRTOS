...
/* TIM15 */
    ...
    ( ( ( CONV ) == ADC_ExternalTrigConv_T1_TRGO ) || \
 ...
 */
    ...
    ( ( ( DIRECTION ) == ADC_ScanDirection_Upward ) || \
 ...
 */
    ...
    ( ( ( CHANNEL ) == ADC_AnalogWatchdog_Channel_0 ) ||  \
 ...
 */
    ...
    ( ( ( IT ) == ADC_IT_ADRDY ) || ( ( IT ) == ADC_IT_EOSMP ) || \
 ...
 */
    ...
    ( ( ( FLAG ) == ADC_FLAG_ADRDY ) || ( ( FLAG ) == ADC_FLAG_EOSMP ) ||   \
...
/* Power saving functions *****************************************************/
    void ADC_AutoPowerOffCmd( ADC_TypeDef * ADCx,
                              FunctionalState NewState );
    void ADC_AutoDelayConversionCmd( ADC_TypeDef * ADCx,
                                     FunctionalState NewState );
