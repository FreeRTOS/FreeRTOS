...
typedef void (* lpuart_isr_t)( LPUART_Type * base,
 ...
 */
static size_t LPUART_TransferGetRxRingBufferLength( LPUART_Type * base,
                                                    lpuart_handle_t * handle );
                      ...
                      uint32_t srcClock_Hz )
{
    ...
    #endif /* if defined( FSL_FEATURE_LPUART_HAS_7BIT_DATA_SUPPORT ) && FSL_FEATURE_LPUART_HAS_7BIT_DATA_SUPPORT */
    {
        if( kLPUART_ParityDisabled != config->parityMode )
        {
    ...
    #endif /* if defined( FSL_FEATURE_LPUART_HAS_MODEM_SUPPORT ) && FSL_FEATURE_LPUART_HAS_MODEM_SUPPORT */
                               ...
                               lpuart_handle_t * handle )
{
    ...
    if( ( LPUART_STAT_IDLE_MASK & base->STAT ) && ( LPUART_CTRL_ILIE_MASK & base->CTRL ) )
    {
        ...
        #endif /* if defined( FSL_FEATURE_LPUART_HAS_FIFO ) && FSL_FEATURE_LPUART_HAS_FIFO */
        /* Clear IDLE flag.*/
                                    ...
                                    lpuart_handle_t * handle )
{
    ...
    #else  /* if defined( FSL_FEATURE_LPUART_HAS_SEPARATE_RX_TX_IRQ ) && FSL_FEATURE_LPUART_HAS_SEPARATE_RX_TX_IRQ */
    ...
    #endif /* if defined( FSL_FEATURE_LPUART_HAS_SEPARATE_RX_TX_IRQ ) && FSL_FEATURE_LPUART_HAS_SEPARATE_RX_TX_IRQ */
#endif /* if defined( FSL_FEATURE_LPUART_HAS_SHARED_IRQ0_IRQ1 ) && FSL_FEATURE_LPUART_HAS_SHARED_IRQ0_IRQ1 */
