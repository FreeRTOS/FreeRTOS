 ...
 */
    ...
    #include <wolfssl/wolfcrypt/sp_int.h>
        ...
        WOLFSSL_LOCAL int sp_ModExp_1024( sp_int * base,
                                          sp_int * exp,
                                          sp_int * mod,
                                          sp_int * res );
        WOLFSSL_LOCAL int sp_ModExp_1536( sp_int * base,
                                          sp_int * exp,
                                          sp_int * mod,
                                          sp_int * res );
        WOLFSSL_LOCAL int sp_ModExp_2048( sp_int * base,
                                          sp_int * exp,
                                          sp_int * mod,
                                          sp_int * res );
        WOLFSSL_LOCAL int sp_ModExp_3072( sp_int * base,
                                          sp_int * exp,
                                          sp_int * mod,
                                          sp_int * res );
        WOLFSSL_LOCAL int sp_ModExp_4096( sp_int * base,
                                          sp_int * exp,
                                          sp_int * mod,
                                          sp_int * res );

    #endif /* if defined( WOLFSSL_HAVE_SP_DH ) || defined( WOLFSSL_HAVE_SP_RSA ) */
 ...
 */
    ...
    #endif /* if !defined( WOLFSSL_RSA_PUBLIC_ONLY ) || ( !defined( NO_DH ) || defined( HAVE_ECC ) ) */
 ...
 *         MP_OKAY otherwise.
 */
    int sp_read_unsigned_bin( sp_int * a,
                              const byte * in,
                              word32 inSz )
    {
        int err = MP_OKAY;
 ...
 * returns MP_OKAY always.
 */
        int sp_to_unsigned_bin( sp_int * a,
                                byte * out )
        {
            int i, j, b;
            sp_int_digit d;
    ...
    #endif /* if !defined( NO_DH ) || defined( HAVE_ECC ) || defined( WC_RSA_BLINDING ) || !defined( WOLFSSL_RSA_VERIFY_ONLY ) */
 ...
 * returns MP_OKAY always.
 */
    int sp_to_unsigned_bin_len( sp_int * a,
                                byte * out,
                                int outSz )
    {
        int i, j, b;
...
/* creates "a" then copies b into it */
    ...
    #endif /* if !defined( WOLFSSL_RSA_VERIFY_ONLY ) || ( !defined( NO_DH ) || defined( HAVE_ECC ) ) */
 ...
 */
            static void _sp_mul_d( sp_int * a,
                                   sp_int_digit n,
                                   sp_int * r,
                                   int o )
            {
        ...
        #endif /* if defined( WOLFSSL_SP_SMALL ) || ( defined( WOLFSSL_KEY_GEN ) || !defined( NO_DH ) && !defined( WC_NO_RNG ) ) */
 ...
 */
        static WC_INLINE sp_int_digit sp_div_word( sp_int_digit hi,
                                                   sp_int_digit lo,
                                                   sp_int_digit d )
        {
                ...
                return r;
            #else  /* ifdef WOLFSSL_SP_DIV_WORD_HALF */
                sp_int_word w;
                sp_int_digit r;
                ...
                return r;
            #endif /* ifdef WOLFSSL_SP_DIV_WORD_HALF */
        }
 ...
 */
        ...
        #endif
    #endif /* if !defined( NO_DH ) || defined( HAVE_ECC ) || !defined( WOLFSSL_RSA_VERIFY_ONLY ) */
 ...
 */
        ...
        #endif /* if defined( WOLFSSL_HAVE_SP_DH ) || defined( WOLFSSL_KEY_GEN ) */
 ...
 */
        static int sp_mod_d( sp_int * a,
                             const sp_int_digit d,
                             sp_int_digit * r )
        {
            int err = MP_OKAY;
            int i;
 ...
 */
                        ...
                        sp_int * r )
        {
            ...
            #else  /* if defined( WOLFSSL_HAVE_SP_DH ) && defined( WOLFSSL_KEY_GEN ) */
                if( !done && ( err == MP_OKAY ) )
                {
                    err = MP_VAL;
                }
 ...
 */
        static int sp_prime_miller_rabin_ex( sp_int * a,
                                             sp_int * b,
                                             int * result,
                                             sp_int * n1,
                                             sp_int * y,
 ...
 */
        static int sp_prime_miller_rabin( sp_int * a,
                                          sp_int * b,
                                          int * result )
        {
            int err = MP_OKAY;
 ...
 */
        int sp_prime_is_prime( sp_int * a,
                               int t,
                               int * result )
        {
            int err = MP_OKAY;
 ...
 *         fails and otherwise MP_OKAY.
 */
        int sp_prime_is_prime_ex( sp_int * a,
                                  int t,
                                  int * result,
                                  WC_RNG * rng )
        {
        ...
        #endif /* ifndef NO_DH */
    #endif /* if defined( WOLFSSL_KEY_GEN ) || !defined( NO_DH ) && !defined( WC_NO_RNG ) */
