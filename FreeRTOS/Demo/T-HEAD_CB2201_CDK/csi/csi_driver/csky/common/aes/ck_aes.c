...
extern int32_t target_get_aes( int32_t idx,
                               uint32_t * base,
                               uint32_t * irq );
...
static void aes_set_key( void * context,
                         uint8_t * key,
                         aes_key_len_bits_e keylen,
                         uint32_t enc,
                         uint32_t endian )
...
static void aes_set_iv( uint32_t mode,
                        uint32_t endian,
                        uint8_t * iv )
{
    uint32_t temp;
...
static int aes_crypto( void * context,
                       uint8_t * in,
                       uint8_t * out,
                       uint32_t len,
                       uint8_t * iv,
 ...
 */
aes_handle_t csi_aes_initialize( int32_t idx,
                                 aes_event_cb_t cb_event )
{
 ...
 * \return      error code
 */
int32_t csi_aes_set_key( aes_handle_t handle,
                         void * context,
                         void * key,
                         aes_key_len_bits_e key_len,
                         aes_crypto_mode_e enc )
{
    AES_NULL_PARA_CHK( handle );
 ...
 * \return      error code
 */
int32_t csi_aes_crypto( aes_handle_t handle,
                        void * context,
                        void * in,
                        void * out,
                        uint32_t len,
                        aes_padding_mode_e padding )
{
    AES_NULL_PARA_CHK( handle );
