...
#else  /* if ( DEBUG_CONSOLE_SYNCHRONIZATION_MODE == DEBUG_CONSOLE_SYNCHRONIZATION_FREERTOS ) */
 ...
 ******************************************************************************/
    ...
    #endif /* if ( defined( DEBUG_CONSOLE_RX_ENABLE ) && ( DEBUG_CONSOLE_RX_ENABLE > 0U ) ) */

#endif /* if defined( DEBUG_CONSOLE_TRANSFER_NON_BLOCKING ) */
...
/* recieve one char every time */
        ...
        #endif /* if defined( DEBUG_CONSOLE_TRANSFER_NON_BLOCKING ) && ( DEBUG_CONSOLE_SYNCHRONIZATION_MODE == DEBUG_CONSOLE_SYNCHRONIZATION_BM ) && defined( OSA_USED ) */
    #else  /* if ( defined( DEBUG_CONSOLE_RX_ENABLE ) && ( DEBUG_CONSOLE_RX_ENABLE > 0U ) ) */
        return ( status_t ) kStatus_Fail;
    #endif /* if ( defined( DEBUG_CONSOLE_RX_ENABLE ) && ( DEBUG_CONSOLE_RX_ENABLE > 0U ) ) */
}

#if DEBUG_CONSOLE_ENABLE_ECHO_FUNCTION
    static status_t DbgConsole_EchoCharacter( uint8_t * ch,
                                              bool isGetChar,
                                              int * index )
    {
...
#endif /* if DEBUG_CONSOLE_ENABLE_ECHO_FUNCTION */
                         ...
                         size_t size )
{
    ...
    assert( 0 != size );
        ...
        EnableGlobalIRQ( regPrimask );
    #else  /* if defined( DEBUG_CONSOLE_TRANSFER_NON_BLOCKING ) */
                                 ...
                                 size_t size )
{
    ...
    if( NULL == g_serialHandle )
    {
        ...
        #else  /* if ( defined( DEBUG_CONSOLE_TX_RELIABLE_ENABLE ) && ( DEBUG_CONSOLE_TX_RELIABLE_ENABLE > 0U ) ) */
...
/* See fsl_debug_console.h for documentation of this function. */
    ...
    DEBUG_CONSOLE_FUNCTION_PREFIX status_t DbgConsole_Flush( void )
    {
                ...
                while( s_debugConsoleState.writeRingBuffer.ringHead != s_debugConsoleState.writeRingBuffer.ringTail )
                {
                    ...
                    #endif /* if ( DEBUG_CONSOLE_SYNCHRONIZATION_MODE == DEBUG_CONSOLE_SYNCHRONIZATION_FREERTOS ) */
                }
            #endif /* if ( DEBUG_CONSOLE_SYNCHRONIZATION_MODE == DEBUG_CONSOLE_SYNCHRONIZATION_BM ) && defined( OSA_USED ) */
        #endif /* if defined( DEBUG_CONSOLE_TRANSFER_NON_BLOCKING ) */
        return ( status_t ) kStatus_Success;
    }
#endif /* if ( ( SDK_DEBUGCONSOLE > 0U ) || ( ( SDK_DEBUGCONSOLE == 0U ) && defined( DEBUG_CONSOLE_TRANSFER_NON_BLOCKING ) && ( defined( DEBUG_CONSOLE_TX_RELIABLE_ENABLE ) && ( DEBUG_CONSOLE_TX_RELIABLE_ENABLE > 0U ) ) ) ) */
...
/* See fsl_debug_console.h for documentation of this function. */
    ...
    #endif /* ifdef DEBUG_CONSOLE_TRANSFER_NON_BLOCKING */
...
/* support LPC Xpresso with RedLib */
    ...
    #endif /* if ( defined( SDK_DEBUGCONSOLE_UART ) ) */
 ...
 */
        ...
        char * _sys_command_string( char * cmd,
                                    int len )
        {
            return( cmd );
        }
...
/* These function __write and __read is used to support ARM_GCC, KDS, Atollic toolchains to printf and scanf*/
    ...
    #endif /* if ( ( defined( __GNUC__ ) && ( !defined( __MCUXPRESSO ) ) && ( defined( SDK_DEBUGCONSOLE_UART ) ) ) || ( defined( __MCUXPRESSO ) && ( defined( SDK_DEBUGCONSOLE_UART ) ) ) ) */
