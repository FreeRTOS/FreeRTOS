...
extern inline int metal_pwm_set_freq( struct metal_pwm * pwm,
                                      unsigned int idx,
                                      unsigned int freq );
extern inline int metal_pwm_set_duty( struct metal_pwm * pwm,
                                      unsigned int idx,
                                      unsigned int duty,
...
extern inline int metal_pwm_stop( struct metal_pwm * pwm,
                                  unsigned int idx );
...
extern inline int metal_pwm_clr_interrupt( struct metal_pwm * pwm,
                                           unsigned int idx );
extern struct metal_interrupt * metal_pwm_interrupt_controller( struct metal_pwm * pwm );
extern int metal_pwm_get_interrupt_id( struct metal_pwm * pwm,
                                       unsigned int idx );
