...
/*************Code for process formatted data*******************************/
    ...
    static uint8_t PrintGetSignChar( long long int ival,
                                     uint32_t flags_used,
                                     char * schar )
    {
        uint8_t len = 1U;
                                 ...
                                 int32_t * count )
{
    ...
    #else  /* if ( defined( PRINTF_ADVANCED_ENABLE ) && ( PRINTF_ADVANCED_ENABLE > 0 ) ) */
        cb( buf, count, ' ', ( int ) field_width - ( int ) vlen );
    #endif /* PRINTF_ADVANCED_ENABLE */
    ...
    while( true )
    {
        ...
        c = *++p;
        {
            ...
            else if( 1U == PrintIsfF( c ) )
            {
                    ...
                    #endif
                #else  /* if ( defined( PRINTF_FLOAT_ENABLE ) && ( PRINTF_FLOAT_ENABLE > 0 ) ) */
...
#endif /* if ( defined( SCANF_FLOAT_ENABLE ) && ( SCANF_FLOAT_ENABLE > 0 ) ) */
                                         ...
                                         int32_t val )
{
    ...
    #else  /* if ( defined( SCANF_ADVANCED_ENABLE ) && ( SCANF_ADVANCED_ENABLE > 0 ) ) */
        /* The default type is the type int. */
        if( 0U != ( flag & ( uint32_t ) kSCANF_TypeSinged ) )
        {
            *va_arg( *args_ptr, signed int * ) = ( signed int ) val;
...
#if ( defined( SCANF_FLOAT_ENABLE ) && ( SCANF_FLOAT_ENABLE > 0 ) )
    static uint8_t StrFormatScanFillFloat( uint32_t flag,
                                           va_list * args_ptr,
                                           double fnum )
    {
        #if ( defined( SCANF_ADVANCED_ENABLE ) && ( SCANF_ADVANCED_ENABLE > 0 ) )
