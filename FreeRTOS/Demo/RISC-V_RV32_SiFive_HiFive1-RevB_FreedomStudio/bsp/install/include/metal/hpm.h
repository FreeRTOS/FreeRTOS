 ...
 * @return 0 If no error.*/
int metal_hpm_set_event( struct metal_cpu * cpu,
 ...
 * @param counter Hardware counter.
 * @return 0 If no error.*/
int metal_hpm_clr_event( struct metal_cpu * cpu,
                         metal_hpm_counter counter,
                         unsigned int bitmask );
 ...
 * @param counter Hardware counter.
 * @return 0 If no error.*/
int metal_hpm_enable_access( struct metal_cpu * cpu,
                             metal_hpm_counter counter );
 ...
 * @param counter Hardware counter.
 * @return 0 If no error.*/
int metal_hpm_disable_access( struct metal_cpu * cpu,
                              metal_hpm_counter counter );
 ...
 * @param counter Hardware counter.
 * @return 0 If no error.*/
int metal_hpm_clear_counter( struct metal_cpu * cpu,
                             metal_hpm_counter counter );

#endif /* ifndef METAL__HPM_H */
