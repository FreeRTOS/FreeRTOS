              ...
              uint8_t * ringBuffer )
{
    ...
    switch( s_debugConsoleIO.ioType )
    {
            ...
            case DEBUG_CONSOLE_DEVICE_TYPE_IUART:
               ...
               break;
        #endif /* if ( defined DEBUG_CONSOLE_IO_UART ) || ( defined DEBUG_CONSOLE_IO_IUART ) */
            ...
            case DEBUG_CONSOLE_DEVICE_TYPE_LPUART:
               ...
               break;
        #endif /* if defined DEBUG_CONSOLE_IO_LPUART */
        #if defined DEBUG_CONSOLE_IO_LPSCI
            ...
            case DEBUG_CONSOLE_DEVICE_TYPE_FLEXCOMM:
               ...
               break;
        #endif /* if defined DEBUG_CONSOLE_IO_FLEXCOMM */
            ...
            case DEBUG_CONSOLE_DEVICE_TYPE_VUSART:
               ...
               break;
        #endif /* if defined DEBUG_CONSOLE_IO_VUSART */
    }
}
...
status_t IO_Deinit( void )
{
    ...
    switch( s_debugConsoleIO.ioType )
    {
            ...
            case DEBUG_CONSOLE_DEVICE_TYPE_VUSART:
                ...
                break;
        #endif /* if ( defined DEBUG_CONSOLE_IO_FLEXCOMM ) || ( defined DEBUG_CONSOLE_IO_VUSART ) */
        default:
                          ...
                          bool tx )
    {
        ...
        switch( s_debugConsoleIO.ioType )
        {
                ...
                case DEBUG_CONSOLE_DEVICE_TYPE_USBCDC:
                    ...
                    break;
            #endif /* if defined DEBUG_CONSOLE_IO_USBCDC */
