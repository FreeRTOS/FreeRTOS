...
#include <wolfssl/wolfcrypt/settings.h>
        ...
        #endif /* if !defined( HAVE_PKCS7 ) && ( ( defined( HAVE_FIPS ) && defined( HAVE_FIPS_VERSION ) && ( HAVE_FIPS_VERSION > 2 ) ) || defined( HAVE_SELFTEST ) ) */
 ...
 */
    ...
    static int fillBuff( WOLFSSL_EVP_CIPHER_CTX * ctx,
                               ...
                               int inl )
    {
        ...
        switch( ctx->cipherType )
        {
                    ...
                    case AES_256_OFB_TYPE:
                        ...
                        break;
                #endif /* if defined( WOLFSSL_AES_OFB ) */
                #if defined( WOLFSSL_AES_CFB )
                    ...
                    case AES_256_XTS_TYPE:
                        ...
                        break;
                #endif /* if defined( WOLFSSL_AES_XTS ) */
            #endif /* !NO_AES */
            #ifndef NO_DES3
                case DES_CBC_TYPE:
 ...
 * length with the block_size so the last block is still captured. */
        ...
        #endif /* ifdef WOLFSSL_EVP_DECRYPT_LEGACY */
 ...
 */
    WOLFSSL_EVP_PKEY_CTX * wolfSSL_EVP_PKEY_CTX_new( WOLFSSL_EVP_PKEY * pkey,
                                                     WOLFSSL_ENGINE * e )
    {
...
/* create a PKEY contxt and return it */
    WOLFSSL_EVP_PKEY_CTX * wolfSSL_EVP_PKEY_CTX_new_id( int id,
                                                        WOLFSSL_ENGINE * e )
    {
...
/* Returns WOLFSSL_SUCCESS or error */
                                          ...
                                          WOLFSSL_EVP_PKEY * peer )
    {
        ...
        return WOLFSSL_SUCCESS;
            ...
            int wolfSSL_EVP_PKEY_derive( WOLFSSL_EVP_PKEY_CTX * ctx,
                                         unsigned char * key,
                                         size_t * keylen )
            {
                int len;
        ...
        switch( pkey->type )
        {
            ...
            !defined( NO_RSA ) && !defined( HAVE_USER_RSA )
                case EVP_PKEY_RSA:
                    ...
                    break;
            #endif /* if !defined( HAVE_FAST_RSA ) && defined( WOLFSSL_KEY_GEN ) && !defined( NO_RSA ) && !defined( HAVE_USER_RSA ) */
            #ifdef HAVE_ECC
                case EVP_PKEY_EC:
 ...
 */
    ...
    WOLFSSL_API int wolfSSL_EVP_PKEY_cmp( const WOLFSSL_EVP_PKEY * a,
 ...
 * returns WOLFSSL_SUCCESS on success
 */
    int wolfSSL_EVP_SignInit( WOLFSSL_EVP_MD_CTX * ctx,
                              const WOLFSSL_EVP_MD * type )
    {
        if( ctx == NULL )
        {
 ...
 * returns WOLFSSL_SUCCESS on success
 */
    int wolfSSL_EVP_SignUpdate( WOLFSSL_EVP_MD_CTX * ctx,
                                const void * data,
                                size_t len )
    {
        if( ctx == NULL )
 ...
 * returns WOLFSSL_SUCCESS on success and WOLFSSL_FAILURE on failure
 */
    int wolfSSL_EVP_SignFinal( WOLFSSL_EVP_MD_CTX * ctx,
 ...
 * returns WOLFSSL_SUCCESS on success
 */
    int wolfSSL_EVP_VerifyInit( WOLFSSL_EVP_MD_CTX * ctx,
                                const WOLFSSL_EVP_MD * type )
    {
        if( ctx == NULL )
        {
 ...
 * returns WOLFSSL_SUCCESS on success and WOLFSSL_FAILURE on failure
 */
    int wolfSSL_EVP_VerifyUpdate( WOLFSSL_EVP_MD_CTX * ctx,
                                  const void * data,
                                  size_t len )
    {
        if( ctx == NULL )
 ...
 */
    ...
    WOLFSSL_EVP_PKEY * wolfSSL_EVP_PKEY_new_mac_key( int type,
                                                     ENGINE * e,
                                                     const unsigned char * key,
                                                     int keylen )
    {
...
/* Get the length of the mac based on the digest algorithm. */
                                       ...
                                       size_t siglen )
    {
        ...
        return WOLFSSL_FAILURE;
            ...
            #ifndef XGETPASSWD
            static int XGETPASSWD( char * buf,
                                   int bufSz )
            {
                int ret = WOLFSSL_SUCCESS;
            ...
            #endif /* ifndef XGETPASSWD */

/* returns 0 on success and -2 or -1 on failure */
        int wolfSSL_EVP_read_pw_string( char * buf,
                                        int bufSz,
                                        const char * banner,
                                        int v )
        {
        ...
        int wolfSSL_PKCS5_PBKDF2_HMAC_SHA1( const char * pass,
                                            int passlen,
        ...
        WOLFSSL_API int wolfSSL_PKCS5_PBKDF2_HMAC( const char * pass,
                                                   int passlen,
                                                   const unsigned char * salt,
                                                   int saltlen,
                                                   int iter,
...
/* this function makes the assumption that out buffer is big enough for digest*/
        int wolfSSL_EVP_Digest( const unsigned char * in,
                                int inSz,
                                unsigned char * out,
                                unsigned int * outSz,
 ...
 * returns WOLFSSL_SUCCESS on success */
    ...
    void wolfSSL_EVP_CIPHER_CTX_init( WOLFSSL_EVP_CIPHER_CTX * ctx )
    {
        ...
        #endif /* if defined( HAVE_AESGCM ) && !defined( HAVE_SELFTEST ) */

/* This function allows cipher specific parameters to be
 * determined and set. */
    int wolfSSL_EVP_CIPHER_CTX_ctrl( WOLFSSL_EVP_CIPHER_CTX * ctx,
                                     int type, \
                                     int arg,
                                     void * ptr )
    {
                    ...
                    case EVP_CTRL_AEAD_SET_IV_FIXED:
                        ...
                        break;
                            ...
                            case EVP_CTRL_GCM_IV_GEN:
                                ...
                                break;
                        #endif /* if !defined( _WIN32 ) && !defined( HAVE_FIPS ) */
...
/* Permanent stub for Qt compilation. */
        ...
        #ifndef NO_AES
        static int AesSetKey_ex( Aes * aes,
                                 const byte * key,
                                 word32 len,
                                 const byte * iv,
                                 int dir,
...
/* returns WOLFSSL_SUCCESS on success, otherwise returns WOLFSSL_FAILURE */
        int wolfSSL_EVP_CIPHER_CTX_set_iv( WOLFSSL_EVP_CIPHER_CTX * ctx,
                                           byte * iv,
                                           int ivLen )
        {
            int expectedIvLen;
...
/* WOLFSSL_SUCCESS on ok */
    int wolfSSL_EVP_Cipher( WOLFSSL_EVP_CIPHER_CTX * ctx,
                            byte * dst,
                            byte * src,
                            word32 len )
    {
...
/* WOLFSSL_SUCCESS on ok, WOLFSSL_FAILURE on failure */
    int wolfSSL_EVP_DigestUpdate( WOLFSSL_EVP_MD_CTX * ctx,
                                  const void * data,
                                  size_t sz )
    {
        int ret = WOLFSSL_FAILURE;
...
/* WOLFSSL_SUCCESS on ok */
    int wolfSSL_EVP_DigestFinal( WOLFSSL_EVP_MD_CTX * ctx,
                                 unsigned char * md,
                                 unsigned int * s )
    {
        int ret = WOLFSSL_FAILURE;
...
/* WOLFSSL_SUCCESS on ok */
    int wolfSSL_EVP_DigestFinal_ex( WOLFSSL_EVP_MD_CTX * ctx,
                                    unsigned char * md,
                                    unsigned int * s )
    {
 ...
 * returns WOLFSSL_SUCCESS on success and WOLFSSL_FAILURE on failure
 */
        int wolfSSL_EVP_PKEY_set1_RSA( WOLFSSL_EVP_PKEY * pkey,
                                       WOLFSSL_RSA * key )
        {
 ...
 * returns WOLFSSL_SUCCESS on success and WOLFSSL_FAILURE on failure
 */
        int wolfSSL_EVP_PKEY_set1_DSA( WOLFSSL_EVP_PKEY * pkey,
                                       WOLFSSL_DSA * key )
        {
            int derMax = 0;
            int derSz = 0;
 ...
 * returns WOLFSSL_SUCCESS on success and WOLFSSL_FAILURE on failure
 */
                int wolfSSL_EVP_PKEY_set1_DH( WOLFSSL_EVP_PKEY * pkey,
                                              WOLFSSL_DH * key )
                {
        ...
        int wolfSSL_EVP_PKEY_assign( WOLFSSL_EVP_PKEY * pkey,
                                     int type,
                                     void * key )
        {
            int ret;
...
/* try and populate public pkey_sz and pkey.ptr */
        static void ECC_populate_EVP_PKEY( EVP_PKEY * pkey,
                                           ecc_key * ecc )
        {
            int ret;
        ...
        WOLFSSL_API int wolfSSL_EVP_PKEY_set1_EC_KEY( WOLFSSL_EVP_PKEY * pkey,
                                                      WOLFSSL_EC_KEY * key )
        {
            #ifdef HAVE_ECC
                if( ( pkey == NULL ) || ( key == NULL ) )
        ...
        int wolfSSL_EVP_PKEY_assign_EC_KEY( EVP_PKEY * pkey,
                                            WOLFSSL_EC_KEY * key )
        {
            if( ( pkey == NULL ) || ( key == NULL ) )
            {
...
/* increments ref count of WOLFSSL_EVP_PKEY. Return 1 on success, 0 on error */
    int wolfSSL_EVP_PKEY_up_ref( WOLFSSL_EVP_PKEY * pkey )
    {
        ...
        #ifndef NO_RSA
        int wolfSSL_EVP_PKEY_assign_RSA( EVP_PKEY * pkey,
                                         WOLFSSL_RSA * key )
        {
            if( ( pkey == NULL ) || ( key == NULL ) )
            {
        ...
        #ifndef NO_DSA
        int wolfSSL_EVP_PKEY_assign_DSA( EVP_PKEY * pkey,
                                         WOLFSSL_DSA * key )
        {
            if( ( pkey == NULL ) || ( key == NULL ) )
            {
        ...
        #ifndef NO_DH
        int wolfSSL_EVP_PKEY_assign_DH( EVP_PKEY * pkey,
                                        WOLFSSL_DH * key )
        {
            if( ( pkey == NULL ) || ( key == NULL ) )
            {
