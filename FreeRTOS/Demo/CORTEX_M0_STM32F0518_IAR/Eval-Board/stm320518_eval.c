...
{
    LED1_GPIO_CLK, LED2_GPIO_CLK, LED3_GPIO_CLK,
    LED4_GPIO_CLK
};

GPIO_TypeDef * BUTTON_PORT[ BUTTONn ] =
{
    TAMPER_BUTTON_GPIO_PORT, KEY_BUTTON_GPIO_PORT,
...
{
    TAMPER_BUTTON_PIN, KEY_BUTTON_PIN,
...
{
    TAMPER_BUTTON_GPIO_CLK, KEY_BUTTON_GPIO_CLK,
...
{
    TAMPER_BUTTON_EXTI_IRQn, KEY_BUTTON_EXTI_IRQn,
