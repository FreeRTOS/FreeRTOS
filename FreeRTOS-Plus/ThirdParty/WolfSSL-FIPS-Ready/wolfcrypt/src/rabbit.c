...
/* IV setup */
    static void wc_RabbitSetIV( Rabbit * ctx,
                                const byte * inIv )
    {
        /* Temporary variables */
...
/* Key setup */
    static WC_INLINE int DoKey( Rabbit * ctx,
                                const byte * key,
                                const byte * iv )
    {
        /* Temporary variables */
    ...
    int wc_Rabbit_SetHeap( Rabbit * ctx,
                           void * heap )
    {
        if( ctx == NULL )
        {
...
/* Key setup */
    int wc_RabbitSetKey( Rabbit * ctx,
                         const byte * key,
                         const byte * iv )
    {
...
/* Encrypt/decrypt a message of any size */
    static WC_INLINE int DoProcess( Rabbit * ctx,
                                    byte * output,
                                    const byte * input,
                                    word32 msglen )
    {
...
/* Encrypt/decrypt a message of any size */
    int wc_RabbitProcess( Rabbit * ctx,
                          byte * output,
                          const byte * input,
                          word32 msglen )
    {
