...
/* sanity size checks */
    ...
    static int GenBase16_Hash( const byte * in,
                               int length,
                               char * out,
                               int outSz );
...
/* convert hex string to binary, store size, 0 success (free mem on failure) */
    static int ConvertHexToBin( const char * h1,
                                byte * b1,
                                word32 * b1Sz,
                                const char * h2,
                                byte * b2,
...
/* 0 on success */
        ...
        static int AesKnownAnswerTest( const char * key,
                                       const char * iv,
...
/* 0 on success */
    #ifndef NO_DES3
        static int Des3_KnownAnswerTest( const char * key,
                                         const char * iv,
                                         const char * plainText,
                                         const char * cbc )
        {
...
/* 0 on success */
        static int HMAC_KnownAnswerTest( int type,
                                         const char * key,
                                         const char * msg,
                                         const char * digest )
        {
    ...
    #endif /* if !defined( NO_SHA ) || defined( WOLFSSL_SHA512 ) || defined( WOLFSSL_SHA3 ) */

/* 0 on success */
    #ifdef HAVE_HASHDRBG
        static int DRBG_KnownAnswerTest( int reseed,
                                         const char * entropyA,
                                         const char * entropyB,
                                         const char * output )
        {
        ...
        static int ECC_CDH_KnownAnswerTest( const char * ax,
                                            const char * ay,
                                            const char * d,
                                            const char * ix,
                                            const char * iy,
    ...
    #ifndef NO_RSA
        static int RsaSignPKCS1v15_KnownAnswerTest( int type,
                                                    const char * msg,
                                                    const char * sig )
        {
            RsaKey rsa;
    ...
    #ifdef HAVE_ECC_DHE
        static int EccPrimitiveZ_KnownAnswerTest( const char * qexServer,
                                                  const char * qeyServer,
                                                  const char * qexClient,
                                                  const char * qeyClient,
                                                  const char * deClient,
                                                  const char * zVerify )
        {
        ...
        static int DhPrimitiveZ_KnownAnswerTest( const char * p,
                                                 const char * q,
                                                 const char * g,
                                                 const char * xClient,
                                                 const char * yServer,
        ...
        static int ECDSA_PairwiseAgreeTest( int type,
                                            const char * msg )
        {
            ecc_key ecc;
            WC_RNG rng;
...
/* Do in core memory integrity check, 0 on success */
    static int DoInCoreCheck( char * base16_hash,
                              int base16_hashSz )
    {
        Hmac hmac;
...
/* do all tests, 0 on success */
    int DoKnownAnswerTests( char * base16_hash,
                            int base16_hashSz )
    {
        ...
        #endif /* if !defined( NO_AES ) && !defined( NO_AES_CBC ) */
