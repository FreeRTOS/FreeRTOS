...
static bsp_int_err_t bsp_fit_interrupts_control( bool enable,
                                                 bsp_int_ctrl_t * pdata );

#ifdef BSP_MCU_GROUP_INTERRUPT
    static bsp_int_err_t bsp_gr_int_enable_disable( bsp_int_src_t vector,
                                                    bool enable,
                                                    uint32_t ipl );
        ...
        case ( BSP_INT_CMD_INTERRUPT_DISABLE ):
            ...
            break;
                ...
                case ( BSP_INT_CMD_GROUP_INTERRUPT_DISABLE ):
                    ...
                    break;
            #endif /* ifdef BSP_MCU_GROUP_INTERRUPT */
...
***********************************************************************************************************************/
    ...
    #endif /* ifdef BSP_MCU_EXCEP_FLOATING_POINT_ISR */
...
***********************************************************************************************************************/
        R_BSP_ATTRIB_INTERRUPT void non_maskable_isr( void )
        {
            ...
            #endif /* ifdef BSP_MCU_NMI_ECCRAM */
...
***********************************************************************************************************************/
    ...
    #endif /* ifdef BSP_MCU_BUS_ERROR_ISR */
