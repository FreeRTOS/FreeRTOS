...
/****** USART Event *****/
    ...
    typedef void (* usart_event_cb_t)( usart_event_e event,
                                       void * cb_arg );                /*/< Pointer to \ref usart_event_cb_t : USART Event call back. */
 ...
 */
    usart_handle_t csi_usart_initialize( pin_t tx,
                                         pin_t rx,
 ...
 * \return      error code
 */
    int32_t csi_usart_set_default_tx_value( usart_handle_t handle,
                                            uint32_t value );
 ...
 * \return      error code
 */
    int32_t csi_usart_send( usart_handle_t handle,
                            const void * data,
                            uint32_t num /*,bool asynch*/ );
 ...
 * \return      error code
 */
    int32_t csi_usart_receive( usart_handle_t handle,
                               void * data,
                               uint32_t num /*,bool asynch*/ );
 ...
 */
    int32_t csi_usart_receive_query( usart_handle_t handle,
                                     void * data,
                                     uint32_t num /*,bool asynch*/ );
 ...
 * \return      error code
 */
    int32_t csi_usart_transfer( usart_handle_t handle,
                                const void * data_out,
                                void * data_in,
                                uint32_t num /*,bool asynch*/ );
 ...
 */
    int32_t csi_usart_flush( usart_handle_t handle,
                             usart_flush_type_e type );
 ...
 * \return      error code
 */
    int32_t csi_usart_interrupt_on_off( usart_handle_t handle,
                                        usart_intr_type_e type,
                                        int flag );
 ...
 * \return      error code
 */
    int32_t csi_usart_config_baudrate( usart_handle_t handle,
                                       uint32_t baudrate,
                                       uint32_t apbfreq );
 ...
 * \return      error code
 */
    int32_t csi_usart_config_mode( usart_handle_t handle,
                                   usart_mode_e mode );
 ...
 * \return      error code
 */
    int32_t csi_usart_config_parity( usart_handle_t handle,
                                     usart_parity_e parity );
 ...
 * \return      error code
 */
    int32_t dw_usart_config_stopbits( usart_handle_t handle,
 ...
 * \return      error code
 */
    int32_t csi_usart_config_databits( usart_handle_t handle,
 ...
 * \return      error code
 */
    int32_t csi_usart_getchar( usart_handle_t handle,
                               uint8_t * ch );
 ...
 * \return      error code
 */
    int32_t csi_usart_putchar( usart_handle_t handle,
                               uint8_t ch );
 ...
 * \return      error code
 */
    int32_t csi_usart_power_control( usart_handle_t handle,
 ...
 * \return      error code
 */
    int32_t csi_usart_modem_ctrl( usart_handle_t handle,
                                  usart_modem_ctrl_e modem_ctrl );
 ...
 * \return      error code
 */
    int32_t csi_usart_config_clock( usart_handle_t handle,
                                    usart_cpol_e cpol,
                                    usart_cpha_e cpha );
 ...
 * \return      error code
 */
    int32_t csi_usart_config_guard_time( usart_handle_t handle,
 ...
 * \return      error code
 */
    int32_t csi_usart_control_tx( usart_handle_t handle,
                                  uint32_t enable );
 ...
 * \return      error code
 */
    int32_t csi_usart_control_rx( usart_handle_t handle,
                                  uint32_t enable );
 ...
 * \return      error code
 */
    int32_t csi_usart_control_break( usart_handle_t handle,
                                     uint32_t enable );
