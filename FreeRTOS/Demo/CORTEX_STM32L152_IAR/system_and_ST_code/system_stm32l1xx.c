...
*******************************************************************************/
    ...
    #endif /* ifdef SYSCLK_FREQ_HSI */
#else  /* ifndef SYSCLK_FREQ_MSI */
    ...
    #else  /* ifdef SYSCLK_FREQ_MSI_64KHz */
        uint32_t SystemCoreClock = MSI_VALUE;                /*!< System Clock Frequency (Core Clock) */
    #endif /* ifdef SYSCLK_FREQ_MSI_64KHz */
#endif /* ifndef SYSCLK_FREQ_MSI */
 ...
 */
    static void SetSysClockToMSI( void )
    {
        ...
        if( MSIStatus == ( uint32_t ) 0x01 )
        {
                    ...
                    /* Disable 64-bit access */
                    FLASH->ACR &= ~FLASH_ACR_ACC64;
                #endif /* ifdef SYSCLK_FREQ_MSI_4MHz */
            #endif /* ifdef SYSCLK_FREQ_MSI */
            /* Enable the PWR APB1 Clock */
            RCC->APB1ENR |= RCC_APB1ENR_PWREN;
