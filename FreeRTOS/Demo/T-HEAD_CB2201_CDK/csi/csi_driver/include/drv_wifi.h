 ...
 *    - others: refer to error code in csi_err.h
 */
    int32_t csi_wifi_scan_start( wifi_scan_config_t * config,
                                 bool block );
 ...
 *    - CSI_ERR_WIFI_NO_MEM: out of memory
 */
    int32_t csi_wifi_scan_get_ap_records( uint16_t * number,
 ...
 */
    int32_t csi_wifi_set_protocol( wifi_interface_t ifx,
 ...
 *    - others: refer to error codes in csi_err.h
 */
    int32_t csi_wifi_get_protocol( wifi_interface_t ifx,
                                   uint8_t * protocol_bitmap );
 ...
 *    - others: refer to error codes in csi_err.h
 */
    int32_t csi_wifi_set_bandwidth( wifi_interface_t ifx,
                                    wifi_bandwidth_t bw );
 ...
 *    - CSI_ERR_WIFI_ARG: invalid argument
 */
    int32_t csi_wifi_get_bandwidth( wifi_interface_t ifx,
                                    wifi_bandwidth_t * bw );
 ...
 *    - CSI_ERR_WIFI_ARG: invalid argument
 */
    int32_t csi_wifi_set_channel( uint8_t primary,
 ...
 *    - CSI_ERR_WIFI_ARG: invalid argument
 */
    int32_t csi_wifi_get_channel( uint8_t * primary,
                                  wifi_second_chan_t * second );
 ...
 *    - others: refer to error codes in csi_err.h
 */
    int32_t csi_wifi_set_mac( wifi_interface_t ifx,
                              uint8_t mac[ 6 ] );
 ...
 *    - CSI_ERR_WIFI_IF: invalid interface
 */
    int32_t csi_wifi_get_mac( wifi_interface_t ifx,
                              uint8_t mac[ 6 ] );
 ...
 */
    int32_t csi_wifi_set_config( wifi_interface_t ifx,
                                 wifi_config_t * conf );
 ...
 *    - CSI_ERR_WIFI_IF: invalid interface
 */
    int32_t csi_wifi_get_config( wifi_interface_t ifx,
                                 wifi_config_t * conf );
 ...
 *    - CSI_ERR_WIFI_NO_MEM: out of memory
 */
    int32_t csi_wifi_set_vendor_ie( bool enable,
 ...
 */
    typedef void (* csi_vendor_ie_cb_t) ( void * ctx,
                                          wifi_vendor_ie_type_t type,
                                          const uint8_t sa[ 6 ],
 ...
 *    - CSI_ERR_WIFI_NOT_INIT: WiFi is not initialized by csi_wifi_init
 */
    int32_t csi_wifi_set_vendor_ie_cb( csi_vendor_ie_cb_t cb,
                                       void * ctx );
 ...
 */
    int csi_wifi_tx( wifi_interface_t wifi_if,
                     void * buffer,
                     uint16_t len );
 ...
 */
    typedef int32_t (* wifi_rxcb_t)( void * buffer,
                                     uint16_t len,
                                     void * ebuf );
 ...
 *     - others : fail
 */
    int32_t csi_wifi_reg_rxcb( wifi_interface_t ifx,
                               wifi_rxcb_t fn );
 ...
 * \return
 */
    int32_t csi_wifi_en_framefilter( uint32_t filter_id,
                                     bool en );
 ...
 * \return
 */
    int32_t csi_wifi_get_framefilter( wifi_frame_filter_list_t * list,
                                      uint32_t * count_out,
                                      uint32_t max_count );
