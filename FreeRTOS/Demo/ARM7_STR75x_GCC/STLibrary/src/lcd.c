...
{
    /* ASCII 0   */
    0x1f,                 0xe0, 0x10, 0x20, 0x10, 0x20, 0x10, 0x20, 0x10, 0x20, 0x1f, 0xe0, 0x00, 0x00,
...
* Return         : None.
*******************************************************************************/
void LCD_DataLinesWrite( GPIO_TypeDef * GPIOx,
                         u32 PortVal )
{
    u32 Tmp = 0;
...
void LCD_DisplayChar( u8 Line,
                      u8 Column,
                      u8 Ascii,
                      TextColorMode_TypeDef CharMode )
{
    u8 DotBuffer[ 14 ], i = 0;
