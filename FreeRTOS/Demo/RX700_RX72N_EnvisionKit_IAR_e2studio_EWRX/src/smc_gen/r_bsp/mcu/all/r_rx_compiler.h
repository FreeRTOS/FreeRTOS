...
/* Fast */
        #define R_BSP_PRAGMA_FAST_INTERRUPT( function_name, vector )                                     \
    extern void function_name( void ) __attribute__( ( interrupt( R_BSP_SECNAME_INTVECTTBL, vector ) ) ) \
    __attribute__( ( fast_interrupt ) );
        #define R_BSP_PRAGMA_STATIC_FAST_INTERRUPT( function_name, vector )                                    \
    static void function_name( void ) __attribute__( ( interrupt( R_BSP_SECNAME_INTVECTTBL, vector ), used ) ) \
...
/* CC-RX' C++ mode does not support variadic macros */
            ...
            #define R_BSP_ASM( ... )            _R_BSP_ASM( __VA_ARGS__ \ n )
            #define R_BSP_ASM_LAB_NEXT( n )     ? +
            #define R_BSP_ASM_LAB_PREV( n )     ? -
            #define R_BSP_ASM_LAB( n_colon )    R_BSP_ASM( ? : )
