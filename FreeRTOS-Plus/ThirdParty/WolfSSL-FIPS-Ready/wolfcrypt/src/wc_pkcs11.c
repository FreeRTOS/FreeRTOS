 ...
 *          0 on success.
 */
    int wc_Pkcs11_Initialize( Pkcs11Dev * dev,
                              const char * library,
                              void * heap )
    {
        int ret = 0;
 ...
 *          0 on success.
 */
    int wc_Pkcs11Token_Init( Pkcs11Token * token,
                             Pkcs11Dev * dev,
                             int slotId,
 ...
 *          0 on success.
 */
    static int Pkcs11OpenSession( Pkcs11Token * token,
 ...
 * @param  session  [in]  Session object.
 */
    static void Pkcs11CloseSession( Pkcs11Token * token,
                                    Pkcs11Session * session )
    {
 ...
 *          0 on success.
 */
    int wc_Pkcs11Token_Open( Pkcs11Token * token,
                             int readWrite )
    {
        int ret = 0;
        Pkcs11Session session;
 ...
 */
    ...
    #if ( !defined( NO_AES ) && ( defined( HAVE_AESGCM ) || defined( HAVE_AES_CBC ) ) ) || \
    !defined( NO_HMAC )
        static int Pkcs11CreateSecretKey( CK_OBJECT_HANDLE * key,
                                          Pkcs11Session * session,
                                          CK_KEY_TYPE keyType,
                                          unsigned char * data,
                                          int len,
    ...
    #endif /* if ( !defined( NO_AES ) && ( defined( HAVE_AESGCM ) || defined( HAVE_AES_CBC ) ) ) || !defined( NO_HMAC ) */
 ...
 *         0 on success.
 */
        static int Pkcs11EccSetParams( ecc_key * key,
                                       CK_ATTRIBUTE * tmpl,
                                       int idx )
        {
            int ret = 0;
 ...
 */
        static int Pkcs11MechAvail( Pkcs11Session * session,
    ...
    #endif /* if !defined( NO_RSA ) || defined( HAVE_ECC ) || ( !defined( NO_AES ) && ( defined( HAVE_AESGCM ) || defined( HAVE_AES_CBC ) ) ) || !defined( NO_HMAC ) */
 ...
 *          0 otherwise.
 */
        static int Pkcs11HmacTypes( int macType,
                                    int * mechType,
                                    int * keyType )
        {
            int ret = 0;
 ...
 *          0 on success.
 */
    int wc_Pkcs11StoreKey( Pkcs11Token * token,
                           int type,
                           int clear,
                           void * key )
    {
        ...
        if( ret == 0 )
        {
            switch( type )
            {
                ...
                #endif /* if !defined( NO_AES ) && defined( HAVE_AESGCM ) */
                ...
                #endif /* if !defined( NO_AES ) && defined( HAVE_AES_CBC ) */
                #ifndef NO_HMAC
 ...
 *          0 on success.
 */
        static int Pkcs11FindKeyById( CK_OBJECT_HANDLE * key,
 ...
 *          0 on success.
 */
        static int Pkcs11FindRsaKey( CK_OBJECT_HANDLE * key,
                                     CK_OBJECT_CLASS keyClass,
                                     Pkcs11Session * session,
                                     RsaKey * rsaKey )
        {
 ...
 *          0 on success.
 */
        static int Pkcs11RsaPublic( Pkcs11Session * session,
                                    wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
        static int Pkcs11RsaPrivate( Pkcs11Session * session,
                                     wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
        static int Pkcs11Rsa( Pkcs11Session * session,
                              wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
            static int Pkcs11GetRsaPublicKey( RsaKey * key,
                                              Pkcs11Session * session,
 ...
 *          0 on success.
 */
            static int Pkcs11RsaKeyGen( Pkcs11Session * session,
                                        wc_CryptoInfo * info )
            {
                int ret = 0;
 ...
 *          0 on success.
 */
        static int Pkcs11FindEccKey( CK_OBJECT_HANDLE * key,
                                     CK_OBJECT_CLASS keyClass,
                                     Pkcs11Session * session,
                                     ecc_key * eccKey )
        {
 ...
 *          0 on success.
 */
            static int Pkcs11GetEccPublicKey( ecc_key * key,
                                              Pkcs11Session * session,
                                              CK_OBJECT_HANDLE pubKey )
            {
                int ret = 0;
 ...
 *          0 on success.
 */
            static int Pkcs11EcKeyGen( Pkcs11Session * session,
                                       wc_CryptoInfo * info )
            {
                int ret = 0;
        ...
        #endif /* ifndef NO_PKCS11_EC_KEYGEN */
 ...
 *          0 on success.
 */
            static int Pkcs11ExtractSecret( Pkcs11Session * session,
 ...
 *          0 on success.
 */
            static int Pkcs11ECDH( Pkcs11Session * session,
                                   wc_CryptoInfo * info )
            {
                int ret = 0;
                int sessionKey = 0;
 ...
 */
        static word32 Pkcs11ECDSASig_Encode( byte * sig,
                                             word32 sz )
        {
 ...
 *          0 on success.
 */
        static int Pkcs11ECDSASig_Decode( const byte * in,
                                          word32 inSz,
                                          byte * sig,
                                          word32 sz )
        {
 ...
 *          0 on success.
 */
        static int Pkcs11GetEccParams( Pkcs11Session * session,
 ...
 *          0 on success.
 */
        static int Pkcs11ECDSA_Sign( Pkcs11Session * session,
                                     wc_CryptoInfo * info )
        {
            int ret = 0;
            int sessionKey = 0;
 ...
 *          0 on success.
 */
        static int Pkcs11ECDSA_Verify( Pkcs11Session * session,
                                       wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
        static int Pkcs11AesGcmEncrypt( Pkcs11Session * session,
                                        wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
        static int Pkcs11AesGcmDecrypt( Pkcs11Session * session,
                                        wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
        static int Pkcs11AesCbcEncrypt( Pkcs11Session * session,
                                        wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
        static int Pkcs11AesCbcDecrypt( Pkcs11Session * session,
                                        wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
        static int Pkcs11Hmac( Pkcs11Session * session,
                               wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
            static int Pkcs11RandomBlock( Pkcs11Session * session,
                                          wc_CryptoInfo * info )
            {
                int ret = 0;
                CK_RV rv;
 ...
 *          0 on success.
 */
        static int Pkcs11RandomSeed( Pkcs11Session * session,
                                     wc_CryptoInfo * info )
        {
            int ret = 0;
            CK_RV rv;
 ...
 *          0 on success.
 */
    int wc_Pkcs11_CryptoDevCb( int devId,
                               wc_CryptoInfo * info,
                               void * ctx )
    {
        int ret = 0;
        ...
        if( ret == 0 )
        {
            ...
            if( ret == 0 )
            {
                if( info->algo_type == WC_ALGO_TYPE_PK )
                {
                    ...
                    #else  /* if !defined( NO_RSA ) || defined( HAVE_ECC ) */
                        ret = NOT_COMPILED_IN;
