...
#define IS_ADC_EXT_TRIG( TRIG1 )                    \
    ( ( TRIG1 == ADC_ExternalTrigConv_T1_CC1 ) ||   \
...
#define IS_ADC_EXT_INJEC_TRIG( TRIG )                   \
    ( ( TRIG == ADC_ExternalTrigInjecConv_T1_TRGO ) ||  \
