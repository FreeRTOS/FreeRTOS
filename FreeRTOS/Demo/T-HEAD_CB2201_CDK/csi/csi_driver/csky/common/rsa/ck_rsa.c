...
extern int32_t target_get_rsa( int32_t idx,
                               uint32_t * base,
                               uint32_t * irq );
...
static uint32_t sw_exptmod_2_2m( const uint32_t * modulus,
                                 uint32_t words,
                                 uint32_t * tmp_c );
static uint32_t get_valid_bits( const uint32_t * addr,
                                uint32_t wordsize,
                                uint32_t keywords );
...
static inline uint32_t rsa_loadm( uint32_t * data,
                                  uint32_t length )
{
    uint32_t i;
...
static void rsa_loadd( uint32_t * data,
                       uint32_t length )
{
    uint32_t i;
...
static void rsa_loadc( uint32_t * data,
                       uint32_t length )
{
    uint32_t i;
...
static void rsa_loadb( uint32_t * data,
                       uint32_t length )
{
    uint32_t i;
...
static void rsa_read_r( uint32_t data[],
                        uint32_t length )
{
    uint32_t i;
...
#endif /* if ( CONFIG_PLATFORM_HOBBIT1_2 > 0 ) */

static uint32_t rsa_exptmod( const uint32_t * modulus,
...
static uint32_t get_first_nonzero_words( uint32_t * a,
                                         uint32_t max_words )
{
    uint32_t i = 0;
...
static uint32_t word_array_left_shift( uint32_t * a,
                                       uint32_t words,
                                       uint32_t shift_bits,
                                       uint32_t * r )
{
...
/* r = a - b */
static uint32_t _word_array_sub( uint32_t * a,
                                 uint32_t a_words,
                                 uint32_t * b,
                                 uint32_t b_words,
                                 uint32_t * r )
...
static uint32_t word_array_mod( uint32_t * a,
                                uint32_t a_words,
                                uint32_t * b,
                                uint32_t b_words,
                                uint32_t * r,
...
static void convert_byte_array( uint8_t * in,
                                uint8_t * out,
                                uint32_t len )
{
...
static void convert_buf_to_bndata( const uint8_t * src,
                                   uint32_t src_bytes,
                                   uint32_t * dst,
                                   uint32_t dst_words )
{
...
static void convert_bndata_to_buf( const uint32_t * src,
                                   uint32_t src_words,
                                   uint8_t * dst,
                                   uint32_t dst_bytes )
{
...
static int rsa_sw_exptmod_2_2m( uint8_t * modulus,
                                uint32_t keybits_len,
                                uint32_t * tmp_c )
{
    uint32_t keywords = 0, keybytes = 0;
...
int rsa_sw_calc_modulus( uint8_t * modulus,
                         uint32_t keybits_len )
{
    #ifdef RSA_USING_ID2KEY
 ...
 */
rsa_handle_t csi_rsa_initialize( int32_t idx,
                                 rsa_event_cb_t cb_event )
{
 ...
 * \return      error code
 */
int32_t csi_rsa_encrypt( rsa_handle_t handle,
                         void * n,
                         void * e,
                         void * src,
                         int32_t src_size,
 ...
 * \return      error code
 */
int32_t csi_rsa_decrypt( rsa_handle_t handle,
                         void * n,
                         void * d,
                         void * src,
                         uint32_t src_size,
 ...
 * \return      error code
 */
int32_t csi_rsa_sign( rsa_handle_t handle,
                      void * n,
                      void * d,
                      void * src,
                      uint32_t src_size,
 ...
 * \return      error code
 */
int32_t csi_rsa_verify( rsa_handle_t handle,
                        void * n,
                        void * e,
                        void * src,
                        uint32_t src_size,
