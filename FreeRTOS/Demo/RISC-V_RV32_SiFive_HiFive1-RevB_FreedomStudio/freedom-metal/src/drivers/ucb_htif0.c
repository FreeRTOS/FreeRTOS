...
#include <metal/machine/platform.h>
    ...
    static void __set_tohost( uintptr_t dev,
                              uintptr_t cmd,
                              uintptr_t data )
    {
        while( tohost )
    ...
    static void do_tohost_fromhost( uintptr_t dev,
                                    uintptr_t cmd,
                                    uintptr_t data )
    {
    ...
    void __metal_driver_ucb_htif0_init( struct metal_uart * uart,
                                        int baud_rate )
    {
    }
    ...
    int __metal_driver_ucb_htif0_putc( struct metal_uart * htif,
                                       int c )
    {
        volatile uint64_t magic_mem[ 8 ];
    ...
    int __metal_driver_ucb_htif0_getc( struct metal_uart * htif,
                                       int * c )
    {
        return -1;
    }
