...
#if PRINTF_ADVANCED_ENABLE
    static uint8_t PrintGetSignChar( int64_t ival,
                                     uint32_t flags_used,
                                     char * schar )
    {
        uint8_t len = 1U;
...
#endif /* if PRINTF_ADVANCED_ENABLE */
                                 ...
                                 int32_t * count )
{
    ...
    #else  /* if PRINTF_ADVANCED_ENABLE */
        cb( buf, count, ' ', ( int ) field_width - ( int ) vlen );
    #endif /* PRINTF_ADVANCED_ENABLE */
