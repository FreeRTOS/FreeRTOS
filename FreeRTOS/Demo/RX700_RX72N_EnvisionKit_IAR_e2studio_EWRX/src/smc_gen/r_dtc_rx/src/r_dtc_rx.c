 ...
 */
dtc_err_t R_DTC_Create( dtc_activation_source_t act_source,
 ...
 * Hardware.
 */
dtc_err_t R_DTC_CreateSeq( dtc_activation_source_t act_source,
                           dtc_transfer_data_t * p_transfer_data,
                           dtc_transfer_data_cfg_t * p_data_cfg,
 ...
 */
dtc_err_t R_DTC_Control( dtc_command_t command,
                         dtc_stat_t * p_stat,
                                          ...
                                          dtc_transfer_data_cfg_t * p_cfg )
{
    ...
    #else  /* if ( DTC_IP_VER_DTCb <= DTC_IP ) */
        /* Casting to match type of "t_mra.BYTE" */
...
static bool r_dtc_check_dmac_locking_sw( void )
{
    ...
    #endif /* if ( ( 0 != BSP_CFG_USER_LOCKING_ENABLED ) || ( bsp_lock_t != BSP_CFG_USER_LOCKING_TYPE ) || ( DTC_ENABLE != DTC_CFG_USE_DMAC_FIT_MODULE ) ) */
