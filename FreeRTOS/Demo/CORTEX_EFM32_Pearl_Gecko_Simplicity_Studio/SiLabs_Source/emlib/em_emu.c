...
/* Fix for errata EMU_E107 - non-WIC interrupt masks. */
    ...
    #else  /* if defined( _EFM32_GECKO_FAMILY ) */
/* Zero Gecko and future families are not affected by errata EMU_E107 */
    #endif /* if defined( _EFM32_GECKO_FAMILY ) */
...
/* DCDCTODVDD output range min/max */
    ...
    #endif /* if defined( _EMU_DCDCCTRL_MASK ) */
 ...
 ******************************************************************************/
    static void emuRestore( void )
    {
        ...
        #else  /* if defined( _CMU_HFCLKSTATUS_RESETVALUE ) */
        ...
        #endif /* if defined( _CMU_HFCLKSTATUS_RESETVALUE ) */
...
/* Get enable conditions for errata EMU_E107 fix. */
    ...
    #endif /* if defined( ERRATA_FIX_EMU_E107_EN ) */
 ...
 ******************************************************************************/
    void EMU_MemPwrDown( uint32_t blocks )
    {
        ...
        && defined( _EMU_MEMCTRL_SEQRAMPOWERDOWN_MASK )
            ...
            EMU->RAM0CTRL = blocks;
        #else  /* if defined( _EMU_MEMCTRL_POWERDOWN_MASK ) */
            ( void ) blocks;
        #endif /* if defined( _EMU_MEMCTRL_POWERDOWN_MASK ) */
    }
 ...
 ******************************************************************************/
    ...
    #endif /* if defined( _EMU_EM4CONF_MASK ) || defined( _EMU_EM4CTRL_MASK ) */
 ...
 ******************************************************************************/
                                       ...
                                       bool setLnVoltage )
        {
            ...
            #endif /* if defined( _DEVINFO_DCDCLNVCTRL0_3V0LNATT1_MASK ) */
            return true;
        }
...
/** @cond DO_NOT_INCLUDE_WITH_DOXYGEN */
        ...
        __STATIC_INLINE uint32_t vmonMilliVoltToFineThreshold( int mV,
                                                               uint32_t coarseThreshold )
        {
