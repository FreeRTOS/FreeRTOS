 ...
 */
        static WC_INLINE void ge448_dbl( ge448_p2 * r,
                                         const ge448_p2 * p )
        {
 ...
 * q  [in]  Point to add.
 */
        static WC_INLINE void ge448_add( ge448_p2 * r,
                                         const ge448_p2 * p,
                                         const ge448_p2 * q )
        {
            ge448 t0[ GE448_WORDS ];
 ...
 */
        int ge448_compress_key( uint8_t * out,
                                const uint8_t * xIn,
                                const uint8_t * yIn )
        {
            ge448 x[ 56 ];
 ...
 */
        static void ge448_scalarmult( ge448_p2 * h,
                                      const ge448_p2 * p,
                                      const uint8_t * a )
        {
            ge448_p2 r;
 ...
 * a  [in]  Scalar to multiply by.
 */
        void ge448_scalarmult_base( ge448_p2 * h,
                                    const uint8_t * a )
        {
 ...
 * a  [in]  Scalar to multiply by.
 */
        int ge448_double_scalarmult_vartime( ge448_p2 * r,
                                             const uint8_t * a,
                                             const ge448_p2 * A,
                                             const uint8_t * b )
        {
 ...
 */
        int ge448_from_bytes_negate_vartime( ge448_p2 * r,
                                             const uint8_t * b )
        {
            int ret = 0;
            ge448 u[ GE448_WORDS ];
...
/* Precomputed multiples of the base point. */
        ...
        #else  /* if defined( CURVED448_128BIT ) */
...
/* Precomputed multiples of the base point. */
        ...
        #endif /* if defined( CURVED448_128BIT ) */
 ...
 * q  [in]  Point to add.
 */
        static WC_INLINE void ge448_madd( ge448_p2 * r,
                                          const ge448_p2 * p,
 ...
 */
        static WC_INLINE void ge448_msub( ge448_p2 * r,
                                          const ge448_p2 * p,
                                          const ge448_precomp * q )
        {
            ge448 t0[ GE448_WORDS ];
 ...
 * q  [in]  Point to subtract.
 */
        static WC_INLINE void ge448_sub( ge448_p2 * r,
                                         const ge448_p2 * p,
                                         const ge448_p2 * q )
        {
            ge448 t0[ GE448_WORDS ];
 ...
 * p  [in]  Point to convert.
 */
        static void ge448_p2z1_to_bytes( uint8_t * b,
                                         const ge448_p2 * p )
        {
 ...
 */
        static uint8_t equal( uint8_t a,
                              uint8_t b )
        {
 ...
 */
        static WC_INLINE void cmov( ge448_precomp * r,
                                    const ge448_precomp * p,
                                    uint8_t b,
                                    uint8_t n )
        {
            b = equal( b, n );
 ...
 */
        static void ge448_select( ge448_precomp * r,
                                  int pos,
                                  int8_t b )
        {
            ge448 minusx[ 16 ];
 ...
 * a  [in]  Scalar to multiply by.
 */
        void ge448_scalarmult_base( ge448_p2 * r,
                                    const uint8_t * a )
        {
            int8_t carry;
            ge448_precomp t;
