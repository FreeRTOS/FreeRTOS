...
#include <wolfssl/wolfcrypt/settings.h>
        ...
        #endif
        static void ge_p3_to_p2( ge_p2 *,
                                 const ge_p3 * );
        static void ge_p3_to_cached( ge_cached *,
                                     const ge_p3 * );
        static void ge_p1p1_to_p2( ge_p2 *,
                                   const ge_p1p1 * );
        static void ge_p1p1_to_p3( ge_p3 *,
                                   const ge_p1p1 * );
        static void ge_p2_dbl( ge_p1p1 *,
                               const ge_p2 * );
        static void ge_p3_dbl( ge_p1p1 *,
                               const ge_p3 * );

        static void ge_madd( ge_p1p1 *,
                             const ge_p3 *,
                             const ge_precomp * );
        static void ge_msub( ge_p1p1 *,
                             const ge_p3 *,
                             const ge_precomp * );
        static void ge_add( ge_p1p1 *,
                            const ge_p3 *,
                            const ge_cached * );
        static void ge_sub( ge_p1p1 *,
                            const ge_p3 *,
                            const ge_cached * );
 ...
 */
            ...
            #endif /* ifdef CURVED25519_ASM_32BIT */
 ...
 */
        ...
        #else  /* if !defined( HAVE___UINT128_T ) || defined( NO_CURVED25519_128BIT ) */
 ...
 * r = p + q
 */
        static WC_INLINE void ge_add( ge_p1p1 * r,
                                      const ge_p3 * p,
                                      const ge_cached * q )
        {
            #ifndef CURVED25519_ASM
                ...
                fe_add( r->Z, t0, r->T );
                fe_sub( r->T, t0, r->T );
            #else  /* ifndef CURVED25519_ASM */
                fe_ge_add( r->X, r->Y, r->Z, r->T, p->X, p->Y, p->Z, p->T, q->Z, q->T2d,
                           q->YplusX, q->YminusX );
            #endif /* ifndef CURVED25519_ASM */
        }
...
/* ge_scalar mult base */
            ...
            static WC_INLINE void cmov( ge_precomp * t,
                                        const ge_precomp * u,
                                        unsigned char b,
                                        unsigned char n )
            {
        ...
        #else  /* ifdef CURVED25519_ASM_64BIT */
/* base[i][j] = (j+1)*256^i*B */
        ...
        #endif /* ifdef CURVED25519_ASM_64BIT */


        static void ge_select( ge_precomp * t,
                               int pos,
                               signed char b )
        {
            #ifndef CURVED25519_ASM
 ...
 * B is the Ed25519 base point (x,4/5) with x positive.
 */
        int ge_double_scalarmult_vartime( ge_p2 * r,
                                          const unsigned char * a,
                                          const ge_p3 * A,
 ...
 */
        ...
        static WC_INLINE void ge_madd( ge_p1p1 * r,
                                       const ge_p3 * p,
                                       const ge_precomp * q )
        {
            #ifndef CURVED25519_ASM
 ...
 */
        ...
        static WC_INLINE void ge_msub( ge_p1p1 * r,
                                       const ge_p3 * p,
                                       const ge_precomp * q )
        {
            #ifndef CURVED25519_ASM
 ...
 */
        ...
        static void ge_p1p1_to_p2( ge_p2 * r,
                                   const ge_p1p1 * p )
        {
            #ifndef CURVED25519_ASM
                fe_mul( r->X, p->X, p->T );
 ...
 */
        ...
        static WC_INLINE void ge_p1p1_to_p3( ge_p3 * r,
                                             const ge_p1p1 * p )
        {
            #ifndef CURVED25519_ASM
                fe_mul( r->X, p->X, p->T );
 ...
 */
        ...
        static WC_INLINE void ge_p2_dbl( ge_p1p1 * r,
                                         const ge_p2 * p )
        {
            #ifndef CURVED25519_ASM
                ge t0;
 ...
 */
        ...
        static WC_INLINE void ge_p3_to_cached( ge_cached * r,
                                               const ge_p3 * p )
        {
 ...
 */
        ...
        static WC_INLINE void ge_sub( ge_p1p1 * r,
                                      const ge_p3 * p,
                                      const ge_cached * q )
        {
            #ifndef CURVED25519_ASM
