 ...
 */
int32_t target_usart_flowctrl_init( int32_t tx_flow,
                                    int32_t rx_flow,
                                    uint32_t flag )
{
    #if 0
 ...
 */
int32_t target_gpio_pin_init( int32_t gpio_pin,
                              uint32_t * port_idx )
{
    uint32_t idx;
 ...
 */
int32_t target_iic_init( int32_t idx,
                         uint32_t * base,
                         uint32_t * irq )
{
 ...
 */
int32_t target_spi_init( int32_t idx,
                         uint32_t * base,
                         uint32_t * irq,
                         uint32_t * ssel )
{
 ...
 */
int32_t target_pwm_init( int32_t pwm_pin,
                         uint32_t * ch_num,
                         uint32_t * base,
                         uint32_t * irq )
{
...
int32_t target_get_etb( int32_t idx,
                        uint32_t * base,
                        uint32_t * irq )
{
 ...
 */
int32_t target_qspi_init( pin_name_t mosi,
                          pin_name_t miso,
                          pin_name_t sclk,
                          pin_name_t ssel,
                          pin_name_t wp,
