...
extern int32_t target_get_trng( int32_t idx,
                                uint32_t * base,
                                uint32_t * irq );
 ...
 */
trng_handle_t csi_trng_initialize( int32_t idx,
                                   trng_event_cb_t cb_event )
{
 ...
 * \return      error code
 */
int32_t csi_trng_get_data( trng_handle_t handle,
                           void * data,
                           uint32_t num )
{
    TRNG_NULL_PARAM_CHK( handle );
