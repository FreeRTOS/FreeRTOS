...
#endif /* if defined( GROUP_erase ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
#endif /* if defined( GROUP_program ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
#endif /* if defined( GROUP_protectget ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
/****************************************************************************** */
    ...
    long FlashProtectSet( unsigned long ulAddress,
...
#endif /* if defined( GROUP_protectset ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
#endif /* if defined( GROUP_protectsave ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
#endif /* if defined( GROUP_intgetstatus ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
