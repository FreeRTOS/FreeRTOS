 ...
 * @return
 */
bool mpfs_sync_bool_compare_and_swap( volatile long * ptr,
                                      long oldval,
                                      long newval )
{
    static long lock = 0;
 ...
 * @param newval
 */
long mpfs_sync_val_compare_and_swap( volatile long * ptr,
                                     long oldval,
                                     long newval )
{
    long result = *ptr;
    ...
    void display_address_of_interest( uint64_t * address_of_interest,
                                      int nb_locations )
    {
...
#endif /* ifdef PRINTF_DEBUG_SUPPORTED */
