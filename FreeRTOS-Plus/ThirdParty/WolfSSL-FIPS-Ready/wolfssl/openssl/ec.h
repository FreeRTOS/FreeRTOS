...
/* WOLFSSL_EC_METHOD is just an alias of WOLFSSL_EC_GROUP for now */
    ...
    int wolfSSL_ECPoint_i2d( const WOLFSSL_EC_GROUP * curve,
                             ...
                             unsigned int * len );
    WOLFSSL_API
    int wolfSSL_ECPoint_d2i( unsigned char * in,
                             unsigned int len,
                             const WOLFSSL_EC_GROUP * curve,
                             WOLFSSL_EC_POINT * p );
    WOLFSSL_API
    ...
    int wolfSSL_EC_POINT_oct2point( const WOLFSSL_EC_GROUP * group,
                                    ...
                                    WOLFSSL_BN_CTX * ctx );
    WOLFSSL_API
    int wolfSSL_i2o_ECPublicKey( const WOLFSSL_EC_KEY * in,
                                 unsigned char ** out );
    WOLFSSL_API
    WOLFSSL_EC_KEY * wolfSSL_d2i_ECPrivateKey( WOLFSSL_EC_KEY ** key,
                                               ...
                                               long len );
    WOLFSSL_API
    int wolfSSL_i2d_ECPrivateKey( const WOLFSSL_EC_KEY * in,
                                  unsigned char ** out );
    WOLFSSL_API
    void wolfSSL_EC_KEY_set_conv_form( WOLFSSL_EC_KEY * eckey,
                                       char form );
    WOLFSSL_API
    ...
    WOLFSSL_API
    int wolfSSL_EC_KEY_set_group( WOLFSSL_EC_KEY * key,
                                  WOLFSSL_EC_GROUP * group );
    WOLFSSL_API
    int wolfSSL_EC_KEY_generate_key( WOLFSSL_EC_KEY * key );
    WOLFSSL_API
    void wolfSSL_EC_KEY_set_asn1_flag( WOLFSSL_EC_KEY * key,
                                       int asn1_flag );
    WOLFSSL_API
    int wolfSSL_EC_KEY_set_public_key( WOLFSSL_EC_KEY * key,
                                       const WOLFSSL_EC_POINT * pub );
    WOLFSSL_API int wolfSSL_ECDSA_size( const WOLFSSL_EC_KEY * key );
    WOLFSSL_API int wolfSSL_ECDSA_sign( int type,
                                        ...
                                        WOLFSSL_EC_KEY * key );
    WOLFSSL_API
    void wolfSSL_EC_GROUP_set_asn1_flag( WOLFSSL_EC_GROUP * group,
                                         int flag );
    WOLFSSL_API
    WOLFSSL_EC_GROUP * wolfSSL_EC_GROUP_new_by_curve_name( int nid );
    WOLFSSL_API
    int wolfSSL_EC_GROUP_cmp( const WOLFSSL_EC_GROUP * a,
                              const WOLFSSL_EC_GROUP * b,
                              WOLFSSL_BN_CTX * ctx );
    WOLFSSL_API
    ...
    WOLFSSL_API
    const WOLFSSL_EC_METHOD * wolfSSL_EC_GROUP_method_of( const WOLFSSL_EC_GROUP * group );
    WOLFSSL_API
    ...
    int wolfSSL_EC_POINT_set_affine_coordinates_GFp( const WOLFSSL_EC_GROUP * group,
                                                     ...
                                                     WOLFSSL_BN_CTX * ctx );
    WOLFSSL_API
    int wolfSSL_EC_POINT_add( const WOLFSSL_EC_GROUP * group,
                              WOLFSSL_EC_POINT * r,
                              const WOLFSSL_EC_POINT * p1,
                              const WOLFSSL_EC_POINT * p2,
                              WOLFSSL_BN_CTX * ctx );
    WOLFSSL_API
    int wolfSSL_EC_POINT_mul( const WOLFSSL_EC_GROUP * group,
                              WOLFSSL_EC_POINT * r,
