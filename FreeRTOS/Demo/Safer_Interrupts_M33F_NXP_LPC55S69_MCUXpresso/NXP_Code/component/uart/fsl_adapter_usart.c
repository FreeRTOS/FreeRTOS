...
#else  /* if ( ( defined( HAL_UART_TRANSFER_MODE ) && ( HAL_UART_TRANSFER_MODE > 0U ) ) || ( defined( HAL_UART_DMA_ENABLE ) && ( HAL_UART_DMA_ENABLE > 0U ) ) ) */
    static hal_uart_status_t HAL_UartGetStatus( status_t status )
    {
...
#endif /* if ( ( defined( HAL_UART_TRANSFER_MODE ) && ( HAL_UART_TRANSFER_MODE > 0U ) ) || ( defined( HAL_UART_DMA_ENABLE ) && ( HAL_UART_DMA_ENABLE > 0U ) ) ) */

#if ( defined( UART_ADAPTER_NON_BLOCKING_MODE ) && ( UART_ADAPTER_NON_BLOCKING_MODE > 0U ) )

    #if ( defined( HAL_UART_TRANSFER_MODE ) && ( HAL_UART_TRANSFER_MODE > 0U ) )
        static void HAL_UartCallback( USART_Type * base,
        ...
        static void HAL_UartInterruptHandle( USART_Type * base,
                                             void * handle )
        {
        ...
        static void HAL_UartInterruptHandle_Wapper( void * base,
                                                    void * handle )
        {
...
#if ( defined( HAL_UART_DMA_ENABLE ) && ( HAL_UART_DMA_ENABLE > 0U ) )
    static void USART_DMACallbacks( USART_Type * base,
