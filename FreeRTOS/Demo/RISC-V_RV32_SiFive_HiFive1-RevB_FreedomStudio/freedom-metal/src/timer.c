 ...
 * timer on a system. */
    ...
    int metal_timer_set_machine_time( int hartid,
...
#else  /* if defined( __METAL_DT_MAX_HARTS ) */
 ...
 */
    ...
    int metal_timer_get_cyclecount( int hartid,
                                    unsigned long long * c ) __attribute__( ( weak, alias( "nop_cyclecount" ) ) )
    {
        #pragma message( \
...
#endif /* if defined( __METAL_DT_MAX_HARTS ) */
