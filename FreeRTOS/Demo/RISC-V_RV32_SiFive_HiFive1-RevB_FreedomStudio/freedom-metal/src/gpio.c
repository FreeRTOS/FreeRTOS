...
extern __inline__ int metal_gpio_disable_input( struct metal_gpio * gpio,
                                                int pin );
extern __inline__ int metal_gpio_enable_input( struct metal_gpio * gpio,
                                               int pin );
...
extern __inline__ int metal_gpio_get_input_pin( struct metal_gpio * gpio,
                                                int pin );
extern __inline__ int metal_gpio_set_pin( struct metal_gpio *,
                                          int pin,
                                          int value );
extern __inline__ int metal_gpio_clear_pin( struct metal_gpio *,
                                            int pin );
extern __inline__ int metal_gpio_toggle_pin( struct metal_gpio *,
                                             int pin );
extern __inline__ int metal_gpio_enable_pinmux( struct metal_gpio *,
                                                int pin,
                                                int io_function );
extern __inline__ int metal_gpio_disable_pinmux( struct metal_gpio *,
                                                 int pin );
