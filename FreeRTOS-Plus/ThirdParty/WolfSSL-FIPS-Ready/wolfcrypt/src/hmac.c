            ...
            switch( hmac->macType )
            {
                    ...
                    case WC_SHA512:
                        ...
                        case WC_SHA3_224:
                            ...
                            break;
                    #endif /* ifndef WOLFSSL_NOSHA3_224 */
                    #ifndef WOLFSSL_NOSHA3_256
                        case WC_SHA3_256:
                            ...
                            break;
                    #endif /* ifndef WOLFSSL_NOSHA3_256 */
                    #ifndef WOLFSSL_NOSHA3_384
                        case WC_SHA3_384:
                            ...
                            break;
                    #endif /* ifndef WOLFSSL_NOSHA3_384 */
                    #ifndef WOLFSSL_NOSHA3_512
                        case WC_SHA3_512:
                ...
                if( hmac->asyncDev.marker == WOLFSSL_ASYNC_MARKER_HMAC )
                {
                    ...
                    #endif /* if defined( HAVE_INTEL_QA ) || defined( HAVE_CAVIUM ) */
                }
            #endif /* if defined( WOLFSSL_ASYNC_CRYPT ) && defined( WC_ASYNC_ENABLE_HMAC ) */
