 ...
 *  Wonder. */
        ...
        #endif
    #endif /* if defined( CMU_CTRL_HFLE ) */
 ...
 ******************************************************************************/
    static uint32_t auxClkGet( void )
    {
        ...
        #else  /* if defined( _CMU_AUXHFRCOCTRL_FREQRANGE_MASK ) */
            /* Gecko has a fixed 14Mhz AUXHFRCO clock */
            ret = 14000000;
        #endif /* if defined( _CMU_AUXHFRCOCTRL_FREQRANGE_MASK ) */
 ...
 ******************************************************************************/
    static void flashWaitStateControl( uint32_t coreFreq )
    {
        ...
        #endif /* if defined( MSC_READCTRL_MODE_WS0SCBTP ) */
        ...
        /* Get clock frequency */
            ...
            switch( sel )
            {
                ...
                case _CMU_LFCLKSEL_LFA_LFXO:
                    ...
                    break;
                        ...
                        case _CMU_LFCLKSEL_LFA_HFCORECLKLEDIV2:
                            ...
                            #else  /* if defined( CMU_CTRL_HFLE ) */
                                ret = SystemCoreClockGet() / 2U;
                            #endif /* if defined( CMU_CTRL_HFLE ) */
                            break;
                    #endif /* if defined( _CMU_LFCLKSEL_LFA_HFCORECLKLEDIV2 ) */
                ...
                case _CMU_LFCLKSEL_LFA_DISABLED:
                    ...
                    #endif /* if defined( CMU_LFCLKSEL_LFAE ) */
                    break;
                    ...
                    break;
                        ...
                        case _CMU_LFBCLKSEL_LFB_HFCLKLE:
                            ret = ( ( CMU->HFPRESC & _CMU_HFPRESC_HFCLKLEPRESC_MASK )
                                  ...
                                  : SystemCoreClockGet() / 2U;
                            break;
                            #endif /* if defined( _CMU_LFACLKSEL_LFA_HFCLKLE ) */

                        case _CMU_LFACLKSEL_LFA_DISABLED:
                            ret = 0;
                            break;
            }
        #endif /* if defined( _CMU_LFACLKSEL_MASK ) */
 ...
 ******************************************************************************/
    ...
    #endif /* if defined( CMU_CTRL_HFLE ) && !defined( _EFM32_WONDER_FAMILY ) && !defined( _EZR32_LEOPARD_FAMILY ) && !defined( _EZR32_WONDER_FAMILY ) */
 ...
 ******************************************************************************/
    ...
    #endif /* if defined( _CMU_CALCTRL_UPSEL_MASK ) && defined( _CMU_CALCTRL_DOWNSEL_MASK ) */
 ...
 ******************************************************************************/
    uint32_t CMU_CalibrateCountGet( void )
    {
        ...
        #else  /* if defined( CMU_CALCTRL_CONT ) */
            while( BUS_RegBitRead( &CMU->STATUS, _CMU_STATUS_CALBSY_SHIFT ) )
            {
            }
        #endif /* if defined( CMU_CALCTRL_CONT ) */
        return CMU->CALCNT;
    }
                          ...
                          CMU_ClkDiv_TypeDef div )
    {
            ...
            switch( divReg )
            {
                    ...
                    case CMU_HFCLKDIV_REG:
                        ...
                        break;
                #endif /* if defined( _CMU_CTRL_HFCLKDIV_MASK ) */
                        ...
                        case cmuClock_RTC:
                            ...
                            break;
                                ...
                                case cmuClock_LETIMER0:
                                    ...
                                    break;
                            #endif /* if defined( _CMU_LFAPRESC0_LETIMER0_MASK ) */
                ...
                case CMU_LFBPRESC0_REG:
                    ...
                    switch( clock )
                    {
                            ...
                            case cmuClock_LEUART0:
                                ...
                                break;
                        #endif /* if defined( _CMU_LFBPRESC0_LEUART0_MASK ) */
                            ...
                            case cmuClock_LEUART1:
                                ...
                                break;
                        #endif /* if defined( _CMU_LFBPRESC0_LEUART1_MASK ) */
                          ...
                          bool enable )
    {
        ...
        switch( ( clock >> CMU_EN_REG_POS ) & CMU_EN_REG_MASK )
        {
                ...
                case CMU_HFCORECLKEN0_EN_REG:
                    ...
                    #endif /* if defined( CMU_CTRL_HFLE ) */
                    break;
            #endif /* if defined( _SILICON_LABS_32B_PLATFORM_1 ) */
            ...
            case ( CMU_LFA_CLK_BRANCH << CMU_CLK_BRANCH_POS ):
                ...
                break;
                    ...
                    case ( CMU_LETIMER0_CLK_BRANCH << CMU_CLK_BRANCH_POS ):
                        ...
                        #endif
                        break;
                #endif /* if defined( _CMU_LFACLKEN0_LETIMER0_MASK ) */
                    ...
                    case ( CMU_LCD_CLK_BRANCH << CMU_CLK_BRANCH_POS ):
                        ...
                        break;
                #endif /* if defined( _CMU_LFACLKEN0_LCD_MASK ) */
            ...
            case ( CMU_LFB_CLK_BRANCH << CMU_CLK_BRANCH_POS ):
                ...
                break;
                    ...
                    case ( CMU_LEUART0_CLK_BRANCH << CMU_CLK_BRANCH_POS ):
                        ...
                        #endif
                        break;
                #endif /* if defined( _CMU_LFBCLKEN0_LEUART0_MASK ) */
                    ...
                    case ( CMU_LEUART1_CLK_BRANCH << CMU_CLK_BRANCH_POS ):
                        ...
                        #endif
                        break;
                #endif /* if defined( _CMU_LFBCLKEN0_LEUART1_MASK ) */
                ...
                case CMU_LFAPRESC0_REG:
                    ...
                    switch( clock )
                    {
                            ...
                            case cmuClock_RTCC:
                                ...
                                #endif /* if defined( _CMU_LFEPRESC0_RTCC_MASK ) */
                                break;
                        #endif /* if defined( RTCC_PRESENT ) */
    ...
    CMU_Select_TypeDef CMU_ClockSelectGet( CMU_Clock_TypeDef clock )
    {
        ...
        switch( selReg )
        {
            case CMU_HFCLKSEL_REG:
                ...
                #else  /* if defined( _CMU_HFCLKSEL_HF_MASK ) */
                    switch( CMU->STATUS
                            & ( CMU_STATUS_HFRCOSEL
                                | CMU_STATUS_HFXOSEL
                                | CMU_STATUS_LFRCOSEL
                ...
                #endif /* if defined( _CMU_HFCLKSEL_HF_MASK ) */
                break;
            ...
            case CMU_LFBCLKSEL_REG:
                ...
                #endif /* if defined( _CMU_LFBCLKSEL_MASK ) */
                break;
                    ...
                    case CMU_LFCCLKSEL_REG:
                        ...
                        break;
                #endif /* if defined( _CMU_LFCLKSEL_LFC_MASK ) */
            ...
            case CMU_DBGCLKSEL_REG:
                ...
                #else  /* if defined( _CMU_DBGCLKSEL_DBG_MASK ) */
                    ret = cmuSelect_AUXHFRCO;
                ...
                #else  /* if defined( _CMU_CTRL_DBGCLK_MASK ) */
                    ret = cmuSelect_AUXHFRCO;
                #endif /* if defined( _CMU_CTRL_DBGCLK_MASK ) */
                break;
                            ...
                            case CMU_DBGCLKSEL_REG:
                                ...
                                switch( ref )
                                {
                                        ...
                                        case cmuSelect_HFCLK:
                                            ...
                                            break;
                                    #endif /* if defined( CMU_CTRL_DBGCLK ) */
                                ...
                                break;
                        #endif /* if defined( CMU_DBGCLKSEL_DBG ) || defined( CMU_CTRL_DBGCLK ) */
                                    ...
                                    case cmuSelect_LFRCO:
                                        ...
                                        break;
                                            ...
                                            case cmuSelect_HFCLK:
                                                ...
                                                break;
                                        #endif /* if defined( CMU_STATUS_USBCHFCLKSEL ) */
                                            ...
                                            case cmuSelect_USHFRCO:
                                                ...
                                                break;
                                        #endif /* if defined( CMU_CMD_USBCCLKSEL_USHFRCO ) */
 ...
 ******************************************************************************/
    ...
    #endif /* if defined( _CMU_HFRCOCTRL_SUDELAY_MASK ) */
 ...
 *****************************************************************************/
    ...
    #endif /* if defined( _CMU_HFXOCTRL_MASK ) */
 ...
 *****************************************************************************/
    ...
    #endif /* if defined( _CMU_LFXOCTRL_MASK ) */
                               ...
                               bool wait )
    {
        ...
        if( enable )
        {
            ...
            if( wait )
            {
                ...
                #endif /* if defined( _CMU_STATUS_HFXOSHUNTOPTRDY_MASK ) */
            }
        }
        else
        {
                ...
                case 0:
                    ...
                    break;
                        ...
                        case 1:
                            ...
                            #endif
                    #endif
            #endif /* if defined( _CMU_PCNTCTRL_PCNT0CLKEN_MASK ) */
