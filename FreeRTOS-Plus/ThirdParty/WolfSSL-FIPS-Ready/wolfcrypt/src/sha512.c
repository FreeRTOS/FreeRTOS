...
/* fips wrapper calls, user can call direct */
    ...
    ( !defined( HAVE_FIPS_VERSION ) || ( HAVE_FIPS_VERSION < 2 ) )
            ...
            int wc_InitSha512_ex( wc_Sha512 * sha,
                                  void * heap,
                                  int devId )
            {
                ( void ) heap;
            ...
            int wc_Sha512Final( wc_Sha512 * sha,
                                byte * out )
            {
            ...
            int wc_InitSha384_ex( wc_Sha384 * sha,
                                  void * heap,
                                  int devId )
            {
                ( void ) heap;
            ...
            int wc_Sha384Final( wc_Sha384 * sha,
                                byte * out )
            {
                if( ( sha == NULL ) || ( out == NULL ) )
                {
        ...
        #include <wolfssl/wolfcrypt/logging.h>
            ...
            #endif
        #endif /* if defined( USE_INTEL_SPEEDUP ) */
 ...
 */
                    ...
                    extern "C" {
                        ...
                        extern int Transform_Sha512_AVX1_Len( wc_Sha512 * sha512,
                                                              word32 len );
                    #endif
                    #if defined( HAVE_INTEL_AVX2 )
                        extern int Transform_Sha512_AVX2( wc_Sha512 * sha512 );
                        extern int Transform_Sha512_AVX2_Len( wc_Sha512 * sha512,
                                                              word32 len );
                    ...
                    static int (* Transform_Sha512_Len_p)( wc_Sha512 * sha512,
                                                           word32 len ) = NULL;
    ...
    ( *Transform_Sha512_Len_p )( sha512, len )
                ...
                int wc_InitSha512_ex( wc_Sha512 * sha512,
                                      void * heap,
                                      int devId )
                {
                    int ret = 0;
    ...
    h( i ) += S0( a( i ) ) + Maj( a( i ), b( i ), c( i ) )
            ...
            static WC_INLINE void AddLength( wc_Sha512 * sha512,
                                             word32 len )
            {
            ...
            static WC_INLINE int Sha512Update( wc_Sha512 * sha512,
                                               const byte * data,
                                               word32 len )
            {
                int ret = 0;
                ...
                if( sha512->buffLen > 0 )
                {
                    ...
                    if( sha512->buffLen == WC_SHA512_BLOCK_SIZE )
                    {
                        ...
                        #endif /* if defined( LITTLE_ENDIAN_ORDER ) */
                        #if !defined( WOLFSSL_ESP32WROOM32_CRYPT ) || \
                        defined( NO_WOLFSSL_ESP32WROOM32_CRYPT_HASH )
                ...
                #else  /* if !defined( LITTLE_ENDIAN_ORDER ) || defined( HAVE_INTEL_AVX1 ) || defined( HAVE_INTEL_AVX2 ) */
                {
                    while( len >= WC_SHA512_BLOCK_SIZE )
                    {
                        XMEMCPY( local, data, WC_SHA512_BLOCK_SIZE );
                ...
                #endif /* if !defined( LITTLE_ENDIAN_ORDER ) || defined( HAVE_INTEL_AVX1 ) || defined( HAVE_INTEL_AVX2 ) */
        ...
        static WC_INLINE int Sha512Final( wc_Sha512 * sha512 )
        {
            ...
            int wc_Sha512FinalRaw( wc_Sha512 * sha512,
                                   byte * hash )
            {
                #ifdef LITTLE_ENDIAN_ORDER
...
/* -------------------------------------------------------------------------- */
                ...
                int wc_Sha384FinalRaw( wc_Sha384 * sha384,
                                       byte * hash )
                {
                    #ifdef LITTLE_ENDIAN_ORDER
                ...
                int wc_InitSha384_ex( wc_Sha384 * sha384,
                                      void * heap,
                                      int devId )
                {
                    int ret;
        ...
        int wc_Sha512GetHash( wc_Sha512 * sha512,
                              byte * hash )
        {
            int ret;
            wc_Sha512 tmpSha512;
        ...
        int wc_Sha512Copy( wc_Sha512 * src,
                           wc_Sha512 * dst )
        {
            int ret = 0;
        ...
        #if defined( WOLFSSL_HASH_FLAGS ) || defined( WOLF_CRYPTO_CB )
            int wc_Sha512SetFlags( wc_Sha512 * sha512,
                                   word32 flags )
            {
                if( sha512 )
                {
            ...
            int wc_Sha512GetFlags( wc_Sha512 * sha512,
                                   word32 * flags )
            {
                if( sha512 && flags )
                {
        ...
        int wc_Sha384GetHash( wc_Sha384 * sha384,
                              byte * hash )
        {
            int ret;
            wc_Sha384 tmpSha384;
        ...
        int wc_Sha384Copy( wc_Sha384 * src,
                           wc_Sha384 * dst )
        {
            int ret = 0;
        ...
        #if defined( WOLFSSL_HASH_FLAGS ) || defined( WOLF_CRYPTO_CB )
            int wc_Sha384SetFlags( wc_Sha384 * sha384,
                                   word32 flags )
            {
                if( sha384 )
                {
            ...
            int wc_Sha384GetFlags( wc_Sha384 * sha384,
                                   word32 * flags )
            {
                if( sha384 && flags )
                {
