...
/* Return values */
    ...
    static int __metal_driver_sifive_pwm0_set_duty( struct metal_pwm * gpwm,
                                                    unsigned int idx,
                                                    unsigned int duty,
    ...
    static int __metal_driver_sifive_pwm0_cfg_interrupt( struct metal_pwm * gpwm,
    ...
    static struct metal_interrupt * __metal_driver_sifive_pwm0_interrupt_controller( struct metal_pwm * gpwm )
    {
