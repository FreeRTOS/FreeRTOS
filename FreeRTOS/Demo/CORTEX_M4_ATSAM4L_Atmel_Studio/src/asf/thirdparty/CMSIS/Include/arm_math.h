...
/* No need to redefine __CLZ */
    ...
    #endif /* if defined( ARM_MATH_CM0 ) && ( ( defined( __ICCARM__ ) ) || ( defined( __GNUC__ ) ) ) */
 ...
 */
        ...
        __STATIC_INLINE q31_t __SSAT( q31_t x,
                                      uint32_t y )
        {
 ...
 */
        __STATIC_INLINE q31_t __QADD8( q31_t x,
                                       q31_t y )
        {
            q31_t sum;
            q7_t r, s, t, u;
 ...
 */
        __STATIC_INLINE q31_t __QSUB8( q31_t x,
                                       q31_t y )
        {
            q31_t sum;
            q31_t r, s, t, u;
 ...
 * @brief C custom defined QADD16 for M3 and M0 processors
 */
        __STATIC_INLINE q31_t __QADD16( q31_t x,
                                        q31_t y )
        {
            q31_t sum;
            q31_t r, s;
 ...
 */
        __STATIC_INLINE q31_t __SHADD16( q31_t x,
                                         q31_t y )
        {
            q31_t sum;
            q31_t r, s;
 ...
 */
        __STATIC_INLINE q31_t __QSUB16( q31_t x,
                                        q31_t y )
        {
            q31_t sum;
            q31_t r, s;
 ...
 */
        __STATIC_INLINE q31_t __SHSUB16( q31_t x,
                                         q31_t y )
        {
            q31_t diff;
            q31_t r, s;
 ...
 */
        __STATIC_INLINE q31_t __QASX( q31_t x,
                                      q31_t y )
        {
            q31_t sum = 0;
 ...
 */
        __STATIC_INLINE q31_t __SHASX( q31_t x,
                                       q31_t y )
        {
            q31_t sum;
            q31_t r, s;
 ...
 */
        __STATIC_INLINE q31_t __QSAX( q31_t x,
                                      q31_t y )
        {
            q31_t sum = 0;
 ...
 */
        __STATIC_INLINE q31_t __SHSAX( q31_t x,
                                       q31_t y )
        {
            q31_t sum;
            q31_t r, s;
 ...
 */
        __STATIC_INLINE q31_t __SMUSDX( q31_t x,
                                        q31_t y )
        {
 ...
 */
        __STATIC_INLINE q31_t __SMUADX( q31_t x,
                                        q31_t y )
        {
            return( ( q31_t ) ( ( ( short ) x * ( short ) ( y >> 16 ) ) +
                                ( ( short ) ( x >> 16 ) * ( short ) y ) ) );
 ...
 */
        __STATIC_INLINE q31_t __QADD( q31_t x,
                                      q31_t y )
        {
 ...
 */
        __STATIC_INLINE q31_t __QSUB( q31_t x,
                                      q31_t y )
        {
            return clip_q63_to_q31( ( q63_t ) x - y );
        }
 ...
 */
        __STATIC_INLINE q31_t __SMLAD( q31_t x,
                                       q31_t y,
                                       q31_t sum )
        {
 ...
 */
        __STATIC_INLINE q31_t __SMLADX( q31_t x,
                                        q31_t y,
                                        q31_t sum )
        {
 ...
 */
        __STATIC_INLINE q31_t __SMLSDX( q31_t x,
                                        q31_t y,
                                        q31_t sum )
        {
            return( sum - ( ( short ) ( x >> 16 ) * ( short ) ( y ) ) +
 ...
 */
        __STATIC_INLINE q63_t __SMLALD( q31_t x,
                                        q31_t y,
                                        q63_t sum )
        {
            return( sum + ( ( short ) ( x >> 16 ) * ( short ) ( y >> 16 ) ) +
 ...
 */
        __STATIC_INLINE q63_t __SMLALDX( q31_t x,
                                         q31_t y,
                                         q63_t sum )
        {
            return ( sum + ( ( short ) ( x >> 16 ) * ( short ) y ) ) +
 ...
 */
        __STATIC_INLINE q31_t __SMUAD( q31_t x,
                                       q31_t y )
        {
            return( ( ( x >> 16 ) * ( y >> 16 ) ) +
                    ( ( ( x << 16 ) >> 16 ) * ( ( y << 16 ) >> 16 ) ) );
 ...
 */
        __STATIC_INLINE q31_t __SMUSD( q31_t x,
                                       q31_t y )
        {
            return( -( ( x >> 16 ) * ( y >> 16 ) ) +
                    ( ( ( x << 16 ) >> 16 ) * ( ( y << 16 ) >> 16 ) ) );
 ...
 */
    ...
    __STATIC_INLINE float32_t arm_pid_f32( arm_pid_instance_f32 * S,
                                           float32_t in )
    {
        float32_t out;
 ...
 */
    ...
    __STATIC_INLINE float32_t arm_linear_interp_f32( arm_linear_interp_instance_f32 * S,
                                                     float32_t x )
    {
        float32_t y;
 ...
 */
    ...
    __STATIC_INLINE q15_t arm_linear_interp_q15( q15_t * pYData,
                                                 q31_t x,
                                                 uint32_t nValues )
    {
        q63_t y;                              /* output */
 ...
 */
    ...
    __STATIC_INLINE q7_t arm_linear_interp_q7( q7_t * pYData,
                                               q31_t x,
                                               uint32_t nValues )
    {
        q31_t y;                               /* output */
