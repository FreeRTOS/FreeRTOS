 ...
 */
        ...
        #endif /* if defined( CUSTOM_RAND_GENERATE_BLOCK ) */
 ...
 * can't be used with CTaoCrypt FIPS */
    ...
    WOLFSSL_ABI WOLFSSL_API WC_RNG * wc_rng_new( byte *,
                                                 word32,
                                                 void * );
    WOLFSSL_ABI WOLFSSL_API void wc_rng_free( WC_RNG * );
        ...
        WOLFSSL_API int wc_InitRng_ex( WC_RNG * rng,
                                       void * heap,
                                       int devId );
        WOLFSSL_API int wc_InitRngNonce( WC_RNG * rng,
                                         byte * nonce,
                                         word32 nonceSz );
        WOLFSSL_API int wc_InitRngNonce_ex( WC_RNG * rng,
                                            byte * nonce,
                                            word32 nonceSz,
                                            void * heap,
                                            int devId );
        WOLFSSL_ABI WOLFSSL_API int wc_RNG_GenerateBlock( WC_RNG *,
                                                          byte *,
                                                          word32 sz );
        WOLFSSL_API int wc_RNG_GenerateByte( WC_RNG *,
                                             byte * );
    ...
    #ifdef HAVE_HASHDRBG
        WOLFSSL_LOCAL int wc_RNG_DRBG_Reseed( WC_RNG * rng,
                                              const byte * entropy,
                                              word32 entropySz );
        WOLFSSL_API int wc_RNG_TestSeed( const byte * seed,
                                         word32 seedSz );
