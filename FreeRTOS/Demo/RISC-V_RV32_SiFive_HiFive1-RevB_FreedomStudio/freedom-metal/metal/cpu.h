 ...
 */
typedef void (* metal_exception_handler_t)( struct metal_cpu * cpu,
                                            int ecode );
...
struct metal_cpu_vtable
{
    ...
    int (* mtimecmp_set)( struct metal_cpu * cpu,
    ...
    int (* set_sw_ipi)( struct metal_cpu * cpu,
                        int hartid );
    int (* clear_sw_ipi)( struct metal_cpu * cpu,
                          int hartid );
    int (* get_msip)( struct metal_cpu * cpu,
                      int hartid );
    struct metal_interrupt *(* controller_interrupt)( struct metal_cpu * cpu );
    int (* exception_register)( struct metal_cpu * cpu,
                                int ecode,
                                metal_exception_handler_t handler );
    int (* get_ilen)( struct metal_cpu * cpu,
                      uintptr_t epc );
    uintptr_t (* get_epc)( struct metal_cpu * cpu );
    int (* set_epc)( struct metal_cpu * cpu,
                     uintptr_t epc );
 ...
 */
__inline__ int metal_cpu_software_set_ipi( struct metal_cpu * cpu,
                                           int hartid )
{
 ...
 * @return 0 upon success
 */
__inline__ int metal_cpu_software_clear_ipi( struct metal_cpu * cpu,
                                             int hartid )
{
 ...
 * @return 0 upon success
 */
__inline__ int metal_cpu_get_msip( struct metal_cpu * cpu,
                                   int hartid )
{
 ...
 * @return 0 upon success
 */
__inline__ int metal_cpu_exception_register( struct metal_cpu * cpu,
                                             int ecode,
                                             metal_exception_handler_t handler )
{
