...
This release also includes CBMC proofs for all public and private functions in the [OTA Update library](https://github.com/aws/ota-for-aws-iot-embedded-sdk). The [corePKCS11 library](https://github.com/FreeRTOS/corePKCS11) has updated its mbed TLS version. Additionally, the [Sigv4 library](https://github.com/aws/SigV4-for-AWS-IoT-embedded-sdk/) has been updated with various performance improvements and bugfixes.
