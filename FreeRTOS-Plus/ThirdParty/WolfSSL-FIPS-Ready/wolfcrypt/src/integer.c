 ...
 */
                                 ...
                                 int redmode )
            {
                ...
                if( redmode == 0 )
                {
                    ...
                    #else  /* ifdef BN_MP_MONTGOMERY_CALC_NORMALIZATION_C */
                        err = MP_VAL;
                        goto LBL_RES;
...
LBL_M:
                ...
                return err;
                    ...
                    #define WINSIZE    6
                #endif
                int mp_exptmod_base_2( mp_int * X,
                                       mp_int * P,
                                       mp_int * Y )
                {
                    mp_digit buf, mp;
...
/* setups the montgomery reduction stuff */
            int mp_montgomery_setup( mp_int * n,
                                     mp_digit * rho )
            {
                mp_digit x, b;
...
/* computes xR**-1 == x (mod N) via Montgomery Reduction */
            int mp_montgomery_reduce( mp_int * x,
                                      mp_int * n,
                                      mp_digit rho )
            {
                int ix, res, digs;
...
/* c = a * a (mod b) */
            ...
            #endif /* if defined( WOLFSSL_KEY_GEN ) || defined( HAVE_ECC ) || !defined( NO_RSA ) || !defined( NO_DSA ) | !defined( NO_DH ) */
...
/* Counts the number of lsbs which are zero before the first zero bit */
                ...
                static int s_is_power_of_two( mp_digit b,
                                              int * p )
                {
                    int x;
 ...
 * very much lower.
 */
                static int mp_prime_miller_rabin( mp_int * a,
                                                  mp_int * b,
                                                  int * result )
                {
                    mp_int n1, y, r;
 ...
 */
                static int mp_prime_is_divisible( mp_int * a,
                                                  int * result )
                {
                    int err, ix;
                    mp_digit res;
