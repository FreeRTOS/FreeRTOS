...
/** Validation of pin typically usable in assert statements. */
    ...
    #define GPIO_STRENGHT_VALID( strenght ) \
    ( !( ( strenght ) &                     \
 ...
 ******************************************************************************/
    ...
    #endif /* if defined( _GPIO_P_CTRL_DRIVEMODE_MASK ) */
 ...
 ******************************************************************************/
    ...
    #endif /* if defined( _GPIO_P_CTRL_DRIVESTRENGTH_MASK ) */
 ...
 *****************************************************************************/
    ...
    #endif /* if defined( _GPIO_EM4WUEN_MASK ) */
