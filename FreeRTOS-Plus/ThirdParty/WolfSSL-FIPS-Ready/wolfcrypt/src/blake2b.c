...
/* Some helper functions, not necessarily useful */
    ...
    static WC_INLINE int blake2b_increment_counter( blake2b_state * S,
                                                    const word64
                                                    inc )
    {
        S->t[ 0 ] += inc;
...
/* init xors IV with input parameter block */
                      ...
                      const byte outlen )
    {
        ...
        #else  /* ifdef WOLFSSL_BLAKE2B_INIT_EACH_FIELD */
            XMEMSET( P, 0, sizeof( *P ) );
            P->digest_length = outlen;
            P->fanout = 1;
            P->depth = 1;
        #endif /* ifdef WOLFSSL_BLAKE2B_INIT_EACH_FIELD */
...
/* inlen, at least, should be word64. Others can be size_t. */
    ...
    #endif /* if defined( BLAKE2B_SELFTEST ) */
