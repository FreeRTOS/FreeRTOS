...
struct metal_spi_config
{
    ...
    enum
    {
        METAL_SPI_SINGLE, METAL_SPI_DUAL, METAL_SPI_QUAD
    }
    protocol;
...
{
    void (* init)( struct metal_spi * spi,
                   int baud_rate );
    int (* transfer)( struct metal_spi * spi,
                      struct metal_spi_config * config,
                      size_t len,
                      char * tx_buf,
                      char * rx_buf );
    int (* get_baud_rate)( struct metal_spi * spi );
    int (* set_baud_rate)( struct metal_spi * spi,
                           int baud_rate );
};
 ...
 */
__inline__ void metal_spi_init( struct metal_spi * spi,
                                int baud_rate )
{
 ...
 */
__inline__ int metal_spi_set_baud_rate( struct metal_spi * spi,
                                        int baud_rate )
{
    return spi->vtable->set_baud_rate( spi, baud_rate );
}

#endif /* ifndef METAL__SPI_H */
