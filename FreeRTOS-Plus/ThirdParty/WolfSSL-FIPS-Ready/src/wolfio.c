 ...
 */
        static WC_INLINE int TranslateReturnCode( int old,
                                                  int sd )
        {
            ( void ) sd;
            ...
            #endif /* if defined( FREESCALE_MQX ) || defined( FREESCALE_KSDK_MQX ) */
 ...
 *  return : nb bytes read, or error
 */
                int EmbedReceiveFromMcast( WOLFSSL * ssl,
                                           char * buf,
                                           int sz,
                                           void * ctx )
                {
 ...
 */
        ...
        static int wolfIO_Word16ToString( char * d,
                                          word16 number )
        {
            int i = 0;
            word16 order = 10000;
        ...
        int wolfIO_DecodeUrl( const char * url,
                              int urlSz,
                              char * outName,
                              char * outPath,
                              word16 * outPort )
        ...
        static int wolfIO_HttpProcessResponseBuf( int sfd,
                                                  byte ** recvBuf,
                                                  int * recvBufSz,
                                                  int chunkSz,
                                                  char * start,
        ...
        int wolfIO_HttpProcessResponse( int sfd,
                                        ...
                                        void * heap )
        {
            ...
            enum phr_state
            {
                phr_init, phr_http_start, phr_have_length, phr_have_type,
        ...
        int wolfIO_HttpBuildRequest( const char * reqType,
        ...
        int wolfIO_HttpBuildRequest_ex( const char * reqType,
                                        const char * domainName,
                                        const char * path,
                                        int pathLen,
                                        int reqSz,
                                        ...
                                        int bufSize )
        {
            ...
            int wolfIO_HttpBuildRequestOcsp( const char * domainName,
                                             const char * path,
                                             int ocspReqSz,
                                             byte * buf,
                                             int bufSize )
 ...
 *         -1 error */
            int wolfIO_HttpProcessResponseOcsp( int sfd,
                                                byte ** respBuf,
                                                byte * httpBuf,
                                                int httpBufSz,
                                                void * heap )
...
/* in default callback ctx is heap hint */
            ...
            int wolfIO_HttpBuildRequestCrl( const char * url,
                                            int urlSz,
                                            const char * domainName,
                                            byte * buf,
                                            int bufSize )
            ...
            int wolfIO_HttpProcessResponseCrl( WOLFSSL_CRL * crl,
                                               int sfd,
                                               byte * httpBuf,
                                               int httpBufSz )
            {
            ...
            int EmbedCrlLookup( WOLFSSL_CRL * crl,
                                const char * url,
                                int urlSz )
            {
                SOCKET_T sfd = SOCKET_INVALID;
    ...
    void wolfSSL_CTX_SetIOSend( WOLFSSL_CTX * ctx,
...
/* sets the IO callback to use for receives at WOLFSSL level */
    void wolfSSL_SSLSetIORecv( WOLFSSL * ssl,
                               CallbackIORecv CBIORecv )
    {
        if( ssl )
        {
...
/* sets the IO callback to use for sends at WOLFSSL level */
    void wolfSSL_SSLSetIOSend( WOLFSSL * ssl,
                               CallbackIOSend CBIOSend )
    {
        if( ssl )
        {
                                  ...
                                  int flags )
    {
        ...
        void wolfSSL_SetCookieCtx( WOLFSSL * ssl,
                                   void * ctx )
        {
            if( ssl )
            {
        ...
        void * wolfSSL_GetCookieCtx( WOLFSSL * ssl )
        {
            ...
            void wolfSSL_CTX_SetIOGetPeer( WOLFSSL_CTX * ctx,
                                           CallbackGetPeer cb )
            {
                if( ctx )
                {
            ...
            void wolfSSL_CTX_SetIOSetPeer( WOLFSSL_CTX * ctx,
                                           CallbackSetPeer cb )
            {
                if( ctx )
                {
 ...
 *  return : nb bytes read, or error
 */
        int MicriumReceive( WOLFSSL * ssl,
                            char * buf,
                            int sz,
                            void * ctx )
        {
 ...
 *  return : nb bytes read, or error
 */
        int MicriumReceiveFrom( WOLFSSL * ssl,
                                char * buf,
                                int sz,
                                void * ctx )
        {
 ...
 *  return : number of bytes copied into buf, or error
 */
        int MicriumGenerateCookie( WOLFSSL * ssl,
                                   byte * buf,
                                   int sz,
                                   void * ctx )
        {
...
/* return Mynewt_Ctx instance */
        ...
        static void mynewt_sock_writable( void * arg,
                                          int err );
        static void mynewt_sock_readable( void * arg,
                                          int err );
 ...
 *  return :  bytes read, or error
 */
        int Mynewt_Receive( WOLFSSL * ssl,
                            char * buf,
                            int sz,
                            void * ctx )
        {
...
/* like set_fd, but for default NetX context */
        void wolfSSL_SetIO_Mynewt( WOLFSSL * ssl,
 ...
 *  return : number of bytes copied into buf, or error
 */
        int uIPGenerateCookie( WOLFSSL * ssl,
                               byte * buf,
                               int sz,
                               void * _ctx )
        {
 ...
 *  return : nb bytes read, or error
 */
        int GNRC_ReceiveFrom( WOLFSSL * ssl,
                              char * buf,
                              int sz,
                              void * _ctx )
        {
 ...
 */
        ...
        int GNRC_GenerateCookie( WOLFSSL * ssl,
                                 byte * buf,
                                 int sz,
                                 void * _ctx )
        {
