...
/****** Ethernet PHY Mode *****/
    ...
    typedef int32_t (* csi_eth_phy_read_t)  ( uint8_t phy_addr,
                                              uint8_t reg_addr,
                                              uint16_t * data );                             /*/< Read Ethernet PHY Register. */
    typedef int32_t (* csi_eth_phy_write_t) ( uint8_t phy_addr,
                                              uint8_t reg_addr,
                                              uint16_t data );                               /*/< Write Ethernet PHY Register. */
 ...
 */
    eth_phy_handle_t csi_eth_phy_initialize( csi_eth_phy_read_t fn_read,
                                             csi_eth_phy_write_t fn_write );
 ...
 * \return      error code
 */
    int32_t csi_eth_phy_power_control( eth_phy_handle_t handle,
 ...
 * \return      error code
 */
    int32_t csi_eth_phy_set_interface( eth_phy_handle_t handle,
                                       uint32_t interface );
 ...
 * \return      error code
 */
    int32_t csi_eth_phy_set_mode( eth_phy_handle_t handle,
                                  uint32_t mode );
