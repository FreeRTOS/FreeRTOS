...
/* helper for PKCS12_PBKDF(), does hash operation */
        static int DoPKCS12Hash( int hashType,
                                 byte * buffer,
                                 word32 totalLen,
                                 byte * Ai,
                                 word32 u,
...
/* extended API that allows a heap hint to be used */
        int wc_PKCS12_PBKDF_ex( byte * output,
                                const byte * passwd,
                                int passLen,
                                const byte * salt,
                                int saltLen,
 ...
 */
        static void scryptSalsa( word32 * out,
                                 word32 * in )
        {
            int i;
            word32 x[ 16 ];
 ...
 * r  Size of the block.
 */
        static void scryptBlockMix( byte * b,
                                    byte * y,
                                    int r )
        {
            byte x[ 64 ];
 ...
 */
        static void scryptROMix( byte * x,
                                 byte * v,
                                 byte * y,
                                 int r,
                                 word32 n )
