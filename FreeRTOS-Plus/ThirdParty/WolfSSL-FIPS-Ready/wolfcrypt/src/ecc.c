 ...
 ***MUST*** be organized by size from smallest to largest. */
    ...
    const ecc_set_type ecc_sets[] =
    {
        ...
        #endif /* if defined( WOLFSSL_CUSTOM_CURVES ) && defined( ECC_CACHE_CURVE ) */
        {
            0,
            ECC_CURVE_INVALID,
            #ifndef WOLFSSL_ECC_CURVE_STATIC
    ...
    #ifdef HAVE_COMP_KEY
        static int wc_ecc_export_x963_compressed( ecc_key *,
                                                  byte * out,
                                                  word32 * outLen );
    #endif
    ...
    !defined( WOLFSSL_ATECC508A ) && !defined( WOLFSSL_ATECC608A )
        static int ecc_check_pubkey_order( ecc_key * key,
                                           ecc_point * pubkey,
                                           mp_int * a,
                                           mp_int * prime,
                                           mp_int * order );
...
/* Curve Specs */
    ...
    static int wc_ecc_curve_load_item( const char * src,
                                       mp_int ** dst,
    ...
    static int wc_ecc_curve_load( const ecc_set_type * dp,
                                  ecc_curve_spec ** pCurve,
                                  byte load_mask )
    {
        int ret = 0, x;
        ecc_curve_spec * curve;
 ...
 */
    ...
    int wc_ecc_set_curve( ecc_key * key,
                          int keysize,
                          int curve_id )
    {
 ...
 */
            int ecc_projective_add_point( ecc_point * P,
                                          ecc_point * Q,
                                          ecc_point * R,
                                          mp_int * a,
                                          mp_int * modulus,
 ...
 * return   MP_OKAY on success
 */
            int ecc_projective_dbl_point( ecc_point * P,
                                          ecc_point * R,
                                          mp_int * a,
                                          mp_int * modulus,
                                          mp_digit mp )
 ...
 */
                            ...
                            int ct )
            {
                    ...
                    if( err == MP_OKAY )
                    {
                        ...
                        #endif /* if defined( ECC_TIMING_RESISTANT ) && defined( USE_FAST_MATH ) */
                        {
...
/* size of sliding window, don't change this! */
                    ...
                    static int ecc_mulmod( mp_int * k,
                                           ecc_point * tG,
                                           ecc_point * R,
                                           ecc_point ** M,
                                           mp_int * a,
...
#undef WINSIZE
                ...
                #else  /* ifndef ECC_TIMING_RESISTANT */

                    static int wc_ecc_gen_z( WC_RNG * rng,
                                             int size,
                                             ecc_point * p,
                                             mp_int * modulus,
                                             mp_digit mp,
                                           ...
                                           WC_RNG * rng )
                    {
                        ...
                        #else  /* ifdef WC_NO_CACHE_RESISTANT */
                            if( err == MP_OKAY )
                            {
                        ...
                        #endif /* ifdef WC_NO_CACHE_RESISTANT */
                ...
                #endif /* ifndef ECC_TIMING_RESISTANT */
 ...
 */
                    static int ecc_point_to_mont( ecc_point * p,
                                                  ecc_point * r,
                                                  mp_int * modulus,
                                                  void * heap )
                    {
                ...
                #ifdef WOLFSSL_SMALL_STACK_CACHE
                    static int ecc_key_tmp_init( ecc_key * key,
                                                 void * heap )
                    {
                        int err = MP_OKAY;
                    ...
                    static void ecc_key_tmp_final( ecc_key * key,
                                                   void * heap )
                    {
                        ( void ) heap;
                        #ifdef ALT_ECC_SIZE
 ...
 */
                #ifdef FP_ECC
                    static int normal_ecc_mulmod( mp_int * k,
                                                  ecc_point * G,
                                                  ecc_point * R,
                                                  mp_int * a,
                                                  mp_int * modulus,
 ...
 * return MP_OKAY on success
 */
                int wc_ecc_mulmod_ex2( mp_int * k,
                                       ecc_point * G,
                                       ecc_point * R,
                                       mp_int * a,
                                       mp_int * modulus,
                ...
                #ifndef WOLFSSL_SP_MATH
                {
                    ...
                    if( mp_count_bits( k ) > mp_count_bits( order ) )
                    {
                        ...
                        mp_forcezero( &t );
                        mp_free( &t );
                    #else  /* ifdef ECC_TIMING_RESISTANT */
                        err = ecc_mulmod( k, tG, R, M, a, modulus, mp, rng );

                        ( void ) order;
                    #endif /* ifdef ECC_TIMING_RESISTANT */
 ...
 */
    ...
    void wc_ecc_del_point_h( ecc_point * p,
                             void * heap )
    {
 ...
 * return curve id, from ecc_sets[] on success, negative on error
 */
    int wc_ecc_get_curve_id_from_oid( const byte * oid,
                                      word32 len )
    {
        int curve_idx;
...
/* Get curve parameters using curve index */
    const ecc_set_type * wc_ecc_get_curve_params( int curve_idx )
    {
        ...
        static WC_INLINE int wc_ecc_alloc_mpint( ecc_key * key,
                                                 mp_int ** mp )
        {
            if( ( key == NULL ) || ( mp == NULL ) )
            {
        ...
        static WC_INLINE void wc_ecc_free_mpint( ecc_key * key,
                                                 mp_int ** mp )
        {
            if( key && mp && *mp )
            {
 ...
 */
                                  ...
                                  word32 * outlen )
        {
            ...
            #else  /* if defined( WOLFSSL_ATECC508A ) || defined( WOLFSSL_ATECC608A ) */
        ...
        !defined( WOLFSSL_CRYPTOCELL )
            ...
            static int wc_ecc_shared_secret_gen_sync( ecc_key * private_key,
                                                      ecc_point * point,
                                                      byte * out,
                                                      word32 * outlen,
                                                      ecc_curve_spec * curve )
            {
                                                           ...
                                                           ecc_curve_spec * curve )
                {
                    ...
                    #endif /* if defined( HAVE_CAVIUM_V ) || defined( HAVE_INTEL_QA ) */
            ...
            int wc_ecc_shared_secret_gen( ecc_key * private_key,
                                          ecc_point * point,
                                          byte * out,
                                          word32 * outlen )
            {
...
/* Checks if a point p lies on the curve with index curve_idx */
        int wc_ecc_point_is_on_curve( ecc_point * p,
                                      int curve_idx )
        {
            int err;
 ...
 */
    static int ecc_make_pub_ex( ecc_key * key,
                                ecc_curve_spec * curveIn,
                                ecc_point * pubOut,
                                WC_RNG * rng )
    {
        int err = MP_OKAY;
 ...
 * returns MP_OKAY on success
 */
    int wc_ecc_make_pub( ecc_key * key,
                         ecc_point * pubOut )
    {
 ...
 * returns MP_OKAY on success
 */
    int wc_ecc_make_pub_ex( ecc_key * key,
                            ecc_point * pubOut,
                            WC_RNG * rng )
    {
        WOLFSSL_ENTER( "wc_ecc_make_pub" );
                            ...
                            int curve_id )
    {
        ...
        if( err != 0 )
        {
            ...
            if( err == SA_SILIB_RET_OK )
            {
                ...
                #endif /* ifndef WOLFSSL_SP_NO_256 */
                #ifdef WOLFSSL_SP_384
                    if( ( key->idx != ECC_CUSTOM_IDX ) && ( ecc_sets[ key->idx ].id == ECC_SECP384R1 ) )
                    {
...
/* Optional dump of encoded OID for adding new curves */
        ...
        static void wc_ecc_dump_oids( void )
        {
            ...
            for( x = 0; ecc_sets[ x ].size != 0; x++ )
            {
                ...
                #else  /* ifdef HAVE_OID_ENCODING */
                    oid = ( byte * ) ecc_sets[ x ].oid;
                    oidSz = ecc_sets[ x ].oidSz;
                #endif /* ifdef HAVE_OID_ENCODING */
...
/* Setup dynamic pointers if using normal math for proper freeing */
    ...
    #ifdef HAVE_PKCS11
        int wc_ecc_init_id( ecc_key * key,
                            unsigned char * id,
                            int len,
                            void * heap,
                            int devId )
    ...
    #endif /* ifdef HAVE_PKCS11 */

    int wc_ecc_set_flags( ecc_key * key,
                          word32 flags )
    {
        if( key == NULL )
        {
    ...
    static int wc_ecc_get_curve_order_bit_count( const ecc_set_type * dp )
    {
        ...
        return ( int ) orderBits;
            ...
            defined( PLUTON_CRYPTO_ECC ) || defined( WOLFSSL_CRYPTOCELL )
                static int wc_ecc_sign_hash_hw( const byte * in,
                                                word32 inlen,
                                                mp_int * r,
                                                mp_int * s,
                                                byte * out,
                                                ...
                                                ecc_key * key )
                {
                    ...
                    #endif
                    {
                        ...
                        #endif /* if defined( WOLFSSL_ATECC508A ) || defined( WOLFSSL_ATECC608A ) */
            ...
            #if defined( WOLFSSL_ASYNC_CRYPT ) && defined( WC_ASYNC_ENABLE_ECC )
                static int wc_ecc_sign_hash_async( const byte * in,
                                                   word32 inlen,
                                                   byte * out,
                                                   word32 * outlen,
                                                   WC_RNG * rng,
 ...
 */
                                     ...
                                     mp_int * s )
            {
                ...
                #endif /* if defined( WOLFSSL_SP_MATH ) || defined( WOLFSSL_HAVE_SP_ECC ) */
                ...
                defined( WOLFSSL_ASYNC_CRYPT_TEST )
                ...
                #endif /* if defined( WOLFSSL_ASYNC_CRYPT ) && defined( WC_ASYNC_ENABLE_ECC ) && defined( WOLFSSL_ASYNC_CRYPT_TEST ) */
                    ...
                    #elif !defined( WOLFSSL_SMALL_STACK )
                        e = &e_lcl;
                    #else  /* if defined( WOLFSSL_ASYNC_CRYPT ) && defined( HAVE_CAVIUM_V ) */
                    ...
                    #endif /* if defined( WOLFSSL_ASYNC_CRYPT ) && defined( HAVE_CAVIUM_V ) */
                    ...
                    #endif /* if defined( WOLFSSL_ECDSA_SET_K ) */
                    ...
                    if( err == MP_OKAY )
                    {
                                                                            ...
                                                                            INVALID_DEVID ) ) == MP_OKAY ) )
                        {
                            ...
                            for( ; err == MP_OKAY; )
                            {
                                ...
                                #endif /* ifdef WOLFSSL_ECDSA_SET_K */
                                {
            ...
            #ifdef WOLFSSL_ECDSA_SET_K
                int wc_ecc_sign_set_k( const byte * k,
                                       word32 klen,
                                       ecc_key * key )
                {
                    int ret = 0;
    ...
    #ifdef WOLFSSL_CUSTOM_CURVES
        void wc_ecc_free_curve( const ecc_set_type * curve,
                                void * heap )
        {
            #ifndef WOLFSSL_ECC_CURVE_STATIC
                if( curve->prime != NULL )
 ...
 */
            #ifdef FP_ECC
                static int normal_ecc_mul2add( ecc_point * A,
                                               mp_int * kA,
                                               ecc_point * B,
                                               mp_int * kB,
                                               ecc_point * C,
 ...
 */
                                    ...
                                    ecc_key * key )
            {
                ...
                if( ( sig == NULL ) || ( hash == NULL ) || ( res == NULL ) || ( key == NULL ) )
                {
                    ...
                    #endif /* ifndef WOLFSSL_SMALL_STACK */
                    XMEMSET( r, 0, sizeof( mp_int ) );
                    XMEMSET( s, 0, sizeof( mp_int ) );
                #endif /* WOLFSSL_ASYNC_CRYPT */
            ...
            *res = 0;
            ...
            defined( WOLFSSL_ASYNC_CRYPT_TEST )
                ...
                *res = 1;
                ...
                #endif /* if defined( WOLFSSL_DSP ) && !defined( FREESCALE_LTC_ECC ) */
                ...
                !defined( FREESCALE_LTC_ECC )
                ...
                #endif /* if ( defined( WOLFSSL_SP_MATH ) || defined( WOLFSSL_HAVE_SP_ECC ) ) && !defined( FREESCALE_LTC_ECC ) */
                    ...
                    #else  /* if defined( FREESCALE_LTC_ECC ) */
                        #ifndef ECC_SHAMIR
                            if( err == MP_OKAY )
                            {
                                mp_digit mp = 0;
 ...
 * if shortKeySize != 0 then keysize is always (inLen-1)>>1 */
        int wc_ecc_import_point_der_ex( byte * in,
                                        word32 inLen,
                                        const int curve_idx,
                                        ecc_point * point,
                                        int shortKeySize )
...
/* export point to der */
        #ifdef HAVE_COMP_KEY
            int wc_ecc_export_point_der_compressed( const int curve_idx,
                                                    ecc_point * point,
                                                    byte * out,
                                                    word32 * outLen )
            {
...
/* is ecc point on curve described by dp ? */
        int wc_ecc_is_point( ecc_point * ecp,
                             mp_int * a,
                             mp_int * b,
                             mp_int * prime )
        {
...
/* validate privkey * generator == pubkey, 0 on success */
            static int ecc_check_privkey_gen( ecc_key * key,
                                              mp_int * a,
                                              mp_int * prime )
            {
                int err = MP_OKAY;
...
/* validate order * pubkey = point at infinity, 0 on success */
        ...
        #endif /* if defined( WOLFSSL_VALIDATE_ECC_KEYGEN ) || !defined( WOLFSSL_SP_MATH ) */
    #endif /* !WOLFSSL_ATECC508A && !WOLFSSL_CRYPTOCELL*/

    #ifdef OPENSSL_EXTRA
        int wc_ecc_get_generator( ecc_point * ecp,
                                  int curve_idx )
        {
            int err = MP_OKAY;
    ...
    int wc_ecc_check_key( ecc_key * key )
    {
        int err;
            ...
            defined( WOLFSSL_CRYPTOCELL )
                ...
                #else  /* ifndef USE_ECC_B_PARAM */
                    if( err == MP_OKAY )
                    {
                        b = curve->Bf;
                    }
                #endif /* ifndef USE_ECC_B_PARAM */
...
/* import public ECC key in ANSI X9.63 format */
        int wc_ecc_import_x963_ex( const byte * in,
                                   word32 inLen,
                                   ecc_key * key,
                                   int curve_id )
        {
 ...
 * encType is WC_TYPE_UNSIGNED_BIN or WC_TYPE_HEX_STR
 * return MP_OKAY on success */
        int wc_ecc_export_ex( ecc_key * key,
                              byte * qx,
                              word32 * qxLen,
                              byte * qy,
                              word32 * qyLen,
 ...
 * return MP_OKAY on success, negative on error */
        int wc_ecc_export_public_raw( ecc_key * key,
                                      byte * qx,
                                      word32 * qxLen,
                                      byte * qy,
                                      word32 * qyLen )
 ...
 * return MP_OKAY on success, negative on error */
        int wc_ecc_export_private_raw( ecc_key * key,
                                       byte * qx,
                                       word32 * qxLen,
                                       byte * qy,
                                       word32 * qyLen,
...
/* import private key, public part optional if (pub) passed as NULL */
        int wc_ecc_import_private_key_ex( const byte * priv,
                                          word32 privSz,
                                          const byte * pub,
                                          word32 pubSz,
                                          ecc_key * key,
 ...
 * return  MP_OKAY on success
 */
        int wc_ecc_rs_raw_to_sig( const byte * r,
                                  word32 rSz,
                                  const byte * s,
                                  word32 sSz,
                                  byte * out,
 ...
 * return  MP_OKAY on success, negative on error
 */
        int wc_ecc_sig_to_rs( const byte * sig,
                              word32 sigLen,
                              byte * r,
                              word32 * rLen,
                              byte * s,
    ...
    #ifdef HAVE_ECC_KEY_IMPORT
        static int wc_ecc_import_raw_private( ecc_key * key,
                                              const char * qx,
                                              const char * qy,
                                              const char * d,
                                              int curve_id,
 ...
 * return    MP_OKAY on success
 */
        int wc_ecc_import_raw_ex( ecc_key * key,
                                  const char * qx,
                                  const char * qy,
                                  const char * d,
                                  int curve_id )
...
/* Import x, y and optional private (d) as unsigned binary */
        int wc_ecc_import_unsigned( ecc_key * key,
                                    byte * qx,
                                    byte * qy,
                                    byte * d,
                                    int curve_id )
...
/* perform a fixed point ECC mulmod */
            static int accel_fp_mul( int idx,
                                     mp_int * k,
                                     ecc_point * R,
                                     mp_int * a,
                                     mp_int * modulus,
...
#undef KB_SIZE
            ...
            #ifndef WOLFSSL_SP_MATH
/* perform a fixed point ECC mulmod */
                static int accel_fp_mul2add( int idx1,
                                             int idx2,
                                             mp_int * kA,
                                             mp_int * kB,
                                             ecc_point * R,
 ...
 */
        ...
        #ifndef WOLFSSL_SP_MATH
            static int normal_ecc_mulmod_ex( mp_int * k,
                                             ecc_point * G,
                                             ecc_point * R,
                                             mp_int * a,
                                             mp_int * modulus,
...
/** Free the Fixed Point cache */
    ...
    #ifdef ECC_TIMING_RESISTANT
        int wc_ecc_set_rng( ecc_key * key,
                            WC_RNG * rng )
        {
            int err = 0;
...
/* optional set info, can be called before or after set_peer_salt */
        ...
        static int ecc_ctx_set_salt( ecEncCtx * ctx,
                                     int flags,
                                     WC_RNG * rng )
        {
        ...
        static void ecc_ctx_init( ecEncCtx * ctx,
                                  int flags )
        {
            if( ctx )
            {
...
/* allow ecc context reset so user doesn't have to init/free for reuse */
        ...
        ecEncCtx * wc_ecc_ctx_new_ex( int flags,
                                      WC_RNG * rng,
                                      void * heap )
        {
            int ret = 0;
...
/* free any resources, clear any keys */
        ...
        static int ecc_get_key_sizes( ecEncCtx * ctx,
                                      int * encKeySz,
                                      int * ivSz,
                                      int * keysLen,
                                      word32 * digestSz,
 ...
 */
                                      ...
                                      mp_int * ret )
                {
                        ...
                        return res;
                    #else  /* ifdef SQRTMOD_USE_MOD_EXP */
                        ...
                        return res;
                    #endif /* ifdef SQRTMOD_USE_MOD_EXP */
                }
            #endif /* ifndef WOLFSSL_SP_MATH */
        #endif /* !WOLFSSL_ATECC508A && !WOLFSSL_CRYPTOCELL */
...
/* export public ECC key in ANSI X9.63 format compressed */
        static int wc_ecc_export_x963_compressed( ecc_key * key,
                                                  byte * out,
                                                  word32 * outLen )
        {
            word32 numlen;
    ...
    int wc_ecc_get_oid( word32 oidSum,
                        const byte ** oid,
                        word32 * oidSz )
    {
        int x;
    ...
    #ifdef WOLFSSL_CUSTOM_CURVES
        int wc_ecc_set_custom_curve( ecc_key * key,
                                     const ecc_set_type * dp )
        {
            if( ( key == NULL ) || ( dp == NULL ) )
            {
...
/* ASN X9.63 Key Derivation Function (SEC1) */
        int wc_X963_KDF( enum wc_HashType type,
                         const byte * secret,
                         word32 secretSz,
                         const byte * sinfo,
                         word32 sinfoSz,
