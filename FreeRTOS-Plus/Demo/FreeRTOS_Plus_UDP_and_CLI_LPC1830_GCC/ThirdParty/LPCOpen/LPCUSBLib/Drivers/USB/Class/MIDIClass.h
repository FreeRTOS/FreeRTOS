/*
 * @brief Master include file for the library USB MIDI Class driver, for both host and device modes
 *
 * @note
 ...
 *
 *  @note The USB MIDI class is actually a special case of the regular Audio class, thus this module depends on
