...
#include <metal/machine/platform.h>
    ...
    void __metal_clic0_handler( int id,
                                void * priv ) __attribute__( ( aligned( 64 ) ) );
    ...
    unsigned int __metal_clic0_interrupt_get_level( struct __metal_driver_sifive_clic0 * clic,
                                                    int id )
    {
        int level;
    ...
    int __metal_clic0_interrupt_set_priority( struct __metal_driver_sifive_clic0 * clic,
                                              int id,
                                              int priority )
    {
    ...
    int __metal_clic0_interrupt_get_priority( struct __metal_driver_sifive_clic0 * clic,
                                              int id )
    {
        int priority;
        uint8_t mask, val, freebits, nlbits;
    ...
    int __metal_clic0_interrupt_set_vector_mode( struct __metal_driver_sifive_clic0 * clic,
                                                 int id,
                                                 int enable )
    {
        uint8_t mask, val;
    ...
    int __metal_clic0_interrupt_is_vectored( struct __metal_driver_sifive_clic0 * clic,
                                             int id )
    {
        uint8_t mask, val;
        unsigned long control_base = __metal_driver_sifive_clic0_control_base(
    ...
    int __metal_clic0_configure_set_vector_mode( struct __metal_driver_sifive_clic0 * clic,
    ...
    int __metal_clic0_configure_set_privilege( struct __metal_driver_sifive_clic0 * clic,
    ...
    void __metal_clic0_default_handler( int id,
                                        void * priv )
    {
        metal_shutdown( 300 );
    }
    ...
    int __metal_driver_sifive_clic0_set_vector_mode( struct metal_interrupt * controller,
                                                     metal_vector_mode mode )
    {
        struct __metal_driver_sifive_clic0 * clic =
            ( struct __metal_driver_sifive_clic0 * ) ( controller );
    ...
    unsigned int __metal_driver_sifive_clic0_get_priority( struct metal_interrupt * controller,
                                                           int id )
    {
        struct __metal_driver_sifive_clic0 * clic =
            ( struct __metal_driver_sifive_clic0 * ) ( controller );
    ...
    unsigned int __metal_driver_sifive_clic0_get_preemptive_level( struct metal_interrupt * controller,
                                                                   int id )
    {
        struct __metal_driver_sifive_clic0 * clic =
            ( struct __metal_driver_sifive_clic0 * ) ( controller );
    ...
    int __metal_driver_sifive_clic0_clear_interrupt( struct metal_interrupt * controller,
                                                     int id )
    {
        struct __metal_driver_sifive_clic0 * clic =
            ( struct __metal_driver_sifive_clic0 * ) ( controller );
    ...
    int __metal_driver_sifive_clic0_set_interrupt( struct metal_interrupt * controller,
                                                   int id )
    {
        struct __metal_driver_sifive_clic0 * clic =
            ( struct __metal_driver_sifive_clic0 * ) ( controller );
