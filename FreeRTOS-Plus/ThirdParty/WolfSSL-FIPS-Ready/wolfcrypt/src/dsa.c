...
#include <wolfssl/wolfcrypt/settings.h>
    ...
    int wc_InitDsaKey_h( DsaKey * key,
                         void * h )
    {
 ...
 * return 0 on success, -1 on error */
    static int CheckDsaLN( int modLen,
                           int divLen )
    {
        int ret = -1;
...
/* modulus_size in bits */
    ...
    static int _DsaImportParamsRaw( DsaKey * dsa,
                                    const char * p,
                                    const char * q,
                                    const char * g,
                                    int trusted,
 ...
 */
    int wc_DsaImportParamsRaw( DsaKey * dsa,
                               const char * p,
                               const char * q,
                               const char * g )
    {
 ...
 * returns 0 on success, negative upon failure
 */
    int wc_DsaImportParamsRawCheck( DsaKey * dsa,
                                    const char * p,
                                    const char * q,
                                    const char * g,
                                    int trusted,
 ...
 * returns 0 on success, negative upon failure
 */
    int wc_DsaExportParamsRaw( DsaKey * dsa,
                               byte * p,
                               word32 * pSz,
                               byte * q,
                               word32 * qSz,
 ...
 * returns 0 on success, negative upon failure
 */
    int wc_DsaExportKeyRaw( DsaKey * dsa,
                            byte * x,
                            word32 * xSz,
                            byte * y,
                            word32 * ySz )
                    ...
                    WC_RNG * rng )
    {
        ...
        #else  /* ifdef WOLFSSL_MP_INVMOD_CONSTANT_TIME */
