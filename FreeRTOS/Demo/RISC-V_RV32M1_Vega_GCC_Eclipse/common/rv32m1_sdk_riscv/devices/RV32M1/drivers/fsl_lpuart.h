...
/*! @brief LPUART transfer callback function. */
    typedef void (* lpuart_transfer_callback_t)( LPUART_Type * base,
 ...
 */
        static inline void LPUART_EnableTxDMA( LPUART_Type * base,
                                               bool enable )
        {
            if( enable )
            {
 ...
 * @param enable True to enable, false to disable.
 */
        static inline void LPUART_EnableRxDMA( LPUART_Type * base,
                                               bool enable )
        {
            if( enable )
            {
 ...
 * @param enable True to enable, false to disable.
 */
    static inline void LPUART_EnableTx( LPUART_Type * base,
                                        bool enable )
    {
        if( enable )
        {
 ...
 * @param enable True to enable, false to disable.
 */
    static inline void LPUART_EnableRx( LPUART_Type * base,
                                        bool enable )
    {
        if( enable )
        {
 ...
 */
    static inline void LPUART_WriteByte( LPUART_Type * base,
                                         uint8_t data )
    {
        base->DATA = data;
    }
 ...
 */
    static inline uint8_t LPUART_ReadByte( LPUART_Type * base )
    {
        ...
        #else  /* if defined( FSL_FEATURE_LPUART_HAS_7BIT_DATA_SUPPORT ) && FSL_FEATURE_LPUART_HAS_7BIT_DATA_SUPPORT */
            return base->DATA;
