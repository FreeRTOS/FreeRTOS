...
#endif /* if !( defined( __ICCARM__ ) && ( __VER__ >= 6010000 ) ) */
FILE __stdout;
FILE __stdin;


#if ( defined( __ARMCC_VERSION ) || defined( __ICCARM__ ) )
    extern int32_t SH_DoCommand( int32_t n32In_R0,
                                 int32_t n32In_R1,
                                 int32_t * pn32Out_R0 );
        ...
        __attribute__( ( weak ) )
    #endif
    uint32_t ProcessHardFault( uint32_t lr,
                               uint32_t msp,
                               uint32_t psp );

#endif /* if ( defined( __ARMCC_VERSION ) || defined( __ICCARM__ ) ) */
...
void SendChar( int ch )
{
    ...
    #else  /* if defined( DEBUG_ENABLE_SEMIHOST ) */
        SendChar_ToUART( ch );
    #endif /* if defined( DEBUG_ENABLE_SEMIHOST ) */
}
...
char GetChar( void )
{
        ...
        return( 0 );
    #else  /* ifdef DEBUG_ENABLE_SEMIHOST */
        while( 1 )
        {
...
#else  /* if ( defined( __GNUC__ ) || defined( __ICCARM__ ) ) */
...
#endif /* if ( defined( __GNUC__ ) || defined( __ICCARM__ ) ) */
