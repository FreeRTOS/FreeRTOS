 ...
 * use cases */
    static int default_handle_cb( remote_handle64 * handle,
                                  int finished,
                                  void * ctx )
    {
        ( void ) ctx;
 ...
 */
                static void int_256_from_bin( int32 * r,
                                              int size,
                                              const byte * a,
                                              int n )
                {
 ...
 */
                static void int_256_from_mp( int32 * r,
                                             int size,
                                             const mp_int * a )
                {
                    #if DIGIT_BIT == 26
 ...
 * MP_OKAY on success.
 */
                int sp_dsp_ecc_verify_256( remote_handle64 handleIn,
                                           const byte * hash,
                                           word32 hashLen,
                                           mp_int * pX,
                                           mp_int * pY,
