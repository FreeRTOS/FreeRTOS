...
#include <metal/machine/platform.h>
    ...
    long __metal_driver_sifive_fe310_g000_prci_get_reg( const struct __metal_driver_sifive_fe310_g000_prci * prci,
                                                        long offset )
    {
    ...
    long __metal_driver_sifive_fe310_g000_prci_set_reg( const struct __metal_driver_sifive_fe310_g000_prci * prci,
                                                        long offset,
                                                        long value )
    {
        unsigned long base = __metal_driver_sifive_fe310_g000_prci_base();
