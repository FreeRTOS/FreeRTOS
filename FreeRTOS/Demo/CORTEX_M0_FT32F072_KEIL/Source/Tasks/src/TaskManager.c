...
void vApplicationTickHook( void )  
{
	...
	if ( (ulSystemTimeTickCount&0x01) == 0 )    SendShortMessageFromISR(xHighProTaskQueue, eMsgFromSystick10ms);
	if ( (ulSystemTimeTickCount%50)   == 0 )    SendShortMessageFromISR(xLowProTaskQueue, eMsgHalfSecondTimeOut);
}
