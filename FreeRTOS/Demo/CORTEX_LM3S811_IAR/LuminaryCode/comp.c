...
/****************************************************************************** */
    ...
    void ComparatorRefSet( unsigned long ulBase,
                           unsigned long ulRef )
    {
        /* */
        /* Check the arguments. */
...
#endif /* if defined( GROUP_refset ) || defined( BUILD_ALL ) || defined( DOXYGEN ) */
...
/****************************************************************************** */
    ...
    tBoolean ComparatorValueGet( unsigned long ulBase,
                                 unsigned long ulComp )
    {
        /* */
        /* Check the arguments. */
...
/****************************************************************************** */
    ...
    void ComparatorIntDisable( unsigned long ulBase,
                               unsigned long ulComp )
    {
        /* */
        /* Check the arguments. */
...
/****************************************************************************** */
    ...
    void ComparatorIntClear( unsigned long ulBase,
                             unsigned long ulComp )
    {
        /* */
        /* Check the arguments. */
