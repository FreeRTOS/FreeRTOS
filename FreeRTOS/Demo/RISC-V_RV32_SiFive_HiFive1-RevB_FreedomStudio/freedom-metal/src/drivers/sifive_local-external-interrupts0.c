...
#include <metal/machine/platform.h>
    ...
    int __metal_driver_sifive_local_external_interrupt_enable( struct metal_interrupt * controller,
                                                               int id )
    {
        int rc = -1;
    ...
    int __metal_driver_sifive_local_external_interrupt_disable( struct metal_interrupt * controller,
                                                                int id )
    {
        int rc = -1;
    ...
    unsigned int __metal_driver_sifive_local_external_interrupt_get_priority( struct metal_interrupt * controller,
                                                                              int id )
    {
        /* Core controller does not support priority configuration */
        return 0;
...
#endif /* ifdef METAL_SIFIVE_LOCAL_EXTERNAL_INTERRUPTS0 */
