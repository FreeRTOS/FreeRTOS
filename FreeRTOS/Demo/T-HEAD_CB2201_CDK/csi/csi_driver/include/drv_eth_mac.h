...
/****** Ethernet MAC Event *****/
    ...
    typedef void (* eth_event_cb_t)( eth_mac_handle_t handle,
                                     uint32_t event );                    /*/< Pointer to \ref eth_event_cb_t : Signal Ethernet Event. */
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_power_control( eth_mac_handle_t handle,
                                       eth_power_state_t state );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_get_macaddr( eth_mac_handle_t handle,
                                     eth_mac_addr_t * mac );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_set_macaddr( eth_mac_handle_t handle,
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_set_addrfilter( eth_mac_handle_t handle,
                                        const eth_mac_addr_t * addr,
                                        uint32_t num_addr );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_send_frame( eth_mac_handle_t handle,
                                    const uint8_t * frame,
                                    uint32_t len,
                                    uint32_t flags );
 ...
 */
    int32_t csi_eth_mac_read_frame( eth_mac_handle_t handle,
                                    uint8_t * frame,
                                    uint32_t len );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_get_rx_frametime( eth_mac_handle_t handle,
                                          eth_mac_time_t * time );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_get_tx_frametime( eth_mac_handle_t handle,
                                          eth_mac_time_t * time );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_control( eth_mac_handle_t handle,
                                 uint32_t control,
                                 uint32_t arg );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_control_time( eth_mac_handle_t handle,
                                      uint32_t control,
                                      eth_mac_time_t * time );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_phy_read( eth_mac_handle_t handle,
                                  uint8_t phy_addr,
                                  uint8_t reg_addr,
                                  uint16_t * data );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_phy_write( eth_mac_handle_t handle,
                                   uint8_t phy_addr,
                                   uint8_t reg_addr,
                                   uint16_t data );
 ...
 * \return      none
 */
    void csi_eth_mac_signal_event( eth_mac_handle_t handle,
                                   uint32_t event );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_add_framefilter( eth_mac_handle_t handle,
                                         const eth_frame_filter_t * filter );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_remove_framefilter( eth_mac_handle_t handle,
                                            uint32_t filter_id );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_en_framefilter( eth_mac_handle_t handle,
                                        uint32_t filter_id,
                                        bool en );
 ...
 * \return      error code
 */
    int32_t csi_eth_mac_get_framefilter( eth_mac_handle_t handle,
                                         eth_frame_filter_list_t * list,
                                         uint32_t * count_out,
                                         uint32_t max_count );
 ...
 * \return      error code
 */
        int32_t csi_eth_mac_ex_send_frame_begin( eth_mac_handle_t handle,
                                                 uint32_t len );
 ...
 *        - sent data length
 */
        int32_t csi_eth_mac_ex_send_frame( eth_mac_handle_t handle,
                                           const uint8_t * frame,
                                           uint32_t len,
                                           uint32_t flags );
 ...
 *               - value < 0: error occurred, value is execution status as defined with execution_status
 */
        int32_t csi_eth_mac_ex_read_frame( eth_mac_handle_t handle,
                                           uint8_t * frame,
                                           uint32_t len );
 ...
 */
    ...
    #endif /* ifdef CONFIG_ETH_ENC28J60_USE_PBUF */

    #ifdef __cplusplus
}
    #endif

#endif /* ifndef _CSI_ETH_H_ */
