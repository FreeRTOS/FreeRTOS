...
#include <metal/machine/platform.h>
    ...
    int __metal_driver_sifive_gpio0_enable_io( struct metal_gpio * ggpio,
                                               long source,
                                               long dest )
    {
        long base = __metal_driver_sifive_gpio0_base( ggpio );
    ...
    int __metal_driver_sifive_gpio0_clear_int( struct metal_gpio * ggpio,
                                               long source,
                                               int intr_type )
    {
        long base = __metal_driver_sifive_gpio0_base( ggpio );
    ...
    struct metal_interrupt * __metal_driver_gpio_interrupt_controller( struct metal_gpio * gpio )
    {
        return __metal_driver_sifive_gpio0_interrupt_parent( gpio );
    }

    int __metal_driver_gpio_get_interrupt_id( struct metal_gpio * gpio,
                                              int pin )
    {
        int irq;
