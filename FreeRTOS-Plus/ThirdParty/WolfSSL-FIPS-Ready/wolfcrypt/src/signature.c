...
/* Signature wrapper disabled check */
        ...
        static int wc_SignatureDerEncode( enum wc_HashType hash_type,
                                          byte * hash_data,
                                          word32 hash_len,
                                          word32 * hash_enc_len )
        {
            ...
            case WC_SIGNATURE_TYPE_ECC:
               {
                   ...
                   #else  /* if defined( HAVE_ECC ) && defined( HAVE_ECC_VERIFY ) */
                       ret = SIG_TYPE_E;
                   #endif /* if defined( HAVE_ECC ) && defined( HAVE_ECC_VERIFY ) */
                   break;
               }
                                     ...
                                     int verify )
    {
        ...
        switch( sig_type )
        {
            case WC_SIGNATURE_TYPE_ECC:
                ...
                #else  /* if defined( HAVE_ECC ) && defined( HAVE_ECC_SIGN ) */
                    ret = SIG_TYPE_E;
                #endif /* if defined( HAVE_ECC ) && defined( HAVE_ECC_SIGN ) */
                break;
            ...
            case WC_SIGNATURE_TYPE_RSA:
                ...
                #else  /* if !defined( NO_RSA ) && !defined( WOLFSSL_RSA_PUBLIC_ONLY ) */
                    ret = SIG_TYPE_E;
                #endif /* if !defined( NO_RSA ) && !defined( WOLFSSL_RSA_PUBLIC_ONLY ) */
                break;
