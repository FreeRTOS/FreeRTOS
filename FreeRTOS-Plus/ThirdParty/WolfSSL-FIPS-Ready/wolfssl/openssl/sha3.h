 ...
 * to Sha3 is expected to also be 16 byte aligned addresses.  */
    struct WOLFSSL_SHA3_CTX
    {
        ...
        WOLFSSL_API int wolfSSL_SHA3_224_Update( WOLFSSL_SHA3_224_CTX *,
                                                 const void *,
                                                 unsigned long );
        WOLFSSL_API int wolfSSL_SHA3_224_Final( unsigned char *,
        ...
        WOLFSSL_API int wolfSSL_SHA3_256_Update( WOLFSSL_SHA3_256_CTX *,
                                                 const void *,
                                                 unsigned long );
        WOLFSSL_API int wolfSSL_SHA3_256_Final( unsigned char *,
                                                WOLFSSL_SHA3_256_CTX * );
    ...
    WOLFSSL_API int wolfSSL_SHA3_384_Update( WOLFSSL_SHA3_384_CTX *,
                                             const void *,
                                             unsigned long );
    WOLFSSL_API int wolfSSL_SHA3_384_Final( unsigned char *,
                                            WOLFSSL_SHA3_384_CTX * );
    ...
    #define SHA3_384_Final     wolfSSL_SHA3_384_Final
        ...
        WOLFSSL_API int wolfSSL_SHA3_512_Update( WOLFSSL_SHA3_512_CTX *,
                                                 const void *,
                                                 unsigned long );
        WOLFSSL_API int wolfSSL_SHA3_512_Final( unsigned char *,
