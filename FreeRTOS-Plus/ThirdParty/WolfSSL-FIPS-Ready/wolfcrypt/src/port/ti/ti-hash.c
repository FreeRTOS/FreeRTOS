...
#include <wolfssl/wolfcrypt/types.h>
    ...
    static int hashUpdate( wolfssl_TI_Hash * hash,
                           const byte * data,
                           word32 len )
    {
        void * p;
    ...
    static int hashGetHash( wolfssl_TI_Hash * hash,
                            byte * result,
                            word32 algo,
                            word32 hsize )
    {
    ...
    static int hashCopy( wolfssl_TI_Hash * src,
                         wolfssl_TI_Hash * dst )
    {
    ...
    static int hashFinal( wolfssl_TI_Hash * hash,
                          byte * result,
                          word32 algo,
                          word32 hsize )
    {
    ...
    static int hashHash( const byte * data,
                         word32 len,
                         byte * hash,
                         word32 algo,
                         word32 hsize )
    ...
    static int hashFree( wolfssl_TI_Hash * hash )
    {
    ...
    #if !defined( NO_MD5 )
        WOLFSSL_API int wc_InitMd5_ex( Md5 * md5,
                                       void * heap,
                                       int devId )
        {
            if( md5 == NULL )
        ...
        WOLFSSL_API int wc_Md5Update( Md5 * md5,
                                      const byte * data,
                                      word32 len )
        {
    ...
    #if !defined( NO_SHA )
        WOLFSSL_API int wc_InitSha_ex( Md5 * sha,
                                       void * heap,
                                       int devId )
        {
            if( sha == NULL )
        ...
        WOLFSSL_API int wc_ShaUpdate( Sha * sha,
                                      const byte * data,
                                      word32 len )
        {
        ...
        WOLFSSL_API int wc_InitSha224_ex( Sha224 * sha224,
                                          void * heap,
                                          int devId )
        {
            if( sha224 == NULL )
        ...
        WOLFSSL_API int wc_Sha224Update( Sha224 * sha224,
                                         const byte * data,
                                         word32 len )
        {
        ...
        WOLFSSL_API int wc_Sha224Final( Sha224 * sha224,
                                        byte * hash )
        {
            return hashFinal( ( wolfssl_TI_Hash * ) sha224, hash, SHAMD5_ALGO_SHA224, SHA224_DIGEST_SIZE );
        }

        WOLFSSL_API int wc_Sha224GetHash( Sha224 * sha224,
                                          byte * hash )
        {
        ...
        WOLFSSL_API int wc_InitSha256_ex( Sha256 * sha256,
                                          void * heap,
                                          int devId )
        {
            if( sha256 == NULL )
        ...
        WOLFSSL_API int wc_Sha256Update( Sha256 * sha256,
                                         const byte * data,
                                         word32 len )
        {
        ...
        WOLFSSL_API int wc_Sha256Final( Sha256 * sha256,
                                        byte * hash )
        {
            return hashFinal( ( wolfssl_TI_Hash * ) sha256, hash, SHAMD5_ALGO_SHA256, SHA256_DIGEST_SIZE );
        }

        WOLFSSL_API int wc_Sha256GetHash( Sha256 * sha256,
                                          byte * hash )
        {
...
#endif /* if defined( WOLFSSL_TI_HASH ) */
