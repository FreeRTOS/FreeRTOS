 ...
 ******************************************************************************/
    ...
    static int DbgConsole_PrintfFormattedData( PUTCHAR_FUNC func_ptr,
                                               const char * fmt,
                                               va_list ap );
 ...
 */
    static void DbgConsole_PrintfPaddingCharacter( char c,
                                                   int32_t curlen,
                                                   int32_t width,
                                                   int32_t * count,
 ...
 */
    static int32_t DbgConsole_ConvertRadixNumToString( char * numstr,
                                                       void * nump,
                                                       int32_t neg,
                                                       int32_t radix,
                                                       bool use_caps )
...
/* These function __write_r and __read_r are used to support Xtensa Clang toolchain to printf and scanf */
        ...
        int __attribute__( ( weak ) ) _write_r( void * ptr,
                                                int handle,
                                                char * buffer,
                                                int size );
        int __attribute__( ( weak ) ) _write_r( void * ptr,
        ...
        int __attribute__( ( weak ) ) _read_r( void * ptr,
                                               int handle,
                                               char * buffer,
                                               int size );
        int __attribute__( ( weak ) ) _read_r( void * ptr,
