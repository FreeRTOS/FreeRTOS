...
#include <metal/machine/platform.h>
    ...
    int __metal_driver_button_exist( struct metal_button * button,
                                     char * label )
    {
    ...
    struct metal_interrupt * __metal_driver_button_interrupt_controller( struct metal_button * button )
    {
...
#endif /* ifdef METAL_SIFIVE_GPIO_BUTTONS */
