...
int metal_hpm_set_event( struct metal_cpu * gcpu,
...
int metal_hpm_clr_event( struct metal_cpu * gcpu,
                         metal_hpm_counter counter,
                         unsigned int bitmask )
{
    struct __metal_driver_cpu * cpu = ( void * ) gcpu;
...
int metal_hpm_enable_access( struct metal_cpu * gcpu,
                             metal_hpm_counter counter )
{
    struct __metal_driver_cpu * cpu = ( void * ) gcpu;
    uintptr_t temp = 0, val = 0;
...
int metal_hpm_clear_counter( struct metal_cpu * gcpu,
                             metal_hpm_counter counter )
{
    struct __metal_driver_cpu * cpu = ( void * ) gcpu;
