 ...
 */
        static inline void POWER_SetBodCoreLevel( power_bod_core_level_t level,
                                                  power_bod_hyst_t hyst,
                                                  bool enBodCoreReset )
        {
    ...
    #endif /* if defined( PMC_BODCORE_TRIGLVL_MASK ) */
 ...
 * @return  none
 */
    extern void POWER_SetXtal16mhzTrim( uint32_t amp,
                                        uint32_t gm );
