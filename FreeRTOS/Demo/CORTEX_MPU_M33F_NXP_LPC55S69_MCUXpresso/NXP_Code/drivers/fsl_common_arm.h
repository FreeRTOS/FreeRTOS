...
/* If the LDREX and STREX are supported, use them. */
    ...
    {                                                         \
        ...
        static inline void _SDK_AtomicLocalAdd1Byte( volatile uint8_t * addr,
                                                     uint8_t val )
        {
            uint8_t s_val;
        ...
        static inline void _SDK_AtomicLocalSub1Byte( volatile uint8_t * addr,
                                                     uint8_t val )
        {
            uint8_t s_val;
    ...
    #else  /* if ( ( defined( __ARM_ARCH_7M__ ) && ( __ARM_ARCH_7M__ == 1 ) ) || ( defined( __ARM_ARCH_7EM__ ) && ( __ARM_ARCH_7EM__ == 1 ) ) || ( defined( __ARM_ARCH_8M_MAIN__ ) && ( __ARM_ARCH_8M_MAIN__ == 1 ) ) || ( defined( __ARM_ARCH_8M_BASE__ ) && ( __ARM_ARCH_8M_BASE__ == 1 ) ) ) */
    ...
    #endif /* if ( ( defined( __ARM_ARCH_7M__ ) && ( __ARM_ARCH_7M__ == 1 ) ) || ( defined( __ARM_ARCH_7EM__ ) && ( __ARM_ARCH_7EM__ == 1 ) ) || ( defined( __ARM_ARCH_8M_MAIN__ ) && ( __ARM_ARCH_8M_MAIN__ == 1 ) ) || ( defined( __ARM_ARCH_8M_BASE__ ) && ( __ARM_ARCH_8M_BASE__ == 1 ) ) ) */
/* @} */
 ...
 */
    ...
    #else  /* if ( ( !( defined( FSL_FEATURE_HAS_NO_NONCACHEABLE_SECTION ) && FSL_FEATURE_HAS_NO_NONCACHEABLE_SECTION ) ) && defined( FSL_FEATURE_L1ICACHE_LINESIZE_BYTE ) ) */
    ...
    #endif /* if ( ( !( defined( FSL_FEATURE_HAS_NO_NONCACHEABLE_SECTION ) && FSL_FEATURE_HAS_NO_NONCACHEABLE_SECTION ) ) && defined( FSL_FEATURE_L1ICACHE_LINESIZE_BYTE ) ) */
 ...
 */
    static inline status_t EnableIRQWithPriority( IRQn_Type interrupt,
                                                  uint8_t priNum )
    {
        status_t status = kStatus_Success;
 ...
 * @retval kStatus_Fail Failed to set the interrupt priority.
 */
    static inline status_t IRQ_SetPriority( IRQn_Type interrupt,
                                            uint8_t priNum )
    {
        status_t status = kStatus_Success;
