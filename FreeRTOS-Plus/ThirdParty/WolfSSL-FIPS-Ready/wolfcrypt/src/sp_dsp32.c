...
/* The base point of curve P256. */
                ...
                static int sp_ecc_point_new_ex( void * heap,
                                                sp_point * sp,
                                                sp_point ** p )
                {
                    int ret = MP_OKAY;
...
/* Set pointer to data and return no error. */
                ...
                static void sp_ecc_point_free( sp_point * p,
                                               int clear,
                                               void * heap )
                {
                    #if defined( WOLFSSL_SP_SMALL ) || defined( WOLFSSL_SMALL_STACK )
/* If valid pointer then clear point data if requested and free data. */
                    ...
                    #else  /* if defined( WOLFSSL_SP_SMALL ) || defined( WOLFSSL_SMALL_STACK ) */
/* Clear point data if requested. */
                        if( clear != 0 )
                        {
                            XMEMSET( p, 0, sizeof( *p ) );
                        }
                    #endif /* if defined( WOLFSSL_SP_SMALL ) || defined( WOLFSSL_SMALL_STACK ) */
                    ( void ) heap;
                }
 ...
 */
                static int sp_256_mod_mul_norm_10( sp_digit * r,
                                                   const sp_digit * a,
                                                   const sp_digit * m )
                {
                    #if defined( WOLFSSL_SP_SMALL ) || defined( WOLFSSL_SMALL_STACK )
 ...
 * respectively.
 */
                static sp_digit sp_256_cmp_10( const sp_digit * a,
                                               const sp_digit * b )
                {
                    sp_digit r = 0;
 ...
 */
                static void sp_256_cond_sub_10( sp_digit * r,
                                                const sp_digit * a,
                                                const sp_digit * b,
                                                const sp_digit m )
                {
 ...
 * b  A scalar.
 */
                SP_NOINLINE static void sp_256_mul_add_10( sp_digit * r,
                                                           const sp_digit * a,
                                                           const sp_digit b )
                {
                    #ifdef WOLFSSL_SP_SMALL
 ...
 */
                static void sp_256_mont_shift_10( sp_digit * r,
                                                  const sp_digit * a )
                {
                    #ifdef WOLFSSL_SP_SMALL
                        int i;
 ...
 */
                static void sp_256_mont_reduce_10( sp_digit * a,
                                                   const sp_digit * m,
                                                   sp_digit mp )
                {
                    sp_digit mu;
 ...
 * b  A single precision integer.
 */
                SP_NOINLINE static void sp_256_mul_10( sp_digit * r,
                                                       const sp_digit * a,
                                                       const sp_digit * b )
                {
                    #if 1
 ...
 */
                static void sp_256_mont_mul_10( sp_digit * r,
                                                const sp_digit * a,
                                                const sp_digit * b,
                                                const sp_digit * m,
                                                sp_digit mp )
 ...
 * a  A single precision integer.
 */
                SP_NOINLINE static void sp_256_sqr_10( sp_digit * r,
                                                       const sp_digit * a )
                {
 ...
 * mp  Montogmery mulitplier.
 */
                static void sp_256_mont_sqr_10( sp_digit * r,
                                                const sp_digit * a,
                                                const sp_digit * m,
                                                sp_digit mp )
                {
 ...
 * mp  Montogmery mulitplier.
 */
                    static void sp_256_mont_sqr_n_10( sp_digit * r,
                                                      const sp_digit * a,
                                                      int n,
                                                      const sp_digit * m,
                                                      sp_digit mp )
 ...
 * td  Temporary data.
 */
                static void sp_256_mont_inv_10( sp_digit * r,
                                                const sp_digit * a,
                                                sp_digit * td )
                {
                    #ifdef WOLFSSL_SP_SMALL
 ...
 */
                static void sp_256_map_10( sp_point * r,
                                           const sp_point * p,
                                           sp_digit * t )
                {
                    sp_digit * t1 = t;
 ...
 * b  A single precision integer.
 */
                SP_NOINLINE static int sp_256_add_10( sp_digit * r,
                                                      const sp_digit * a,
                                                      const sp_digit * b )
                {
                    #if 0
 ...
 * m   Modulus (prime).
 */
                static void sp_256_mont_add_10( sp_digit * r,
                                                const sp_digit * a,
                                                const sp_digit * b,
                                                const sp_digit * m )
                {
 ...
 * m   Modulus (prime).
 */
                static void sp_256_mont_dbl_10( sp_digit * r,
                                                const sp_digit * a,
                                                const sp_digit * m )
                {
 ...
 * m   Modulus (prime).
 */
                static void sp_256_mont_tpl_10( sp_digit * r,
                                                const sp_digit * a,
                                                const sp_digit * m )
                {
                    ( void ) sp_256_add_10( r, a, a );
 ...
 * b  A single precision integer.
 */
                SP_NOINLINE static int sp_256_sub_10( sp_digit * r,
                                                      const sp_digit * a,
                                                      const sp_digit * b )
                {
                    #if 0
 ...
 * m  Mask value to apply.
 */
                static void sp_256_cond_add_10( sp_digit * r,
                                                const sp_digit * a,
                                                const sp_digit * b,
                                                const sp_digit m )
                {
 ...
 * m   Modulus (prime).
 */
                static void sp_256_mont_sub_10( sp_digit * r,
                                                const sp_digit * a,
                                                const sp_digit * b,
                                                const sp_digit * m )
                {
 ...
 * a  Number to shift.
 */
                SP_NOINLINE static void sp_256_rshift1_10( sp_digit * r,
                                                           sp_digit * a )
                {
                    #ifdef WOLFSSL_SP_SMALL
                        int i;
 ...
 * m  Modulus (prime).
 */
                static void sp_256_div2_10( sp_digit * r,
                                            const sp_digit * a,
                                            const sp_digit * m )
                {
 ...
 * t  Temporary ordinate data.
 */
                static void sp_256_proj_point_dbl_10( sp_point * r,
                                                      const sp_point * p,
                                                      sp_digit * t )
                {
                    sp_point * rp[ 2 ];
 ...
 */
                static int sp_256_cmp_equal_10( const sp_digit * a,
                                                const sp_digit * b )
                {
 ...
 * t  Temporary ordinate data.
 */
                static void sp_256_proj_point_add_10( sp_point * r,
                                                      const sp_point * p,
                                                      const sp_point * q,
                                                      sp_digit * t )
                {
 ...
 */
                    static int sp_256_ecc_mulmod_10( sp_point * r,
                                                     const sp_point * g,
                                                     const sp_digit * k,
                                                     int map,
                                                     void * heap )
 ...
 * returns MEMORY_E when memory allocation fails and MP_OKAY on success.
 */
                    static int sp_256_ecc_mulmod_fast_10( sp_point * r,
                                                          const sp_point * g,
                                                          const sp_digit * k,
                                                          int map,
                                                          void * heap )
 ...
 * t  Temporary ordinate data.
 */
                        static void sp_256_proj_point_dbl_n_10( sp_point * r,
                                                                const sp_point * p,
                                                                int n,
                                                                sp_digit * t )
                        {
 ...
 * t  Temporary ordinate data.
 */
                    static void sp_256_proj_point_add_qz1_10( sp_point * r,
                                                              const sp_point * p,
                                                              const sp_point * q,
                                                              sp_digit * t )
                    {
 ...
 * t  Temporary data.
 */
                        static void sp_256_proj_to_affine_10( sp_point * a,
                                                              sp_digit * t )
                        {
                            sp_digit * t1 = t;
                            sp_digit * t2 = t + 2 * 10;
 ...
 * returns MEMORY_E when memory allocation fails and MP_OKAY on success.
 */
                    static int sp_256_ecc_mulmod_stripe_10( sp_point * r,
                                                            const sp_point * g,
                                                            const sp_table_entry * table,
                                                            const sp_digit * k,
                                                            int map,
                                                            void * heap )
                    {
                        ...
                        static void sp_ecc_get_cache( const sp_point * g,
                                                      sp_cache_t ** cache )
                        {
                            int i, j;
                            uint32_t least;
 ...
 * returns MEMORY_E when memory allocation fails and MP_OKAY on success.
 */
                    static int sp_256_ecc_mulmod_base_10( sp_point * r,
                                                          const sp_digit * k,
                                                          int map,
                                                          void * heap )
                    {
 ...
 * b  A scalar.
 */
                    SP_NOINLINE static void sp_256_mul_d_10( sp_digit * r,
                                                             const sp_digit * a,
                                                             sp_digit b )
                    {
                        #ifdef WOLFSSL_SP_SMALL
                        ...
                        static WC_INLINE sp_digit sp_256_div_word_10( sp_digit d1,
                                                                      sp_digit d0,
                                                                      sp_digit dv )
                        {
                            sp_digit d, r, t, dv;
 ...
 */
                    static int sp_256_div_10( const sp_digit * a,
                                              const sp_digit * d,
                                              sp_digit * m,
                                              sp_digit * r )
                    {
 ...
 * returns MEMORY_E when unable to allocate memory and MP_OKAY otherwise.
 */
                    static int sp_256_mod_10( sp_digit * r,
                                              const sp_digit * a,
                                              const sp_digit * m )
                    {
 ...
 */
                    static void sp_256_mont_mul_order_10( sp_digit * r,
                                                          const sp_digit * a,
                                                          const sp_digit * b )
                    {
                        sp_256_mul_10( r, a, b );
 ...
 * a  Number to square.
 */
                    static void sp_256_mont_sqr_order_10( sp_digit * r,
                                                          const sp_digit * a )
                    {
                        sp_256_sqr_10( r, a );
                        sp_256_mont_reduce_order_10( r, p256_order, p256_mp_order );
 ...
 * a  Number to square.
 */
                        static void sp_256_mont_sqr_n_order_10( sp_digit * r,
                                                                const sp_digit * a,
                                                                int n )
                        {
                            int i;
 ...
 * td  Temporary data.
 */
                    static void sp_256_mont_inv_order_10( sp_digit * r,
                                                          const sp_digit * a,
                                                          sp_digit * td )
                    {
                        #ifdef WOLFSSL_SP_SMALL
 ...
 * MP_OKAY on success.
 */
                    int wolfSSL_DSP_ECC_Verify_256( remote_handle64 h,
                                                    int32 * u1,
                                                    int hashLen,
                                                    int32 * r,
                                                    int rSz,
...
/** Free the Fixed Point cache */
                    ...
                    AEEResult wolfSSL_open( const char * uri,
 ...
 */
                    int sp_ecc_proj_add_point_256( mp_int * pX,
                                                   mp_int * pY,
                                                   mp_int * pZ,
                                                   mp_int * qX,
                                                   mp_int * qY,
 ...
 * returns MEMORY_E if dynamic memory allocation fails and MP_OKAY otherwise.
 */
                    int sp_ecc_proj_dbl_point_256( mp_int * pX,
                                                   mp_int * pY,
                                                   mp_int * pZ,
                                                   mp_int * rX,
                                                   mp_int * rY,
 ...
 * returns MEMORY_E if dynamic memory allocation fails and MP_OKAY otherwise.
 */
                    int sp_ecc_uncompress_256( mp_int * xm,
                                               int odd,
                                               mp_int * ym )
                    {
                        #if defined( WOLFSSL_SP_SMALL ) || defined( WOLFSSL_SMALL_STACK )
