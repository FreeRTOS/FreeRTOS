...
#include <wolfssl/wolfcrypt/settings.h>
        ...
        int InitOCSP( WOLFSSL_OCSP * ocsp,
        ...
        static int InitOcspEntry( OcspEntry * entry,
                                  OcspRequest * request )
        {
        ...
        void FreeOCSP( WOLFSSL_OCSP * ocsp,
                       int dynamic )
        {
 ...
 * But no store available to verify certificate. */
            ...
            int wolfSSL_i2d_OCSP_REQUEST( OcspRequest * request,
                                          unsigned char ** data )
            {
                int size;
 ...
 */
            int wolfSSL_OCSP_check_nonce( OcspRequest * req,
                                          WOLFSSL_OCSP_BASICRESP * bs )
            {
                byte * reqNonce = NULL;
                byte * rspNonce = NULL;
